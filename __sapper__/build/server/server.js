...
const Origin = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `
	<div id="letter" class="svelte-rgrdu4">
	  <h1 id="letter-header" class="svelte-rgrdu4">The Origins of Theta Tau</h1>
	  <p class="svelte-rgrdu4">
	    In the Spring of 2009, several students of UCSD's Jacobs School of
	    Engineering felt that there was a lack of engineering representation in the
	    Greek community on campus. Luckily an opportunity arose for them to change
	    that.
	  ...
	  <img id="founders" src="images/founders.jpg" alt="the mighty founders" class="svelte-rgrdu4">
	  <img src="images/hamntongs.png" alt="the seals" class="svelte-rgrdu4">
