...
const css$2 = {
	code: ".pillars.svelte-1b94ul9{display:flex;flex-direction:row;margin:1em 0}.pillar.svelte-1b94ul9{display:flex;flex-direction:column;align-items:center;width:40em;max-width:calc(33vw - 10em);border:4px maroon solid;margin:1em;padding:2em;background-color:white}.pillar.svelte-1b94ul9 img.svelte-1b94ul9{width:10em}.pillar.svelte-1b94ul9 h4.svelte-1b94ul9{font-size:1.8em;color:maroon;text-align:center;border-bottom:3px maroon solid}@media(max-width: 1000px){.pillars.svelte-1b94ul9{flex-direction:column}.pillar.svelte-1b94ul9{max-width:calc(100vw - 6em);width:30em}}",
...
const Pillars = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="pillars svelte-1b94ul9">
	  <div class="pillar svelte-1b94ul9">
	    <img src="icons/pillar.png" alt="pillar" class="svelte-1b94ul9">
	    <h4 class="svelte-1b94ul9">Brotherhood</h4>
	    <p>
	      We strive to make the group as
	      <strong>closely knit as possible</strong>
	      throughout one’s college years. Our goal is to develop bonds between our
	  ...
	  <div class="pillar svelte-1b94ul9">
	    <img src="icons/pillar.png" alt="pillar" class="svelte-1b94ul9">
	    <h4 class="svelte-1b94ul9">Philanthropy</h4>
	    <p>
	      For the purpose of our members’ personal growth, as well as our
	      community’s benefits, we are involved in projects that <strong>give back 
	      to the community</strong> around us. Serving alongside brothers will 
	  ...
	  <div class="pillar svelte-1b94ul9">
	    <img src="icons/pillar.png" alt="pillar" class="svelte-1b94ul9">
	    <h4 class="svelte-1b94ul9">Professionalism</h4>
	    <p>
	      We also seek to shape up one’s professional interests to prepare them for
	      their <strong>life ahead of college</strong>. We plan various 
	      <strong>networking opportunities</strong> as well as events that provide 
...
const css$4 = {
	code: ".hero-div.svelte-171vvm7{height:32em;max-width:50em}p.svelte-171vvm7{padding:0 2em 1em 1em}@media(max-width: 999px){.hero-div.svelte-171vvm7{height:20em}body{background-color:white}h3.svelte-171vvm7{text-align:center}}figcaption.svelte-171vvm7{text-align:center;font-size:1.4em}#rush-video.svelte-171vvm7{max-width:40vw}",
...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const brotherLabels = [
	...
	<div class="hero-div svelte-171vvm7">
	...
	${validate_component(Card, 'Card').$$render($$result, {}, {}, {
		default: () => `
	  `,
		header: () => `<h3 slot="header" class="svelte-171vvm7">
	    <strong>UC San Diego's premier engineering fraternity</strong>
	  </h3>
	  `,
		left: () => `<section slot="left">
	    <p class="svelte-171vvm7">
	      Formed in 1904 with chapters in over 80 campuses, Theta Tau is both the
	      <strong>nation's largest and oldest co-ed engineering fraternity</strong>.
	      Our brothers develop each other to not only focus on one aspect of
	      ourselves, but on many. We strive to be well-rounded people who excel in
...
const css$5 = {
	code: ".button-wrapper.svelte-1ox04ca{display:flex;justify-items:center}.carousel-button.svelte-1ox04ca{z-index:2;padding:0.3em;border-radius:1em;font-size:2em;font-weight:900;color:gold;border:3px white solid;background-color:black;cursor:pointer}.button-left.svelte-1ox04ca{margin:auto 1em auto}.button-right.svelte-1ox04ca{margin:auto 0 auto 1em}.carousel-wrapper.svelte-1ox04ca{width:70vw;height:70vh;background-color:gold;border:7px black solid;box-shadow:0 0 10px 10px goldenrod;padding:2em}.carousel.svelte-1ox04ca{position:relative;width:70vw;height:70vh;overflow:hidden}.carousel.svelte-1ox04ca img.svelte-1ox04ca{position:absolute;top:-9999px;left:-9999px;right:-9999px;bottom:-9999px;margin:auto}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\n  export let images;\\n  import { onMount } from \\\"svelte\\\";\\n  import { fade, fly } from \\\"svelte/transition\\\";\\n\\n  let image = images[0];\\n  let index = 0;\\n  let visible = true;\\n  let interval;\\n\\n  function nextImage() {\\n    visible = false;\\n    setTimeout(() => {\\n      visible = true;\\n      index = (index + 1) % images.length;\\n      image = images[index];\\n    }, 300);\\n  }\\n\\n  function prevImage() {\\n    visible = false;\\n    setTimeout(() => {\\n      visible = true;\\n      index = (index + images.length - 1) % images.length;\\n      image = images[index];\\n    }, 300);\\n  }\\n\\n  function handleNextClick() {\\n    clearInterval(interval);\\n    nextImage();\\n    interval = setInterval(nextImage, 3000);\\n  }\\n\\n  function handlePrevClick() {\\n    clearInterval(interval);\\n    prevImage();\\n    interval = setInterval(prevImage, 3000);\\n  }\\n\\n  onMount(() => {\\n    interval = setInterval(nextImage, 3000);\\n\\n    return () => clearInterval(interval);\\n  });\\n</script>\\n\\n<style>\\n  .button-wrapper {\\n    display: flex;\\n    /* flex-direction: row; */\\n    justify-items: center;\\n  }\\n\\n  .carousel-button {\\n    z-index: 2;\\n    padding: 0.3em;\\n    border-radius: 1em;\\n    font-size: 2em;\\n    font-weight: 900;\\n    color: gold;\\n    border: 3px white solid;\\n    background-color: black;\\n    cursor: pointer;\\n  }\\n\\n  .button-left {\\n    margin: auto 1em auto;\\n    }\\n\\n  .button-right {\\n    margin: auto 0 auto 1em;\\n  }\\n\\n  .carousel-wrapper {\\n    width: 70vw;\\n    height: 70vh;\\n    background-color: gold;\\n    border: 7px black solid;\\n    box-shadow: 0 0 10px 10px goldenrod;\\n    padding: 2em;\\n  }\\n\\n  .carousel {\\n  position: relative;\\n    width: 70vw;\\n    height: 70vh;\\n    overflow: hidden;\\n  }\\n  \\n  .carousel img {\\n    position: absolute;\\n    top: -9999px;\\n    left: -9999px;\\n    right: -9999px;\\n    bottom: -9999px;\\n    margin: auto;\\n  }\\n</style>\\n\\n<div class=\\\"button-wrapper\\\">\\n  <button \\n    on:click=\\\"{handlePrevClick}\\\"\\n    class=\\\"carousel-button button-left\\\"\\n  >\\n    &lt;\\n  </button>\\n  <div class=\\\"carousel-wrapper\\\">\\n    {#if visible}\\n      <div class=\\\"carousel\\\">\\n        <img src={image} alt=\\\"pillar image\\\" transition:fade=\\\"{{duration:100}}\\\" />\\n      </div>\\n    {/if}\\n  </div>\\n  <button\\n    on:click=\\\"{handleNextClick}\\\" \\n    class=\\\"carousel-button button-right\\\"\\n  >\\n    &gt;\\n  </button>\\n</div>\"],\"names\":[],\"mappings\":\"AAgDE,eAAe,eAAC,CAAC,AACf,OAAO,CAAE,IAAI,CAEb,aAAa,CAAE,MAAM,AACvB,CAAC,AAED,gBAAgB,eAAC,CAAC,AAChB,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,KAAK,CACd,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,GAAG,CACd,WAAW,CAAE,GAAG,CAChB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,gBAAgB,CAAE,KAAK,CACvB,MAAM,CAAE,OAAO,AACjB,CAAC,AAED,YAAY,eAAC,CAAC,AACZ,MAAM,CAAE,IAAI,CAAC,GAAG,CAAC,IAAI,AACrB,CAAC,AAEH,aAAa,eAAC,CAAC,AACb,MAAM,CAAE,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,GAAG,AACzB,CAAC,AAED,iBAAiB,eAAC,CAAC,AACjB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,gBAAgB,CAAE,IAAI,CACtB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,IAAI,CAAC,SAAS,CACnC,OAAO,CAAE,GAAG,AACd,CAAC,AAED,SAAS,eAAC,CAAC,AACX,QAAQ,CAAE,QAAQ,CAChB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,MAAM,AAClB,CAAC,AAED,wBAAS,CAAC,GAAG,eAAC,CAAC,AACb,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,OAAO,CACZ,IAAI,CAAE,OAAO,CACb,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,OAAO,CACf,MAAM,CAAE,IAAI,AACd,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  onMount(() => {
	...
	return `<div class="button-wrapper svelte-1ox04ca">
	  <button class="carousel-button button-left svelte-1ox04ca">
	    &lt;
	  </button>
	  <div class="carousel-wrapper svelte-1ox04ca">
	    ${ visible ? `<div class="carousel svelte-1ox04ca">
	        <img${(v => v == null ? "" : ` src="${escape(image)}"`)(image)} alt="pillar image" class="svelte-1ox04ca">
	      </div>` : `` }
	  </div>
	  <button class="carousel-button button-right svelte-1ox04ca">
	    &gt;
	  </button>
	</div>`;
});
...
const Origin = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `
	<div id="letter" class="svelte-a4aodc">
	  <h1 id="letter-header" class="svelte-a4aodc">The Origins of Theta Tau</h1>
	  <p class="svelte-a4aodc">
	    In the Spring of 2009, several students of UCSD's Jacobs School of
	    Engineering felt that there was a lack of engineering representation in the
	    Greek community on campus. Luckily an opportunity arose for them to change
	    that.
	  ...
	  <img id="founders" src="images/founders.jpg" alt="the mighty founders" class="svelte-a4aodc">
	  <img src="images/hamntongs.png" alt="the seals" class="svelte-a4aodc">
...
const About = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const images = [
	...
	${validate_component(Carousel, 'Carousel').$$render($$result, { images: images }, {}, {})}
