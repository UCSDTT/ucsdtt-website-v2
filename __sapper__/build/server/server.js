...
const Origin = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `
	<div id="letter" class="svelte-tlsyle">
	  <h1 id="letter-header" class="svelte-tlsyle">The Origins of Theta Tau</h1>
	  <p class="svelte-tlsyle">
	    In the Spring of 2009, several students of UCSD's Jacobs School of
	    Engineering felt that there was a lack of engineering representation in the
	    Greek community on campus. Luckily an opportunity arose for them to change
	    that.
	  ...
	  <img id="founders" src="images/founders.jpg" alt="the mighty founders" class="svelte-tlsyle">
	  <img src="images/hamntongs.png" alt="the seals" class="svelte-tlsyle">
