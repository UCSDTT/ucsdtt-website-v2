...
const css = {
	code: ".parallax.svelte-13iz6yw{position:absolute;width:50em;height:30em;left:10em;will-change:transform;display:none}@media(min-width: 1000px){.parallax.svelte-13iz6yw{display:block}}@media(max-width: 999px){h1.text-display.svelte-13iz6yw{top:1em;font-size:3em}}h1.text-display.svelte-13iz6yw{position:absolute;text-align:center;top:1.9em;left:0.1em;right:0.1em;color:white;text-shadow:0 0 10px black;font-size:5em;padding:0.1em;background-color:rgba(128, 0, 0, 0.7);z-index:1}",
	map: "{\"version\":3,\"file\":\"Hero.svelte\",\"sources\":[\"Hero.svelte\"],\"sourcesContent\":[\"<!-- Taken from https://github.com/sveltejs/site-kit/blob/master/components/ParallaxLogo.svelte -->\\n<script>\\n\\timport { fade, fly } from 'svelte/transition';\\n\\timport { onMount } from 'svelte';\\n\\n\\tlet visible = false;\\n\\n\\texport let svg;\\n\\texport let titleBig;\\n\\texport let titleSmall;\\n\\n\\tlet sy = 0;\\n\\tlet iw = 0;\\n\\n\\t$: dispSmall = iw <= 1000;\\n\\n\\tonMount(()=> {\\n\\t\\tvisible = true;\\n\\t})\\n</script>\\n\\n<svelte:window bind:scrollY={sy} bind:innerWidth={iw}/>\\n\\n<style>\\n\\t.parallax {\\n\\t\\tposition: absolute;\\n\\t\\twidth: 50em;\\n\\t\\theight: 30em;\\n\\t\\tleft: 10em;\\n\\t\\twill-change: transform;\\n\\t\\tdisplay: none;\\n\\t}\\n\\n\\t@media (min-width: 1000px) {\\n\\t\\t.parallax {\\n\\t\\t\\tdisplay: block;\\n\\t\\t}\\n\\t}\\n\\t@media (max-width: 999px) {\\n\\t\\th1.text-display {\\n\\t\\t\\ttop: 1em;\\n\\t\\t\\tfont-size: 3em;\\n\\t\\t}\\n\\t}\\n\\n\\th1.text-display {\\n\\t\\tposition: absolute;\\n\\t\\ttext-align: center;\\n\\t\\ttop: 1.9em;\\n\\t\\tleft: 0.1em;\\n\\t\\tright: 0.1em;\\n\\t\\tcolor: white;\\n\\t\\ttext-shadow: 0 0 10px black;\\n\\t\\tfont-size: 5em;\\n\\t\\tpadding: 0.1em;\\n\\t\\tbackground-color: rgba(128, 0, 0, 0.7);\\n\\t\\tz-index: 1;\\n\\t}\\n\\n\\n</style>\\n\\n{#if visible}\\n\\t<h1 \\n\\t\\tclass=\\\"text-display lg-view\\\" \\n\\t\\tin:fade\\n\\t>\\n\\t\\t{dispSmall ? titleSmall : titleBig}\\n\\t</h1>\\n{/if}\\n{#if visible}\\n\\t<svg \\n\\t\\txmlns=\\\"http://www.w3.org/2000/svg\\\"\\n\\t\\tviewBox=\\\"0 0 64 64\\\"\\n\\t\\twidth=\\\"64px\\\"\\n\\t\\theight=\\\"64px\\\"\\n\\t\\tclass=\\\"parallax\\\"\\n\\t\\tstyle=\\\"transform: translate(0, {sy * .4}px)\\\"\\n\\t>\\n\\t\\t<path\\n\\t\\t\\td={svg}\\n\\t\\t\\topacity=\\\"0.6\\\" \\n\\t\\t\\tin:fly=\\\"{{y: -5, delay: 250}}\\\"\\n\\t\\t/>\\n\\t</svg>\\n{/if}\\n\\n\\t<!-- <img {alt} {src} class=\\\"parallax\\\" style=\\\"transform: translate(0, {sy * .4}px)\\\"> -->\"],\"names\":[],\"mappings\":\"AAwBC,SAAS,eAAC,CAAC,AACV,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,IAAI,CAAE,IAAI,CACV,WAAW,CAAE,SAAS,CACtB,OAAO,CAAE,IAAI,AACd,CAAC,AAED,MAAM,AAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC3B,SAAS,eAAC,CAAC,AACV,OAAO,CAAE,KAAK,AACf,CAAC,AACF,CAAC,AACD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,EAAE,aAAa,eAAC,CAAC,AAChB,GAAG,CAAE,GAAG,CACR,SAAS,CAAE,GAAG,AACf,CAAC,AACF,CAAC,AAED,EAAE,aAAa,eAAC,CAAC,AAChB,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,MAAM,CAClB,GAAG,CAAE,KAAK,CACV,IAAI,CAAE,KAAK,CACX,KAAK,CAAE,KAAK,CACZ,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,KAAK,CAC3B,SAAS,CAAE,GAAG,CACd,OAAO,CAAE,KAAK,CACd,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACtC,OAAO,CAAE,CAAC,AACX,CAAC\"}"
};
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	${ visible ? `<h1 class="text-display lg-view svelte-13iz6yw">
			${escape( titleSmall )}
		</h1>` : `` }
	${ visible ? `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64px" height="64px" class="parallax svelte-13iz6yw" style="transform: translate(0, ${escape(sy * .4)}px)">
...
const css$2 = {
	code: "ul.pillared.svelte-1ww5203{list-style-type:none;padding:0;margin:0}ul.pillared.svelte-1ww5203 li.svelte-1ww5203{margin:0.5em;padding:1em;font-size:2em;display:flex;align-items:center}ul.pillared.svelte-1ww5203 li span.svelte-1ww5203{color:white;padding-left:0.5em}ul.pillared.svelte-1ww5203 li.svelte-1ww5203:hover{cursor:pointer;background-color:rgba(50, 50, 50, 0.5);background-clip:border-box;border-radius:1em;text-decoration:underline;text-decoration-color:goldenrod}ul.pillared.svelte-1ww5203 li:hover img.svelte-1ww5203{filter:drop-shadow(0 0 0.3em yellow)}h2.modal-li.svelte-1ww5203{font-size:2em;margin:initial;padding:0.4em}li.modal-li.svelte-1ww5203{font-size:1.4em;padding:0}img[src=\"icons/pillar-white.png\"].svelte-1ww5203{height:2em;border-radius:1em}",
	map: "{\"version\":3,\"file\":\"Pillars.svelte\",\"sources\":[\"Pillars.svelte\"],\"sourcesContent\":[\"<script>\\n    import {fade} from 'svelte/transition';\\n    import Modal from './Modal.svelte';\\n\\n    let broVis = false;\\n    let philVis = false;\\n    let proVis = false;\\n</script>\\n\\n<style>\\n    ul.pillared {\\n        list-style-type: none;\\n        padding: 0;\\n        margin: 0;\\n    }\\n\\n    ul.pillared li {\\n        margin: 0.5em;\\n        padding: 1em;\\n        font-size: 2em;\\n        display: flex;\\n        /* justify-items: center; */\\n        align-items: center;\\n    }\\n    ul.pillared li span {\\n        color: white;\\n        padding-left: 0.5em;\\n    }\\n\\n    ul.pillared li:hover{\\n        cursor: pointer;\\n        background-color: rgba(50, 50, 50, 0.5);\\n        background-clip: border-box;\\n        border-radius: 1em;\\n        text-decoration: underline;\\n        text-decoration-color: goldenrod;\\n    }\\n\\n    ul.pillared li:hover img {\\n        filter: drop-shadow(0 0 0.3em yellow);\\n    }\\n\\n    h2.modal-li {\\n        font-size: 2em;\\n        margin: initial;\\n        padding: 0.4em;\\n    }\\n\\n    li.modal-li {\\n        font-size: 1.4em;\\n        padding: 0;\\n    }\\n\\n    img[src=\\\"icons/pillar-white.png\\\"] {\\n        height: 2em;\\n        border-radius: 1em;\\n    }\\n\\n</style>\\n\\n<ul class=\\\"pillared\\\">\\n    <li on:click={() => broVis = true}>\\n        <img src=\\\"icons/pillar-white.png\\\" alt=\\\"pillar\\\">\\n        <span>Brotherhood</span>\\n    </li>\\n    <li on:click={() => philVis = true}>\\n        <img src=\\\"icons/pillar-white.png\\\" alt=\\\"pillar\\\">\\n        <span>Philanthropy</span>\\n    </li>\\n    <li on:click={() => proVis = true}>\\n        <img src=\\\"icons/pillar-white.png\\\" alt=\\\"pillar\\\">\\n        <span>Professionalism</span>\\n    </li>\\n</ul>\\n\\n{#if broVis}\\n    <Modal on:close=\\\"{() => broVis = false}\\\">\\n        <h2 class=\\\"modal-li\\\" slot=\\\"header\\\">Brotherhood</h2>\\n        <ul>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n        </ul>\\n        <img src=\\\"images/sigma_fun.jpg\\\" alt=\\\"sigmas having fun\\\" width=\\\"100%\\\">\\n    </Modal>\\n{/if}\\n\\n{#if philVis}\\n    <Modal on:close=\\\"{() => philVis = false}\\\">\\n        <h2 class=\\\"modal-li\\\" slot=\\\"header\\\">Philanthropy</h2>\\n        <ul>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n        </ul>\\n        <img src=\\\"images/sigma_fun.jpg\\\" alt=\\\"sigmas having fun\\\" width=\\\"100%\\\">\\n    </Modal>\\n{/if}\\n\\n{#if proVis}\\n    <Modal on:close=\\\"{() => proVis = false}\\\">\\n        <h2 class=\\\"modal-li\\\" slot=\\\"header\\\">Professionalism</h2>\\n        <ul>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n        </ul>\\n        <img src=\\\"images/sigma_fun.jpg\\\" alt=\\\"sigmas having fun\\\" width=\\\"100%\\\">\\n    </Modal>\\n{/if}\"],\"names\":[],\"mappings\":\"AAUI,EAAE,SAAS,eAAC,CAAC,AACT,eAAe,CAAE,IAAI,CACrB,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,CAAC,AACb,CAAC,AAED,EAAE,wBAAS,CAAC,EAAE,eAAC,CAAC,AACZ,MAAM,CAAE,KAAK,CACb,OAAO,CAAE,GAAG,CACZ,SAAS,CAAE,GAAG,CACd,OAAO,CAAE,IAAI,CAEb,WAAW,CAAE,MAAM,AACvB,CAAC,AACD,EAAE,wBAAS,CAAC,EAAE,CAAC,IAAI,eAAC,CAAC,AACjB,KAAK,CAAE,KAAK,CACZ,YAAY,CAAE,KAAK,AACvB,CAAC,AAED,EAAE,wBAAS,CAAC,iBAAE,MAAM,CAAC,AACjB,MAAM,CAAE,OAAO,CACf,gBAAgB,CAAE,KAAK,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,CACvC,eAAe,CAAE,UAAU,CAC3B,aAAa,CAAE,GAAG,CAClB,eAAe,CAAE,SAAS,CAC1B,qBAAqB,CAAE,SAAS,AACpC,CAAC,AAED,EAAE,wBAAS,CAAC,EAAE,MAAM,CAAC,GAAG,eAAC,CAAC,AACtB,MAAM,CAAE,YAAY,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,MAAM,CAAC,AACzC,CAAC,AAED,EAAE,SAAS,eAAC,CAAC,AACT,SAAS,CAAE,GAAG,CACd,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,KAAK,AAClB,CAAC,AAED,EAAE,SAAS,eAAC,CAAC,AACT,SAAS,CAAE,KAAK,CAChB,OAAO,CAAE,CAAC,AACd,CAAC,AAED,GAAG,CAAC,GAAG,CAAC,wBAAwB,CAAC,eAAC,CAAC,AAC/B,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,GAAG,AACtB,CAAC\"}"
};
...
const Pillars = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="pillared svelte-1ww5203">
	    <li class="svelte-1ww5203">
	        <img src="icons/pillar-white.png" alt="pillar" class="svelte-1ww5203">
	        <span class="svelte-1ww5203">Brotherhood</span>
	    </li>
	    <li class="svelte-1ww5203">
	        <img src="icons/pillar-white.png" alt="pillar" class="svelte-1ww5203">
	        <span class="svelte-1ww5203">Philanthropy</span>
	    </li>
	    <li class="svelte-1ww5203">
	        <img src="icons/pillar-white.png" alt="pillar" class="svelte-1ww5203">
	        <span class="svelte-1ww5203">Professionalism</span>
	    </li>
	</ul>
...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="hero-div svelte-12z78b6">
	...
	<div class="pillars-div svelte-12z78b6">
		<h1 class="svelte-12z78b6">the Three Pillars</h1>
	...
	<br>
	<br>
	<p class="svelte-12z78b6">Icons from <a href="https://icons8.com/icons">icons8</a></p>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="svelte-nu110m">
		<ul class="svelte-nu110m">
			<li class="svelte-nu110m"><a id="letters" href="." class="svelte-nu110m">Θ Τ</a></li>
			<li class="svelte-nu110m"><a class="${escape(segment === undefined ? "selected" : "")} svelte-nu110m" href=".">Home</a></li>
			<li class="svelte-nu110m"><a class="${escape(segment === "about" ? "selected" : "")} svelte-nu110m" href="about">About</a></li>
			<li class="svelte-nu110m"><a class="${escape(segment === "rush" ? "selected" : "")} svelte-nu110m" href="rush">Rush</a></li>
			<li class="svelte-nu110m"><a class="${escape(segment === "faq" ? "selected" : "")} svelte-nu110m" href="faq">FAQ</a></li>
			<li class="svelte-nu110m"><a class="${escape(segment === "members" ? "selected" : "")} svelte-nu110m" href="members">Members</a></li>
		</ul>
	</nav>`;
});
