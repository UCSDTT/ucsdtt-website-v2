...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  onMount(() => {
	...
	return `<div class="button-wrapper svelte-smhls4">
	  <button class="carousel-button button-left svelte-smhls4">
	    &lt;
	  </button>
	  <div class="carousel-wrapper svelte-smhls4">
	    ${ visible ? `<div class="carousel svelte-smhls4">
	        <img${(v => v == null ? "" : ` src="${escape(image)}"`)(image)} alt="pillar image" class="svelte-smhls4">
	      </div>` : `` }
	  </div>
	  <button class="carousel-button button-right svelte-smhls4">
	    &gt;
	  </button>
	</div>`;
});
