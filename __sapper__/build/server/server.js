...
const PledgeClass = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  let my, mx;
	...
	${ boxVisible ? `<div class="cursor-box svelte-1ct97j0" style="
	      top: ${escape(picY)};
	      left: ${escape(picX)};
	    ">
	</div>` : `` }

	<div class="class-img-container svelte-1ct97j0">
	  <img class="class-img svelte-1ct97j0"${(v => v == null ? "" : ` src="${escape(curClass.image)}"`)(curClass.image)}${(v => v == null ? "" : ` alt="${escape(curClass.className)}"`)(curClass.className)}>
	</div>
