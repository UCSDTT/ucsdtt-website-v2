...
const css$5 = {
	code: ".button-wrapper.svelte-18fvrgx{display:flex;justify-items:center}.carousel-button.svelte-18fvrgx{z-index:2;padding:0.3em;border-radius:1em;font-size:30px;font-weight:900;color:gold;border:3px white solid;background-color:black;cursor:pointer}.button-left.svelte-18fvrgx{margin:auto 1em auto 0}.button-right.svelte-18fvrgx{margin:auto 0 auto 1em}.carousel-wrapper.svelte-18fvrgx{width:70vw;max-width:calc(100vw - 10em);height:70vh;border:7px black solid;background-color:white;box-shadow:0 0 10px 10px goldenrod;padding:2em}.carousel.svelte-18fvrgx{position:relative;width:70vw;max-width:calc(100vw - 10em);height:70vh;overflow:hidden}.carousel.svelte-18fvrgx img.svelte-18fvrgx{position:absolute;top:-9999px;left:-9999px;right:-9999px;bottom:-9999px;margin:auto}.carousel-caption.svelte-18fvrgx{display:block;width:70vw;max-width:calc(100vw - 10em);margin-top:2em;margin-left:auto;margin-right:auto;border:4px black solid;background-color:white;font-size:1.4em;text-align:center}.figure-wrapper.svelte-18fvrgx{margin:0}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\n  export let images;\\n  export let caption;\\n\\n  import { onMount } from \\\"svelte\\\";\\n  import { fade, fly } from \\\"svelte/transition\\\";\\n\\n  let image = images[0];\\n  let index = 0;\\n  let visible = true;\\n  let interval;\\n  let iw;\\n\\n  // Lowkey a race condition, but we will fix that later\\n  function nextImage() {\\n    visible = false;\\n    setTimeout(() => {\\n      visible = true;\\n      index = (index + 1) % images.length;\\n      image = images[index];\\n    }, 700);\\n  }\\n\\n  function prevImage() {\\n    visible = false;\\n    setTimeout(() => {\\n      visible = true;\\n      index = (index + images.length - 1) % images.length;\\n      image = images[index];\\n    }, 700);\\n  }\\n\\n  function handleNextClick() {\\n    clearInterval(interval);\\n    if (!visible) {\\n      index = (index + 1) % images.length;\\n      return;\\n    }\\n    nextImage();\\n    interval = setInterval(nextImage, 3900);\\n  }\\n\\n  function handlePrevClick() {\\n    clearInterval(interval);\\n    if (!visible) {\\n      index = (index + images.length - 1) % images.length;\\n      return;\\n    }\\n    prevImage();\\n    interval = setInterval(prevImage, 3900);\\n  }\\n\\n  onMount(() => {\\n    interval = setInterval(nextImage, 3900);\\n\\n    return () => clearInterval(interval);\\n  });\\n</script>\\n\\n<svelte:window bind:innerWidth={iw} />\\n\\n<style>\\n  .button-wrapper {\\n    display: flex;\\n    /* flex-direction: row; */\\n    justify-items: center;\\n  }\\n\\n  .carousel-button {\\n    z-index: 2;\\n    padding: 0.3em;\\n    border-radius: 1em;\\n    font-size: 30px;\\n    font-weight: 900;\\n    color: gold;\\n    border: 3px white solid;\\n    background-color: black;\\n    cursor: pointer;\\n  }\\n\\n  .button-left {\\n    margin: auto 1em auto 0;\\n  }\\n\\n  .button-right {\\n    margin: auto 0 auto 1em;\\n  }\\n\\n  .carousel-wrapper {\\n    width: 70vw;\\n    max-width: calc(100vw - 10em);\\n    height: 70vh;\\n    border: 7px black solid;\\n    background-color: white;\\n    /* background: radial-gradient(maroon, gold 60%); */\\n    box-shadow: 0 0 10px 10px goldenrod;\\n    padding: 2em;\\n  }\\n\\n  .carousel {\\n    position: relative;\\n    width: 70vw;\\n    max-width: calc(100vw - 10em);\\n    height: 70vh;\\n    overflow: hidden;\\n  }\\n\\n  .carousel img {\\n    position: absolute;\\n    top: -9999px;\\n    left: -9999px;\\n    right: -9999px;\\n    bottom: -9999px;\\n    margin: auto;\\n  }\\n\\n  .carousel-caption {\\n    display: block;\\n    width: 70vw;\\n    max-width: calc(100vw - 10em);\\n    margin-top: 2em;\\n    margin-left: auto;\\n    margin-right: auto;\\n    border: 4px black solid;\\n    background-color: white;\\n    font-size: 1.4em;\\n    text-align: center;\\n  }\\n\\n  .figure-wrapper {\\n    margin: 0;\\n  }\\n</style>\\n\\n<figure class=\\\"figure-wrapper\\\">\\n  <div class=\\\"button-wrapper\\\">\\n    {#if iw > 1000}\\n      <button on:click={handlePrevClick} class=\\\"carousel-button button-left\\\">\\n        &lt;\\n      </button>\\n    {/if}\\n    <div class=\\\"carousel-wrapper\\\">\\n      {#if visible}\\n        <div class=\\\"carousel\\\">\\n          <img\\n            src={image}\\n            alt=\\\"pillar image\\\"\\n            transition:fade={{ duration: 500 }} />\\n        </div>\\n      {/if}\\n    </div>\\n    {#if iw > 1000}\\n      <button on:click={handleNextClick} class=\\\"carousel-button button-right\\\">\\n        &gt;\\n      </button>\\n    {/if}\\n  </div>\\n  <figcaption class=\\\"carousel-caption\\\">{caption}</figcaption>\\n</figure>\\n\\n\"],\"names\":[],\"mappings\":\"AA8DE,eAAe,eAAC,CAAC,AACf,OAAO,CAAE,IAAI,CAEb,aAAa,CAAE,MAAM,AACvB,CAAC,AAED,gBAAgB,eAAC,CAAC,AAChB,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,KAAK,CACd,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,gBAAgB,CAAE,KAAK,CACvB,MAAM,CAAE,OAAO,AACjB,CAAC,AAED,YAAY,eAAC,CAAC,AACZ,MAAM,CAAE,IAAI,CAAC,GAAG,CAAC,IAAI,CAAC,CAAC,AACzB,CAAC,AAED,aAAa,eAAC,CAAC,AACb,MAAM,CAAE,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,GAAG,AACzB,CAAC,AAED,iBAAiB,eAAC,CAAC,AACjB,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,CAC7B,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,gBAAgB,CAAE,KAAK,CAEvB,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,IAAI,CAAC,SAAS,CACnC,OAAO,CAAE,GAAG,AACd,CAAC,AAED,SAAS,eAAC,CAAC,AACT,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,CAC7B,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,MAAM,AAClB,CAAC,AAED,wBAAS,CAAC,GAAG,eAAC,CAAC,AACb,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,OAAO,CACZ,IAAI,CAAE,OAAO,CACb,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,OAAO,CACf,MAAM,CAAE,IAAI,AACd,CAAC,AAED,iBAAiB,eAAC,CAAC,AACjB,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,CAC7B,UAAU,CAAE,GAAG,CACf,WAAW,CAAE,IAAI,CACjB,YAAY,CAAE,IAAI,CAClB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,gBAAgB,CAAE,KAAK,CACvB,SAAS,CAAE,KAAK,CAChB,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,eAAe,eAAC,CAAC,AACf,MAAM,CAAE,CAAC,AACX,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  onMount(() => {
	...
	<figure class="figure-wrapper svelte-18fvrgx">
	  <div class="button-wrapper svelte-18fvrgx">
	    ${  `` }
	    <div class="carousel-wrapper svelte-18fvrgx">
	      ${ visible ? `<div class="carousel svelte-18fvrgx">
	          <img${(v => v == null ? "" : ` src="${escape(image)}"`)(image)} alt="pillar image" class="svelte-18fvrgx">
	        </div>` : `` }
	    </div>
	    ${  `` }
	  </div>
	  <figcaption class="carousel-caption svelte-18fvrgx">${escape(caption)}</figcaption>
	</figure>`;
});
...
const css$6 = {
	code: "@import url(\"https://fonts.googleapis.com/css?family=Cutive+Mono&display=swap\");div#letter.svelte-1lto86f{margin-top:5em;width:900px;background-color:white;box-shadow:0 10px 5px 6px black;font-family:\"Cutive Mono\", \"Courier New\", Courier, monospace;padding:2em;max-width:calc(100vw - 10em)}div#letter.svelte-1lto86f h1#letter-header.svelte-1lto86f{font-family:\"Cutive Mono\", \"Courier New\", Courier, monospace;font-size:2em}div#letter.svelte-1lto86f p.svelte-1lto86f{font-size:1.5em}div#letter.svelte-1lto86f img#founders.svelte-1lto86f{-webkit-filter:grayscale(100%);filter:grayscale(100%);width:80%;border:3px black solid}div#letter.svelte-1lto86f img.svelte-1lto86f{display:block;width:5%;margin:4em auto 5em auto}",
...
const Origin = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `
	<div id="letter" class="svelte-1lto86f">
	  <h1 id="letter-header" class="svelte-1lto86f">The Origins of Theta Tau</h1>
	  <p class="svelte-1lto86f">
	    In the Spring of 2009, several students of UCSD's Jacobs School of
	    Engineering felt that there was a lack of engineering representation in the
	    Greek community on campus. Luckily an opportunity arose for them to change
	    that.
	  ...
	  <img id="founders" src="images/founders.jpg" alt="the mighty founders" class="svelte-1lto86f">
	  <img src="images/hamntongs.png" alt="the seals" class="svelte-1lto86f">
