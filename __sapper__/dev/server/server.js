...
const css$4 = {
	code: ".pillars.svelte-1nh349{display:flex;flex-direction:row;align-items:center}.pillar.svelte-1nh349{display:flex;flex-direction:column;max-width:15em;border:2px gold solid;margin:1em;text-align:center}.pillar.svelte-1nh349 img.svelte-1nh349{width:12em}@media(max-width: 1000px){.pillars.svelte-1nh349{flex-direction:column}}",
	map: "{\"version\":3,\"file\":\"about.svelte\",\"sources\":[\"about.svelte\"],\"sourcesContent\":[\"<script>\\n\\timport SvgDraw from '../components/SvgDraw.svelte';\\n\\timport {paths} from '../scripts/pillar.js';\\n\\n\\tconst height=\\\"132.608px\\\"\\n\\tconst width = \\\"132.608px\\\"\\n\\tconst viewBox = \\\"0 0 132.608px 132.608px\\\"\\n</script>\\n\\n<style>\\n\\t.pillars {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: row;\\n\\t\\talign-items: center;\\n\\t}\\n\\n\\t.pillar {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tmax-width: 15em;\\n\\t\\tborder: 2px gold solid;\\n\\t\\tmargin: 1em;\\n\\t\\ttext-align: center;\\n\\t}\\n\\n\\t.pillar img {\\n\\t\\twidth: 12em;\\n\\t}\\n\\n\\t@media (max-width: 1000px) {\\n\\t\\t.pillars {\\n\\t\\t\\tflex-direction: column;\\n\\t\\t}\\n\\t}\\n</style>\\n\\n<svelte:head>\\n\\t<title>About</title>\\n</svelte:head>\\n\\n<h1>About</h1>\\n\\n<h3>Theta Tau bases its moral tenets in three pillars:</h3>\\n\\n<div class=\\\"pillars\\\">\\n\\t<div class=\\\"pillar\\\">\\n\\t\\t<img src=\\\"icons/pillar.png\\\" alt=\\\"pillar\\\">\\n\\t\\t<h4>Brotherhood</h4>\\n\\t</div>\\n\\t<div class=\\\"pillar\\\">\\n\\t\\t<img src=\\\"icons/pillar.png\\\" alt=\\\"pillar\\\">\\n\\t\\t<h4>Philanthropy</h4>\\n\\t</div>\\n\\t<div class=\\\"pillar\\\">\\n\\t\\t<img src=\\\"icons/pillar.png\\\" alt=\\\"pillar\\\">\\n\\t\\t<h4>Professionalism</h4>\\n\\t</div>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAUC,QAAQ,cAAC,CAAC,AACT,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,GAAG,CACnB,WAAW,CAAE,MAAM,AACpB,CAAC,AAED,OAAO,cAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,GAAG,CAAC,IAAI,CAAC,KAAK,CACtB,MAAM,CAAE,GAAG,CACX,UAAU,CAAE,MAAM,AACnB,CAAC,AAED,qBAAO,CAAC,GAAG,cAAC,CAAC,AACZ,KAAK,CAAE,IAAI,AACZ,CAAC,AAED,MAAM,AAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC3B,QAAQ,cAAC,CAAC,AACT,cAAc,CAAE,MAAM,AACvB,CAAC,AACF,CAAC\"}"
};
...
const About = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="pillars svelte-1nh349">
		<div class="pillar svelte-1nh349">
			<img src="icons/pillar.png" alt="pillar" class="svelte-1nh349">
			<h4>Brotherhood</h4>
		</div>
		<div class="pillar svelte-1nh349">
			<img src="icons/pillar.png" alt="pillar" class="svelte-1nh349">
...
const css$8 = {
	code: "footer.svelte-8az7wp{background-color:#777;margin-top:30px;border-top:5px maroon solid;display:flex;flex-direction:row;align-items:space-between;justify-content:space-evenly;font-size:0.8em}.footer-div.svelte-8az7wp{padding:0 10px;margin:10px 10px;border-left:1px black dashed;color:white}ul.footer-div.svelte-8az7wp{list-style-type:none}",
	map: "{\"version\":3,\"file\":\"Footer.svelte\",\"sources\":[\"Footer.svelte\"],\"sourcesContent\":[\"<script>\\n</script>\\n\\n<style>\\n    footer {\\n        background-color: #777;\\n        margin-top: 30px;\\n        border-top: 5px maroon solid;\\n        display: flex;\\n        flex-direction: row;\\n        align-items: space-between;\\n        justify-content: space-evenly;\\n        font-size: 0.8em;\\n    }\\n\\n    .footer-div {\\n        padding: 0 10px;\\n        margin: 10px 10px;\\n        border-left: 1px black dashed;\\n        color: white;\\n    }\\n\\n    ul.footer-div {\\n        list-style-type: none;\\n    }\\n\\n</style>\\n\\n<footer>\\n    <img class=\\\"footer-div\\\" src=\\\"images/hamntongs.png\\\" alt=\\\"our seal\\\" height=\\\"60px\\\">\\n    <ul class=\\\"footer-div\\\">\\n        <strong>Contributors:</strong><br>\\n        <li><a href=\\\"https://github.com/willxu1234\\\"> Will Xu</a></li>\\n        <li><a href=\\\"https://github.com/clarkphan\\\">Clark Phan</a></li>\\n    </ul>\\n    <p class=\\\"footer-div\\\">\\n        Icons from\\n        <a href=\\\"https://icons8.com/icons\\\">icons8</a>\\n    </p>\\n</footer>\"],\"names\":[],\"mappings\":\"AAII,MAAM,cAAC,CAAC,AACJ,gBAAgB,CAAE,IAAI,CACtB,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,GAAG,CAAC,MAAM,CAAC,KAAK,CAC5B,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,GAAG,CACnB,WAAW,CAAE,aAAa,CAC1B,eAAe,CAAE,YAAY,CAC7B,SAAS,CAAE,KAAK,AACpB,CAAC,AAED,WAAW,cAAC,CAAC,AACT,OAAO,CAAE,CAAC,CAAC,IAAI,CACf,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,MAAM,CAC7B,KAAK,CAAE,KAAK,AAChB,CAAC,AAED,EAAE,WAAW,cAAC,CAAC,AACX,eAAe,CAAE,IAAI,AACzB,CAAC\"}"
};

const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$8);

	return `<footer class="svelte-8az7wp">
	    <img class="footer-div svelte-8az7wp" src="images/hamntongs.png" alt="our seal" height="60px">
	    <ul class="footer-div svelte-8az7wp">
	        <strong>Contributors:</strong><br>
	        <li><a href="https://github.com/willxu1234"> Will Xu</a></li>
	        <li><a href="https://github.com/clarkphan">Clark Phan</a></li>
	    </ul>
	    <p class="footer-div svelte-8az7wp">
	        Icons from
	        <a href="https://icons8.com/icons">icons8</a>
	    </p>
	</footer>`;
