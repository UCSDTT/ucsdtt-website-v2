...
const css$5 = {
	code: ".cursor-box.svelte-sbaidr{position:absolute;padding:50px;border:5px maroon dashed;z-index:2;cursor:pointer;border-radius:40px}.class-img-container.svelte-sbaidr{position:absolute;top:180px;border:5px black solid}.class-img-container.svelte-sbaidr img.svelte-sbaidr{background-color:black;cursor:pointer;width:900px}.brother-info.svelte-sbaidr{padding-top:100vh;height:120px\n  }",
	map: "{\"version\":3,\"file\":\"PledgeClass.svelte\",\"sources\":[\"PledgeClass.svelte\"],\"sourcesContent\":[\"<script>\\n  import { elasticOut } from \\\"svelte/easing\\\";\\n\\n  // Contains an array of Javascript objects.\\n  // Each object contains: \\n  // [\\n  //    {\\n  //         className: string\\n  //         image: string (url to image)\\n  //         members: [{\\n  //           name: string\\n  //           major: string\\n  //           pixelLocationX: number (pixel location on class picture)\\n  //           pixelLocationY: number (same but on y axis)\\n  //           linkedIn: string (the url)\\n  //         },\\n  //     ...]\\n  //    },\\n  // ...]\\n  // basically an ar\\n  // order from newest to oldest\\n  export let pledgeClasses;\\n\\n  let visible = true;\\n  let boxVisible = false;\\n\\n  let classIndex = 0;\\n  let curClass = pledgeClasses[classIndex];\\n\\n  let my, mx, sy, sx;\\n  $: picY = `${my - 140}px`\\n  $: picX = `${mx - 58}px`\\n\\n  function handleMouseClick(event) {\\n\\t\\tmx = event.clientX;\\n\\t\\tmy = event.clientY;\\n    boxVisible = true;\\n\\t}\\n</script>\\n\\n<style>\\n  .cursor-box {\\n    position: absolute;\\n    padding: 50px;\\n    border: 5px maroon dashed;\\n    z-index: 2;\\n    cursor: pointer;\\n    border-radius: 40px;\\n  }\\n\\n  .class-img-container {\\n    position: absolute;\\n    top: 180px;\\n    border: 5px black solid;\\n  }\\n\\n  .class-img-container img {\\n    background-color: black;\\n    cursor: pointer;\\n    width: 900px;\\n  }\\n\\n  .brother-info {\\n    padding-top: 100vh;\\n    height: 120px\\n  }\\n\\n</style>\\n\\n{#if boxVisible}\\n  <div \\n    class=\\\"cursor-box\\\"\\n    style=\\\"\\n      top: {picY};\\n      left: {picX};\\n    \\\"\\n    on:click={handleMouseClick}\\n  >\\n</div>\\n{/if}\\n\\n<div class=\\\"class-img-container\\\">\\n  <img\\n    on:click={handleMouseClick}\\n    class=\\\"class-img\\\"\\n    src=\\\"{curClass.image}\\\"\\n    alt=\\\"{curClass.className}\\\"\\n  >\\n</div>\\n\\n<div class=\\\"brother-info\\\">\\n  <h3>temp</h3>\\n</div>\"],\"names\":[],\"mappings\":\"AAyCE,WAAW,cAAC,CAAC,AACX,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,GAAG,CAAC,MAAM,CAAC,MAAM,CACzB,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,OAAO,CACf,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,oBAAoB,cAAC,CAAC,AACpB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,KAAK,CACV,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,AACzB,CAAC,AAED,kCAAoB,CAAC,GAAG,cAAC,CAAC,AACxB,gBAAgB,CAAE,KAAK,CACvB,MAAM,CAAE,OAAO,CACf,KAAK,CAAE,KAAK,AACd,CAAC,AAED,aAAa,cAAC,CAAC,AACb,WAAW,CAAE,KAAK,CAClB,MAAM,CAAE,KAAK;EACf,CAAC\"}"
};
...
const PledgeClass = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  let my, mx;
	...
	return `${ boxVisible ? `<div class="cursor-box svelte-sbaidr" style="
	      top: ${escape(picY)};
	      left: ${escape(picX)};
	    ">
	</div>` : `` }

	<div class="class-img-container svelte-sbaidr">
	  <img class="class-img svelte-sbaidr"${(v => v == null ? "" : ` src="${escape(curClass.image)}"`)(curClass.image)}${(v => v == null ? "" : ` alt="${escape(curClass.className)}"`)(curClass.className)}>
	</div>

	<div class="brother-info svelte-sbaidr">
	  <h3>temp</h3>
	</div>`;
});
