...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	${ visible ? `<h1 class="text-display lg-view svelte-btcm8q">
			${escape( titleSmall )}
		</h1>` : `` }
	${ visible ? `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64px" height="64px" class="parallax svelte-btcm8q" style="transform: translate(0, ${escape(sy * .4)}px)">
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  onMount(() => {
	...
	<figure class="figure-wrapper svelte-bgbr7d">
	  <div class="button-wrapper svelte-bgbr7d">
	    ${  `` }
	    <div class="carousel-wrapper svelte-bgbr7d">
	      ${ visible ? `<div class="carousel svelte-bgbr7d">
	          <img${(v => v == null ? "" : ` src="${escape(image)}"`)(image)} alt="pillar image" class="svelte-bgbr7d">
	        </div>` : `` }
	    </div>
	    ${  `` }
	  </div>
	  <figcaption class="carousel-caption svelte-bgbr7d">${escape(caption)}</figcaption>
	</figure>`;
});
...
const Origin = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `
	<div id="letter" class="svelte-1lbiaoq">
	  <h1 id="letter-header" class="svelte-1lbiaoq">The Origins of Theta Tau</h1>
	  <p class="svelte-1lbiaoq">
	    In the Spring of 2009, several students of UCSD's Jacobs School of
	    Engineering felt that there was a lack of engineering representation in the
	    Greek community on campus. Luckily an opportunity arose for them to change
	    that.
	  ...
	  <img id="founders" src="images/founders.jpg" alt="the mighty founders" class="svelte-1lbiaoq">
	  <img src="images/hamntongs.png" alt="the seals" class="svelte-1lbiaoq">
