...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="svelte-82xl7q">
		<ul class="svelte-82xl7q">
			<li class="svelte-82xl7q"><a id="letters" href="." class="svelte-82xl7q">Θ Τ</a></li>
			<li class="svelte-82xl7q"><a class="${escape(segment === undefined ? "selected" : "")} svelte-82xl7q" href=".">Home</a></li>
			<li class="svelte-82xl7q"><a class="${escape(segment === "about" ? "selected" : "")} svelte-82xl7q" href="about">About</a></li>
			<li class="svelte-82xl7q"><a class="${escape(segment === "rush" ? "selected" : "")} svelte-82xl7q" href="rush">Rush</a></li>
			<li class="svelte-82xl7q"><a class="${escape(segment === "faq" ? "selected" : "")} svelte-82xl7q" href="faq">FAQ</a></li>

			<li class="svelte-82xl7q"><a rel="prefetch" class="${escape(segment === "members" ? "selected" : "")} svelte-82xl7q" href="members">Members</a></li>
		</ul>
	</nav>`;
});
