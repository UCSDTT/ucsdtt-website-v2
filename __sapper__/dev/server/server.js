...
const css = {
	code: ".parallax.svelte-n4vdqm{position:absolute;width:50em;height:30em;left:10em;will-change:transform;display:none}@media(min-width: 800px){.parallax.svelte-n4vdqm{display:block}}h1.text-display.svelte-n4vdqm{position:absolute;text-align:center;top:1.7em;left:0.1em;right:0.1em;color:white;text-shadow:0 0 10px black;font-size:6em;padding:0.1em;background-color:rgba(128, 0, 0, 0.7);z-index:1}",
	map: "{\"version\":3,\"file\":\"Hero.svelte\",\"sources\":[\"Hero.svelte\"],\"sourcesContent\":[\"<!-- Taken from https://github.com/sveltejs/site-kit/blob/master/components/ParallaxLogo.svelte -->\\n<script>\\n\\timport { fade, fly } from 'svelte/transition';\\n\\timport { onMount } from 'svelte';\\n\\n\\tlet visible = false;\\n\\n\\texport let svg;\\n\\texport let titleBig;\\n\\texport let titleSmall;\\n\\n\\tlet sy = 0;\\n\\tlet iw = 0;\\n\\n\\t$: dispSmall = iw <= 1000;\\n\\n\\tonMount(()=> {\\n\\t\\tvisible = true;\\n\\t})\\n</script>\\n\\n<svelte:window bind:scrollY={sy} bind:innerWidth={iw}/>\\n\\n<style>\\n\\t.parallax {\\n\\t\\tposition: absolute;\\n\\t\\twidth: 50em;\\n\\t\\theight: 30em;\\n\\t\\tleft: 10em;\\n\\t\\twill-change: transform;\\n\\t\\tdisplay: none;\\n\\t}\\n\\n\\t@media (min-width: 800px) {\\n\\t\\t.parallax {\\n\\t\\t\\tdisplay: block;\\n\\t\\t}\\n\\t}\\n\\n\\th1.text-display {\\n\\t\\tposition: absolute;\\n\\t\\ttext-align: center;\\n\\t\\ttop: 1.7em;\\n\\t\\tleft: 0.1em;\\n\\t\\tright: 0.1em;\\n\\t\\tcolor: white;\\n\\t\\ttext-shadow: 0 0 10px black;\\n\\t\\tfont-size: 6em;\\n\\t\\tpadding: 0.1em;\\n\\t\\tbackground-color: rgba(128, 0, 0, 0.7);\\n\\t\\tz-index: 1;\\n\\t}\\n\\n\\n</style>\\n\\n{#if visible}\\n\\t<h1 \\n\\t\\tclass=\\\"text-display lg-view\\\" \\n\\t\\ttransition:fade>{dispSmall ? titleSmall : titleBig}\\n\\t</h1>\\n{/if}\\n{#if visible}\\n\\t<svg \\n\\t\\txmlns=\\\"http://www.w3.org/2000/svg\\\"\\n\\t\\tviewBox=\\\"0 0 64 64\\\"\\n\\t\\twidth=\\\"64px\\\"\\n\\t\\theight=\\\"64px\\\"\\n\\t\\tclass=\\\"parallax\\\"\\n\\t\\tstyle=\\\"transform: translate(0, {sy * .4}px)\\\"\\n\\t>\\n\\t\\t<path\\n\\t\\t\\td={svg}\\n\\t\\t\\topacity=\\\"0.6\\\" \\n\\t\\t\\tin:fly=\\\"{{y: -5, delay: 250}}\\\"\\n\\t\\t/>\\n\\t</svg>\\n{/if}\\n\\n\\t<!-- <img {alt} {src} class=\\\"parallax\\\" style=\\\"transform: translate(0, {sy * .4}px)\\\"> -->\"],\"names\":[],\"mappings\":\"AAwBC,SAAS,cAAC,CAAC,AACV,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,IAAI,CAAE,IAAI,CACV,WAAW,CAAE,SAAS,CACtB,OAAO,CAAE,IAAI,AACd,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,SAAS,cAAC,CAAC,AACV,OAAO,CAAE,KAAK,AACf,CAAC,AACF,CAAC,AAED,EAAE,aAAa,cAAC,CAAC,AAChB,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,MAAM,CAClB,GAAG,CAAE,KAAK,CACV,IAAI,CAAE,KAAK,CACX,KAAK,CAAE,KAAK,CACZ,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,KAAK,CAC3B,SAAS,CAAE,GAAG,CACd,OAAO,CAAE,KAAK,CACd,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACtC,OAAO,CAAE,CAAC,AACX,CAAC\"}"
};
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	${ visible ? `<h1 class="text-display lg-view svelte-n4vdqm">${escape( titleSmall )}
		</h1>` : `` }
	${ visible ? `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64px" height="64px" class="parallax svelte-n4vdqm" style="transform: translate(0, ${escape(sy * .4)}px)">
...
const css$2 = {
	code: ".hero-div.svelte-1y4obx9{width:100%;height:30em}p.svelte-1y4obx9{margin:1em auto}@media(max-width: 799px){.hero-div.svelte-1y4obx9{height:20em}}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\n\\timport Hero from '../components/Hero.svelte';\\n\\timport WeAre from '../components/WeAre.svelte';\\n\\timport { garnetUnfilled } from './shapes.js';\\n\\n\\tconst brotherLabels = ['brothers', 'entrepreneurs', 'leaders', 'pioneers',\\n\\t\\t\\t\\t\\t'philanthropists', 'best friends', 'family', 'world changers']\\n</script>\\n\\n<style>\\n\\t.hero-div {\\n\\t\\twidth: 100%;\\n\\t\\theight: 30em;\\n\\t}\\n\\n\\tmain {\\n\\t\\tbackground-image: url(images/sigma_fun.jpg);\\n\\t}\\n\\n\\tp {\\n\\t\\tmargin: 1em auto;\\n\\t}\\n\\n\\t@media (max-width: 799px) {\\n\\t\\t.hero-div {\\n\\t\\t\\theight: 20em;\\n\\t\\t}\\n\\t}\\n</style>\\n\\n<svelte:head>\\n\\t<title>UCSD Theta Tau</title>\\n</svelte:head>\\n\\n<div class=\\\"hero-div\\\">\\n\\t<Hero \\n\\t\\ttitleBig='UCSD Theta Tau' \\n\\t\\ttitleSmall='UCSD ΘΤ' \\n\\t\\ttagline='Epsilon Delta' \\n\\t\\tsvg={garnetUnfilled}\\n\\t\\talt='a hero'\\n\\t/>\\n</div>\\n<WeAre {brotherLabels}/>\\n\\n<!-- <h1>Great success!</h1> -->\\n\\n<!-- <img alt='fun' src='images/sigma_fun.jpg'> -->\\n\\n<!-- Leave this here until we can make our own icon that is just an outline -->\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<p>Icons from <a href=\\\"https://icons8.com/icons\\\">icons8</a></p>\"],\"names\":[],\"mappings\":\"AAUC,SAAS,eAAC,CAAC,AACV,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACb,CAAC,AAMD,CAAC,eAAC,CAAC,AACF,MAAM,CAAE,GAAG,CAAC,IAAI,AACjB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,SAAS,eAAC,CAAC,AACV,MAAM,CAAE,IAAI,AACb,CAAC,AACF,CAAC\"}"
};
...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="hero-div svelte-1y4obx9">
	...
	<br>
	<br>
	<p class="svelte-1y4obx9">Icons from <a href="https://icons8.com/icons">icons8</a></p>`;
});
