...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	${ visible ? `<h1 class="text-display lg-view svelte-6s44p1">
			${escape( titleSmall )}
		</h1>` : `` }
	${ visible ? `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64px" height="64px" class="parallax svelte-6s44p1" style="transform: translate(0, ${escape(sy * .4)}px)">
...
const css$2 = {
	code: ".card.svelte-zva0ep{margin-top:5em;background-color:white;border:4px solid black;width:100%;padding:15px}.wrapper.svelte-zva0ep{display:flex;justify-items:center}.subcards.svelte-zva0ep{padding:10px}.left-div.svelte-zva0ep{border-right:5px dotted #333}.right-div.svelte-zva0ep{}.header.svelte-zva0ep{padding-top:30px;min-width:100%;text-align:center}",
...
const Card = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="card svelte-zva0ep">
	    ${$$slots.header ? $$slots.header({ class: `header svelte-zva0ep` }) : ``}
	    <hr>
	    <div class="wrapper svelte-zva0ep">
	        <section class="left-div subcards svelte-zva0ep">
	            ${$$slots.left ? $$slots.left() : ``}
	        </section>
	        <section class="right-div subcards svelte-zva0ep">
...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const brotherLabels = [
	...
	<div class="hero-div svelte-5uys0y">
	...
	${validate_component(Card, 'Card').$$render($$result, {}, {}, {
		default: () => `
	  `,
		header: () => `<h3 slot="header"><strong>UC San Diego's premier engineering fraternity</strong></h3>
	  `,
		left: () => `<section slot="left">
	  	<p class="svelte-5uys0y">
			Formed in 1904 with chapters in over 80 campuses, Theta Tau is both the
			<strong>nation's largest and oldest co-ed engineering fraternity</strong>. Our brothers 
			develop each other to not only focus on one aspect of ourselves, but on 
			many. We strive to be well-rounded people who excel in 
	  ...
	  `,
		...
		<figcaption class="svelte-5uys0y">Our rush video for Spring 2019!</figcaption>
	  </figure>
	`
	})}
