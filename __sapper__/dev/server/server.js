...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  onMount(() => {
	...
	<div class="carousel-wrapper svelte-yumz93">
	  ${ visible ? `<div class="carousel svelte-yumz93">
	      <img${(v => v == null ? "" : ` src="${escape(image)}"`)(image)} alt="pillar image" class="svelte-yumz93">
	    </div>` : `` }
	</div>`;
});
