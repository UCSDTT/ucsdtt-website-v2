...
const css = {
	code: ".parallax.svelte-14ft542{position:absolute;width:50em;height:30em;left:10em;will-change:transform;display:none}@media(min-width: 800px){.parallax.svelte-14ft542{display:block}}h1.text-display.svelte-14ft542{position:absolute;text-align:center;top:1.7em;left:0.1em;right:0.1em;color:white;text-shadow:0 0 10px black;font-size:6em;padding:0.1em;background-color:rgba(128, 0, 0, 0.7);z-index:1}",
	map: "{\"version\":3,\"file\":\"Hero.svelte\",\"sources\":[\"Hero.svelte\"],\"sourcesContent\":[\"<!-- Taken from https://github.com/sveltejs/site-kit/blob/master/components/ParallaxLogo.svelte -->\\n<script>\\n\\timport { fade, fly } from 'svelte/transition';\\n\\timport { onMount } from 'svelte';\\n\\n\\tlet visible = false;\\n\\n\\texport let svg;\\n\\texport let titleBig;\\n\\texport let titleSmall;\\n\\texport let tagline;\\n\\n\\tlet sy = 0;\\n\\tlet iw = 0;\\n\\n\\t$: dispSmall = iw <= 800;\\n\\n\\tonMount(()=> {\\n\\t\\tvisible = true;\\n\\t})\\n</script>\\n\\n<svelte:window bind:scrollY={sy} bind:innerWidth={iw}/>\\n\\n<style>\\n\\t.parallax {\\n\\t\\tposition: absolute;\\n\\t\\twidth: 50em;\\n\\t\\theight: 30em;\\n\\t\\tleft: 10em;\\n\\t\\twill-change: transform;\\n\\t\\tdisplay: none;\\n\\t}\\n\\t@media (min-width: 800px) {\\n\\t\\t.parallax {\\n\\t\\t\\tdisplay: block;\\n\\t\\t}\\n\\t}\\n\\n\\th1.text-display {\\n\\t\\tposition: absolute;\\n\\t\\ttext-align: center;\\n\\t\\ttop: 1.7em;\\n\\t\\tleft: 0.1em;\\n\\t\\tright: 0.1em;\\n\\t\\tcolor: white;\\n\\t\\ttext-shadow: 0 0 10px black;\\n\\t\\tfont-size: 6em;\\n\\t\\tpadding: 0.1em;\\n\\t\\tbackground-color: rgba(128, 0, 0, 0.7);\\n\\t\\tz-index: 1;\\n\\t}\\n\\n\\n</style>\\n\\n{#if visible}\\n\\t<h1 \\n\\t\\tclass=\\\"text-display lg-view\\\" \\n\\t\\ttransition:fade>{dispSmall ? titleSmall : titleBig}\\n\\t</h1>\\n{/if}\\n{#if visible}\\n\\t<svg \\n\\t\\txmlns=\\\"http://www.w3.org/2000/svg\\\"\\n\\t\\tviewBox=\\\"0 0 64 64\\\"\\n\\t\\twidth=\\\"64px\\\"\\n\\t\\theight=\\\"64px\\\"\\n\\t\\tclass=\\\"parallax\\\"\\n\\t\\tstyle=\\\"transform: translate(0, {sy * .4}px)\\\"\\n\\t>\\n\\t\\t<path\\n\\t\\t\\td={svg}\\n\\t\\t\\topacity=\\\"0.6\\\" \\n\\t\\t\\tin:fly=\\\"{{y: -5, delay: 250}}\\\"\\n\\t\\t/>\\n\\t</svg>\\n{/if}\\n\\n\\t<!-- <img {alt} {src} class=\\\"parallax\\\" style=\\\"transform: translate(0, {sy * .4}px)\\\"> -->\"],\"names\":[],\"mappings\":\"AAyBC,SAAS,eAAC,CAAC,AACV,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,IAAI,CAAE,IAAI,CACV,WAAW,CAAE,SAAS,CACtB,OAAO,CAAE,IAAI,AACd,CAAC,AACD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,SAAS,eAAC,CAAC,AACV,OAAO,CAAE,KAAK,AACf,CAAC,AACF,CAAC,AAED,EAAE,aAAa,eAAC,CAAC,AAChB,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,MAAM,CAClB,GAAG,CAAE,KAAK,CACV,IAAI,CAAE,KAAK,CACX,KAAK,CAAE,KAAK,CACZ,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,KAAK,CAC3B,SAAS,CAAE,GAAG,CACd,OAAO,CAAE,KAAK,CACd,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACtC,OAAO,CAAE,CAAC,AACX,CAAC\"}"
};
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	let { svg, titleBig, titleSmall, tagline } = $$props;
	...
	${ visible ? `<h1 class="text-display lg-view svelte-14ft542">${escape( titleSmall )}
		</h1>` : `` }
	${ visible ? `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64px" height="64px" class="parallax svelte-14ft542" style="transform: translate(0, ${escape(sy * .4)}px)">
...
const css$1 = {
	code: ".hero-section.svelte-sazog6{background-image:url(images/sigma_fun.jpg)}p.svelte-sazog6{margin:1em auto}@media(min-width: 480px){}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\n\\timport Hero from '../components/Hero.svelte';\\n\\timport { garnetUnfilled } from './shapes.js';\\n</script>\\n\\n<style>\\n\\t.hero-section {\\n\\t\\tbackground-image: url(images/sigma_fun.jpg);\\n\\t}\\n\\n\\tp {\\n\\t\\tmargin: 1em auto;\\n\\t}\\n\\n\\t@media (min-width: 480px) {\\n\\t\\th1 {\\n\\t\\t\\tfont-size: 4em;\\n\\t\\t}\\n\\t}\\n</style>\\n\\n<svelte:head>\\n\\t<title>UCSD Theta Tau</title>\\n</svelte:head>\\n\\n<!-- <p>{garnetUnfilled}</p> -->\\n\\n<section class=\\\"hero-section\\\">\\n\\t<Hero \\n\\t\\ttitleBig='UCSD Theta Tau' \\n\\t\\ttitleSmall='UCSD ΘΤ' \\n\\t\\ttagline='Epsilon Delta' \\n\\t\\tsvg={garnetUnfilled}\\n\\t\\talt='a hero'\\n\\t\\t/>\\n</section>\\n\\n<!-- <h1>Great success!</h1> -->\\n\\n<!-- <img alt='fun' src='images/sigma_fun.jpg'> -->\\n\\n<!-- Leave this here until we can make our own icon that is just an outline -->\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<br/>\\n<p>Icons from <a href=\\\"https://icons8.com/icons\\\">icons8</a></p>\"],\"names\":[],\"mappings\":\"AAMC,aAAa,cAAC,CAAC,AACd,gBAAgB,CAAE,IAAI,oBAAoB,CAAC,AAC5C,CAAC,AAED,CAAC,cAAC,CAAC,AACF,MAAM,CAAE,GAAG,CAAC,IAAI,AACjB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAI3B,CAAC\"}"
};
...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<section class="hero-section svelte-sazog6">
	...
	<br>
	<br>
	<p class="svelte-sazog6">Icons from <a href="https://icons8.com/icons">icons8</a></p>`;
});
