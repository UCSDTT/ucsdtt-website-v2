...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  onMount(() => {
	...
	<figure class="figure-wrapper svelte-7tzwwb">
	  <div class="button-wrapper svelte-7tzwwb">
	    ${  `` }
	    <div class="carousel-wrapper svelte-7tzwwb">
	      ${ visible ? `<div class="carousel svelte-7tzwwb">
	          <img${(v => v == null ? "" : ` src="${escape(image)}"`)(image)} alt="pillar image" class="svelte-7tzwwb">
	        </div>` : `` }
	    </div>
	    ${  `` }
	  </div>
	  <figcaption class="carousel-caption svelte-7tzwwb">${escape(caption)}</figcaption>
	</figure>`;
});
