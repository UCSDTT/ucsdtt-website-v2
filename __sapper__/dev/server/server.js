...
const css = {
	code: ".parallax.svelte-1qj7hu6{position:absolute;top:4em;width:50em;height:30em;left:50%;margin-left:-25em;will-change:transform;display:none;z-index:-1}@media(min-width: 1000px){.parallax.svelte-1qj7hu6{display:block}}@media(max-width: 999px){}h1.text-display.svelte-1qj7hu6{text-align:center;margin-top:2em;padding:3em 5em 0 5em;color:white;text-shadow:0 0 10px black;font-size:5em;padding:0.1em;background-color:rgba(128, 0, 0, 0.7);z-index:1}",
	map: "{\"version\":3,\"file\":\"Hero.svelte\",\"sources\":[\"Hero.svelte\"],\"sourcesContent\":[\"<!-- Taken from https://github.com/sveltejs/site-kit/blob/master/components/ParallaxLogo.svelte -->\\n<script>\\n\\timport { fade, fly } from 'svelte/transition';\\n\\timport { onMount } from 'svelte';\\n\\n\\tlet visible = false;\\n\\n\\texport let svg;\\n\\texport let titleBig;\\n\\texport let titleSmall;\\n\\n\\tlet sy = 0;\\n\\tlet iw = 0;\\n\\n\\t$: dispSmall = iw <= 1000;\\n\\n\\tonMount(()=> {\\n\\t\\tvisible = true;\\n\\t})\\n</script>\\n\\n<svelte:window bind:scrollY={sy} bind:innerWidth={iw}/>\\n\\n<style>\\n\\t.parallax {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 4em;\\n\\t\\twidth: 50em;\\n\\t\\theight: 30em;\\n\\t\\tleft: 50%;\\n\\t\\tmargin-left: -25em;\\n\\t\\twill-change: transform;\\n\\t\\tdisplay: none;\\n\\t\\tz-index: -1;\\n\\t}\\n\\n\\t@media (min-width: 1000px) {\\n\\t\\t.parallax {\\n\\t\\t\\tdisplay: block;\\n\\t\\t}\\n\\t}\\n\\t@media (max-width: 999px) {\\n\\t\\t/* h1.text-display {\\n\\t\\t\\ttop: 1em;\\n\\t\\t\\tfont-size: 3em;\\n\\t\\t} */\\n\\t}\\n\\n\\th1.text-display {\\n\\t\\t/* position: relative; */\\n\\t\\ttext-align: center;\\n\\t\\tmargin-top: 2em;\\n\\t\\tpadding: 3em 5em 0 5em;\\n\\t\\t/* top: 1.9em;\\n\\t\\tleft: 3.5em;\\n\\t\\tright: 3.5em;\\n\\t\\tmin-width: 10em; */\\n\\t\\tcolor: white;\\n\\t\\ttext-shadow: 0 0 10px black;\\n\\t\\tfont-size: 5em;\\n\\t\\tpadding: 0.1em;\\n\\t\\tbackground-color: rgba(128, 0, 0, 0.7);\\n\\t\\tz-index: 1;\\n\\t}\\n\\n\\n</style>\\n\\n{#if visible}\\n\\t<h1 \\n\\t\\tclass=\\\"text-display lg-view\\\" \\n\\t\\tin:fade\\n\\t>\\n\\t\\t{dispSmall ? titleSmall : titleBig}\\n\\t</h1>\\n{/if}\\n{#if visible}\\n\\t<svg \\n\\t\\txmlns=\\\"http://www.w3.org/2000/svg\\\"\\n\\t\\tviewBox=\\\"0 0 64 64\\\"\\n\\t\\twidth=\\\"64px\\\"\\n\\t\\theight=\\\"64px\\\"\\n\\t\\tclass=\\\"parallax\\\"\\n\\t\\tstyle=\\\"transform: translate(0, {sy * .4}px)\\\"\\n\\t>\\n\\t\\t<path\\n\\t\\t\\td={svg}\\n\\t\\t\\topacity=\\\"0.6\\\" \\n\\t\\t\\tin:fly=\\\"{{y: -5, delay: 250}}\\\"\\n\\t\\t/>\\n\\t</svg>\\n{/if}\\n\\n\\t<!-- <img {alt} {src} class=\\\"parallax\\\" style=\\\"transform: translate(0, {sy * .4}px)\\\"> -->\"],\"names\":[],\"mappings\":\"AAwBC,SAAS,eAAC,CAAC,AACV,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,IAAI,CAAE,GAAG,CACT,WAAW,CAAE,KAAK,CAClB,WAAW,CAAE,SAAS,CACtB,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,EAAE,AACZ,CAAC,AAED,MAAM,AAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC3B,SAAS,eAAC,CAAC,AACV,OAAO,CAAE,KAAK,AACf,CAAC,AACF,CAAC,AACD,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAK3B,CAAC,AAED,EAAE,aAAa,eAAC,CAAC,AAEhB,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,GAAG,CACf,OAAO,CAAE,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,GAAG,CAKtB,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,KAAK,CAC3B,SAAS,CAAE,GAAG,CACd,OAAO,CAAE,KAAK,CACd,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACtC,OAAO,CAAE,CAAC,AACX,CAAC\"}"
};
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	${ visible ? `<h1 class="text-display lg-view svelte-1qj7hu6">
			${escape( titleSmall )}
		</h1>` : `` }
	${ visible ? `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64px" height="64px" class="parallax svelte-1qj7hu6" style="transform: translate(0, ${escape(sy * .4)}px)">
...
const css$2 = {
	code: "ul.pillared.svelte-6aq29p{list-style-type:none;padding:0;margin:0}ul.pillared.svelte-6aq29p li.svelte-6aq29p{margin:0.5em;padding:10px;font-size:2em;display:flex;align-items:center}ul.pillared.svelte-6aq29p li span.svelte-6aq29p{padding-left:0.5em;color:white}ul.pillared.svelte-6aq29p li.svelte-6aq29p:hover{cursor:pointer;background-color:rgba(50, 50, 50, 0.5);background-clip:border-box;border-radius:1em;text-decoration:underline;text-decoration-color:goldenrod}ul.pillared.svelte-6aq29p li:hover img.svelte-6aq29p{filter:drop-shadow(0 0 0.3em yellow)}h2.modal-li.svelte-6aq29p{font-size:2em;margin:initial;padding:0.2em}li.modal-li.svelte-6aq29p{font-size:1.4em;padding:0}img[src=\"icons/pillar-white.png\"].svelte-6aq29p{height:2em;border-radius:1em}",
	map: "{\"version\":3,\"file\":\"Pillars.svelte\",\"sources\":[\"Pillars.svelte\"],\"sourcesContent\":[\"<script>\\n    import {fade} from 'svelte/transition';\\n    import Modal from './Modal.svelte';\\n\\n    let broVis = false;\\n    let philVis = false;\\n    let proVis = false;\\n</script>\\n\\n<style>\\n    ul.pillared {\\n        list-style-type: none;\\n        padding: 0;\\n        margin: 0;\\n    }\\n\\n    ul.pillared li {\\n        margin: 0.5em;\\n        padding: 10px;\\n        font-size: 2em;\\n        display: flex;\\n        /* justify-items: center; */\\n        align-items: center;\\n    }\\n    ul.pillared li span {\\n        padding-left: 0.5em;\\n        color: white;\\n    }\\n\\n    ul.pillared li:hover{\\n        cursor: pointer;\\n        background-color: rgba(50, 50, 50, 0.5);\\n        background-clip: border-box;\\n        border-radius: 1em;\\n        text-decoration: underline;\\n        text-decoration-color: goldenrod;\\n    }\\n\\n    ul.pillared li:hover img {\\n        filter: drop-shadow(0 0 0.3em yellow);\\n    }\\n\\n    h2.modal-li {\\n        font-size: 2em;\\n        margin: initial;\\n        padding: 0.2em;\\n    }\\n\\n    li.modal-li {\\n        font-size: 1.4em;\\n        padding: 0;\\n    }\\n\\n    img[src=\\\"icons/pillar-white.png\\\"] {\\n        height: 2em;\\n        border-radius: 1em;\\n    }\\n\\n</style>\\n\\n<ul class=\\\"pillared\\\">\\n    <li on:click={() => broVis = true}>\\n        <img src=\\\"icons/pillar-white.png\\\" alt=\\\"pillar\\\">\\n        <span>Brotherhood</span>\\n    </li>\\n    <li on:click={() => philVis = true}>\\n        <img src=\\\"icons/pillar-white.png\\\" alt=\\\"pillar\\\">\\n        <span>Philanthropy</span>\\n    </li>\\n    <li on:click={() => proVis = true}>\\n        <img src=\\\"icons/pillar-white.png\\\" alt=\\\"pillar\\\">\\n        <span>Professionalism</span>\\n    </li>\\n</ul>\\n\\n{#if broVis}\\n    <Modal on:close=\\\"{() => broVis = false}\\\">\\n        <h2 class=\\\"modal-li\\\" slot=\\\"header\\\">Brotherhood</h2>\\n        <ul>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n        </ul>\\n        <img src=\\\"images/sigma_fun.jpg\\\" alt=\\\"sigmas having fun\\\" width=\\\"100%\\\">\\n    </Modal>\\n{/if}\\n\\n{#if philVis}\\n    <Modal on:close=\\\"{() => philVis = false}\\\">\\n        <h2 class=\\\"modal-li\\\" slot=\\\"header\\\">Philanthropy</h2>\\n        <ul>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n        </ul>\\n        <img src=\\\"images/sigma_fun.jpg\\\" alt=\\\"sigmas having fun\\\" width=\\\"100%\\\">\\n    </Modal>\\n{/if}\\n\\n{#if proVis}\\n    <Modal on:close=\\\"{() => proVis = false}\\\">\\n        <h2 class=\\\"modal-li\\\" slot=\\\"header\\\">Professionalism</h2>\\n        <ul>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n            <li class=\\\"modal-li\\\">Lorem ipsum</li>\\n        </ul>\\n        <img src=\\\"images/sigma_fun.jpg\\\" alt=\\\"sigmas having fun\\\" width=\\\"100%\\\">\\n    </Modal>\\n{/if}\"],\"names\":[],\"mappings\":\"AAUI,EAAE,SAAS,cAAC,CAAC,AACT,eAAe,CAAE,IAAI,CACrB,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,CAAC,AACb,CAAC,AAED,EAAE,uBAAS,CAAC,EAAE,cAAC,CAAC,AACZ,MAAM,CAAE,KAAK,CACb,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,GAAG,CACd,OAAO,CAAE,IAAI,CAEb,WAAW,CAAE,MAAM,AACvB,CAAC,AACD,EAAE,uBAAS,CAAC,EAAE,CAAC,IAAI,cAAC,CAAC,AACjB,YAAY,CAAE,KAAK,CACnB,KAAK,CAAE,KAAK,AAChB,CAAC,AAED,EAAE,uBAAS,CAAC,gBAAE,MAAM,CAAC,AACjB,MAAM,CAAE,OAAO,CACf,gBAAgB,CAAE,KAAK,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,CACvC,eAAe,CAAE,UAAU,CAC3B,aAAa,CAAE,GAAG,CAClB,eAAe,CAAE,SAAS,CAC1B,qBAAqB,CAAE,SAAS,AACpC,CAAC,AAED,EAAE,uBAAS,CAAC,EAAE,MAAM,CAAC,GAAG,cAAC,CAAC,AACtB,MAAM,CAAE,YAAY,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,MAAM,CAAC,AACzC,CAAC,AAED,EAAE,SAAS,cAAC,CAAC,AACT,SAAS,CAAE,GAAG,CACd,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,KAAK,AAClB,CAAC,AAED,EAAE,SAAS,cAAC,CAAC,AACT,SAAS,CAAE,KAAK,CAChB,OAAO,CAAE,CAAC,AACd,CAAC,AAED,GAAG,CAAC,GAAG,CAAC,wBAAwB,CAAC,cAAC,CAAC,AAC/B,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,GAAG,AACtB,CAAC\"}"
};
...
const Pillars = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="pillared svelte-6aq29p">
	    <li class="svelte-6aq29p">
	        <img src="icons/pillar-white.png" alt="pillar" class="svelte-6aq29p">
	        <span class="svelte-6aq29p">Brotherhood</span>
	    </li>
	    <li class="svelte-6aq29p">
	        <img src="icons/pillar-white.png" alt="pillar" class="svelte-6aq29p">
	        <span class="svelte-6aq29p">Philanthropy</span>
	    </li>
	    <li class="svelte-6aq29p">
	        <img src="icons/pillar-white.png" alt="pillar" class="svelte-6aq29p">
	        <span class="svelte-6aq29p">Professionalism</span>
	    </li>
	</ul>
...
const css$3 = {
	code: ".card.svelte-1laj3e{margin-top:5em;background-color:white;border:4px solid black;width:100%;padding:15px}.wrapper.svelte-1laj3e{display:flex;justify-items:center}.subcards.svelte-1laj3e{padding:10px}.left-div.svelte-1laj3e{border-right:2px dotted #333}.right-div.svelte-1laj3e{}.header.svelte-1laj3e{padding-top:30px;min-width:100%;text-align:center}",
	map: "{\"version\":3,\"file\":\"Card.svelte\",\"sources\":[\"Card.svelte\"],\"sourcesContent\":[\"<script>\\n    export let section;\\n</script>\\n\\n<style>\\n\\t.card {\\n\\t\\tmargin-top: 5em;\\n\\t\\tbackground-color: white;\\n\\t\\tborder: 4px solid black;\\n\\t\\twidth: 100%;\\n        padding: 15px;\\n    }\\n\\n    .wrapper {\\n        display: flex;\\n        justify-items: center;\\n    }\\n\\n    .subcards {\\n        padding: 10px;\\n    }\\n    \\n    .left-div {\\n        border-right: 2px dotted #333;\\n    }\\n    \\n    .right-div {\\n        /* border-right: 2px dotted #333; */\\n    }\\n\\n    .header {\\n        padding-top: 30px;\\n        min-width: 100%;\\n        text-align: center;\\n    }\\n    \\n</style>\\n\\n<section class=\\\"card\\\">\\n    <slot name=\\\"header\\\" class=\\\"header\\\"></slot>\\n    <hr>\\n    <div class=\\\"wrapper\\\">\\n        <section class=\\\"left-div subcards\\\">\\n            <slot name=\\\"left\\\"></slot>\\n        </section>\\n        <section class=\\\"right-div subcards\\\">\\n            <slot name=\\\"right\\\"></slot>\\n        </section>\\n    </div>\\n</section>\"],\"names\":[],\"mappings\":\"AAKC,KAAK,cAAC,CAAC,AACN,UAAU,CAAE,GAAG,CACf,gBAAgB,CAAE,KAAK,CACvB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,CACvB,KAAK,CAAE,IAAI,CACL,OAAO,CAAE,IAAI,AACjB,CAAC,AAED,QAAQ,cAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,aAAa,CAAE,MAAM,AACzB,CAAC,AAED,SAAS,cAAC,CAAC,AACP,OAAO,CAAE,IAAI,AACjB,CAAC,AAED,SAAS,cAAC,CAAC,AACP,YAAY,CAAE,GAAG,CAAC,MAAM,CAAC,IAAI,AACjC,CAAC,AAED,UAAU,cAAC,CAAC,AAEZ,CAAC,AAED,OAAO,cAAC,CAAC,AACL,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,MAAM,AACtB,CAAC\"}"
};
...
const Card = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="card svelte-1laj3e">
	    ${$$slots.header ? $$slots.header({ class: `header svelte-1laj3e` }) : ``}
	    <hr>
	    <div class="wrapper svelte-1laj3e">
	        <section class="left-div subcards svelte-1laj3e">
	            ${$$slots.left ? $$slots.left() : ``}
	        </section>
	        <section class="right-div subcards svelte-1laj3e">
...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const brotherLabels = [
	...
	return `${($$result.head += `<title>UCSD Theta Tau</title>`, "")}

	<div class="hero-div svelte-z97d5i">
	...
	${validate_component(Card, 'Card').$$render($$result, {}, {}, {
		default: () => `
	  `,
		header: () => `<h3 slot="header">UC San Diego's premier engineering fraternity</h3>
	  `,
		left: () => `<section slot="left">
	  	<p class="svelte-z97d5i">
			Formed in 1904 with chapters in over 80 campuses, Theta Tau is both the
			nation's largest and oldest co-ed engineering fraternity. Our brothers 
			develop each other to not only focus on one aspect of ourselves, but on 
			many. We strive to be well-rounded people who excel in brotherhood,
	  ...
	  `,
	    ...
	    <iframe title="SP19 rush video" width="960" height="540" src="https://www.youtube.com/embed/FLfQ3UrGNKk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope;
	      picture-in-picture" allowfullscreen></iframe>
		<figcaption class="svelte-z97d5i">Our rush video for Spring 2019!</figcaption>
	  </figure>
	`
	})}

	<div class="pillars-div svelte-z97d5i">
	  <h1 class="svelte-z97d5i">the Three Pillars</h1>
...
const Members = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<p>This is the 'members' page. There's not much here.</p>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="svelte-jfl6d8">
...
const css$8 = {
	...
	map: "{\"version\":3,\"file\":\"_layout.svelte\",\"sources\":[\"_layout.svelte\"],\"sourcesContent\":[\"<script>\\n\\timport Nav from '../components/Nav.svelte';\\n\\n\\texport let segment;\\n</script>\\n\\n<style>\\n\\tmain {\\n\\t\\tposition: relative;\\n\\t\\tpadding: 2em;\\n\\t\\tmargin: 0 auto;\\n\\t\\tbox-sizing: border-box;\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\talign-items: center;\\n\\t}\\n</style>\\n\\n<Nav {segment}/>\\n\\n<main>\\n\\t<slot></slot>\\n</main>\"],\"names\":[],\"mappings\":\"AAOC,IAAI,cAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,UAAU,CACtB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,AACpB,CAAC\"}"
};
