...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="svelte-1fwy2ov">
		<ul class="svelte-1fwy2ov">
			<li class="svelte-1fwy2ov"><a id="letters" href="." class="svelte-1fwy2ov">Θ Τ</a></li>
			<li class="svelte-1fwy2ov"><a class="${escape(segment === undefined ? "selected" : "")} svelte-1fwy2ov" href=".">Home</a></li>
			<li class="svelte-1fwy2ov"><a class="${escape(segment === "about" ? "selected" : "")} svelte-1fwy2ov" href="about">About</a></li>
			<li class="svelte-1fwy2ov"><a class="${escape(segment === "rush" ? "selected" : "")} svelte-1fwy2ov" href="rush">Rush</a></li>
			<li class="svelte-1fwy2ov"><a class="${escape(segment === "faq" ? "selected" : "")} svelte-1fwy2ov" href="faq">FAQ</a></li>
			<li class="svelte-1fwy2ov"><a class="${escape(segment === "members" ? "selected" : "")} svelte-1fwy2ov" href="members">Members</a></li>
		</ul>
	</nav>`;
});
