...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const brotherLabels = [
	...
	<div class="hero-div svelte-1a2i6qs">
	...
	${validate_component(Card, 'Card').$$render($$result, {}, {}, {
	  ...
	  `,
		left: () => `<p slot="left" class="svelte-1a2i6qs">
	    Lorem ipsoumLorem ipsoumLorem ipsoum Lorem ipsoumLorem ipsoum Lorem
	    ipsoumLorem ipsoumLorem ipsoumLorem ipsoumLorem ipsoum Lorem ipsoumLorem
	    ipsoumLorem ipsoumLorem ipsoumLorem ipsoum Lorem ipsoumLorem ipsoum
	  </p>
	  `,
		...
		<figcaption class="svelte-1a2i6qs">Our rush video for Spring 2019!</figcaption>
	  </figure>
	`
	})}

	<div class="pillars-div svelte-1a2i6qs">
	  <h1 class="svelte-1a2i6qs">the Three Pillars</h1>
