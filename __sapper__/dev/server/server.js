...
const css$3 = {
	code: ".card.svelte-xiwb3z{margin-top:5em;background-color:white;border:4px solid black;width:100%;padding:15px}.wrapper.svelte-xiwb3z{display:flex;justify-items:center}.subcards.svelte-xiwb3z{padding:10px}.left-div.svelte-xiwb3z{border-right:5px dotted #333}.right-div.svelte-xiwb3z{}.header.svelte-xiwb3z{padding-top:30px;min-width:100%;text-align:center}@media(max-width: 1000px){.wrapper.svelte-xiwb3z{flex-direction:column}.wrapper.svelte-xiwb3z .subcards.svelte-xiwb3z{font-size:1em}.left-div.svelte-xiwb3z{border-right:none}}",
...
const Card = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="card svelte-xiwb3z">
	    ${$$slots.header ? $$slots.header({ class: `header svelte-xiwb3z` }) : ``}
	    <hr>
	    <div class="wrapper svelte-xiwb3z">
	        <section class="left-div subcards svelte-xiwb3z">
	            ${$$slots.left ? $$slots.left() : ``}
	        </section>
	        <section class="right-div subcards svelte-xiwb3z">
...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const brotherLabels = [
	...
	<div class="hero-div svelte-2xf468">
	...
	${validate_component(Card, 'Card').$$render($$result, {}, {}, {
		default: () => `
	  `,
		header: () => `<h3 slot="header" class="svelte-2xf468">
	    <strong>UC San Diego's premier engineering fraternity</strong>
	  </h3>
	  `,
		left: () => `<section slot="left">
	    <p class="svelte-2xf468">
	      Formed in 1904 with chapters in over 80 campuses, Theta Tau is both the
	      <strong>nation's largest and oldest co-ed engineering fraternity</strong>.
	      Our brothers develop each other to not only focus on one aspect of
	      ourselves, but on many. We strive to be well-rounded people who excel in
...
const css$8 = {
	code: "footer.svelte-182sns6{background-color:#777;margin-top:30px;border-top:5px maroon solid;display:flex;flex-direction:row;align-items:space-between;justify-content:space-evenly;font-size:0.8em}.footer-div.svelte-182sns6{padding:0 10px;margin:10px 10px;border-left:1px black dashed}p.footer-div.svelte-182sns6{color:white}",
	map: "{\"version\":3,\"file\":\"Footer.svelte\",\"sources\":[\"Footer.svelte\"],\"sourcesContent\":[\"<script>\\n</script>\\n\\n<style>\\n    footer {\\n        background-color: #777;\\n        margin-top: 30px;\\n        border-top: 5px maroon solid;\\n        display: flex;\\n        flex-direction: row;\\n        align-items: space-between;\\n        justify-content: space-evenly;\\n        font-size: 0.8em;\\n    }\\n\\n    .footer-div {\\n        padding: 0 10px;\\n        margin: 10px 10px;\\n        border-left: 1px black dashed;\\n    }\\n\\n    p.footer-div {\\n        color: white;\\n    }\\n\\n</style>\\n\\n<footer>\\n    <img class=\\\"footer-div\\\" src=\\\"images/hamntongs.png\\\" alt=\\\"our seal\\\" height=\\\"60px\\\">\\n    <p class=\\\"footer-div\\\">\\n        <strong>Contributors:</strong><br>\\n        Will Xu\\n    </p>\\n    <p class=\\\"footer-div\\\">\\n        Icons from\\n        <a href=\\\"https://icons8.com/icons\\\">icons8</a>\\n    </p>\\n</footer>\"],\"names\":[],\"mappings\":\"AAII,MAAM,eAAC,CAAC,AACJ,gBAAgB,CAAE,IAAI,CACtB,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,GAAG,CAAC,MAAM,CAAC,KAAK,CAC5B,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,GAAG,CACnB,WAAW,CAAE,aAAa,CAC1B,eAAe,CAAE,YAAY,CAC7B,SAAS,CAAE,KAAK,AACpB,CAAC,AAED,WAAW,eAAC,CAAC,AACT,OAAO,CAAE,CAAC,CAAC,IAAI,CACf,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,MAAM,AACjC,CAAC,AAED,CAAC,WAAW,eAAC,CAAC,AACV,KAAK,CAAE,KAAK,AAChB,CAAC\"}"
};

const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$8);

	return `<footer class="svelte-182sns6">
	    <img class="footer-div svelte-182sns6" src="images/hamntongs.png" alt="our seal" height="60px">
	    <p class="footer-div svelte-182sns6">
	        <strong>Contributors:</strong><br>
	        Will Xu
	    </p>
	    <p class="footer-div svelte-182sns6">
