...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 90, 8, 1674);
			attr(div, "class", "carousel svelte-1ox04ca");
			add_location(div, file, 89, 6, 1643);
		},
