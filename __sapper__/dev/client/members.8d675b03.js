...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1jwl42e");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 77, 2, 1535);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file, 74, 0, 1490);
			attr(img, "class", "class-img svelte-1jwl42e");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 89, 2, 1707);
			attr(div0, "class", "class-img-container svelte-1jwl42e");
			add_location(div0, file, 88, 0, 1671);
			add_location(h2, file, 98, 2, 1865);
			add_location(h3, file, 99, 2, 1903);
			attr(div1, "class", "brother-info svelte-1jwl42e");
			add_location(div1, file, 97, 0, 1836);
