...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-eeuv7b");
			add_location(img, file, 110, 8, 2064);
			attr(div, "class", "carousel svelte-eeuv7b");
			add_location(div, file, 109, 6, 2033);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-eeuv7b");
			add_location(button0, file, 101, 2, 1869);
			attr(div0, "class", "carousel-wrapper svelte-eeuv7b");
			add_location(div0, file, 107, 2, 1978);
			attr(button1, "class", "carousel-button button-right svelte-eeuv7b");
			add_location(button1, file, 114, 2, 2172);
			attr(div1, "class", "button-wrapper svelte-eeuv7b");
			add_location(div1, file, 100, 0, 1838);
