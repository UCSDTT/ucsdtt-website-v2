...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-smhls4");
			add_location(img, file, 111, 8, 2103);
			attr(div, "class", "carousel svelte-smhls4");
			add_location(div, file, 110, 6, 2072);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-smhls4");
			add_location(button0, file, 102, 2, 1908);
			attr(div0, "class", "carousel-wrapper svelte-smhls4");
			add_location(div0, file, 108, 2, 2017);
			attr(button1, "class", "carousel-button button-right svelte-smhls4");
			add_location(button1, file, 115, 2, 2211);
			attr(div1, "class", "button-wrapper svelte-smhls4");
