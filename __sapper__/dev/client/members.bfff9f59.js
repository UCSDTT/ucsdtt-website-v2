...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p0, "class", "svelte-1q75jp6");
			add_location(p0, file, 62, 0, 1208);
			attr(p1, "class", "svelte-1q75jp6");
			add_location(p1, file, 63, 0, 1223);
			attr(p2, "class", "svelte-1q75jp6");
			add_location(p2, file, 64, 0, 1238);
			attr(p3, "class", "svelte-1q75jp6");
			add_location(p3, file, 65, 0, 1253);
			attr(div0, "class", "cursor-box svelte-1q75jp6");
			set_style(div0, "top", ctx.picY);
			set_style(div0, "left", ctx.picX);
			add_location(div0, file, 69, 0, 1337);
			attr(img, "class", "class-img");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 79, 2, 1459);
			attr(div1, "class", "class-img-container svelte-1q75jp6");
			add_location(div1, file, 78, 0, 1423);
