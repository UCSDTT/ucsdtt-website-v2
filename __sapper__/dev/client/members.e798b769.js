...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1t9vnc6");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-1t9vnc6");
			...
			attr(div0, "class", "class-img-container svelte-1t9vnc6");
			add_location(div0, file, 80, 0, 1492);
			attr(div1, "class", "space-maker svelte-1t9vnc6");
