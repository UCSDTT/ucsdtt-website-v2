import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, e as element, t as text, a as space, E as svg_element, c as claim_element, b as children, d as claim_text, f as detach, g as attr, h as add_location, F as set_style, j as insert, k as append, w as set_data, G as create_bidirectional_transition, x as empty, H as listen, q as transition_in, B as group_outros, r as transition_out, C as check_outros, I as onMount, m as mount_component, u as destroy_component } from './chunk.b69937b6.js';
...
function create_if_block(ctx) {
	var h1, t0, h1_transition, t1, svg_1, path, path_transition, current;
	...
	return {
		...
		l: function claim(nodes) {
			...
			svg_1 = claim_element(nodes, "svg", { class: true, style: true, xmlns: true, viewBox: true, width: true, height: true }, true);
		...
		h: function hydrate() {
			...
			add_location(h1, file, 53, 1, 874);
			attr(path, "d", ctx.svg);
			attr(path, "opacity", "0.6");
			add_location(path, file, 55, 2, 1081);
			attr(svg_1, "class", "parallax svelte-mhzkyt");
			...
			add_location(svg_1, file, 54, 1, 929);
		},
		...
		i: function intro(local) {
			...
			add_render_callback(() => {
				if (!path_transition) path_transition = create_bidirectional_transition(path, draw, {duration: 1000}, true);
		...
		o: function outro(local) {
			...
			if (!path_transition) path_transition = create_bidirectional_transition(path, draw, {duration: 1000}, false);
		...
		d: function destroy(detaching) {
			if (detaching) {
				...
				detach(t1);
				detach(svg_1);
				if (path_transition) path_transition.end();
			}
		}
	};
}
...
function instance($$self, $$props, $$invalidate) {
	...
	const writable_props = ['svg', 'title', 'tagline'];
...
class Hero extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, ["svg", "title", "tagline"]);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t1 = claim_text(p0_nodes, garnetUnfilled);
			...
			t67 = claim_text(p1_nodes, "Icons from ");

			a = claim_element(p1_nodes, "A", { href: true }, false);
		...
		h: function hydrate() {
			...
			attr(p0, "class", "svelte-sazog6");
			add_location(p0, file$1, 25, 0, 352);
			attr(section, "class", "hero-section svelte-sazog6");
			add_location(section, file$1, 27, 0, 377);
			add_location(br0, file$1, 41, 0, 691);
			add_location(br1, file$1, 42, 0, 697);
			add_location(br2, file$1, 43, 0, 703);
			add_location(br3, file$1, 44, 0, 709);
			add_location(br4, file$1, 45, 0, 715);
			add_location(br5, file$1, 46, 0, 721);
			add_location(br6, file$1, 47, 0, 727);
			add_location(br7, file$1, 48, 0, 733);
			add_location(br8, file$1, 49, 0, 739);
			add_location(br9, file$1, 50, 0, 745);
			add_location(br10, file$1, 51, 0, 751);
			add_location(br11, file$1, 52, 0, 757);
			add_location(br12, file$1, 53, 0, 763);
			add_location(br13, file$1, 54, 0, 769);
			add_location(br14, file$1, 55, 0, 775);
			add_location(br15, file$1, 56, 0, 781);
			add_location(br16, file$1, 57, 0, 787);
			add_location(br17, file$1, 58, 0, 793);
			add_location(br18, file$1, 59, 0, 799);
			add_location(br19, file$1, 60, 0, 805);
			add_location(br20, file$1, 61, 0, 811);
			add_location(br21, file$1, 62, 0, 817);
			add_location(br22, file$1, 63, 0, 823);
			add_location(br23, file$1, 64, 0, 829);
			add_location(br24, file$1, 65, 0, 835);
			add_location(br25, file$1, 66, 0, 841);
			add_location(br26, file$1, 67, 0, 847);
			add_location(br27, file$1, 68, 0, 853);
			add_location(br28, file$1, 69, 0, 859);
			add_location(br29, file$1, 70, 0, 865);
			add_location(br30, file$1, 71, 0, 871);
			add_location(br31, file$1, 72, 0, 877);
			add_location(br32, file$1, 73, 0, 883);
			add_location(br33, file$1, 74, 0, 889);
			add_location(br34, file$1, 75, 0, 895);
			add_location(br35, file$1, 76, 0, 901);
			add_location(br36, file$1, 77, 0, 907);
			add_location(br37, file$1, 78, 0, 913);
			add_location(br38, file$1, 79, 0, 919);
			add_location(br39, file$1, 80, 0, 925);
			add_location(br40, file$1, 81, 0, 931);
			add_location(br41, file$1, 82, 0, 937);
			add_location(br42, file$1, 83, 0, 943);
			add_location(br43, file$1, 84, 0, 949);
			add_location(br44, file$1, 85, 0, 955);
			add_location(br45, file$1, 86, 0, 961);
			add_location(br46, file$1, 87, 0, 967);
			add_location(br47, file$1, 88, 0, 973);
			add_location(br48, file$1, 89, 0, 979);
			add_location(br49, file$1, 90, 0, 985);
			add_location(br50, file$1, 91, 0, 991);
			add_location(br51, file$1, 92, 0, 997);
			add_location(br52, file$1, 93, 0, 1003);
			add_location(br53, file$1, 94, 0, 1009);
			add_location(br54, file$1, 95, 0, 1015);
			add_location(br55, file$1, 96, 0, 1021);
			add_location(br56, file$1, 97, 0, 1027);
			add_location(br57, file$1, 98, 0, 1033);
			add_location(br58, file$1, 99, 0, 1039);
			add_location(br59, file$1, 100, 0, 1045);
			add_location(br60, file$1, 101, 0, 1051);
			add_location(br61, file$1, 102, 0, 1057);
			add_location(br62, file$1, 103, 0, 1063);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$1, 104, 14, 1083);
			attr(p1, "class", "svelte-sazog6");
			add_location(p1, file$1, 104, 0, 1069);
		},
		...
		p: function update(changed, ctx) {
			var hero_changes = {};
			if (changed.garnetUnfilled) hero_changes.src = garnetUnfilled;
