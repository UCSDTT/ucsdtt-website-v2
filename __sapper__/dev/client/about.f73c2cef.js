...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 30, 0, 517);
			add_location(h3, file, 32, 0, 533);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			add_location(img0, file, 36, 2, 640);
			attr(div0, "class", "pillar svelte-13vgz03");
			add_location(div0, file, 35, 1, 617);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			add_location(img1, file, 39, 2, 714);
			attr(div1, "class", "pillar svelte-13vgz03");
			add_location(div1, file, 38, 1, 691);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			add_location(img2, file, 42, 2, 788);
			attr(div2, "class", "pillar svelte-13vgz03");
			add_location(div2, file, 41, 1, 765);
			attr(div3, "class", "pillars svelte-13vgz03");
			add_location(div3, file, 34, 0, 594);
		},
