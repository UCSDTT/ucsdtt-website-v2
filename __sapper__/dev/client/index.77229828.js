...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong, file$3, 81, 4, 1367);
			attr(h3, "slot", "header");
			add_location(h3, file$3, 80, 2, 1344);
		},
...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong0, file$3, 86, 6, 1554);
			add_location(strong1, file$3, 89, 6, 1787);
			add_location(strong2, file$3, 90, 6, 1823);
			add_location(strong3, file$3, 91, 6, 1864);
			attr(p0, "class", "svelte-wr6xou");
			add_location(p0, file$3, 84, 4, 1466);
			add_location(strong4, file$3, 99, 6, 2294);
			attr(p1, "class", "svelte-wr6xou");
			add_location(p1, file$3, 93, 4, 1911);
			add_location(strong5, file$3, 103, 6, 2451);
			attr(p2, "class", "svelte-wr6xou");
			add_location(p2, file$3, 101, 4, 2363);
			attr(section, "slot", "left");
			add_location(section, file$3, 83, 2, 1440);
		},
...
function create_if_block$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(iframe, "max-width", "calc(100vw - 3em)");
			...
			attr(iframe, "class", "svelte-wr6xou");
			add_location(iframe, file$3, 110, 6, 2606);
			attr(figcaption, "class", "svelte-wr6xou");
			add_location(figcaption, file$3, 121, 6, 2958);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(figure, file$3, 106, 2, 2511);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-wr6xou");
			add_location(div, file$3, 69, 0, 1142);
