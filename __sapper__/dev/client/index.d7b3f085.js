...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(p1, file$5, 101, 1, 2037);
			attr(p2, "class", "svelte-1a2i6qs");
			add_location(p2, file$5, 109, 1, 2425);
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 117, 4, 2618);
			attr(figcaption, "class", "svelte-1a2i6qs");
			add_location(figcaption, file$5, 126, 1, 2884);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 114, 2, 2545);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$5, 131, 2, 2990);
			attr(div1, "class", "pillars-div svelte-1a2i6qs");
			add_location(div1, file$5, 130, 0, 2962);
			add_location(br0, file$5, 139, 0, 3205);
			add_location(br1, file$5, 140, 0, 3212);
			add_location(br2, file$5, 141, 0, 3219);
			add_location(br3, file$5, 142, 0, 3226);
			add_location(br4, file$5, 143, 0, 3233);
			add_location(br5, file$5, 144, 0, 3240);
			add_location(br6, file$5, 145, 0, 3247);
			add_location(br7, file$5, 146, 0, 3254);
			add_location(br8, file$5, 147, 0, 3261);
			add_location(br9, file$5, 148, 0, 3268);
			add_location(br10, file$5, 149, 0, 3275);
			add_location(br11, file$5, 150, 0, 3282);
			add_location(br12, file$5, 151, 0, 3289);
			add_location(br13, file$5, 152, 0, 3296);
			add_location(br14, file$5, 153, 0, 3303);
			add_location(br15, file$5, 154, 0, 3310);
			add_location(br16, file$5, 155, 0, 3317);
			add_location(br17, file$5, 156, 0, 3324);
			add_location(br18, file$5, 157, 0, 3331);
			add_location(br19, file$5, 158, 0, 3338);
			add_location(br20, file$5, 159, 0, 3345);
			add_location(br21, file$5, 160, 0, 3352);
			add_location(br22, file$5, 161, 0, 3359);
			add_location(br23, file$5, 162, 0, 3366);
			add_location(br24, file$5, 163, 0, 3373);
			add_location(br25, file$5, 164, 0, 3380);
			add_location(br26, file$5, 165, 0, 3387);
			add_location(br27, file$5, 166, 0, 3394);
			add_location(br28, file$5, 167, 0, 3401);
			add_location(br29, file$5, 168, 0, 3408);
			add_location(br30, file$5, 169, 0, 3415);
			add_location(br31, file$5, 170, 0, 3422);
			add_location(br32, file$5, 171, 0, 3429);
			add_location(br33, file$5, 172, 0, 3436);
			add_location(br34, file$5, 173, 0, 3443);
			add_location(br35, file$5, 174, 0, 3450);
			add_location(br36, file$5, 175, 0, 3457);
			add_location(br37, file$5, 176, 0, 3464);
			add_location(br38, file$5, 177, 0, 3471);
			add_location(br39, file$5, 178, 0, 3478);
			add_location(br40, file$5, 179, 0, 3485);
			add_location(br41, file$5, 180, 0, 3492);
			add_location(br42, file$5, 181, 0, 3499);
			add_location(br43, file$5, 182, 0, 3506);
			add_location(br44, file$5, 183, 0, 3513);
			add_location(br45, file$5, 184, 0, 3520);
			add_location(br46, file$5, 185, 0, 3527);
			add_location(br47, file$5, 186, 0, 3534);
			add_location(br48, file$5, 187, 0, 3541);
			add_location(br49, file$5, 188, 0, 3548);
			add_location(br50, file$5, 189, 0, 3555);
			add_location(br51, file$5, 190, 0, 3562);
			add_location(br52, file$5, 191, 0, 3569);
			add_location(br53, file$5, 192, 0, 3576);
			add_location(br54, file$5, 193, 0, 3583);
			add_location(br55, file$5, 194, 0, 3590);
			add_location(br56, file$5, 195, 0, 3597);
			add_location(br57, file$5, 196, 0, 3604);
			add_location(br58, file$5, 197, 0, 3611);
			add_location(br59, file$5, 198, 0, 3618);
			add_location(br60, file$5, 199, 0, 3625);
			add_location(br61, file$5, 200, 0, 3632);
			add_location(br62, file$5, 201, 0, 3639);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 204, 2, 3665);
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 202, 0, 3646);
		},
