...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1g99psr");
			add_location(img0, file$2, 40, 8, 728);
			attr(span0, "class", "svelte-1g99psr");
			add_location(span0, file$2, 40, 55, 775);
			attr(li0, "class", "svelte-1g99psr");
			add_location(li0, file$2, 40, 4, 724);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1g99psr");
			add_location(img1, file$2, 41, 8, 813);
			attr(span1, "class", "svelte-1g99psr");
			add_location(span1, file$2, 41, 55, 860);
			attr(li1, "class", "svelte-1g99psr");
			add_location(li1, file$2, 41, 4, 809);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1g99psr");
			add_location(img2, file$2, 42, 8, 899);
			attr(span2, "class", "svelte-1g99psr");
			add_location(span2, file$2, 42, 55, 946);
			attr(li2, "class", "svelte-1g99psr");
			add_location(li2, file$2, 42, 4, 895);
			attr(ul, "class", "pillared svelte-1g99psr");
			add_location(ul, file$2, 39, 0, 698);
		},
