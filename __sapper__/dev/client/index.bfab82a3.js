...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-1wetaz5");
			add_location(div, file$2, 37, 0, 656);
			add_location(br0, file$2, 53, 0, 1009);
			add_location(br1, file$2, 54, 0, 1015);
			add_location(br2, file$2, 55, 0, 1021);
			add_location(br3, file$2, 56, 0, 1027);
			add_location(br4, file$2, 57, 0, 1033);
			add_location(br5, file$2, 58, 0, 1039);
			add_location(br6, file$2, 59, 0, 1045);
			add_location(br7, file$2, 60, 0, 1051);
			add_location(br8, file$2, 61, 0, 1057);
			add_location(br9, file$2, 62, 0, 1063);
			add_location(br10, file$2, 63, 0, 1069);
			add_location(br11, file$2, 64, 0, 1075);
			add_location(br12, file$2, 65, 0, 1081);
			add_location(br13, file$2, 66, 0, 1087);
			add_location(br14, file$2, 67, 0, 1093);
			add_location(br15, file$2, 68, 0, 1099);
			add_location(br16, file$2, 69, 0, 1105);
			add_location(br17, file$2, 70, 0, 1111);
			add_location(br18, file$2, 71, 0, 1117);
			add_location(br19, file$2, 72, 0, 1123);
			add_location(br20, file$2, 73, 0, 1129);
			add_location(br21, file$2, 74, 0, 1135);
			add_location(br22, file$2, 75, 0, 1141);
			add_location(br23, file$2, 76, 0, 1147);
			add_location(br24, file$2, 77, 0, 1153);
			add_location(br25, file$2, 78, 0, 1159);
			add_location(br26, file$2, 79, 0, 1165);
			add_location(br27, file$2, 80, 0, 1171);
			add_location(br28, file$2, 81, 0, 1177);
			add_location(br29, file$2, 82, 0, 1183);
			add_location(br30, file$2, 83, 0, 1189);
			add_location(br31, file$2, 84, 0, 1195);
			add_location(br32, file$2, 85, 0, 1201);
			add_location(br33, file$2, 86, 0, 1207);
			add_location(br34, file$2, 87, 0, 1213);
			add_location(br35, file$2, 88, 0, 1219);
			add_location(br36, file$2, 89, 0, 1225);
			add_location(br37, file$2, 90, 0, 1231);
			add_location(br38, file$2, 91, 0, 1237);
			add_location(br39, file$2, 92, 0, 1243);
			add_location(br40, file$2, 93, 0, 1249);
			add_location(br41, file$2, 94, 0, 1255);
			add_location(br42, file$2, 95, 0, 1261);
			add_location(br43, file$2, 96, 0, 1267);
			add_location(br44, file$2, 97, 0, 1273);
			add_location(br45, file$2, 98, 0, 1279);
			add_location(br46, file$2, 99, 0, 1285);
			add_location(br47, file$2, 100, 0, 1291);
			add_location(br48, file$2, 101, 0, 1297);
			add_location(br49, file$2, 102, 0, 1303);
			add_location(br50, file$2, 103, 0, 1309);
			add_location(br51, file$2, 104, 0, 1315);
			add_location(br52, file$2, 105, 0, 1321);
			add_location(br53, file$2, 106, 0, 1327);
			add_location(br54, file$2, 107, 0, 1333);
			add_location(br55, file$2, 108, 0, 1339);
			add_location(br56, file$2, 109, 0, 1345);
			add_location(br57, file$2, 110, 0, 1351);
			add_location(br58, file$2, 111, 0, 1357);
			add_location(br59, file$2, 112, 0, 1363);
			add_location(br60, file$2, 113, 0, 1369);
			add_location(br61, file$2, 114, 0, 1375);
			add_location(br62, file$2, 115, 0, 1381);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$2, 116, 14, 1401);
			attr(p, "class", "svelte-1wetaz5");
			add_location(p, file$2, 116, 0, 1387);
		},
