...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-1aq0wyz");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 61, 4, 1345);
			attr(div0, "class", "class-img-container svelte-1aq0wyz");
			add_location(div0, file, 60, 2, 1307);
			attr(div1, "class", "pledge-classes svelte-1aq0wyz");
			add_location(div1, file, 59, 0, 1276);
		},
