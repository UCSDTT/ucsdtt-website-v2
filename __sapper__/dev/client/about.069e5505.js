import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, e as element, a as space, c as claim_element, b as children, f as detach, d as claim_text, g as attr, h as add_location, j as insert, t as text, H as listen, k as append, n as noop, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.86736f05.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			img0 = claim_element(nodes, "IMG", { id: true, src: true, alt: true, class: true }, false);
			var img0_nodes = children(img0);

			img0_nodes.forEach(detach);
			t = claim_text(nodes, "\n    ");

			img1 = claim_element(nodes, "IMG", { src: true, alt: true, class: true }, false);
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1wopt9k");
			add_location(img0, file, 79, 4, 2161);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-1wopt9k");
			add_location(img1, file, 80, 4, 2237);
		},
