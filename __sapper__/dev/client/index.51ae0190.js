...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-keeegp");
			add_location(div0, file$2, 38, 0, 652);

			add_location(hr0, file$2, 42, 1, 777);

			add_location(hr1, file$2, 44, 1, 798);
			attr(button, "class", "svelte-keeegp");
			add_location(button, file$2, 46, 1, 805);
			attr(div1, "class", "modal svelte-keeegp");
			add_location(div1, file$2, 40, 0, 727);
