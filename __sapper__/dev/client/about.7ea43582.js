...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-1hb0uje");
			add_location(h1, file, 36, 2, 829);
			attr(p0, "class", "svelte-1hb0uje");
			add_location(p0, file, 37, 2, 884);
			add_location(strong0, file, 44, 4, 1145);
			attr(p1, "class", "svelte-1hb0uje");
			add_location(p1, file, 43, 2, 1137);
			add_location(strong1, file, 51, 4, 1417);
			add_location(strong2, file, 52, 4, 1451);
			add_location(strong3, file, 53, 4, 1486);
			add_location(strong4, file, 54, 4, 1526);
			add_location(strong5, file, 55, 4, 1559);
			add_location(strong6, file, 56, 4, 1591);
			add_location(strong7, file, 57, 4, 1623);
			add_location(strong8, file, 58, 4, 1655);
			add_location(strong9, file, 59, 4, 1686);
			add_location(strong10, file, 60, 4, 1724);
			add_location(strong11, file, 61, 4, 1777);
			add_location(strong12, file, 62, 4, 1811);
			add_location(strong13, file, 63, 8, 1848);
			attr(p2, "class", "svelte-1hb0uje");
			add_location(p2, file, 50, 2, 1409);
			add_location(strong14, file, 67, 4, 1954);
			add_location(strong15, file, 68, 4, 2001);
			attr(p3, "class", "svelte-1hb0uje");
			add_location(p3, file, 65, 2, 1891);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-1hb0uje");
			add_location(img0, file, 70, 2, 2038);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-1hb0uje");
			add_location(img1, file, 71, 2, 2112);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-1hb0uje");
			add_location(div, file, 35, 0, 809);
		},
