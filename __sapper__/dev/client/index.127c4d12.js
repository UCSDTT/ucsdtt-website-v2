...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-z8zjpa");
			add_location(div0, file$2, 36, 0, 590);

			add_location(hr0, file$2, 40, 1, 715);

			add_location(hr1, file$2, 42, 1, 736);
			attr(button, "class", "svelte-z8zjpa");
			add_location(button, file$2, 44, 1, 743);
			attr(div1, "class", "modal svelte-z8zjpa");
			add_location(div1, file$2, 38, 0, 665);
...
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-1swkb6t");
			add_location(li0, file$3, 77, 12, 1707);
			attr(li1, "class", "modal-li svelte-1swkb6t");
			add_location(li1, file$3, 78, 12, 1757);
			attr(li2, "class", "modal-li svelte-1swkb6t");
			add_location(li2, file$3, 79, 12, 1807);
			attr(li3, "class", "modal-li svelte-1swkb6t");
			add_location(li3, file$3, 80, 12, 1857);
			attr(li4, "class", "modal-li svelte-1swkb6t");
