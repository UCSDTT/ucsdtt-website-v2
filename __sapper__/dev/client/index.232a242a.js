...
function create_fragment$2(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t3 = claim_text(h2_nodes, "the Three Pillars");
		...
		h: function hydrate() {
			...
			attr(h2, "class", "svelte-1ioancz");
			add_location(h2, file$2, 58, 1, 998);
