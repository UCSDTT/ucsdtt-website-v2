...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-19by3zl");
			add_location(img0, file$2, 48, 8, 940);
			attr(span0, "class", "svelte-19by3zl");
			add_location(span0, file$2, 48, 55, 987);
			attr(li0, "class", "svelte-19by3zl");
			add_location(li0, file$2, 48, 4, 936);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-19by3zl");
			add_location(img1, file$2, 49, 8, 1025);
			attr(span1, "class", "svelte-19by3zl");
			add_location(span1, file$2, 49, 55, 1072);
			attr(li1, "class", "svelte-19by3zl");
			add_location(li1, file$2, 49, 4, 1021);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-19by3zl");
			add_location(img2, file$2, 50, 8, 1111);
			attr(span2, "class", "svelte-19by3zl");
			add_location(span2, file$2, 50, 55, 1158);
			attr(li2, "class", "svelte-19by3zl");
			add_location(li2, file$2, 50, 4, 1107);
			attr(ul, "class", "pillared svelte-19by3zl");
			add_location(ul, file$2, 47, 0, 910);
		},
