...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1pplonk");
			add_location(img0, file$2, 32, 12, 599);
			attr(h20, "class", "svelte-1pplonk");
			add_location(h20, file$2, 32, 8, 595);
			attr(li0, "class", "svelte-1pplonk");
			add_location(li0, file$2, 32, 4, 591);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1pplonk");
			add_location(img1, file$2, 33, 12, 680);
			attr(h21, "class", "svelte-1pplonk");
			add_location(h21, file$2, 33, 8, 676);
			attr(li1, "class", "svelte-1pplonk");
			add_location(li1, file$2, 33, 4, 672);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1pplonk");
			add_location(img2, file$2, 34, 12, 762);
			attr(h22, "class", "svelte-1pplonk");
			add_location(h22, file$2, 34, 8, 758);
			attr(li2, "class", "svelte-1pplonk");
			add_location(li2, file$2, 34, 4, 754);
			attr(ul, "class", "pillared svelte-1pplonk");
			add_location(ul, file$2, 31, 0, 565);
		},
