...
function create_header_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 69, 8, 1537);
		},
...
// (69:4) <Modal on:close="{() => broVis = false}">
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 71, 12, 1597);
			add_location(li1, file$3, 72, 12, 1630);
			add_location(li2, file$3, 73, 12, 1663);
			add_location(li3, file$3, 74, 12, 1696);
			add_location(li4, file$3, 75, 12, 1729);
			add_location(ul, file$3, 70, 8, 1580);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 77, 8, 1772);
		},
...
function create_header_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 83, 8, 1931);
		},
...
// (83:4) <Modal on:close="{() => philVis = false}">
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 85, 12, 1992);
			add_location(li1, file$3, 86, 12, 2025);
			add_location(li2, file$3, 87, 12, 2058);
			add_location(li3, file$3, 88, 12, 2091);
			add_location(li4, file$3, 89, 12, 2124);
			add_location(ul, file$3, 84, 8, 1975);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 91, 8, 2167);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 97, 8, 2324);
		},
...
// (97:4) <Modal on:close="{() => proVis = false}">
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-1ugbbgr");
			add_location(li0, file$3, 99, 12, 2405);
			attr(li1, "class", "modal-li svelte-1ugbbgr");
			add_location(li1, file$3, 100, 12, 2455);
			attr(li2, "class", "modal-li svelte-1ugbbgr");
			add_location(li2, file$3, 101, 12, 2505);
			attr(li3, "class", "modal-li svelte-1ugbbgr");
			add_location(li3, file$3, 102, 12, 2555);
			attr(li4, "class", "modal-li svelte-1ugbbgr");
			add_location(li4, file$3, 103, 12, 2605);
			attr(ul, "class", "pillared svelte-1ugbbgr");
			add_location(ul, file$3, 98, 8, 2371);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 105, 8, 2665);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1ugbbgr");
			add_location(img0, file$3, 54, 8, 1088);
			attr(span0, "class", "svelte-1ugbbgr");
			add_location(span0, file$3, 55, 8, 1144);
			attr(li0, "class", "svelte-1ugbbgr");
			add_location(li0, file$3, 53, 4, 1044);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1ugbbgr");
			add_location(img1, file$3, 58, 8, 1228);
			attr(span1, "class", "svelte-1ugbbgr");
			add_location(span1, file$3, 59, 8, 1284);
			attr(li1, "class", "svelte-1ugbbgr");
			add_location(li1, file$3, 57, 4, 1183);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1ugbbgr");
			add_location(img2, file$3, 62, 8, 1368);
			attr(span2, "class", "svelte-1ugbbgr");
			add_location(span2, file$3, 63, 8, 1424);
			attr(li2, "class", "svelte-1ugbbgr");
			add_location(li2, file$3, 61, 4, 1324);
			attr(ul, "class", "pillared svelte-1ugbbgr");
			add_location(ul, file$3, 52, 0, 1018);
