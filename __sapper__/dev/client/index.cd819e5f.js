import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, e as element, t as text, c as claim_element, b as children, d as claim_text, f as detach, g as attr, h as add_location, j as insert, k as append, w as set_data, E as create_bidirectional_transition, F as svg_element, G as set_style, H as create_in_transition, n as noop, a as space, x as empty, I as listen, q as transition_in, B as group_outros, r as transition_out, C as check_outros, J as run_all, K as onMount, v as globals, L as create_out_transition, m as mount_component, u as destroy_component } from './chunk.38ed4505.js';
...
function create_if_block_1(ctx) {
	var h1, t_value = ctx.dispSmall ? ctx.titleSmall : ctx.titleBig, t, h1_transition, current;
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "text-display lg-view svelte-10k24ob");
			add_location(h1, file, 57, 1, 924);
		},
		...
		p: function update(changed, ctx) {
			if ((!current || changed.dispSmall || changed.titleSmall || changed.titleBig) && t_value !== (t_value = ctx.dispSmall ? ctx.titleSmall : ctx.titleBig)) {
				set_data(t, t_value);
			}
		},
...
function create_fragment(ctx) {
	var scrolling = false, clear_scrolling = () => { scrolling = false; }, scrolling_timeout, t, if_block1_anchor, current, dispose;
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = ($$dirty = { iw: 1 }) => {
		if ($$dirty.iw) { $$invalidate('dispSmall', dispSmall = iw <= 800); }
	};
...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(span, file$1, 61, 12, 1196);
		},
...
function create_if_block$1(ctx) {
	var code, t_value = ctx.brotherLabels[ctx.wordIndex], t, code_intro, code_outro, current;
	...
	return {
		...
		l: function claim(nodes) {
			code = claim_element(nodes, "CODE", { class: true }, false);
		...
		h: function hydrate() {
			attr(code, "class", "labels svelte-aznfos");
			add_location(code, file$1, 64, 12, 1273);
		},
		...
		i: function intro(local) {
			if (current) return;
			add_render_callback(() => {
				if (code_outro) code_outro.end(1);
				if (!code_intro) code_intro = create_in_transition(code, ctx.typewriter, {});
				code_intro.start();
			});
		...
		o: function outro(local) {
			if (code_intro) code_intro.invalidate();

			code_outro = create_out_transition(code, fade, {});
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "svelte-aznfos");
			add_location(h1, file$1, 59, 4, 1152);
			add_location(section, file$1, 58, 0, 1138);
		},
...
function create_fragment$2(ctx) {
	var t0, div, t1, t2, br0, t3, br1, t4, br2, t5, br3, t6, br4, t7, br5, t8, br6, t9, br7, t10, br8, t11, br9, t12, br10, t13, br11, t14, br12, t15, br13, t16, br14, t17, br15, t18, br16, t19, br17, t20, br18, t21, br19, t22, br20, t23, br21, t24, br22, t25, br23, t26, br24, t27, br25, t28, br26, t29, br27, t30, br28, t31, br29, t32, br30, t33, br31, t34, br32, t35, br33, t36, br34, t37, br35, t38, br36, t39, br37, t40, br38, t41, br39, t42, br40, t43, br41, t44, br42, t45, br43, t46, br44, t47, br45, t48, br46, t49, br47, t50, br48, t51, br49, t52, br50, t53, br51, t54, br52, t55, br53, t56, br54, t57, br55, t58, br56, t59, br57, t60, br58, t61, br59, t62, br60, t63, br61, t64, br62, t65, p, t66, a, t67, current;
	...
	return {
		...
		l: function claim(nodes) {
			...
			t66 = claim_text(p_nodes, "Icons from ");

			a = claim_element(p_nodes, "A", { href: true }, false);
			var a_nodes = children(a);

			t67 = claim_text(a_nodes, "icons8");
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-8xgnda");
			add_location(div, file$2, 33, 0, 612);
			add_location(br0, file$2, 49, 0, 965);
			add_location(br1, file$2, 50, 0, 971);
			add_location(br2, file$2, 51, 0, 977);
			add_location(br3, file$2, 52, 0, 983);
			add_location(br4, file$2, 53, 0, 989);
			add_location(br5, file$2, 54, 0, 995);
			add_location(br6, file$2, 55, 0, 1001);
			add_location(br7, file$2, 56, 0, 1007);
			add_location(br8, file$2, 57, 0, 1013);
			add_location(br9, file$2, 58, 0, 1019);
			add_location(br10, file$2, 59, 0, 1025);
			add_location(br11, file$2, 60, 0, 1031);
			add_location(br12, file$2, 61, 0, 1037);
			add_location(br13, file$2, 62, 0, 1043);
			add_location(br14, file$2, 63, 0, 1049);
			add_location(br15, file$2, 64, 0, 1055);
			add_location(br16, file$2, 65, 0, 1061);
			add_location(br17, file$2, 66, 0, 1067);
			add_location(br18, file$2, 67, 0, 1073);
			add_location(br19, file$2, 68, 0, 1079);
			add_location(br20, file$2, 69, 0, 1085);
			add_location(br21, file$2, 70, 0, 1091);
			add_location(br22, file$2, 71, 0, 1097);
			add_location(br23, file$2, 72, 0, 1103);
			add_location(br24, file$2, 73, 0, 1109);
			add_location(br25, file$2, 74, 0, 1115);
			add_location(br26, file$2, 75, 0, 1121);
			add_location(br27, file$2, 76, 0, 1127);
			add_location(br28, file$2, 77, 0, 1133);
			add_location(br29, file$2, 78, 0, 1139);
			add_location(br30, file$2, 79, 0, 1145);
			add_location(br31, file$2, 80, 0, 1151);
			add_location(br32, file$2, 81, 0, 1157);
			add_location(br33, file$2, 82, 0, 1163);
			add_location(br34, file$2, 83, 0, 1169);
			add_location(br35, file$2, 84, 0, 1175);
			add_location(br36, file$2, 85, 0, 1181);
			add_location(br37, file$2, 86, 0, 1187);
			add_location(br38, file$2, 87, 0, 1193);
			add_location(br39, file$2, 88, 0, 1199);
			add_location(br40, file$2, 89, 0, 1205);
			add_location(br41, file$2, 90, 0, 1211);
			add_location(br42, file$2, 91, 0, 1217);
			add_location(br43, file$2, 92, 0, 1223);
			add_location(br44, file$2, 93, 0, 1229);
			add_location(br45, file$2, 94, 0, 1235);
			add_location(br46, file$2, 95, 0, 1241);
			add_location(br47, file$2, 96, 0, 1247);
			add_location(br48, file$2, 97, 0, 1253);
			add_location(br49, file$2, 98, 0, 1259);
			add_location(br50, file$2, 99, 0, 1265);
			add_location(br51, file$2, 100, 0, 1271);
			add_location(br52, file$2, 101, 0, 1277);
			add_location(br53, file$2, 102, 0, 1283);
			add_location(br54, file$2, 103, 0, 1289);
			add_location(br55, file$2, 104, 0, 1295);
			add_location(br56, file$2, 105, 0, 1301);
			add_location(br57, file$2, 106, 0, 1307);
			add_location(br58, file$2, 107, 0, 1313);
			add_location(br59, file$2, 108, 0, 1319);
			add_location(br60, file$2, 109, 0, 1325);
			add_location(br61, file$2, 110, 0, 1331);
			add_location(br62, file$2, 111, 0, 1337);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$2, 112, 14, 1357);
			attr(p, "class", "svelte-8xgnda");
			add_location(p, file$2, 112, 0, 1343);
		},
