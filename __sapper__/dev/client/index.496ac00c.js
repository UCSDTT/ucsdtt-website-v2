...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(path, file, 65, 2, 1162);
			...
			add_location(svg_1, file, 57, 1, 995);
		},
...
function create_fragment(ctx) {
	var scrolling = false, clear_scrolling = () => { scrolling = false; }, scrolling_timeout, input, t0, t1, if_block1_anchor, current, dispose;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input, file, 51, 0, 857);
