...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 80, 2, 1569);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 92, 2, 1741);
			attr(div0, "class", "class-img-container svelte-1ct97j0");
			add_location(div0, file, 91, 0, 1705);
			add_location(h2, file, 101, 2, 1899);
			add_location(h3, file, 102, 2, 1937);
			attr(div1, "class", "brother-info svelte-1ct97j0");
			add_location(div1, file, 100, 0, 1870);
