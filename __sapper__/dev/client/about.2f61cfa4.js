...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(strong1, file, 38, 4, 1160);
			add_location(strong2, file, 40, 4, 1199);
			add_location(strong3, file, 42, 4, 1239);
			add_location(strong4, file, 44, 4, 1284);
			add_location(strong5, file, 46, 4, 1322);
			add_location(strong6, file, 48, 4, 1359);
			add_location(strong7, file, 50, 4, 1396);
			add_location(strong8, file, 52, 4, 1433);
			add_location(strong9, file, 54, 4, 1469);
			add_location(strong10, file, 56, 4, 1512);
			add_location(strong11, file, 58, 4, 1570);
			add_location(strong12, file, 60, 4, 1609);
			add_location(strong13, file, 62, 8, 1651);
