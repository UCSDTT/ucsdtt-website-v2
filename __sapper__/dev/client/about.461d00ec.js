...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-12mamab");
			add_location(h1, file$1, 42, 2, 863);
			attr(p0, "class", "svelte-12mamab");
			add_location(p0, file$1, 43, 2, 918);
			add_location(strong0, file$1, 50, 4, 1179);
			attr(p1, "class", "svelte-12mamab");
			add_location(p1, file$1, 49, 2, 1171);
			add_location(strong1, file$1, 57, 4, 1451);
			add_location(strong2, file$1, 58, 4, 1485);
			add_location(strong3, file$1, 59, 4, 1520);
			add_location(strong4, file$1, 60, 4, 1560);
			add_location(strong5, file$1, 61, 4, 1593);
			add_location(strong6, file$1, 62, 4, 1625);
			add_location(strong7, file$1, 63, 4, 1657);
			add_location(strong8, file$1, 64, 4, 1689);
			add_location(strong9, file$1, 65, 4, 1720);
			add_location(strong10, file$1, 66, 4, 1758);
			add_location(strong11, file$1, 67, 4, 1811);
			add_location(strong12, file$1, 68, 4, 1845);
			add_location(strong13, file$1, 69, 8, 1882);
			attr(p2, "class", "svelte-12mamab");
			add_location(p2, file$1, 56, 2, 1443);
			add_location(strong14, file$1, 73, 4, 1988);
			add_location(strong15, file$1, 74, 4, 2035);
			attr(p3, "class", "svelte-12mamab");
			add_location(p3, file$1, 71, 2, 1925);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-12mamab");
			add_location(img0, file$1, 76, 2, 2072);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-12mamab");
			add_location(img1, file$1, 77, 2, 2146);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-12mamab");
			add_location(div, file$1, 41, 0, 843);
		},
