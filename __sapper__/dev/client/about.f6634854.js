...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-left svelte-1uezifn");
			add_location(button, file, 136, 6, 2620);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1uezifn");
			add_location(img, file, 143, 10, 2827);
			attr(div, "class", "carousel svelte-1uezifn");
			add_location(div, file, 142, 8, 2794);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-right svelte-1uezifn");
			add_location(button, file, 151, 6, 3002);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-1uezifn");
			add_location(div0, file, 140, 4, 2735);
			attr(div1, "class", "button-wrapper svelte-1uezifn");
			add_location(div1, file, 134, 2, 2565);
			attr(figcaption, "class", "carousel-caption svelte-1uezifn");
			add_location(figcaption, file, 156, 2, 3125);
			attr(figure, "class", "figure-wrapper svelte-1uezifn");
			add_location(figure, file, 133, 0, 2531);
