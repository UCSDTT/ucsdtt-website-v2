...
function create_fragment$2(ctx) {
	var ul, li0, img0, span0, t0, t1, li1, img1, span1, t2, t3, li2, img2, span2, t4;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img0, file$2, 27, 8, 548);
			attr(span0, "class", "svelte-1fc4p7k");
			add_location(span0, file$2, 27, 55, 595);
			attr(li0, "class", "svelte-1fc4p7k");
			add_location(li0, file$2, 27, 4, 544);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			add_location(img1, file$2, 28, 8, 633);
			attr(span1, "class", "svelte-1fc4p7k");
			add_location(span1, file$2, 28, 55, 680);
			attr(li1, "class", "svelte-1fc4p7k");
			add_location(li1, file$2, 28, 4, 629);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			add_location(img2, file$2, 29, 8, 719);
			attr(span2, "class", "svelte-1fc4p7k");
			add_location(span2, file$2, 29, 55, 766);
			attr(li2, "class", "svelte-1fc4p7k");
			add_location(li2, file$2, 29, 4, 715);
			attr(ul, "class", "pillared svelte-1fc4p7k");
			add_location(ul, file$2, 26, 0, 518);
		},
