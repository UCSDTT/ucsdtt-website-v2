...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "text-display lg-view svelte-hq0zrh");
			add_location(h1, file, 73, 1, 1373);
		},
