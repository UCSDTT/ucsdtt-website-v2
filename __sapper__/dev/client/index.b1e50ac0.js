...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-158kjqv");
			add_location(img0, file$2, 34, 8, 675);
			attr(span0, "class", "svelte-158kjqv");
			add_location(span0, file$2, 34, 55, 722);
			attr(li0, "class", "svelte-158kjqv");
			add_location(li0, file$2, 34, 4, 671);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-158kjqv");
			add_location(img1, file$2, 35, 8, 760);
			attr(span1, "class", "svelte-158kjqv");
			add_location(span1, file$2, 35, 55, 807);
			attr(li1, "class", "svelte-158kjqv");
			add_location(li1, file$2, 35, 4, 756);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-158kjqv");
			add_location(img2, file$2, 36, 8, 846);
			attr(span2, "class", "svelte-158kjqv");
			add_location(span2, file$2, 36, 55, 893);
			attr(li2, "class", "svelte-158kjqv");
			add_location(li2, file$2, 36, 4, 842);
			attr(ul, "class", "pillared svelte-158kjqv");
			add_location(ul, file$2, 33, 0, 645);
		},
