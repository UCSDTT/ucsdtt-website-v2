...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1bt2eh7");
			add_location(img0, file$2, 33, 8, 548);
			attr(span0, "class", "svelte-1bt2eh7");
			add_location(span0, file$2, 33, 55, 595);
			attr(li0, "class", "svelte-1bt2eh7");
			add_location(li0, file$2, 33, 4, 544);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1bt2eh7");
			add_location(img1, file$2, 34, 8, 633);
			attr(span1, "class", "svelte-1bt2eh7");
			add_location(span1, file$2, 34, 55, 680);
			attr(li1, "class", "svelte-1bt2eh7");
			add_location(li1, file$2, 34, 4, 629);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1bt2eh7");
			add_location(img2, file$2, 35, 8, 719);
			attr(span2, "class", "svelte-1bt2eh7");
			add_location(span2, file$2, 35, 55, 766);
			attr(li2, "class", "svelte-1bt2eh7");
			add_location(li2, file$2, 35, 4, 715);
			attr(ul, "class", "pillared svelte-1bt2eh7");
			add_location(ul, file$2, 32, 0, 518);
		},
