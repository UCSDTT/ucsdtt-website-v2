import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, t as text, a as space, c as claim_element, b as children, d as claim_text, f as detach, h as add_location, g as attr, H as listen, j as insert, k as append, n as noop, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.b5534b6a.js';
...
function create_fragment(ctx) {
	var button, t0, t1, div1, div0, img, img_src_value, img_alt_value, dispose;
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(button_nodes, "ZOOM");
		...
		h: function hydrate() {
			add_location(button, file, 62, 0, 1301);
			attr(img, "class", "class-img svelte-1n7uzin");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 65, 4, 1408);
			attr(div0, "class", "class-img-container svelte-1n7uzin");
			add_location(div0, file, 64, 2, 1370);
			attr(div1, "class", "pledge-classes svelte-1n7uzin");
			add_location(div1, file, 63, 0, 1339);
			dispose = listen(button, "click", zoom);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 17, 0, 236);
		},
