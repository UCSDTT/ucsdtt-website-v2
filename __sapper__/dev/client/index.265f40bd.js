...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1ogv3fr");
			add_location(img0, file$2, 32, 8, 617);
			attr(span0, "class", "svelte-1ogv3fr");
			add_location(span0, file$2, 32, 55, 664);
			attr(li0, "class", "svelte-1ogv3fr");
			add_location(li0, file$2, 32, 4, 613);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1ogv3fr");
			add_location(img1, file$2, 33, 8, 702);
			attr(span1, "class", "svelte-1ogv3fr");
			add_location(span1, file$2, 33, 55, 749);
			attr(li1, "class", "svelte-1ogv3fr");
			add_location(li1, file$2, 33, 4, 698);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1ogv3fr");
			add_location(img2, file$2, 34, 8, 788);
			attr(span2, "class", "svelte-1ogv3fr");
			add_location(span2, file$2, 34, 55, 835);
			attr(li2, "class", "svelte-1ogv3fr");
			add_location(li2, file$2, 34, 4, 784);
			attr(ul, "class", "pillared svelte-1ogv3fr");
			add_location(ul, file$2, 31, 0, 587);
		},
