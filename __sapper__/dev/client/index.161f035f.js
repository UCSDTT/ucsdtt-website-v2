...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "text-display lg-view svelte-14ft542");
			add_location(h1, file, 56, 1, 922);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(span, file$1, 38, 12, 834);
		},
...
function create_fragment$1(ctx) {
	var section, h1, span, t0, t1, current;
	...
	return {
		...
		l: function claim(nodes) {
			...
			h1 = claim_element(section_nodes, "H1", {}, false);
			var h1_nodes = children(h1);

			span = claim_element(h1_nodes, "SPAN", {}, false);
			var span_nodes = children(span);

			t0 = claim_text(span_nodes, "We are");
			span_nodes.forEach(detach);
		...
		h: function hydrate() {
			add_location(span, file$1, 36, 8, 779);
			add_location(h1, file$1, 35, 4, 766);
			add_location(section, file$1, 34, 0, 752);
		},
...
function instance$1($$self, $$props, $$invalidate) {
    ...
    setInterval(() => {
        ...
        setTimeout(() => {
            ...
            $$invalidate('wordIndex', wordIndex = (brotherLabels.length + 1) % brotherLabels.length);
        }, 3000);
    }, 6000);
...
function create_fragment$2(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			hero.$$.fragment.l(section_nodes);
			t1 = claim_text(section_nodes, "\n\t");
			weare.$$.fragment.l(section_nodes);
			section_nodes.forEach(detach);
			t2 = claim_text(nodes, "\n\n\n\n\n\n\n");
		...
		h: function hydrate() {
			...
			attr(section, "class", "hero-section svelte-sazog6");
			add_location(section, file$2, 31, 0, 580);
			add_location(br0, file$2, 47, 0, 946);
			add_location(br1, file$2, 48, 0, 952);
			add_location(br2, file$2, 49, 0, 958);
			add_location(br3, file$2, 50, 0, 964);
			add_location(br4, file$2, 51, 0, 970);
			add_location(br5, file$2, 52, 0, 976);
			add_location(br6, file$2, 53, 0, 982);
			add_location(br7, file$2, 54, 0, 988);
			add_location(br8, file$2, 55, 0, 994);
			add_location(br9, file$2, 56, 0, 1000);
			add_location(br10, file$2, 57, 0, 1006);
			add_location(br11, file$2, 58, 0, 1012);
			add_location(br12, file$2, 59, 0, 1018);
			add_location(br13, file$2, 60, 0, 1024);
			add_location(br14, file$2, 61, 0, 1030);
			add_location(br15, file$2, 62, 0, 1036);
			add_location(br16, file$2, 63, 0, 1042);
			add_location(br17, file$2, 64, 0, 1048);
			add_location(br18, file$2, 65, 0, 1054);
			add_location(br19, file$2, 66, 0, 1060);
			add_location(br20, file$2, 67, 0, 1066);
			add_location(br21, file$2, 68, 0, 1072);
			add_location(br22, file$2, 69, 0, 1078);
			add_location(br23, file$2, 70, 0, 1084);
			add_location(br24, file$2, 71, 0, 1090);
			add_location(br25, file$2, 72, 0, 1096);
			add_location(br26, file$2, 73, 0, 1102);
			add_location(br27, file$2, 74, 0, 1108);
			add_location(br28, file$2, 75, 0, 1114);
			add_location(br29, file$2, 76, 0, 1120);
			add_location(br30, file$2, 77, 0, 1126);
			add_location(br31, file$2, 78, 0, 1132);
			add_location(br32, file$2, 79, 0, 1138);
			add_location(br33, file$2, 80, 0, 1144);
			add_location(br34, file$2, 81, 0, 1150);
			add_location(br35, file$2, 82, 0, 1156);
			add_location(br36, file$2, 83, 0, 1162);
			add_location(br37, file$2, 84, 0, 1168);
			add_location(br38, file$2, 85, 0, 1174);
			add_location(br39, file$2, 86, 0, 1180);
			add_location(br40, file$2, 87, 0, 1186);
			add_location(br41, file$2, 88, 0, 1192);
			add_location(br42, file$2, 89, 0, 1198);
			add_location(br43, file$2, 90, 0, 1204);
			add_location(br44, file$2, 91, 0, 1210);
			add_location(br45, file$2, 92, 0, 1216);
			add_location(br46, file$2, 93, 0, 1222);
			add_location(br47, file$2, 94, 0, 1228);
			add_location(br48, file$2, 95, 0, 1234);
			add_location(br49, file$2, 96, 0, 1240);
			add_location(br50, file$2, 97, 0, 1246);
			add_location(br51, file$2, 98, 0, 1252);
			add_location(br52, file$2, 99, 0, 1258);
			add_location(br53, file$2, 100, 0, 1264);
			add_location(br54, file$2, 101, 0, 1270);
			add_location(br55, file$2, 102, 0, 1276);
			add_location(br56, file$2, 103, 0, 1282);
			add_location(br57, file$2, 104, 0, 1288);
			add_location(br58, file$2, 105, 0, 1294);
			add_location(br59, file$2, 106, 0, 1300);
			add_location(br60, file$2, 107, 0, 1306);
			add_location(br61, file$2, 108, 0, 1312);
			add_location(br62, file$2, 109, 0, 1318);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$2, 110, 14, 1338);
			attr(p, "class", "svelte-sazog6");
			add_location(p, file$2, 110, 0, 1324);
		},
		...
		m: function mount(target, anchor) {
			...
			append(section, t1);
			mount_component(weare, section, null);
