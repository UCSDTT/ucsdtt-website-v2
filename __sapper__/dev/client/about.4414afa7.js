...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 54, 0, 895);
			add_location(h3, file, 56, 0, 911);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-g0hnxr");
			add_location(img0, file, 60, 4, 1021);
			attr(h40, "class", "svelte-g0hnxr");
			add_location(h40, file, 61, 4, 1069);
			add_location(p0, file, 62, 4, 1094);
			attr(div0, "class", "pillar svelte-g0hnxr");
			add_location(div0, file, 59, 2, 996);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-g0hnxr");
			add_location(img1, file, 70, 4, 1430);
			attr(h41, "class", "svelte-g0hnxr");
			add_location(h41, file, 71, 4, 1478);
			add_location(p1, file, 72, 4, 1504);
			attr(div1, "class", "pillar svelte-g0hnxr");
			add_location(div1, file, 69, 2, 1405);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-g0hnxr");
			add_location(img2, file, 81, 4, 1867);
			attr(h42, "class", "svelte-g0hnxr");
			add_location(h42, file, 82, 4, 1915);
			add_location(p2, file, 83, 4, 1944);
			attr(div2, "class", "pillar svelte-g0hnxr");
			add_location(div2, file, 80, 2, 1842);
			attr(div3, "class", "pillars svelte-g0hnxr");
			add_location(div3, file, 58, 0, 972);
		},
