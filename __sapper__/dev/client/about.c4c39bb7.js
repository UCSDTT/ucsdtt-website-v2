import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, e as element, t as text, c as claim_element, b as children, d as claim_text, f as detach, g as attr, h as add_location, H as listen, j as insert, k as append, n as noop, L as create_bidirectional_transition, a as space, q as transition_in, B as group_outros, r as transition_out, C as check_outros, w as set_data, J as onMount, m as mount_component, u as destroy_component } from './chunk.b5534b6a.js';
import { f as fade } from './chunk.b0c5adc1.js';
import { P as Pillars } from './chunk.78e433eb.js';
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-left svelte-ph2035");
			add_location(button, file, 135, 6, 2603);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-ph2035");
			add_location(img, file, 142, 10, 2810);
			attr(div, "class", "carousel svelte-ph2035");
			add_location(div, file, 141, 8, 2777);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-right svelte-ph2035");
			add_location(button, file, 150, 6, 2985);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-ph2035");
			add_location(div0, file, 139, 4, 2718);
			attr(div1, "class", "button-wrapper svelte-ph2035");
			add_location(div1, file, 133, 2, 2548);
			attr(figcaption, "class", "carousel-caption svelte-ph2035");
			add_location(figcaption, file, 155, 2, 3108);
			attr(figure, "class", "figure-wrapper svelte-ph2035");
			add_location(figure, file, 132, 0, 2514);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-u4zad7");
			add_location(h1, file$1, 44, 2, 978);
			attr(p0, "class", "svelte-u4zad7");
			add_location(p0, file$1, 45, 2, 1033);
			add_location(strong0, file$1, 52, 4, 1294);
			attr(p1, "class", "svelte-u4zad7");
			add_location(p1, file$1, 51, 2, 1286);
			add_location(strong1, file$1, 59, 4, 1566);
			add_location(strong2, file$1, 60, 4, 1600);
			add_location(strong3, file$1, 61, 4, 1635);
			add_location(strong4, file$1, 62, 4, 1675);
			add_location(strong5, file$1, 63, 4, 1708);
			add_location(strong6, file$1, 64, 4, 1740);
			add_location(strong7, file$1, 65, 4, 1772);
			add_location(strong8, file$1, 66, 4, 1804);
			add_location(strong9, file$1, 67, 4, 1835);
			add_location(strong10, file$1, 68, 4, 1873);
			add_location(strong11, file$1, 69, 4, 1926);
			add_location(strong12, file$1, 70, 4, 1960);
			add_location(strong13, file$1, 71, 8, 1997);
			attr(p2, "class", "svelte-u4zad7");
			add_location(p2, file$1, 58, 2, 1558);
			add_location(strong14, file$1, 75, 4, 2103);
			add_location(strong15, file$1, 76, 4, 2150);
			attr(p3, "class", "svelte-u4zad7");
			add_location(p3, file$1, 73, 2, 2040);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-u4zad7");
			add_location(img0, file$1, 78, 2, 2187);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-u4zad7");
			add_location(img1, file$1, 79, 2, 2261);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-u4zad7");
			add_location(div, file$1, 43, 0, 958);
		},
