...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-18hiysl");
			add_location(img, file, 71, 8, 1309);
			attr(div, "class", "carousel svelte-18hiysl");
			add_location(div, file, 70, 6, 1278);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button svelte-18hiysl");
			add_location(button0, file, 67, 2, 1175);
			attr(div0, "class", "carousel-wrapper svelte-18hiysl");
			add_location(div0, file, 68, 2, 1223);
			attr(button1, "class", "carousel-button svelte-18hiysl");
			add_location(button1, file, 75, 2, 1417);
			attr(div1, "class", "button-wrapper svelte-18hiysl");
			add_location(div1, file, 66, 0, 1144);
		},
