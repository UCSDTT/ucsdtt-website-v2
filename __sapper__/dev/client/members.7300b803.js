...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 78, 2, 1546);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 90, 2, 1718);
			attr(div0, "class", "class-img-container svelte-1m4e4j8");
			add_location(div0, file, 89, 0, 1682);
			add_location(h2, file, 99, 2, 1876);
			add_location(h3, file, 100, 2, 1914);
			attr(div1, "class", "brother-info svelte-1m4e4j8");
			add_location(div1, file, 98, 0, 1847);
