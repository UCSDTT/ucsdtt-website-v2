...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1uh2jht");
			add_location(img0, file$2, 50, 8, 1034);
			attr(span0, "class", "svelte-1uh2jht");
			add_location(span0, file$2, 50, 55, 1081);
			attr(li0, "class", "svelte-1uh2jht");
			add_location(li0, file$2, 50, 4, 1030);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1uh2jht");
			add_location(img1, file$2, 51, 8, 1119);
			attr(span1, "class", "svelte-1uh2jht");
			add_location(span1, file$2, 51, 55, 1166);
			attr(li1, "class", "svelte-1uh2jht");
			add_location(li1, file$2, 51, 4, 1115);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1uh2jht");
			add_location(img2, file$2, 52, 8, 1205);
			attr(span2, "class", "svelte-1uh2jht");
			add_location(span2, file$2, 52, 55, 1252);
			attr(li2, "class", "svelte-1uh2jht");
			add_location(li2, file$2, 52, 4, 1201);
			attr(ul, "class", "pillared svelte-1uh2jht");
			add_location(ul, file$2, 49, 0, 1004);
		},
