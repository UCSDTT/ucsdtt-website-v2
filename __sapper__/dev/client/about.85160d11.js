...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1cpc2is");
			add_location(img, file, 63, 8, 1150);
			attr(div, "class", "carousel svelte-1cpc2is");
			add_location(div, file, 62, 6, 1119);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(button0, file, 59, 2, 1040);
			attr(div0, "class", "carousel-wrapper svelte-1cpc2is");
			add_location(div0, file, 60, 2, 1064);
			add_location(button1, file, 67, 2, 1258);
			attr(div1, "class", "button-wrapper svelte-1cpc2is");
			add_location(div1, file, 58, 0, 1009);
		},
