...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-131g112");
			add_location(h1, file, 33, 2, 804);
			attr(p0, "class", "svelte-131g112");
			add_location(p0, file, 34, 2, 859);
			add_location(strong0, file, 42, 4, 1162);
			attr(p1, "class", "svelte-131g112");
			add_location(p1, file, 40, 2, 1112);
			add_location(strong1, file, 48, 4, 1393);
			add_location(strong2, file, 49, 4, 1427);
			add_location(strong3, file, 50, 4, 1462);
			add_location(strong4, file, 51, 4, 1502);
			add_location(strong5, file, 52, 4, 1535);
			add_location(strong6, file, 53, 4, 1567);
			add_location(strong7, file, 54, 4, 1599);
			add_location(strong8, file, 55, 4, 1631);
			add_location(strong9, file, 56, 4, 1662);
			add_location(strong10, file, 57, 4, 1700);
			add_location(strong11, file, 58, 4, 1753);
			add_location(strong12, file, 59, 4, 1787);
			add_location(strong13, file, 60, 8, 1824);
			attr(p2, "class", "svelte-131g112");
			add_location(p2, file, 47, 2, 1385);
			add_location(strong14, file, 64, 4, 1930);
			add_location(strong15, file, 65, 4, 1977);
			attr(p3, "class", "svelte-131g112");
			add_location(p3, file, 62, 2, 1867);
			attr(img, "src", "images/founders.jpg");
			attr(img, "alt", "the mighty founders");
			attr(img, "class", "svelte-131g112");
			add_location(img, file, 67, 2, 2014);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-131g112");
			add_location(div, file, 32, 0, 784);
		},
