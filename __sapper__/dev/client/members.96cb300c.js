...
function create_fragment(ctx) {
	var p0, t0, t1, t2, p1, t3, t4, t5, div, img, img_src_value, img_alt_value, dispose;
	...
	return {
		...
		h: function hydrate() {
			add_location(p0, file, 39, 0, 826);
			add_location(p1, file, 40, 0, 841);
			attr(img, "class", "class-img");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 43, 2, 893);
			attr(div, "class", "class-img-container");
			add_location(div, file, 42, 0, 857);
