...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 80, 2, 1480);
			attr(div1, "class", "class-img-container svelte-4l1uk5");
			add_location(div1, file, 79, 0, 1444);
