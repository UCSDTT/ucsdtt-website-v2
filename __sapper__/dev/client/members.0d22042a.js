...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-b69334");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 61, 4, 1344);
			attr(div0, "class", "class-img-container svelte-b69334");
			add_location(div0, file, 60, 2, 1306);
			attr(div1, "class", "pledge-classes svelte-b69334");
			add_location(div1, file, 59, 0, 1275);
		},
