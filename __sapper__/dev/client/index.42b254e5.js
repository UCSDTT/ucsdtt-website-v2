...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-1xrypsz");
			add_location(div0, file$2, 54, 0, 931);

			attr(button, "class", "svelte-1xrypsz");
			add_location(button, file$2, 59, 8, 1097);
			attr(section, "class", "header svelte-1xrypsz");
			add_location(section, file$2, 57, 4, 1030);
			add_location(hr0, file$2, 61, 1, 1169);

			add_location(hr1, file$2, 63, 1, 1190);
			attr(div1, "class", "modal svelte-1xrypsz");
			add_location(div1, file$2, 56, 0, 1006);
