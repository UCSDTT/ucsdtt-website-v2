...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-mc2xhm");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "class-img svelte-mc2xhm");
			...
			attr(div0, "class", "class-img-container svelte-mc2xhm");
			add_location(div0, file, 85, 0, 1603);
			attr(div1, "class", "brother-info svelte-mc2xhm");
