...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-left svelte-1lg5lau");
			add_location(button, file, 134, 6, 2568);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1lg5lau");
			add_location(img, file, 141, 10, 2775);
			attr(div, "class", "carousel svelte-1lg5lau");
			add_location(div, file, 140, 8, 2742);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-right svelte-1lg5lau");
			add_location(button, file, 149, 6, 2950);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-1lg5lau");
			add_location(div0, file, 138, 4, 2683);
			attr(div1, "class", "button-wrapper svelte-1lg5lau");
			add_location(div1, file, 132, 2, 2513);
			attr(figcaption, "class", "carousel-caption svelte-1lg5lau");
			add_location(figcaption, file, 154, 2, 3073);
			attr(figure, "class", "figure-wrapper svelte-1lg5lau");
			add_location(figure, file, 131, 0, 2479);
