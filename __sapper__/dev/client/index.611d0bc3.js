...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(strong1, file$3, 85, 6, 1745);
			add_location(strong2, file$3, 86, 6, 1781);
			add_location(strong3, file$3, 87, 6, 1822);
			attr(p0, "class", "svelte-1fm1lc2");
			add_location(p0, file$3, 80, 4, 1424);
			add_location(strong4, file$3, 95, 6, 2252);
			attr(p1, "class", "svelte-1fm1lc2");
			add_location(p1, file$3, 89, 4, 1869);
			add_location(strong5, file$3, 99, 6, 2409);
			attr(p2, "class", "svelte-1fm1lc2");
			add_location(p2, file$3, 97, 4, 2321);
...
function create_if_block$2(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			iframe = claim_element(nodes, "IFRAME", { width: true, height: true, title: true, "max-width": true, src: true, frameborder: true, allow: true, allowfullscreen: true }, false);
		...
		h: function hydrate() {
			...
			add_location(iframe, file$3, 106, 6, 2564);
			attr(figcaption, "class", "svelte-1fm1lc2");
			add_location(figcaption, file$3, 116, 6, 2892);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(figure, file$3, 102, 2, 2469);
		},
