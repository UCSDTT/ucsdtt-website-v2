...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-bj1ruk");
			add_location(img, file, 83, 8, 1496);
			attr(div, "class", "carousel svelte-bj1ruk");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-bj1ruk");
			add_location(button0, file, 79, 2, 1350);
			attr(div0, "class", "carousel-wrapper svelte-bj1ruk");
			add_location(div0, file, 80, 2, 1410);
			attr(button1, "class", "carousel-button button-right svelte-bj1ruk");
			add_location(button1, file, 87, 2, 1604);
			attr(div1, "class", "button-wrapper svelte-bj1ruk");
