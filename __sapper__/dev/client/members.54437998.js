...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p0, file, 56, 0, 1117);
			add_location(p1, file, 57, 0, 1132);
			add_location(p2, file, 58, 0, 1147);
			add_location(p3, file, 59, 0, 1162);
			attr(div0, "class", "cursor-box svelte-6dd0yn");
			set_style(div0, "top", ((ctx.my - 120) + 'px'));
			set_style(div0, "left", ((ctx.mx - 50) + 'px'));
			add_location(div0, file, 63, 0, 1246);
			attr(img, "class", "class-img");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 73, 2, 1393);
			attr(div1, "class", "class-img-container svelte-6dd0yn");
			add_location(div1, file, 72, 0, 1357);
