...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 95, 2, 2041);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 107, 2, 2213);
			attr(div0, "class", "class-img-container svelte-1ct97j0");
			add_location(div0, file, 106, 0, 2177);
			add_location(h2, file, 116, 2, 2371);
			add_location(h3, file, 117, 2, 2409);
			attr(div1, "class", "brother-info svelte-1ct97j0");
			add_location(div1, file, 115, 0, 2342);
		...
		p: function update(changed, ctx) {
			...
			if ((changed.curBrother) && t8_value !== (t8_value = ctx.curBrother.name)) {
				set_data(t8, t8_value);
			}

			if ((changed.curBrother) && t11_value !== (t11_value = ctx.curBrother.major)) {
