...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-95ku3f");
			add_location(img, file, 71, 8, 1314);
			attr(div, "class", "carousel svelte-95ku3f");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button svelte-95ku3f");
			add_location(button0, file, 67, 2, 1180);
			attr(div0, "class", "carousel-wrapper svelte-95ku3f");
			add_location(div0, file, 68, 2, 1228);
			attr(button1, "class", "carousel-button svelte-95ku3f");
			add_location(button1, file, 75, 2, 1422);
			attr(div1, "class", "button-wrapper svelte-95ku3f");
