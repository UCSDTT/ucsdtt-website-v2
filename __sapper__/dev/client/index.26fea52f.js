...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1unopnu");
			add_location(img0, file$2, 41, 8, 757);
			attr(span0, "class", "svelte-1unopnu");
			add_location(span0, file$2, 41, 55, 804);
			attr(li0, "class", "svelte-1unopnu");
			add_location(li0, file$2, 41, 4, 753);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1unopnu");
			add_location(img1, file$2, 42, 8, 842);
			attr(span1, "class", "svelte-1unopnu");
			add_location(span1, file$2, 42, 55, 889);
			attr(li1, "class", "svelte-1unopnu");
			add_location(li1, file$2, 42, 4, 838);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1unopnu");
			add_location(img2, file$2, 43, 8, 928);
			attr(span2, "class", "svelte-1unopnu");
			add_location(span2, file$2, 43, 55, 975);
			attr(li2, "class", "svelte-1unopnu");
			add_location(li2, file$2, 43, 4, 924);
			attr(ul, "class", "pillared svelte-1unopnu");
			add_location(ul, file$2, 40, 0, 727);
		},
