...
// (66:4) <Modal on:close="{() => broVis = false}">
...
// (72:4) <Modal on:close="{() => hilVis = false}">
...
// (78:4) <Modal on:close="{() => rofVis = false}">
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img0, file$3, 54, 8, 1057);
			attr(span0, "class", "svelte-cw6hkh");
			add_location(span0, file$3, 54, 55, 1104);
			...
			add_location(img1, file$3, 57, 8, 1156);
			attr(span1, "class", "svelte-cw6hkh");
			add_location(span1, file$3, 57, 55, 1203);
			attr(li1, "class", "svelte-cw6hkh");
			add_location(li1, file$3, 56, 4, 1143);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-cw6hkh");
			add_location(img2, file$3, 60, 8, 1256);
			attr(span2, "class", "svelte-cw6hkh");
			add_location(span2, file$3, 60, 55, 1303);
			attr(li2, "class", "svelte-cw6hkh");
			add_location(li2, file$3, 59, 4, 1243);
