...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-se52lq");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-se52lq");
			...
			attr(div0, "class", "class-img-container svelte-se52lq");
			add_location(div0, file, 80, 0, 1492);
			attr(div1, "class", "space-maker svelte-se52lq");
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handleMouseClick(event) {
	...
	$$self.$$.update = ($$dirty = { my: 1, mx: 1 }) => {
		if ($$dirty.my) { $$invalidate('picY', picY = `${my - 170}px`); }
