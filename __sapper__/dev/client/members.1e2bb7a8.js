...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1hqkjp0");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-1hqkjp0");
			...
			attr(div0, "class", "class-img-container svelte-1hqkjp0");
			add_location(div0, file, 82, 0, 1533);
			add_location(h3, file, 92, 2, 1727);
			attr(div1, "class", "brother-info svelte-1hqkjp0");
