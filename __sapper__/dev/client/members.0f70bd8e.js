...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-l8ynye");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 68, 2, 1338);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-l8ynye");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 80, 2, 1510);
			attr(div0, "class", "class-img-container svelte-l8ynye");
			add_location(div0, file, 79, 0, 1474);
			attr(div1, "class", "space-maker svelte-l8ynye");
			add_location(div1, file, 89, 2, 1668);
			attr(div2, "class", "brother-info");
			add_location(div2, file, 88, 0, 1639);
