...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-7jt70o");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-7jt70o");
			...
			attr(div0, "class", "class-img-container svelte-7jt70o");
			add_location(div0, file, 80, 0, 1492);
			attr(div1, "class", "space-maker svelte-7jt70o");
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handleMouseClick(event) {
	...
	$$self.$$.update = ($$dirty = { my: 1, mx: 1 }) => {
		if ($$dirty.my) { $$invalidate('picY', picY = `${my - 160}px`); }
