...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal svelte-1u9wja6");
			add_location(span, file$1, 73, 12, 1622);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal svelte-1u9wja6");
			add_location(span, file$1, 76, 12, 1714);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "svelte-1u9wja6");
			add_location(h1, file$1, 71, 4, 1578);
			add_location(section, file$1, 70, 0, 1564);
		},
