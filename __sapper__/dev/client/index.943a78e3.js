...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-13go6e7");
			add_location(div0, file$2, 56, 0, 996);

			attr(button, "class", "svelte-13go6e7");
			add_location(button, file$2, 61, 8, 1162);
			attr(section, "class", "header svelte-13go6e7");
			add_location(section, file$2, 59, 4, 1095);
			add_location(hr0, file$2, 63, 1, 1234);

			add_location(hr1, file$2, 65, 1, 1255);
			attr(div1, "class", "modal svelte-13go6e7");
			add_location(div1, file$2, 58, 0, 1071);
