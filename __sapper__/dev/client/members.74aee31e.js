...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 61, 4, 1270);
			attr(div0, "class", "class-img-container svelte-15e2r1d");
			add_location(div0, file, 60, 2, 1232);
			attr(div1, "class", "pledge-classes");
			add_location(div1, file, 59, 0, 1201);
			add_location(p0, file, 69, 0, 1420);
			add_location(p1, file, 70, 0, 1435);
