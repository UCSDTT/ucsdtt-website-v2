...
function create_fragment(ctx) {
	var div1, div0, img, img_src_value, img_alt_value, t0, p0, t1, t2, t3, p1, t4, t5, dispose;
	...
	return {
		...
		l: function claim(nodes) {
			...
			t1 = claim_text(p0_nodes, "mx:");
			t2 = claim_text(p0_nodes, ctx.mx);
			...
			t4 = claim_text(p1_nodes, "my:");
			t5 = claim_text(p1_nodes, ctx.my);
		...
		h: function hydrate() {
			...
			add_location(p0, file, 69, 0, 1422);
			add_location(p1, file, 70, 0, 1437);
			dispose = listen(img, "mousemove", handleMousemove);
		},
