...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 42, 0, 717);
			add_location(h3, file, 44, 0, 733);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-304roe");
			add_location(img0, file, 48, 4, 843);
			add_location(h40, file, 49, 4, 891);
			add_location(p0, file, 50, 4, 916);
			attr(div0, "class", "pillar svelte-304roe");
			add_location(div0, file, 47, 2, 818);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-304roe");
			add_location(img1, file, 58, 4, 1252);
			add_location(h41, file, 59, 4, 1300);
			add_location(p1, file, 60, 4, 1326);
			attr(div1, "class", "pillar svelte-304roe");
			add_location(div1, file, 57, 2, 1227);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-304roe");
			add_location(img2, file, 69, 4, 1689);
			add_location(h42, file, 70, 4, 1737);
			add_location(p2, file, 71, 4, 1766);
			attr(div2, "class", "pillar svelte-304roe");
			add_location(div2, file, 68, 2, 1664);
			attr(div3, "class", "pillars svelte-304roe");
			add_location(div3, file, 46, 0, 794);
		},
