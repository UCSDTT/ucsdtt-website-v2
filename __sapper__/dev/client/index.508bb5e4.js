...
function create_header_slot$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "slot", "header");
			add_location(h3, file$5, 92, 2, 1603);
		},
...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p0, "class", "svelte-z97d5i");
			add_location(p0, file$5, 94, 3, 1699);
			attr(p1, "class", "svelte-z97d5i");
			add_location(p1, file$5, 101, 1, 2040);
			attr(p2, "class", "svelte-z97d5i");
			add_location(p2, file$5, 109, 1, 2447);
			attr(section, "slot", "left");
			add_location(section, file$5, 93, 2, 1674);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 117, 4, 2640);
			attr(figcaption, "class", "svelte-z97d5i");
			add_location(figcaption, file$5, 126, 1, 2906);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 114, 2, 2567);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div0, "class", "hero-div svelte-z97d5i");
			add_location(div0, file$5, 81, 0, 1401);
			attr(h1, "class", "svelte-z97d5i");
			add_location(h1, file$5, 131, 2, 3012);
			attr(div1, "class", "pillars-div svelte-z97d5i");
			add_location(div1, file$5, 130, 0, 2984);
			add_location(br0, file$5, 139, 0, 3227);
			add_location(br1, file$5, 140, 0, 3234);
			add_location(br2, file$5, 141, 0, 3241);
			add_location(br3, file$5, 142, 0, 3248);
			add_location(br4, file$5, 143, 0, 3255);
			add_location(br5, file$5, 144, 0, 3262);
			add_location(br6, file$5, 145, 0, 3269);
			add_location(br7, file$5, 146, 0, 3276);
			add_location(br8, file$5, 147, 0, 3283);
			add_location(br9, file$5, 148, 0, 3290);
			add_location(br10, file$5, 149, 0, 3297);
			add_location(br11, file$5, 150, 0, 3304);
			add_location(br12, file$5, 151, 0, 3311);
			add_location(br13, file$5, 152, 0, 3318);
			add_location(br14, file$5, 153, 0, 3325);
			add_location(br15, file$5, 154, 0, 3332);
			add_location(br16, file$5, 155, 0, 3339);
			add_location(br17, file$5, 156, 0, 3346);
			add_location(br18, file$5, 157, 0, 3353);
			add_location(br19, file$5, 158, 0, 3360);
			add_location(br20, file$5, 159, 0, 3367);
			add_location(br21, file$5, 160, 0, 3374);
			add_location(br22, file$5, 161, 0, 3381);
			add_location(br23, file$5, 162, 0, 3388);
			add_location(br24, file$5, 163, 0, 3395);
			add_location(br25, file$5, 164, 0, 3402);
			add_location(br26, file$5, 165, 0, 3409);
			add_location(br27, file$5, 166, 0, 3416);
			add_location(br28, file$5, 167, 0, 3423);
			add_location(br29, file$5, 168, 0, 3430);
			add_location(br30, file$5, 169, 0, 3437);
			add_location(br31, file$5, 170, 0, 3444);
			add_location(br32, file$5, 171, 0, 3451);
			add_location(br33, file$5, 172, 0, 3458);
			add_location(br34, file$5, 173, 0, 3465);
			add_location(br35, file$5, 174, 0, 3472);
			add_location(br36, file$5, 175, 0, 3479);
			add_location(br37, file$5, 176, 0, 3486);
			add_location(br38, file$5, 177, 0, 3493);
			add_location(br39, file$5, 178, 0, 3500);
			add_location(br40, file$5, 179, 0, 3507);
			add_location(br41, file$5, 180, 0, 3514);
			add_location(br42, file$5, 181, 0, 3521);
			add_location(br43, file$5, 182, 0, 3528);
			add_location(br44, file$5, 183, 0, 3535);
			add_location(br45, file$5, 184, 0, 3542);
			add_location(br46, file$5, 185, 0, 3549);
			add_location(br47, file$5, 186, 0, 3556);
			add_location(br48, file$5, 187, 0, 3563);
			add_location(br49, file$5, 188, 0, 3570);
			add_location(br50, file$5, 189, 0, 3577);
			add_location(br51, file$5, 190, 0, 3584);
			add_location(br52, file$5, 191, 0, 3591);
			add_location(br53, file$5, 192, 0, 3598);
			add_location(br54, file$5, 193, 0, 3605);
			add_location(br55, file$5, 194, 0, 3612);
			add_location(br56, file$5, 195, 0, 3619);
			add_location(br57, file$5, 196, 0, 3626);
			add_location(br58, file$5, 197, 0, 3633);
			add_location(br59, file$5, 198, 0, 3640);
			add_location(br60, file$5, 199, 0, 3647);
			add_location(br61, file$5, 200, 0, 3654);
			add_location(br62, file$5, 201, 0, 3661);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 204, 2, 3687);
			attr(p, "class", "svelte-z97d5i");
			add_location(p, file$5, 202, 0, 3668);
		},
