...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1hfs6dg");
			add_location(img, file, 85, 8, 1546);
			attr(div, "class", "carousel svelte-1hfs6dg");
			add_location(div, file, 84, 6, 1515);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-1hfs6dg");
			add_location(button0, file, 81, 2, 1400);
			attr(div0, "class", "carousel-wrapper svelte-1hfs6dg");
			add_location(div0, file, 82, 2, 1460);
			attr(button1, "class", "carousel-button button-right svelte-1hfs6dg");
			add_location(button1, file, 89, 2, 1654);
			attr(div1, "class", "button-wrapper svelte-1hfs6dg");
			add_location(div1, file, 80, 0, 1369);
		},
