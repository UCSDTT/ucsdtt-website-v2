...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p0, file, 51, 0, 1050);
			add_location(p1, file, 52, 0, 1065);
			add_location(p2, file, 53, 0, 1080);
			add_location(p3, file, 54, 0, 1095);
			attr(div0, "class", "cursor-box svelte-1cou661");
			set_style(div0, "top", ((ctx.my) + 'px'));
			set_style(div0, "left", ((ctx.mx) + 'px'));
			add_location(div0, file, 58, 0, 1179);
			attr(img, "class", "class-img");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 68, 2, 1315);
			attr(div1, "class", "class-img-container svelte-1cou661");
			add_location(div1, file, 67, 0, 1279);
