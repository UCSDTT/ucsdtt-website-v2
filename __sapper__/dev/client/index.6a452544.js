import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, e as element, t as text, a as space, c as claim_element, b as children, d as claim_text, f as detach, g as attr, h as add_location, E as set_style, F as listen, j as insert, k as append, w as set_data, n as noop, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.8b03c4d1.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "text-display svelte-12py48w");
			add_location(h1, file, 45, 0, 729);
			attr(img, "alt", ctx.alt);
			attr(img, "src", ctx.src);
			attr(img, "class", "parallax svelte-12py48w");
			set_style(img, "transform", "translate(0, " + ctx.sy * .2 + "px)");
			add_location(img, file, 46, 0, 767);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(br0, file$1, 57, 0, 821);
			add_location(br1, file$1, 58, 0, 827);
			add_location(br2, file$1, 59, 0, 833);
			add_location(br3, file$1, 60, 0, 839);
			add_location(br4, file$1, 61, 0, 845);
			add_location(br5, file$1, 62, 0, 851);
			add_location(br6, file$1, 63, 0, 857);
			add_location(br7, file$1, 64, 0, 863);
			add_location(br8, file$1, 65, 0, 869);
			add_location(br9, file$1, 66, 0, 875);
			add_location(br10, file$1, 67, 0, 881);
			add_location(br11, file$1, 68, 0, 887);
			add_location(br12, file$1, 69, 0, 893);
			add_location(br13, file$1, 70, 0, 899);
			add_location(br14, file$1, 71, 0, 905);
			add_location(br15, file$1, 72, 0, 911);
			add_location(br16, file$1, 73, 0, 917);
			add_location(br17, file$1, 74, 0, 923);
			add_location(br18, file$1, 75, 0, 929);
			add_location(br19, file$1, 76, 0, 935);
			add_location(br20, file$1, 77, 0, 941);
			add_location(br21, file$1, 78, 0, 947);
			add_location(br22, file$1, 79, 0, 953);
			add_location(br23, file$1, 80, 0, 959);
			add_location(br24, file$1, 81, 0, 965);
			add_location(br25, file$1, 82, 0, 971);
			add_location(br26, file$1, 83, 0, 977);
			add_location(br27, file$1, 84, 0, 983);
			add_location(br28, file$1, 85, 0, 989);
			add_location(br29, file$1, 86, 0, 995);
			add_location(br30, file$1, 87, 0, 1001);
			add_location(br31, file$1, 88, 0, 1007);
			add_location(br32, file$1, 89, 0, 1013);
			add_location(br33, file$1, 90, 0, 1019);
			add_location(br34, file$1, 91, 0, 1025);
			add_location(br35, file$1, 92, 0, 1031);
			add_location(br36, file$1, 93, 0, 1037);
			add_location(br37, file$1, 94, 0, 1043);
			add_location(br38, file$1, 95, 0, 1049);
			add_location(br39, file$1, 96, 0, 1055);
			add_location(br40, file$1, 97, 0, 1061);
			add_location(br41, file$1, 98, 0, 1067);
			add_location(br42, file$1, 99, 0, 1073);
			add_location(br43, file$1, 100, 0, 1079);
			add_location(br44, file$1, 101, 0, 1085);
			add_location(br45, file$1, 102, 0, 1091);
			add_location(br46, file$1, 103, 0, 1097);
			add_location(br47, file$1, 104, 0, 1103);
			add_location(br48, file$1, 105, 0, 1109);
			add_location(br49, file$1, 106, 0, 1115);
			add_location(br50, file$1, 107, 0, 1121);
			add_location(br51, file$1, 108, 0, 1127);
			add_location(br52, file$1, 109, 0, 1133);
			add_location(br53, file$1, 110, 0, 1139);
			add_location(br54, file$1, 111, 0, 1145);
			add_location(br55, file$1, 112, 0, 1151);
			add_location(br56, file$1, 113, 0, 1157);
			add_location(br57, file$1, 114, 0, 1163);
			add_location(br58, file$1, 115, 0, 1169);
			add_location(br59, file$1, 116, 0, 1175);
			add_location(br60, file$1, 117, 0, 1181);
			add_location(br61, file$1, 118, 0, 1187);
			add_location(br62, file$1, 119, 0, 1193);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$1, 120, 14, 1213);
			attr(p, "class", "svelte-1hsgy2r");
			add_location(p, file$1, 120, 0, 1199);
		},
