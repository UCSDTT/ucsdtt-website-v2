...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 69, 1, 1234);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(path, file, 85, 2, 1533);
			...
			add_location(svg_1, file, 77, 1, 1358);
		},
...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 65, 12, 1488);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal");
			add_location(span, file$1, 68, 12, 1583);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "svelte-18zrfhu");
			add_location(h1, file$1, 63, 4, 1442);
			add_location(section, file$1, 62, 0, 1427);
		},
...
const get_header_slot_context = () => ({ class: `header svelte-10viqjz` });
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(hr, file$2, 56, 4, 980);

			attr(section0, "class", "left-div subcards svelte-10viqjz");
			add_location(section0, file$2, 58, 8, 1021);

			attr(section1, "class", "right-div subcards svelte-10viqjz");
			add_location(section1, file$2, 61, 8, 1125);
			attr(div, "class", "wrapper svelte-10viqjz");
			add_location(div, file$2, 57, 4, 990);
			attr(section2, "class", "card svelte-10viqjz");
			add_location(section2, file$2, 54, 0, 904);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong, file$3, 81, 4, 1448);
			attr(h3, "slot", "header");
			add_location(h3, file$3, 80, 2, 1424);
		},
...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong0, file$3, 86, 6, 1640);
			add_location(strong1, file$3, 89, 6, 1876);
			add_location(strong2, file$3, 90, 6, 1913);
			add_location(strong3, file$3, 91, 6, 1955);
			attr(p0, "class", "svelte-7xnkcf");
			add_location(p0, file$3, 84, 4, 1550);
			add_location(strong4, file$3, 99, 6, 2393);
			attr(p1, "class", "svelte-7xnkcf");
			add_location(p1, file$3, 93, 4, 2004);
			add_location(strong5, file$3, 103, 6, 2554);
			attr(p2, "class", "svelte-7xnkcf");
			add_location(p2, file$3, 101, 4, 2464);
			attr(section, "slot", "left");
			add_location(section, file$3, 83, 2, 1523);
		},
...
function create_if_block$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(iframe, "class", "svelte-7xnkcf");
			add_location(iframe, file$3, 110, 6, 2716);
			attr(figcaption, "class", "svelte-7xnkcf");
			add_location(figcaption, file$3, 121, 6, 3079);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(figure, file$3, 106, 2, 2617);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-7xnkcf");
			add_location(div, file$3, 69, 0, 1211);
