...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1291vzt");
			add_location(img0, file$2, 42, 8, 793);
			attr(span0, "class", "svelte-1291vzt");
			add_location(span0, file$2, 42, 55, 840);
			attr(li0, "class", "svelte-1291vzt");
			add_location(li0, file$2, 42, 4, 789);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1291vzt");
			add_location(img1, file$2, 43, 8, 878);
			attr(span1, "class", "svelte-1291vzt");
			add_location(span1, file$2, 43, 55, 925);
			attr(li1, "class", "svelte-1291vzt");
			add_location(li1, file$2, 43, 4, 874);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1291vzt");
			add_location(img2, file$2, 44, 8, 964);
			attr(span2, "class", "svelte-1291vzt");
			add_location(span2, file$2, 44, 55, 1011);
			attr(li2, "class", "svelte-1291vzt");
			add_location(li2, file$2, 44, 4, 960);
			attr(ul, "class", "pillared svelte-1291vzt");
			add_location(ul, file$2, 41, 0, 763);
		},
