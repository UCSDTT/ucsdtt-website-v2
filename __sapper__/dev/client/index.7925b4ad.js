import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, E as svg_element, c as claim_element, b as children, f as detach, g as attr, h as add_location, j as insert, F as create_bidirectional_transition, e as element, a as space, d as claim_text, G as set_style, H as listen, q as transition_in, B as group_outros, r as transition_out, C as check_outros, I as run_all, J as onMount, t as text, m as mount_component, k as append, u as destroy_component } from './chunk.82b023b3.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			path = claim_element(nodes, "path", { d: true, opacity: true }, true);
		...
		h: function hydrate() {
			...
			add_location(path, file, 64, 3, 1174);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			svg_1 = claim_element(nodes, "svg", { class: true, style: true, xmlns: true, viewBox: true }, true);
		...
		h: function hydrate() {
			...
			add_location(input, file, 51, 0, 858);
			...
			add_location(svg_1, file, 56, 0, 990);
