...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 203, 2, 4621);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-1utrzbj");
			add_location(select, file, 148, 4, 3361);
			attr(h4, "class", "svelte-1utrzbj");
			add_location(h4, file, 147, 2, 3327);
			attr(div0, "class", "space-maker svelte-1utrzbj");
			add_location(div0, file, 158, 2, 3586);
			attr(img, "class", "class-img svelte-1utrzbj");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 173, 4, 3836);
			attr(div1, "class", "class-img-container svelte-1utrzbj");
			add_location(div1, file, 172, 2, 3798);
			attr(div2, "class", "brother-info svelte-1utrzbj");
			add_location(div2, file, 181, 2, 3979);
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 150, 8, 3491);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1utrzbj");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 161, 4, 3642);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-1utrzbj");
			add_location(h4, file, 197, 6, 4494);
		},
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong, file, 193, 14, 4393);
			add_location(h5, file, 193, 10, 4389);
			attr(h4, "class", "svelte-1utrzbj");
			add_location(h4, file, 193, 42, 4421);
		},
