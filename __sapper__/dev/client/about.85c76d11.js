...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-1hdvyuj");
			add_location(h1, file$1, 44, 2, 990);
			attr(p0, "class", "svelte-1hdvyuj");
			add_location(p0, file$1, 45, 2, 1045);
			add_location(strong0, file$1, 52, 4, 1306);
			attr(p1, "class", "svelte-1hdvyuj");
			add_location(p1, file$1, 51, 2, 1298);
			add_location(strong1, file$1, 59, 4, 1578);
			add_location(strong2, file$1, 60, 4, 1612);
			add_location(strong3, file$1, 61, 4, 1647);
			add_location(strong4, file$1, 62, 4, 1687);
			add_location(strong5, file$1, 63, 4, 1720);
			add_location(strong6, file$1, 64, 4, 1752);
			add_location(strong7, file$1, 65, 4, 1784);
			add_location(strong8, file$1, 66, 4, 1816);
			add_location(strong9, file$1, 67, 4, 1847);
			add_location(strong10, file$1, 68, 4, 1885);
			add_location(strong11, file$1, 69, 4, 1938);
			add_location(strong12, file$1, 70, 4, 1972);
			add_location(strong13, file$1, 71, 8, 2009);
			attr(p2, "class", "svelte-1hdvyuj");
			add_location(p2, file$1, 58, 2, 1570);
			add_location(strong14, file$1, 75, 4, 2115);
			add_location(strong15, file$1, 76, 4, 2162);
			attr(p3, "class", "svelte-1hdvyuj");
			add_location(p3, file$1, 73, 2, 2052);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-1hdvyuj");
			add_location(img0, file$1, 78, 2, 2199);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-1hdvyuj");
			add_location(img1, file$1, 79, 2, 2273);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-1hdvyuj");
			add_location(div, file$1, 43, 0, 970);
		},
