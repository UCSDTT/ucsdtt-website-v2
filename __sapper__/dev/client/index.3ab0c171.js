...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-k7qksl");
			add_location(img0, file$2, 33, 8, 632);
			attr(span0, "class", "svelte-k7qksl");
			add_location(span0, file$2, 33, 55, 679);
			attr(li0, "class", "svelte-k7qksl");
			add_location(li0, file$2, 33, 4, 628);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-k7qksl");
			add_location(img1, file$2, 34, 8, 717);
			attr(span1, "class", "svelte-k7qksl");
			add_location(span1, file$2, 34, 55, 764);
			attr(li1, "class", "svelte-k7qksl");
			add_location(li1, file$2, 34, 4, 713);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-k7qksl");
			add_location(img2, file$2, 35, 8, 803);
			attr(span2, "class", "svelte-k7qksl");
			add_location(span2, file$2, 35, 55, 850);
			attr(li2, "class", "svelte-k7qksl");
			add_location(li2, file$2, 35, 4, 799);
			attr(ul, "class", "pillared svelte-k7qksl");
			add_location(ul, file$2, 32, 0, 602);
		},
