...
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 77, 12, 1690);
			add_location(li1, file$3, 78, 12, 1723);
			add_location(li2, file$3, 79, 12, 1756);
			add_location(li3, file$3, 80, 12, 1789);
			add_location(li4, file$3, 81, 12, 1822);
			add_location(ul, file$3, 76, 8, 1673);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 83, 8, 1865);
		},
...
function create_header_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 89, 8, 2024);
		},
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 91, 12, 2085);
			add_location(li1, file$3, 92, 12, 2118);
			add_location(li2, file$3, 93, 12, 2151);
			add_location(li3, file$3, 94, 12, 2184);
			add_location(li4, file$3, 95, 12, 2217);
			add_location(ul, file$3, 90, 8, 2068);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 97, 8, 2260);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 103, 8, 2417);
		},
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(li0, file$3, 105, 12, 2481);
			attr(li1, "class", "modal-li svelte-1swkb6t");
			add_location(li1, file$3, 106, 12, 2531);
			attr(li2, "class", "modal-li svelte-1swkb6t");
			add_location(li2, file$3, 107, 12, 2581);
			attr(li3, "class", "modal-li svelte-1swkb6t");
			add_location(li3, file$3, 108, 12, 2631);
			attr(li4, "class", "modal-li svelte-1swkb6t");
			add_location(li4, file$3, 109, 12, 2681);
			add_location(ul, file$3, 104, 8, 2464);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 111, 8, 2741);
		},
