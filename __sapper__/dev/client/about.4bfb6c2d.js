...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-left svelte-6x0fgp");
			add_location(button, file, 138, 6, 2694);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-6x0fgp");
			add_location(img, file, 145, 10, 2901);
			attr(div, "class", "carousel svelte-6x0fgp");
			add_location(div, file, 144, 8, 2868);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-right svelte-6x0fgp");
			add_location(button, file, 153, 6, 3076);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-6x0fgp");
			add_location(div0, file, 142, 4, 2809);
			attr(div1, "class", "button-wrapper svelte-6x0fgp");
			add_location(div1, file, 136, 2, 2639);
			attr(figcaption, "class", "carousel-caption svelte-6x0fgp");
			add_location(figcaption, file, 158, 2, 3199);
			attr(figure, "class", "figure-wrapper svelte-6x0fgp");
			add_location(figure, file, 135, 0, 2605);
