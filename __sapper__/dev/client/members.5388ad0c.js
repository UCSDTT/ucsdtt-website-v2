...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 210, 2, 4733);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-15u4npl");
			add_location(select, file, 155, 4, 3468);
			attr(h4, "class", "svelte-15u4npl");
			add_location(h4, file, 154, 2, 3434);
			attr(div0, "class", "space-maker svelte-15u4npl");
			add_location(div0, file, 165, 2, 3693);
			attr(img, "class", "class-img svelte-15u4npl");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 180, 4, 3943);
			attr(div1, "class", "class-img-container svelte-15u4npl");
			add_location(div1, file, 179, 2, 3905);
			attr(div2, "class", "brother-info svelte-15u4npl");
			add_location(div2, file, 188, 2, 4086);
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 157, 8, 3598);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-15u4npl");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 168, 4, 3749);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-15u4npl");
			add_location(h4, file, 204, 6, 4604);
		},
...
function create_if_block_2(ctx) {
	var h5, t0_value = ctx.key, t0, t1, h4, t2_value = ctx.curBrother[ctx.key], t2;
	...
	return {
		...
		l: function claim(nodes) {
			h5 = claim_element(nodes, "H5", { class: true }, false);
		...
		h: function hydrate() {
			attr(h5, "class", "brother-key svelte-15u4npl");
			add_location(h5, file, 200, 10, 4496);
			attr(h4, "class", "svelte-15u4npl");
			add_location(h4, file, 200, 45, 4531);
		},
