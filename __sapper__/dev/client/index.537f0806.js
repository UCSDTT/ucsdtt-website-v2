...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-1xv5hj6");
			add_location(div, file$2, 31, 0, 576);
			add_location(br0, file$2, 47, 0, 929);
			add_location(br1, file$2, 48, 0, 935);
			add_location(br2, file$2, 49, 0, 941);
			add_location(br3, file$2, 50, 0, 947);
			add_location(br4, file$2, 51, 0, 953);
			add_location(br5, file$2, 52, 0, 959);
			add_location(br6, file$2, 53, 0, 965);
			add_location(br7, file$2, 54, 0, 971);
			add_location(br8, file$2, 55, 0, 977);
			add_location(br9, file$2, 56, 0, 983);
			add_location(br10, file$2, 57, 0, 989);
			add_location(br11, file$2, 58, 0, 995);
			add_location(br12, file$2, 59, 0, 1001);
			add_location(br13, file$2, 60, 0, 1007);
			add_location(br14, file$2, 61, 0, 1013);
			add_location(br15, file$2, 62, 0, 1019);
			add_location(br16, file$2, 63, 0, 1025);
			add_location(br17, file$2, 64, 0, 1031);
			add_location(br18, file$2, 65, 0, 1037);
			add_location(br19, file$2, 66, 0, 1043);
			add_location(br20, file$2, 67, 0, 1049);
			add_location(br21, file$2, 68, 0, 1055);
			add_location(br22, file$2, 69, 0, 1061);
			add_location(br23, file$2, 70, 0, 1067);
			add_location(br24, file$2, 71, 0, 1073);
			add_location(br25, file$2, 72, 0, 1079);
			add_location(br26, file$2, 73, 0, 1085);
			add_location(br27, file$2, 74, 0, 1091);
			add_location(br28, file$2, 75, 0, 1097);
			add_location(br29, file$2, 76, 0, 1103);
			add_location(br30, file$2, 77, 0, 1109);
			add_location(br31, file$2, 78, 0, 1115);
			add_location(br32, file$2, 79, 0, 1121);
			add_location(br33, file$2, 80, 0, 1127);
			add_location(br34, file$2, 81, 0, 1133);
			add_location(br35, file$2, 82, 0, 1139);
			add_location(br36, file$2, 83, 0, 1145);
			add_location(br37, file$2, 84, 0, 1151);
			add_location(br38, file$2, 85, 0, 1157);
			add_location(br39, file$2, 86, 0, 1163);
			add_location(br40, file$2, 87, 0, 1169);
			add_location(br41, file$2, 88, 0, 1175);
			add_location(br42, file$2, 89, 0, 1181);
			add_location(br43, file$2, 90, 0, 1187);
			add_location(br44, file$2, 91, 0, 1193);
			add_location(br45, file$2, 92, 0, 1199);
			add_location(br46, file$2, 93, 0, 1205);
			add_location(br47, file$2, 94, 0, 1211);
			add_location(br48, file$2, 95, 0, 1217);
			add_location(br49, file$2, 96, 0, 1223);
			add_location(br50, file$2, 97, 0, 1229);
			add_location(br51, file$2, 98, 0, 1235);
			add_location(br52, file$2, 99, 0, 1241);
			add_location(br53, file$2, 100, 0, 1247);
			add_location(br54, file$2, 101, 0, 1253);
			add_location(br55, file$2, 102, 0, 1259);
			add_location(br56, file$2, 103, 0, 1265);
			add_location(br57, file$2, 104, 0, 1271);
			add_location(br58, file$2, 105, 0, 1277);
			add_location(br59, file$2, 106, 0, 1283);
			add_location(br60, file$2, 107, 0, 1289);
			add_location(br61, file$2, 108, 0, 1295);
			add_location(br62, file$2, 109, 0, 1301);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$2, 110, 14, 1321);
			attr(p, "class", "svelte-1xv5hj6");
			add_location(p, file$2, 110, 0, 1307);
		},
