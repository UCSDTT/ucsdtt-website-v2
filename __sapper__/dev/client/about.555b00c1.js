...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-left svelte-ejfmvx");
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-ejfmvx");
			add_location(img, file, 144, 10, 2867);
			attr(div, "class", "carousel svelte-ejfmvx");
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-right svelte-ejfmvx");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-ejfmvx");
			add_location(div0, file, 141, 4, 2775);
			attr(div1, "class", "button-wrapper svelte-ejfmvx");
			add_location(div1, file, 135, 2, 2605);
			attr(figcaption, "class", "carousel-caption svelte-ejfmvx");
			add_location(figcaption, file, 157, 2, 3165);
			attr(figure, "class", "figure-wrapper svelte-ejfmvx");
