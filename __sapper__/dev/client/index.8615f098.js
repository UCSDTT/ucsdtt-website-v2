...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-18rc3pq");
			add_location(img0, file$2, 32, 8, 616);
			attr(span0, "class", "svelte-18rc3pq");
			add_location(span0, file$2, 32, 55, 663);
			attr(li0, "class", "svelte-18rc3pq");
			add_location(li0, file$2, 32, 4, 612);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-18rc3pq");
			add_location(img1, file$2, 33, 8, 701);
			attr(span1, "class", "svelte-18rc3pq");
			add_location(span1, file$2, 33, 55, 748);
			attr(li1, "class", "svelte-18rc3pq");
			add_location(li1, file$2, 33, 4, 697);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-18rc3pq");
			add_location(img2, file$2, 34, 8, 787);
			attr(span2, "class", "svelte-18rc3pq");
			add_location(span2, file$2, 34, 55, 834);
			attr(li2, "class", "svelte-18rc3pq");
			add_location(li2, file$2, 34, 4, 783);
			attr(ul, "class", "pillared svelte-18rc3pq");
			add_location(ul, file$2, 31, 0, 586);
		},
