...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 210, 2, 4732);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h4_nodes, "pledge class: \n    ");
		...
		h: function hydrate() {
			...
			add_location(select, file, 155, 4, 3467);
			attr(h4, "class", "svelte-1ikbvcr");
			add_location(h4, file, 154, 2, 3444);
			attr(div0, "class", "space-maker svelte-1ikbvcr");
			add_location(div0, file, 165, 2, 3692);
			...
			add_location(img, file, 180, 4, 3942);
			attr(div1, "class", "class-img-container svelte-1ikbvcr");
			add_location(div1, file, 179, 2, 3904);
			attr(div2, "class", "brother-info svelte-1ikbvcr");
			add_location(div2, file, 188, 2, 4085);
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 157, 8, 3597);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 168, 4, 3748);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-1ikbvcr");
			add_location(h4, file, 204, 6, 4603);
		},
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h5, file, 200, 10, 4495);
			attr(h4, "class", "svelte-1ikbvcr");
			add_location(h4, file, 200, 45, 4530);
		},
