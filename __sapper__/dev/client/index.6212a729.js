...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-nmv7ag");
			add_location(div0, file$2, 56, 0, 982);

			attr(button, "class", "svelte-nmv7ag");
			add_location(button, file$2, 61, 8, 1148);
			attr(section, "class", "header svelte-nmv7ag");
			add_location(section, file$2, 59, 4, 1081);
			add_location(hr0, file$2, 63, 1, 1220);

			add_location(hr1, file$2, 65, 1, 1241);
			attr(div1, "class", "modal svelte-nmv7ag");
			add_location(div1, file$2, 58, 0, 1057);
