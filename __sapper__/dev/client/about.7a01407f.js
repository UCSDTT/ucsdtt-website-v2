...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(strong2, file, 39, 4, 1194);
			add_location(strong3, file, 40, 4, 1229);
			add_location(strong4, file, 41, 4, 1269);
			add_location(strong5, file, 42, 4, 1302);
			add_location(strong6, file, 43, 4, 1334);
			add_location(strong7, file, 44, 4, 1366);
			add_location(strong8, file, 45, 4, 1398);
			add_location(strong9, file, 46, 4, 1429);
			add_location(strong10, file, 47, 4, 1467);
			add_location(strong11, file, 48, 4, 1520);
			add_location(strong12, file, 49, 4, 1554);
			add_location(strong13, file, 50, 8, 1591);
