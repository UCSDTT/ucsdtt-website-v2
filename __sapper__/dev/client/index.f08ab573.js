...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1n3fnqa");
			add_location(img0, file$2, 43, 8, 835);
			attr(span0, "class", "svelte-1n3fnqa");
			add_location(span0, file$2, 43, 55, 882);
			attr(li0, "class", "svelte-1n3fnqa");
			add_location(li0, file$2, 43, 4, 831);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1n3fnqa");
			add_location(img1, file$2, 44, 8, 920);
			attr(span1, "class", "svelte-1n3fnqa");
			add_location(span1, file$2, 44, 55, 967);
			attr(li1, "class", "svelte-1n3fnqa");
			add_location(li1, file$2, 44, 4, 916);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1n3fnqa");
			add_location(img2, file$2, 45, 8, 1006);
			attr(span2, "class", "svelte-1n3fnqa");
			add_location(span2, file$2, 45, 55, 1053);
			attr(li2, "class", "svelte-1n3fnqa");
			add_location(li2, file$2, 45, 4, 1002);
			attr(ul, "class", "pillared svelte-1n3fnqa");
			add_location(ul, file$2, 42, 0, 805);
		},
