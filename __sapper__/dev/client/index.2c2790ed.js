...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1feahq6");
			add_location(img0, file$2, 32, 8, 522);
			attr(span0, "class", "svelte-1feahq6");
			add_location(span0, file$2, 32, 55, 569);
			attr(li0, "class", "svelte-1feahq6");
			add_location(li0, file$2, 32, 4, 518);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1feahq6");
			add_location(img1, file$2, 33, 8, 607);
			attr(span1, "class", "svelte-1feahq6");
			add_location(span1, file$2, 33, 55, 654);
			attr(li1, "class", "svelte-1feahq6");
			add_location(li1, file$2, 33, 4, 603);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1feahq6");
			add_location(img2, file$2, 34, 8, 693);
			attr(span2, "class", "svelte-1feahq6");
			add_location(span2, file$2, 34, 55, 740);
			attr(li2, "class", "svelte-1feahq6");
			add_location(li2, file$2, 34, 4, 689);
			attr(ul, "class", "pillared svelte-1feahq6");
			add_location(ul, file$2, 31, 0, 492);
		},
