...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 42, 0, 723);
			add_location(h3, file, 44, 0, 739);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-1rmsfo8");
			add_location(img0, file, 48, 4, 849);
			add_location(h40, file, 49, 4, 897);
			add_location(p0, file, 50, 4, 922);
			attr(div0, "class", "pillar svelte-1rmsfo8");
			add_location(div0, file, 47, 2, 824);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1rmsfo8");
			add_location(img1, file, 58, 4, 1258);
			add_location(h41, file, 59, 4, 1306);
			add_location(p1, file, 60, 4, 1332);
			attr(div1, "class", "pillar svelte-1rmsfo8");
			add_location(div1, file, 57, 2, 1233);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1rmsfo8");
			add_location(img2, file, 69, 4, 1695);
			add_location(h42, file, 70, 4, 1743);
			add_location(p2, file, 71, 4, 1772);
			attr(div2, "class", "pillar svelte-1rmsfo8");
			add_location(div2, file, 68, 2, 1670);
			attr(div3, "class", "pillars svelte-1rmsfo8");
			add_location(div3, file, 46, 0, 800);
		},
