...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-lv8jnv");
			add_location(img, file, 53, 6, 1035);
			attr(div, "class", "carousel svelte-lv8jnv");
			add_location(div, file, 52, 4, 1006);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-lv8jnv");
			add_location(div, file, 50, 0, 955);
		},
