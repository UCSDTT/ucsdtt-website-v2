import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, e as element, t as text, a as space, c as claim_element, b as children, d as claim_text, f as detach, g as attr, h as add_location, j as insert, k as append, w as set_data, E as create_bidirectional_transition, F as svg_element, G as set_style, H as create_in_transition, n as noop, x as empty, I as listen, q as transition_in, B as group_outros, r as transition_out, C as check_outros, J as onMount, m as mount_component, u as destroy_component } from './chunk.54f67dbc.js';
...
function create_if_block_1(ctx) {
	var h10, t0, h10_transition, t1, h11, t2, h11_transition, current;

	return {
		c: function create() {
			h10 = element("h1");
			t0 = text(ctx.titleBig);
			t1 = space();
			h11 = element("h1");
			t2 = text(ctx.titleSmall);
			this.h();
		},

		l: function claim(nodes) {
			h10 = claim_element(nodes, "H1", { class: true }, false);
			var h10_nodes = children(h10);

			t0 = claim_text(h10_nodes, ctx.titleBig);
			h10_nodes.forEach(detach);
			t1 = claim_text(nodes, "\n\t");

			h11 = claim_element(nodes, "H1", { class: true }, false);
			var h11_nodes = children(h11);

			t2 = claim_text(h11_nodes, ctx.titleSmall);
			h11_nodes.forEach(detach);
			this.h();
		},

		h: function hydrate() {
			attr(h10, "class", "text-display lg-view svelte-xcfgkc");
			add_location(h10, file, 70, 1, 1077);
			attr(h11, "class", "text-display sm-view svelte-xcfgkc");
			add_location(h11, file, 71, 1, 1143);
		},
		...
		p: function update(changed, ctx) {
			if (!current || changed.titleBig) {
				set_data(t0, ctx.titleBig);
			}

			if (!current || changed.titleSmall) {
				set_data(t2, ctx.titleSmall);
			}
		},
		...
		i: function intro(local) {
			if (current) return;
			add_render_callback(() => {
				if (!h10_transition) h10_transition = create_bidirectional_transition(h10, fade, {}, true);
				h10_transition.run(1);
			});

			add_render_callback(() => {
				if (!h11_transition) h11_transition = create_bidirectional_transition(h11, fade, {}, true);
		...
		o: function outro(local) {
			if (!h10_transition) h10_transition = create_bidirectional_transition(h10, fade, {}, false);
			h10_transition.run(0);

			if (!h11_transition) h11_transition = create_bidirectional_transition(h11, fade, {}, false);
		...
		d: function destroy(detaching) {
			if (detaching) {
				detach(h10);
				if (h10_transition) h10_transition.end();
				detach(t1);
				detach(h11);
				if (h11_transition) h11_transition.end();
			}
		}
	};
}
...
function instance($$self, $$props, $$invalidate) {
	...
	const writable_props = ['svg', 'titleBig', 'titleSmall', 'tagline'];
...
class Hero extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, ["svg", "titleBig", "titleSmall", "tagline"]);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(section, file$1, 27, 0, 386);
			add_location(br0, file$1, 42, 0, 730);
			add_location(br1, file$1, 43, 0, 736);
			add_location(br2, file$1, 44, 0, 742);
			add_location(br3, file$1, 45, 0, 748);
			add_location(br4, file$1, 46, 0, 754);
			add_location(br5, file$1, 47, 0, 760);
			add_location(br6, file$1, 48, 0, 766);
			add_location(br7, file$1, 49, 0, 772);
			add_location(br8, file$1, 50, 0, 778);
			add_location(br9, file$1, 51, 0, 784);
			add_location(br10, file$1, 52, 0, 790);
			add_location(br11, file$1, 53, 0, 796);
			add_location(br12, file$1, 54, 0, 802);
			add_location(br13, file$1, 55, 0, 808);
			add_location(br14, file$1, 56, 0, 814);
			add_location(br15, file$1, 57, 0, 820);
			add_location(br16, file$1, 58, 0, 826);
			add_location(br17, file$1, 59, 0, 832);
			add_location(br18, file$1, 60, 0, 838);
			add_location(br19, file$1, 61, 0, 844);
			add_location(br20, file$1, 62, 0, 850);
			add_location(br21, file$1, 63, 0, 856);
			add_location(br22, file$1, 64, 0, 862);
			add_location(br23, file$1, 65, 0, 868);
			add_location(br24, file$1, 66, 0, 874);
			add_location(br25, file$1, 67, 0, 880);
			add_location(br26, file$1, 68, 0, 886);
			add_location(br27, file$1, 69, 0, 892);
			add_location(br28, file$1, 70, 0, 898);
			add_location(br29, file$1, 71, 0, 904);
			add_location(br30, file$1, 72, 0, 910);
			add_location(br31, file$1, 73, 0, 916);
			add_location(br32, file$1, 74, 0, 922);
			add_location(br33, file$1, 75, 0, 928);
			add_location(br34, file$1, 76, 0, 934);
			add_location(br35, file$1, 77, 0, 940);
			add_location(br36, file$1, 78, 0, 946);
			add_location(br37, file$1, 79, 0, 952);
			add_location(br38, file$1, 80, 0, 958);
			add_location(br39, file$1, 81, 0, 964);
			add_location(br40, file$1, 82, 0, 970);
			add_location(br41, file$1, 83, 0, 976);
			add_location(br42, file$1, 84, 0, 982);
			add_location(br43, file$1, 85, 0, 988);
			add_location(br44, file$1, 86, 0, 994);
			add_location(br45, file$1, 87, 0, 1000);
			add_location(br46, file$1, 88, 0, 1006);
			add_location(br47, file$1, 89, 0, 1012);
			add_location(br48, file$1, 90, 0, 1018);
			add_location(br49, file$1, 91, 0, 1024);
			add_location(br50, file$1, 92, 0, 1030);
			add_location(br51, file$1, 93, 0, 1036);
			add_location(br52, file$1, 94, 0, 1042);
			add_location(br53, file$1, 95, 0, 1048);
			add_location(br54, file$1, 96, 0, 1054);
			add_location(br55, file$1, 97, 0, 1060);
			add_location(br56, file$1, 98, 0, 1066);
			add_location(br57, file$1, 99, 0, 1072);
			add_location(br58, file$1, 100, 0, 1078);
			add_location(br59, file$1, 101, 0, 1084);
			add_location(br60, file$1, 102, 0, 1090);
			add_location(br61, file$1, 103, 0, 1096);
			add_location(br62, file$1, 104, 0, 1102);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$1, 105, 14, 1122);
			attr(p, "class", "svelte-sazog6");
			add_location(p, file$1, 105, 0, 1108);
		},
