...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(button, file, 62, 0, 1313);
			attr(img, "class", "class-img svelte-wog5t5");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 65, 4, 1420);
			attr(div0, "class", "class-img-container svelte-wog5t5");
			add_location(div0, file, 64, 2, 1382);
			attr(div1, "class", "pledge-classes");
			add_location(div1, file, 63, 0, 1351);
