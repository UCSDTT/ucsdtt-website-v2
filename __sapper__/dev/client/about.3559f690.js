import { S as SvelteComponentDev, i as init, s as safe_not_equal, t as text, e as element, a as space, d as claim_text, c as claim_element, b as children, f as detach, g as attr, h as add_location, j as insert, k as append, n as noop, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.86736f05.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t1 = claim_text(h1_nodes, "The Origins of Theta Tau");
			...
			t3 = claim_text(p0_nodes, "In the Spring of 2009, several students of UCSD's Jacobs School of\n    Engineering felt that there was a lack of engineering representation in the\n    Greek community on campus. Luckily an opportunity arose for them to change\n    that.");
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-rgrdu4");
			add_location(h1, file, 37, 2, 863);
			attr(p0, "class", "svelte-rgrdu4");
			add_location(p0, file, 38, 2, 918);
			add_location(strong0, file, 45, 4, 1179);
			attr(p1, "class", "svelte-rgrdu4");
			add_location(p1, file, 44, 2, 1171);
			add_location(strong1, file, 52, 4, 1451);
			add_location(strong2, file, 53, 4, 1485);
			add_location(strong3, file, 54, 4, 1520);
			add_location(strong4, file, 55, 4, 1560);
			add_location(strong5, file, 56, 4, 1593);
			add_location(strong6, file, 57, 4, 1625);
			add_location(strong7, file, 58, 4, 1657);
			add_location(strong8, file, 59, 4, 1689);
			add_location(strong9, file, 60, 4, 1720);
			add_location(strong10, file, 61, 4, 1758);
			add_location(strong11, file, 62, 4, 1811);
			add_location(strong12, file, 63, 4, 1845);
			add_location(strong13, file, 64, 8, 1882);
			attr(p2, "class", "svelte-rgrdu4");
			add_location(p2, file, 51, 2, 1443);
			add_location(strong14, file, 68, 4, 1988);
			add_location(strong15, file, 69, 4, 2035);
			attr(p3, "class", "svelte-rgrdu4");
			add_location(p3, file, 66, 2, 1925);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-rgrdu4");
			add_location(img0, file, 71, 2, 2072);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-rgrdu4");
			add_location(img1, file, 72, 2, 2146);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-rgrdu4");
