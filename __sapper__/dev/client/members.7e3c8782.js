...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 210, 2, 4729);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-12fh3ep");
			add_location(select, file, 155, 4, 3464);
			attr(h4, "class", "svelte-12fh3ep");
			add_location(h4, file, 154, 2, 3430);
			attr(div0, "class", "space-maker svelte-12fh3ep");
			add_location(div0, file, 165, 2, 3689);
			attr(img, "class", "class-img svelte-12fh3ep");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 180, 4, 3939);
			attr(div1, "class", "class-img-container svelte-12fh3ep");
			add_location(div1, file, 179, 2, 3901);
			attr(div2, "class", "brother-info svelte-12fh3ep");
			add_location(div2, file, 188, 2, 4082);
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 157, 8, 3594);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-12fh3ep");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 168, 4, 3745);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-12fh3ep");
			add_location(h4, file, 204, 6, 4600);
		},
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h5, "class", "brother-key svelte-12fh3ep");
			add_location(h5, file, 200, 10, 4492);
			attr(h4, "class", "svelte-12fh3ep");
			add_location(h4, file, 200, 45, 4527);
		},
