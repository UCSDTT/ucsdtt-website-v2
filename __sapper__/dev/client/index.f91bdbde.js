...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(p2, file$5, 109, 1, 2444);
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 117, 4, 2637);
			attr(figcaption, "class", "svelte-1a2i6qs");
			add_location(figcaption, file$5, 126, 1, 2903);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 114, 2, 2564);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$5, 131, 2, 3009);
			attr(div1, "class", "pillars-div svelte-1a2i6qs");
			add_location(div1, file$5, 130, 0, 2981);
			add_location(br0, file$5, 139, 0, 3224);
			add_location(br1, file$5, 140, 0, 3231);
			add_location(br2, file$5, 141, 0, 3238);
			add_location(br3, file$5, 142, 0, 3245);
			add_location(br4, file$5, 143, 0, 3252);
			add_location(br5, file$5, 144, 0, 3259);
			add_location(br6, file$5, 145, 0, 3266);
			add_location(br7, file$5, 146, 0, 3273);
			add_location(br8, file$5, 147, 0, 3280);
			add_location(br9, file$5, 148, 0, 3287);
			add_location(br10, file$5, 149, 0, 3294);
			add_location(br11, file$5, 150, 0, 3301);
			add_location(br12, file$5, 151, 0, 3308);
			add_location(br13, file$5, 152, 0, 3315);
			add_location(br14, file$5, 153, 0, 3322);
			add_location(br15, file$5, 154, 0, 3329);
			add_location(br16, file$5, 155, 0, 3336);
			add_location(br17, file$5, 156, 0, 3343);
			add_location(br18, file$5, 157, 0, 3350);
			add_location(br19, file$5, 158, 0, 3357);
			add_location(br20, file$5, 159, 0, 3364);
			add_location(br21, file$5, 160, 0, 3371);
			add_location(br22, file$5, 161, 0, 3378);
			add_location(br23, file$5, 162, 0, 3385);
			add_location(br24, file$5, 163, 0, 3392);
			add_location(br25, file$5, 164, 0, 3399);
			add_location(br26, file$5, 165, 0, 3406);
			add_location(br27, file$5, 166, 0, 3413);
			add_location(br28, file$5, 167, 0, 3420);
			add_location(br29, file$5, 168, 0, 3427);
			add_location(br30, file$5, 169, 0, 3434);
			add_location(br31, file$5, 170, 0, 3441);
			add_location(br32, file$5, 171, 0, 3448);
			add_location(br33, file$5, 172, 0, 3455);
			add_location(br34, file$5, 173, 0, 3462);
			add_location(br35, file$5, 174, 0, 3469);
			add_location(br36, file$5, 175, 0, 3476);
			add_location(br37, file$5, 176, 0, 3483);
			add_location(br38, file$5, 177, 0, 3490);
			add_location(br39, file$5, 178, 0, 3497);
			add_location(br40, file$5, 179, 0, 3504);
			add_location(br41, file$5, 180, 0, 3511);
			add_location(br42, file$5, 181, 0, 3518);
			add_location(br43, file$5, 182, 0, 3525);
			add_location(br44, file$5, 183, 0, 3532);
			add_location(br45, file$5, 184, 0, 3539);
			add_location(br46, file$5, 185, 0, 3546);
			add_location(br47, file$5, 186, 0, 3553);
			add_location(br48, file$5, 187, 0, 3560);
			add_location(br49, file$5, 188, 0, 3567);
			add_location(br50, file$5, 189, 0, 3574);
			add_location(br51, file$5, 190, 0, 3581);
			add_location(br52, file$5, 191, 0, 3588);
			add_location(br53, file$5, 192, 0, 3595);
			add_location(br54, file$5, 193, 0, 3602);
			add_location(br55, file$5, 194, 0, 3609);
			add_location(br56, file$5, 195, 0, 3616);
			add_location(br57, file$5, 196, 0, 3623);
			add_location(br58, file$5, 197, 0, 3630);
			add_location(br59, file$5, 198, 0, 3637);
			add_location(br60, file$5, 199, 0, 3644);
			add_location(br61, file$5, 200, 0, 3651);
			add_location(br62, file$5, 201, 0, 3658);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 204, 2, 3684);
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 202, 0, 3665);
		},
