...
import { f as fade, P as Pillars } from './chunk.723a20a3.js';
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-left svelte-1o6pt95");
			add_location(button, file, 138, 6, 2692);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1o6pt95");
			add_location(img, file, 145, 10, 2899);
			attr(div, "class", "carousel svelte-1o6pt95");
			add_location(div, file, 144, 8, 2866);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-right svelte-1o6pt95");
			add_location(button, file, 153, 6, 3074);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-1o6pt95");
			add_location(div0, file, 142, 4, 2807);
			attr(div1, "class", "button-wrapper svelte-1o6pt95");
			add_location(div1, file, 136, 2, 2637);
			attr(figcaption, "class", "carousel-caption svelte-1o6pt95");
			add_location(figcaption, file, 158, 2, 3197);
			attr(figure, "class", "figure-wrapper svelte-1o6pt95");
			add_location(figure, file, 135, 0, 2603);
