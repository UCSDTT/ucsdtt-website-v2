...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "text-display lg-view svelte-6s44p1");
			add_location(h1, file, 70, 1, 1184);
		},
...
const get_header_slot_context = () => ({ class: `header svelte-zva0ep` });
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(hr, file$2, 40, 4, 629);

			attr(section0, "class", "left-div subcards svelte-zva0ep");
			add_location(section0, file$2, 42, 8, 668);

			attr(section1, "class", "right-div subcards svelte-zva0ep");
			add_location(section1, file$2, 45, 8, 769);
			attr(div, "class", "wrapper svelte-zva0ep");
			add_location(div, file$2, 41, 4, 638);
			attr(section2, "class", "card svelte-zva0ep");
			add_location(section2, file$2, 38, 0, 555);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong, file$3, 73, 21, 1280);
			attr(h3, "slot", "header");
			add_location(h3, file$3, 73, 2, 1261);
		},
...
function create_left_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t2 = claim_text(p0_nodes, ". Our brothers \n\t\tdevelop each other to not only focus on one aspect of ourselves, but on \n\t\tmany. We strive to be well-rounded people who excel in \n\t\t");
		...
		h: function hydrate() {
			add_location(strong0, file$3, 77, 2, 1455);
			add_location(strong1, file$3, 80, 2, 1679);
			add_location(strong2, file$3, 81, 2, 1711);
			add_location(strong3, file$3, 82, 2, 1749);
			attr(p0, "class", "svelte-5uys0y");
			add_location(p0, file$3, 75, 3, 1375);
			add_location(strong4, file$3, 90, 2, 2152);
			attr(p1, "class", "svelte-5uys0y");
			add_location(p1, file$3, 84, 1, 1790);
			add_location(strong5, file$3, 94, 2, 2295);
			attr(p2, "class", "svelte-5uys0y");
			add_location(p2, file$3, 92, 1, 2215);
			attr(section, "slot", "left");
			add_location(section, file$3, 74, 2, 1350);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$3, 100, 4, 2425);
			attr(figcaption, "class", "svelte-5uys0y");
			add_location(figcaption, file$3, 109, 1, 2691);
			attr(figure, "slot", "right");
			add_location(figure, file$3, 97, 2, 2352);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-5uys0y");
			add_location(div, file$3, 62, 0, 1059);
		},
