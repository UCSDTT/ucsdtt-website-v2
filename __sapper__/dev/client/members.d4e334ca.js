...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-avac10");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-avac10");
			...
			attr(div0, "class", "class-img-container svelte-avac10");
			add_location(div0, file, 83, 0, 1577);
			attr(div1, "class", "brother-info svelte-avac10");
