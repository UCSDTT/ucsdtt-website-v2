...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-121x756");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 72, 2, 1407);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-121x756");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 84, 2, 1579);
			attr(div0, "class", "class-img-container svelte-121x756");
			add_location(div0, file, 83, 0, 1543);
			attr(div1, "class", "space-maker svelte-121x756");
			add_location(div1, file, 93, 2, 1737);
			attr(div2, "class", "brother-info");
			add_location(div2, file, 92, 0, 1708);
