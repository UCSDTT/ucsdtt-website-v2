...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-19ubdmf");
			add_location(img0, file$2, 48, 8, 948);
			attr(span0, "class", "svelte-19ubdmf");
			add_location(span0, file$2, 48, 55, 995);
			attr(li0, "class", "svelte-19ubdmf");
			add_location(li0, file$2, 48, 4, 944);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-19ubdmf");
			add_location(img1, file$2, 49, 8, 1033);
			attr(span1, "class", "svelte-19ubdmf");
			add_location(span1, file$2, 49, 55, 1080);
			attr(li1, "class", "svelte-19ubdmf");
			add_location(li1, file$2, 49, 4, 1029);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-19ubdmf");
			add_location(img2, file$2, 50, 8, 1119);
			attr(span2, "class", "svelte-19ubdmf");
			add_location(span2, file$2, 50, 55, 1166);
			attr(li2, "class", "svelte-19ubdmf");
			add_location(li2, file$2, 50, 4, 1115);
			attr(ul, "class", "pillared svelte-19ubdmf");
			add_location(ul, file$2, 47, 0, 918);
		},
