...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-nrl6c4");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-nrl6c4");
			...
			attr(div0, "class", "class-img-container svelte-nrl6c4");
			add_location(div0, file, 82, 0, 1538);
			attr(div1, "class", "space-maker svelte-nrl6c4");
