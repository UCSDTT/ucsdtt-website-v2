...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-1iqo0ua");
			add_location(div0, file$2, 56, 0, 992);

			attr(button, "class", "svelte-1iqo0ua");
			add_location(button, file$2, 61, 8, 1158);
			attr(section, "class", "header svelte-1iqo0ua");
			add_location(section, file$2, 59, 4, 1091);
			add_location(hr0, file$2, 63, 1, 1230);

			add_location(hr1, file$2, 65, 1, 1251);
			attr(div1, "class", "modal svelte-1iqo0ua");
			add_location(div1, file$2, 58, 0, 1067);
...
// (76:8) <h2 class="modal-li" slot="header">
function create_header_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "modal-li svelte-v9shis");
			attr(h2, "slot", "header");
			add_location(h2, file$3, 75, 8, 1630);
		},
...
// (75:4) <Modal on:close="{() => broVis = false}">
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-v9shis");
			add_location(li0, file$3, 77, 12, 1707);
			attr(li1, "class", "modal-li svelte-v9shis");
			add_location(li1, file$3, 78, 12, 1757);
			attr(li2, "class", "modal-li svelte-v9shis");
			add_location(li2, file$3, 79, 12, 1807);
			attr(li3, "class", "modal-li svelte-v9shis");
			add_location(li3, file$3, 80, 12, 1857);
			attr(li4, "class", "modal-li svelte-v9shis");
			add_location(li4, file$3, 81, 12, 1907);
			add_location(ul, file$3, 76, 8, 1690);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 83, 8, 1967);
		},
...
// (90:8) <h2 class="modal-li" slot="header">
function create_header_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "modal-li svelte-v9shis");
			attr(h2, "slot", "header");
			add_location(h2, file$3, 89, 8, 2126);
		},
...
// (89:4) <Modal on:close="{() => philVis = false}">
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-v9shis");
			add_location(li0, file$3, 91, 12, 2204);
			attr(li1, "class", "modal-li svelte-v9shis");
			add_location(li1, file$3, 92, 12, 2254);
			attr(li2, "class", "modal-li svelte-v9shis");
			add_location(li2, file$3, 93, 12, 2304);
			attr(li3, "class", "modal-li svelte-v9shis");
			add_location(li3, file$3, 94, 12, 2354);
			attr(li4, "class", "modal-li svelte-v9shis");
			add_location(li4, file$3, 95, 12, 2404);
			add_location(ul, file$3, 90, 8, 2187);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 97, 8, 2464);
		},
...
// (104:8) <h2 class="modal-li" slot="header">
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "modal-li svelte-v9shis");
			attr(h2, "slot", "header");
			add_location(h2, file$3, 103, 8, 2621);
		},
...
// (103:4) <Modal on:close="{() => proVis = false}">
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-v9shis");
			add_location(li0, file$3, 105, 12, 2702);
			attr(li1, "class", "modal-li svelte-v9shis");
			add_location(li1, file$3, 106, 12, 2752);
			attr(li2, "class", "modal-li svelte-v9shis");
			add_location(li2, file$3, 107, 12, 2802);
			attr(li3, "class", "modal-li svelte-v9shis");
			add_location(li3, file$3, 108, 12, 2852);
			attr(li4, "class", "modal-li svelte-v9shis");
			add_location(li4, file$3, 109, 12, 2902);
			add_location(ul, file$3, 104, 8, 2685);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 111, 8, 2962);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-v9shis");
			add_location(img0, file$3, 60, 8, 1181);
			attr(span0, "class", "svelte-v9shis");
			add_location(span0, file$3, 61, 8, 1237);
			attr(li0, "class", "svelte-v9shis");
			add_location(li0, file$3, 59, 4, 1137);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-v9shis");
			add_location(img1, file$3, 64, 8, 1321);
			attr(span1, "class", "svelte-v9shis");
			add_location(span1, file$3, 65, 8, 1377);
			attr(li1, "class", "svelte-v9shis");
			add_location(li1, file$3, 63, 4, 1276);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-v9shis");
			add_location(img2, file$3, 68, 8, 1461);
			attr(span2, "class", "svelte-v9shis");
			add_location(span2, file$3, 69, 8, 1517);
			attr(li2, "class", "svelte-v9shis");
			add_location(li2, file$3, 67, 4, 1417);
			attr(ul, "class", "pillared svelte-v9shis");
			add_location(ul, file$3, 58, 0, 1111);
...
function create_fragment$4(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t3 = claim_text(h1_nodes, "the Three Pillars");
			h1_nodes.forEach(detach);
			t4 = claim_text(div1_nodes, "\n\t");
			...
			t69 = claim_text(p_nodes, "Icons from ");

			a = claim_element(p_nodes, "A", { href: true }, false);
			var a_nodes = children(a);

			t70 = claim_text(a_nodes, "icons8");
		...
		h: function hydrate() {
			...
			attr(div0, "class", "hero-div svelte-12z78b6");
			add_location(div0, file$4, 48, 0, 860);
			attr(h1, "class", "svelte-12z78b6");
			add_location(h1, file$4, 60, 1, 1073);
			attr(div1, "class", "pillars-div svelte-12z78b6");
			add_location(div1, file$4, 59, 0, 1046);
			add_location(br0, file$4, 68, 0, 1287);
			add_location(br1, file$4, 69, 0, 1293);
			add_location(br2, file$4, 70, 0, 1299);
			add_location(br3, file$4, 71, 0, 1305);
			add_location(br4, file$4, 72, 0, 1311);
			add_location(br5, file$4, 73, 0, 1317);
			add_location(br6, file$4, 74, 0, 1323);
			add_location(br7, file$4, 75, 0, 1329);
			add_location(br8, file$4, 76, 0, 1335);
			add_location(br9, file$4, 77, 0, 1341);
			add_location(br10, file$4, 78, 0, 1347);
			add_location(br11, file$4, 79, 0, 1353);
			add_location(br12, file$4, 80, 0, 1359);
			add_location(br13, file$4, 81, 0, 1365);
			add_location(br14, file$4, 82, 0, 1371);
			add_location(br15, file$4, 83, 0, 1377);
			add_location(br16, file$4, 84, 0, 1383);
			add_location(br17, file$4, 85, 0, 1389);
			add_location(br18, file$4, 86, 0, 1395);
			add_location(br19, file$4, 87, 0, 1401);
			add_location(br20, file$4, 88, 0, 1407);
			add_location(br21, file$4, 89, 0, 1413);
			add_location(br22, file$4, 90, 0, 1419);
			add_location(br23, file$4, 91, 0, 1425);
			add_location(br24, file$4, 92, 0, 1431);
			add_location(br25, file$4, 93, 0, 1437);
			add_location(br26, file$4, 94, 0, 1443);
			add_location(br27, file$4, 95, 0, 1449);
			add_location(br28, file$4, 96, 0, 1455);
			add_location(br29, file$4, 97, 0, 1461);
			add_location(br30, file$4, 98, 0, 1467);
			add_location(br31, file$4, 99, 0, 1473);
			add_location(br32, file$4, 100, 0, 1479);
			add_location(br33, file$4, 101, 0, 1485);
			add_location(br34, file$4, 102, 0, 1491);
			add_location(br35, file$4, 103, 0, 1497);
			add_location(br36, file$4, 104, 0, 1503);
			add_location(br37, file$4, 105, 0, 1509);
			add_location(br38, file$4, 106, 0, 1515);
			add_location(br39, file$4, 107, 0, 1521);
			add_location(br40, file$4, 108, 0, 1527);
			add_location(br41, file$4, 109, 0, 1533);
			add_location(br42, file$4, 110, 0, 1539);
			add_location(br43, file$4, 111, 0, 1545);
			add_location(br44, file$4, 112, 0, 1551);
			add_location(br45, file$4, 113, 0, 1557);
			add_location(br46, file$4, 114, 0, 1563);
			add_location(br47, file$4, 115, 0, 1569);
			add_location(br48, file$4, 116, 0, 1575);
			add_location(br49, file$4, 117, 0, 1581);
			add_location(br50, file$4, 118, 0, 1587);
			add_location(br51, file$4, 119, 0, 1593);
			add_location(br52, file$4, 120, 0, 1599);
			add_location(br53, file$4, 121, 0, 1605);
			add_location(br54, file$4, 122, 0, 1611);
			add_location(br55, file$4, 123, 0, 1617);
			add_location(br56, file$4, 124, 0, 1623);
			add_location(br57, file$4, 125, 0, 1629);
			add_location(br58, file$4, 126, 0, 1635);
			add_location(br59, file$4, 127, 0, 1641);
			add_location(br60, file$4, 128, 0, 1647);
			add_location(br61, file$4, 129, 0, 1653);
			add_location(br62, file$4, 130, 0, 1659);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$4, 131, 14, 1679);
			attr(p, "class", "svelte-12z78b6");
			add_location(p, file$4, 131, 0, 1665);
		},
