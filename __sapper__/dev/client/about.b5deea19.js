...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-zlwz8x");
			add_location(img, file, 83, 8, 1496);
			attr(div, "class", "carousel svelte-zlwz8x");
			add_location(div, file, 82, 6, 1465);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-zlwz8x");
			add_location(button0, file, 79, 2, 1350);
			attr(div0, "class", "carousel-wrapper svelte-zlwz8x");
			add_location(div0, file, 80, 2, 1410);
			attr(button1, "class", "carousel-button button-right svelte-zlwz8x");
			add_location(button1, file, 87, 2, 1604);
			attr(div1, "class", "button-wrapper svelte-zlwz8x");
			add_location(div1, file, 78, 0, 1319);
		},
