...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p0, "class", "svelte-e1r03t");
			add_location(p0, file, 62, 0, 1207);
			attr(p1, "class", "svelte-e1r03t");
			add_location(p1, file, 63, 0, 1222);
			attr(p2, "class", "svelte-e1r03t");
			add_location(p2, file, 64, 0, 1237);
			attr(p3, "class", "svelte-e1r03t");
			add_location(p3, file, 65, 0, 1252);
			attr(div0, "class", "cursor-box svelte-e1r03t");
			set_style(div0, "top", ctx.picY);
			set_style(div0, "left", ctx.picX);
			add_location(div0, file, 69, 0, 1336);
			attr(img, "class", "class-img svelte-e1r03t");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 79, 2, 1458);
			attr(div1, "class", "class-img-container svelte-e1r03t");
			add_location(div1, file, 78, 0, 1422);
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handleMouseClick(event) {
	...
	$$self.$$.update = ($$dirty = { my: 1, mx: 1 }) => {
		if ($$dirty.my) { $$invalidate('picY', picY = `${my - 150}px`); }
