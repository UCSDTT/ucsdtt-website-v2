...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-la0usd");
			add_location(img, file, 110, 8, 2046);
			attr(div, "class", "carousel svelte-la0usd");
			add_location(div, file, 109, 6, 2015);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-la0usd");
			add_location(button0, file, 101, 2, 1851);
			attr(div0, "class", "carousel-wrapper svelte-la0usd");
			add_location(div0, file, 107, 2, 1960);
			attr(button1, "class", "carousel-button button-right svelte-la0usd");
			add_location(button1, file, 114, 2, 2154);
			attr(div1, "class", "button-wrapper svelte-la0usd");
			add_location(div1, file, 100, 0, 1820);
