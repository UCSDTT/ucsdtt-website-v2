...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-mwt009");
			add_location(img, file, 58, 6, 1123);
			attr(div, "class", "carousel svelte-mwt009");
			add_location(div, file, 57, 4, 1094);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-mwt009");
			add_location(div, file, 55, 0, 1043);
		},
