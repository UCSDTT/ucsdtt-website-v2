...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-1kfblhf");
			add_location(div0, file$2, 56, 0, 984);

			attr(button, "class", "svelte-1kfblhf");
			add_location(button, file$2, 61, 8, 1150);
			attr(section, "class", "header svelte-1kfblhf");
			add_location(section, file$2, 59, 4, 1083);
			add_location(hr0, file$2, 63, 1, 1222);

			add_location(hr1, file$2, 65, 1, 1243);
			attr(div1, "class", "modal svelte-1kfblhf");
			add_location(div1, file$2, 58, 0, 1059);
