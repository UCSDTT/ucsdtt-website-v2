...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h20, "class", "svelte-1cmmuqk");
			add_location(h20, file$2, 27, 8, 540);
			attr(li0, "class", "svelte-1cmmuqk");
			add_location(li0, file$2, 27, 4, 536);
			attr(h21, "class", "svelte-1cmmuqk");
			add_location(h21, file$2, 28, 8, 574);
			attr(li1, "class", "svelte-1cmmuqk");
			add_location(li1, file$2, 28, 4, 570);
			attr(h22, "class", "svelte-1cmmuqk");
			add_location(h22, file$2, 29, 8, 609);
			attr(li2, "class", "svelte-1cmmuqk");
			add_location(li2, file$2, 29, 4, 605);
			attr(ul, "class", "pillared svelte-1cmmuqk");
