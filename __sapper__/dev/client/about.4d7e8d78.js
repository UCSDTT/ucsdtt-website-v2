...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-m1hbxl");
			add_location(img, file, 110, 8, 2068);
			attr(div, "class", "carousel svelte-m1hbxl");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-m1hbxl");
			add_location(button0, file, 101, 2, 1873);
			attr(div0, "class", "carousel-wrapper svelte-m1hbxl");
			add_location(div0, file, 107, 2, 1982);
			attr(button1, "class", "carousel-button button-right svelte-m1hbxl");
			add_location(button1, file, 114, 2, 2176);
			attr(div1, "class", "button-wrapper svelte-m1hbxl");
