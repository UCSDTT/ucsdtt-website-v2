...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-g60kdo");
			add_location(img, file, 110, 8, 2050);
			attr(div, "class", "carousel svelte-g60kdo");
			add_location(div, file, 109, 6, 2019);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-g60kdo");
			add_location(button0, file, 101, 2, 1855);
			attr(div0, "class", "carousel-wrapper svelte-g60kdo");
			add_location(div0, file, 107, 2, 1964);
			attr(button1, "class", "carousel-button button-right svelte-g60kdo");
			add_location(button1, file, 114, 2, 2158);
			attr(div1, "class", "button-wrapper svelte-g60kdo");
			add_location(div1, file, 100, 0, 1824);
