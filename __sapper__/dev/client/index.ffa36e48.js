...
function create_left_slot(ctx) {
	...
	return {
		c: function create() {
			p = element("p");
			t = text("Formed in 1904, Theta Tau is the nation's largest and oldest co-ed \n\tengineering fraternity.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t = claim_text(p_nodes, "Formed in 1904, Theta Tau is the nation's largest and oldest co-ed \n\tengineering fraternity.");
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 100, 4, 1867);
			attr(figcaption, "class", "svelte-1a2i6qs");
			add_location(figcaption, file$5, 109, 1, 2133);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 97, 2, 1794);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$5, 114, 2, 2239);
			attr(div1, "class", "pillars-div svelte-1a2i6qs");
			add_location(div1, file$5, 113, 0, 2211);
			add_location(br0, file$5, 122, 0, 2454);
			add_location(br1, file$5, 123, 0, 2461);
			add_location(br2, file$5, 124, 0, 2468);
			add_location(br3, file$5, 125, 0, 2475);
			add_location(br4, file$5, 126, 0, 2482);
			add_location(br5, file$5, 127, 0, 2489);
			add_location(br6, file$5, 128, 0, 2496);
			add_location(br7, file$5, 129, 0, 2503);
			add_location(br8, file$5, 130, 0, 2510);
			add_location(br9, file$5, 131, 0, 2517);
			add_location(br10, file$5, 132, 0, 2524);
			add_location(br11, file$5, 133, 0, 2531);
			add_location(br12, file$5, 134, 0, 2538);
			add_location(br13, file$5, 135, 0, 2545);
			add_location(br14, file$5, 136, 0, 2552);
			add_location(br15, file$5, 137, 0, 2559);
			add_location(br16, file$5, 138, 0, 2566);
			add_location(br17, file$5, 139, 0, 2573);
			add_location(br18, file$5, 140, 0, 2580);
			add_location(br19, file$5, 141, 0, 2587);
			add_location(br20, file$5, 142, 0, 2594);
			add_location(br21, file$5, 143, 0, 2601);
			add_location(br22, file$5, 144, 0, 2608);
			add_location(br23, file$5, 145, 0, 2615);
			add_location(br24, file$5, 146, 0, 2622);
			add_location(br25, file$5, 147, 0, 2629);
			add_location(br26, file$5, 148, 0, 2636);
			add_location(br27, file$5, 149, 0, 2643);
			add_location(br28, file$5, 150, 0, 2650);
			add_location(br29, file$5, 151, 0, 2657);
			add_location(br30, file$5, 152, 0, 2664);
			add_location(br31, file$5, 153, 0, 2671);
			add_location(br32, file$5, 154, 0, 2678);
			add_location(br33, file$5, 155, 0, 2685);
			add_location(br34, file$5, 156, 0, 2692);
			add_location(br35, file$5, 157, 0, 2699);
			add_location(br36, file$5, 158, 0, 2706);
			add_location(br37, file$5, 159, 0, 2713);
			add_location(br38, file$5, 160, 0, 2720);
			add_location(br39, file$5, 161, 0, 2727);
			add_location(br40, file$5, 162, 0, 2734);
			add_location(br41, file$5, 163, 0, 2741);
			add_location(br42, file$5, 164, 0, 2748);
			add_location(br43, file$5, 165, 0, 2755);
			add_location(br44, file$5, 166, 0, 2762);
			add_location(br45, file$5, 167, 0, 2769);
			add_location(br46, file$5, 168, 0, 2776);
			add_location(br47, file$5, 169, 0, 2783);
			add_location(br48, file$5, 170, 0, 2790);
			add_location(br49, file$5, 171, 0, 2797);
			add_location(br50, file$5, 172, 0, 2804);
			add_location(br51, file$5, 173, 0, 2811);
			add_location(br52, file$5, 174, 0, 2818);
			add_location(br53, file$5, 175, 0, 2825);
			add_location(br54, file$5, 176, 0, 2832);
			add_location(br55, file$5, 177, 0, 2839);
			add_location(br56, file$5, 178, 0, 2846);
			add_location(br57, file$5, 179, 0, 2853);
			add_location(br58, file$5, 180, 0, 2860);
			add_location(br59, file$5, 181, 0, 2867);
			add_location(br60, file$5, 182, 0, 2874);
			add_location(br61, file$5, 183, 0, 2881);
			add_location(br62, file$5, 184, 0, 2888);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 187, 2, 2914);
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 185, 0, 2895);
		},
