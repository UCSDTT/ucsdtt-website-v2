import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, E as svg_element, c as claim_element, b as children, f as detach, g as attr, h as add_location, F as set_style, j as insert, k as append, G as create_in_transition, n as noop, e as element, a as space, x as empty, d as claim_text, H as listen, q as transition_in, I as run_all, t as text, m as mount_component, r as transition_out, u as destroy_component } from './chunk.cfced375.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(path, file, 67, 1, 1260);
			...
			add_location(svg_1, file, 59, 0, 1101);
		},
		...
		i: function intro(local) {
			if (!path_intro) {
				add_render_callback(() => {
					path_intro = create_in_transition(path, fly, {y: -5});
					path_intro.start();
				});
			}
		},
...
function create_fragment(ctx) {
	var scrolling = false, clear_scrolling = () => { scrolling = false; }, scrolling_timeout, input, t, if_block_anchor, dispose;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input, file, 51, 0, 866);
