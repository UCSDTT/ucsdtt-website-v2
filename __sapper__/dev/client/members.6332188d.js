import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, c as claim_element, b as children, f as detach, g as attr, h as add_location, j as insert, k as append, n as noop, a as space, t as text, d as claim_text, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.b5534b6a.js';
...
function create_fragment(ctx) {
	var div1, div0, img, img_src_value, img_alt_value;
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-1pqdj91");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 60, 4, 1327);
			attr(div0, "class", "class-img-container svelte-1pqdj91");
			add_location(div0, file, 59, 2, 1289);
			attr(div1, "class", "pledge-classes svelte-1pqdj91");
			add_location(div1, file, 58, 0, 1258);
		},
