...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(br0, file$1, 37, 0, 617);
			add_location(br1, file$1, 38, 0, 623);
			add_location(br2, file$1, 39, 0, 629);
			add_location(br3, file$1, 40, 0, 635);
			add_location(br4, file$1, 41, 0, 641);
			add_location(br5, file$1, 42, 0, 647);
			add_location(br6, file$1, 43, 0, 653);
			add_location(br7, file$1, 44, 0, 659);
			add_location(br8, file$1, 45, 0, 665);
			add_location(br9, file$1, 46, 0, 671);
			add_location(br10, file$1, 47, 0, 677);
			add_location(br11, file$1, 48, 0, 683);
			add_location(br12, file$1, 49, 0, 689);
			add_location(br13, file$1, 50, 0, 695);
			add_location(br14, file$1, 51, 0, 701);
			add_location(br15, file$1, 52, 0, 707);
			add_location(br16, file$1, 53, 0, 713);
			add_location(br17, file$1, 54, 0, 719);
			add_location(br18, file$1, 55, 0, 725);
			add_location(br19, file$1, 56, 0, 731);
			add_location(br20, file$1, 57, 0, 737);
			add_location(br21, file$1, 58, 0, 743);
			add_location(br22, file$1, 59, 0, 749);
			add_location(br23, file$1, 60, 0, 755);
			add_location(br24, file$1, 61, 0, 761);
			add_location(br25, file$1, 62, 0, 767);
			add_location(br26, file$1, 63, 0, 773);
			add_location(br27, file$1, 64, 0, 779);
			add_location(br28, file$1, 65, 0, 785);
			add_location(br29, file$1, 66, 0, 791);
			add_location(br30, file$1, 67, 0, 797);
			add_location(br31, file$1, 68, 0, 803);
			add_location(br32, file$1, 69, 0, 809);
			add_location(br33, file$1, 70, 0, 815);
			add_location(br34, file$1, 71, 0, 821);
			add_location(br35, file$1, 72, 0, 827);
			add_location(br36, file$1, 73, 0, 833);
			add_location(br37, file$1, 74, 0, 839);
			add_location(br38, file$1, 75, 0, 845);
			add_location(br39, file$1, 76, 0, 851);
			add_location(br40, file$1, 77, 0, 857);
			add_location(br41, file$1, 78, 0, 863);
			add_location(br42, file$1, 79, 0, 869);
			add_location(br43, file$1, 80, 0, 875);
			add_location(br44, file$1, 81, 0, 881);
			add_location(br45, file$1, 82, 0, 887);
			add_location(br46, file$1, 83, 0, 893);
			add_location(br47, file$1, 84, 0, 899);
			add_location(br48, file$1, 85, 0, 905);
			add_location(br49, file$1, 86, 0, 911);
			add_location(br50, file$1, 87, 0, 917);
			add_location(br51, file$1, 88, 0, 923);
			add_location(br52, file$1, 89, 0, 929);
			add_location(br53, file$1, 90, 0, 935);
			add_location(br54, file$1, 91, 0, 941);
			add_location(br55, file$1, 92, 0, 947);
			add_location(br56, file$1, 93, 0, 953);
			add_location(br57, file$1, 94, 0, 959);
			add_location(br58, file$1, 95, 0, 965);
			add_location(br59, file$1, 96, 0, 971);
			add_location(br60, file$1, 97, 0, 977);
			add_location(br61, file$1, 98, 0, 983);
			add_location(br62, file$1, 99, 0, 989);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$1, 100, 14, 1009);
			attr(p, "class", "svelte-16dyq0i");
			add_location(p, file$1, 100, 0, 995);
		},
