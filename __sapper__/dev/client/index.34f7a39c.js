...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(span, file$1, 57, 12, 1151);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "labels");
			add_location(span, file$1, 60, 12, 1228);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "svelte-1jiyxcj");
			add_location(h1, file$1, 55, 4, 1107);
			add_location(section, file$1, 54, 0, 1093);
		},
