import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, e as element, c as claim_element, b as children, f as detach, g as attr, G as set_style, h as add_location, j as insert, t as text, a as space, d as claim_text, H as listen, k as append, w as set_data, n as noop, I as run_all, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.b5534b6a.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1r6divw");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 73, 2, 1429);
		},
...
function create_fragment(ctx) {
	var scrolling = false, clear_scrolling = () => { scrolling = false; }, scrolling_timeout, p0, t0, t1, t2, p1, t3, t4, t5, p2, t6, t7, t8, p3, t9, t10, t11, t12, div, img, img_src_value, img_alt_value, dispose;
	...
	return {
		...
		h: function hydrate() {
			attr(p0, "class", "svelte-1r6divw");
			add_location(p0, file, 65, 0, 1281);
			attr(p1, "class", "svelte-1r6divw");
			add_location(p1, file, 66, 0, 1296);
			attr(p2, "class", "svelte-1r6divw");
			add_location(p2, file, 67, 0, 1311);
			attr(p3, "class", "svelte-1r6divw");
			add_location(p3, file, 68, 0, 1326);
			attr(img, "class", "class-img svelte-1r6divw");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 84, 2, 1569);
			attr(div, "class", "class-img-container svelte-1r6divw");
			add_location(div, file, 83, 0, 1533);
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handleMouseClick(event) {
	...
	$$self.$$.update = ($$dirty = { my: 1, mx: 1 }) => {
		if ($$dirty.my) { $$invalidate('picY', picY = `${my - 180}px`); }
		if ($$dirty.mx) { $$invalidate('picX', picX = `${mx - 80}px`); }
	};
