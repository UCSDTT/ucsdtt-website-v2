...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-28kjb8");
			add_location(select, file, 156, 4, 3463);
			attr(h4, "class", "svelte-28kjb8");
			add_location(h4, file, 155, 2, 3447);
			attr(div0, "class", "space-maker svelte-28kjb8");
			add_location(div0, file, 166, 2, 3688);
			attr(img, "class", "class-img svelte-28kjb8");
			...
			attr(div1, "class", "class-img-container svelte-28kjb8");
			add_location(div1, file, 180, 2, 3900);
			attr(div2, "class", "brother-info svelte-28kjb8");
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-28kjb8");
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h5, "class", "brother-key svelte-28kjb8");
