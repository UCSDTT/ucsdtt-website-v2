...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-10oocyg");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 87, 6, 2012);
			attr(div0, "class", "class-img-container svelte-10oocyg");
			add_location(div0, file, 86, 4, 1972);
			attr(div1, "class", "pledge-classes");
			add_location(div1, file, 85, 2, 1939);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(button, file, 83, 0, 1873);
