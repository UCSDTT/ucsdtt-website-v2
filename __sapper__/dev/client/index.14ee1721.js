...
import { f as fade, a as fly } from './chunk.2eabe72b.js';
import './chunk.e0035de7.js';
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "text-display lg-view svelte-1p4jbsz");
			add_location(h1, file, 73, 1, 1371);
		},
...
function create_if_block$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(iframe, "class", "svelte-1ho6o1s");
			add_location(iframe, file$3, 110, 6, 2567);
			attr(figcaption, "class", "svelte-1ho6o1s");
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-1ho6o1s");
