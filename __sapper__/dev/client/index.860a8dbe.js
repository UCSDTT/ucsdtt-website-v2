...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-qzgni2");
			add_location(img0, file$2, 40, 8, 730);
			attr(span0, "class", "svelte-qzgni2");
			add_location(span0, file$2, 40, 55, 777);
			attr(li0, "class", "svelte-qzgni2");
			add_location(li0, file$2, 40, 4, 726);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-qzgni2");
			add_location(img1, file$2, 41, 8, 815);
			attr(span1, "class", "svelte-qzgni2");
			add_location(span1, file$2, 41, 55, 862);
			attr(li1, "class", "svelte-qzgni2");
			add_location(li1, file$2, 41, 4, 811);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-qzgni2");
			add_location(img2, file$2, 42, 8, 901);
			attr(span2, "class", "svelte-qzgni2");
			add_location(span2, file$2, 42, 55, 948);
			attr(li2, "class", "svelte-qzgni2");
			add_location(li2, file$2, 42, 4, 897);
			attr(ul, "class", "pillared svelte-qzgni2");
			add_location(ul, file$2, 39, 0, 700);
		},
