...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 92, 2, 1963);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 104, 2, 2135);
			attr(div0, "class", "class-img-container svelte-1ct97j0");
			add_location(div0, file, 103, 0, 2099);
			add_location(h2, file, 113, 2, 2293);
			add_location(h3, file, 114, 2, 2331);
			attr(div1, "class", "brother-info svelte-1ct97j0");
			add_location(div1, file, 112, 0, 2264);
