...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-18ebobv");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "class-img svelte-18ebobv");
			...
			attr(div0, "class", "class-img-container svelte-18ebobv");
			add_location(div0, file, 89, 0, 1685);
			add_location(h2, file, 99, 2, 1879);
			add_location(h3, file, 100, 2, 1917);
			attr(div1, "class", "brother-info svelte-18ebobv");
