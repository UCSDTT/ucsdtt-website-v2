import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, a as space, t as text, c as claim_element, b as children, f as detach, d as claim_text, g as attr, h as add_location, H as listen, j as insert, k as append, n as noop, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.b5534b6a.js';
...
function create_fragment(ctx) {
	var div1, div0, img, img_src_value, img_alt_value, t0, h10, t1, t2, t3, h11, t4, t5, dispose;
	...
	return {
		...
		l: function claim(nodes) {
			...
			h10 = claim_element(nodes, "H1", {}, false);
			var h10_nodes = children(h10);

			t1 = claim_text(h10_nodes, "mx:");
			t2 = claim_text(h10_nodes, ctx.mx);
			h10_nodes.forEach(detach);
			t3 = claim_text(nodes, "\n");

			h11 = claim_element(nodes, "H1", {}, false);
			var h11_nodes = children(h11);

			t4 = claim_text(h11_nodes, "my:");
			t5 = claim_text(h11_nodes, ctx.my);
		...
		h: function hydrate() {
			...
			add_location(img, file, 61, 4, 1272);
			attr(div0, "class", "class-img-container svelte-15e2r1d");
			add_location(div0, file, 60, 2, 1234);
			attr(div1, "class", "pledge-classes");
			add_location(div1, file, 59, 0, 1203);
			add_location(h10, file, 69, 0, 1423);
			add_location(h11, file, 70, 0, 1440);
			dispose = listen(img, "mousemove", handleMousemoves);
		},
...
function instance($$self, $$props, $$invalidate) {
  ...
  let my, mx;
	...
	return { pledgeClasses, curClass, my, mx };
}
