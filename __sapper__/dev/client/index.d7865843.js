...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(p1, file$5, 101, 1, 2005);
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 109, 4, 2214);
			attr(figcaption, "class", "svelte-1a2i6qs");
			add_location(figcaption, file$5, 118, 1, 2480);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 106, 2, 2141);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$5, 123, 2, 2586);
			attr(div1, "class", "pillars-div svelte-1a2i6qs");
			add_location(div1, file$5, 122, 0, 2558);
			add_location(br0, file$5, 131, 0, 2801);
			add_location(br1, file$5, 132, 0, 2808);
			add_location(br2, file$5, 133, 0, 2815);
			add_location(br3, file$5, 134, 0, 2822);
			add_location(br4, file$5, 135, 0, 2829);
			add_location(br5, file$5, 136, 0, 2836);
			add_location(br6, file$5, 137, 0, 2843);
			add_location(br7, file$5, 138, 0, 2850);
			add_location(br8, file$5, 139, 0, 2857);
			add_location(br9, file$5, 140, 0, 2864);
			add_location(br10, file$5, 141, 0, 2871);
			add_location(br11, file$5, 142, 0, 2878);
			add_location(br12, file$5, 143, 0, 2885);
			add_location(br13, file$5, 144, 0, 2892);
			add_location(br14, file$5, 145, 0, 2899);
			add_location(br15, file$5, 146, 0, 2906);
			add_location(br16, file$5, 147, 0, 2913);
			add_location(br17, file$5, 148, 0, 2920);
			add_location(br18, file$5, 149, 0, 2927);
			add_location(br19, file$5, 150, 0, 2934);
			add_location(br20, file$5, 151, 0, 2941);
			add_location(br21, file$5, 152, 0, 2948);
			add_location(br22, file$5, 153, 0, 2955);
			add_location(br23, file$5, 154, 0, 2962);
			add_location(br24, file$5, 155, 0, 2969);
			add_location(br25, file$5, 156, 0, 2976);
			add_location(br26, file$5, 157, 0, 2983);
			add_location(br27, file$5, 158, 0, 2990);
			add_location(br28, file$5, 159, 0, 2997);
			add_location(br29, file$5, 160, 0, 3004);
			add_location(br30, file$5, 161, 0, 3011);
			add_location(br31, file$5, 162, 0, 3018);
			add_location(br32, file$5, 163, 0, 3025);
			add_location(br33, file$5, 164, 0, 3032);
			add_location(br34, file$5, 165, 0, 3039);
			add_location(br35, file$5, 166, 0, 3046);
			add_location(br36, file$5, 167, 0, 3053);
			add_location(br37, file$5, 168, 0, 3060);
			add_location(br38, file$5, 169, 0, 3067);
			add_location(br39, file$5, 170, 0, 3074);
			add_location(br40, file$5, 171, 0, 3081);
			add_location(br41, file$5, 172, 0, 3088);
			add_location(br42, file$5, 173, 0, 3095);
			add_location(br43, file$5, 174, 0, 3102);
			add_location(br44, file$5, 175, 0, 3109);
			add_location(br45, file$5, 176, 0, 3116);
			add_location(br46, file$5, 177, 0, 3123);
			add_location(br47, file$5, 178, 0, 3130);
			add_location(br48, file$5, 179, 0, 3137);
			add_location(br49, file$5, 180, 0, 3144);
			add_location(br50, file$5, 181, 0, 3151);
			add_location(br51, file$5, 182, 0, 3158);
			add_location(br52, file$5, 183, 0, 3165);
			add_location(br53, file$5, 184, 0, 3172);
			add_location(br54, file$5, 185, 0, 3179);
			add_location(br55, file$5, 186, 0, 3186);
			add_location(br56, file$5, 187, 0, 3193);
			add_location(br57, file$5, 188, 0, 3200);
			add_location(br58, file$5, 189, 0, 3207);
			add_location(br59, file$5, 190, 0, 3214);
			add_location(br60, file$5, 191, 0, 3221);
			add_location(br61, file$5, 192, 0, 3228);
			add_location(br62, file$5, 193, 0, 3235);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 196, 2, 3261);
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 194, 0, 3242);
		},
