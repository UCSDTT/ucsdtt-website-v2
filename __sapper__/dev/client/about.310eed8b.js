...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-i35q5r");
			add_location(h1, file, 36, 2, 827);
			attr(p0, "class", "svelte-i35q5r");
			add_location(p0, file, 37, 2, 882);
			add_location(strong0, file, 44, 4, 1143);
			attr(p1, "class", "svelte-i35q5r");
			add_location(p1, file, 43, 2, 1135);
			add_location(strong1, file, 51, 4, 1415);
			add_location(strong2, file, 52, 4, 1449);
			add_location(strong3, file, 53, 4, 1484);
			add_location(strong4, file, 54, 4, 1524);
			add_location(strong5, file, 55, 4, 1557);
			add_location(strong6, file, 56, 4, 1589);
			add_location(strong7, file, 57, 4, 1621);
			add_location(strong8, file, 58, 4, 1653);
			add_location(strong9, file, 59, 4, 1684);
			add_location(strong10, file, 60, 4, 1722);
			add_location(strong11, file, 61, 4, 1775);
			add_location(strong12, file, 62, 4, 1809);
			add_location(strong13, file, 63, 8, 1846);
			attr(p2, "class", "svelte-i35q5r");
			add_location(p2, file, 50, 2, 1407);
			add_location(strong14, file, 67, 4, 1952);
			add_location(strong15, file, 68, 4, 1999);
			attr(p3, "class", "svelte-i35q5r");
			add_location(p3, file, 65, 2, 1889);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-i35q5r");
			add_location(img0, file, 70, 2, 2036);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-i35q5r");
			add_location(img1, file, 71, 2, 2110);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-i35q5r");
			add_location(div, file, 35, 0, 807);
		},
