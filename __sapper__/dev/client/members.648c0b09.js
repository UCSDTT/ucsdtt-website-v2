...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 211, 2, 4724);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-i7410n");
			add_location(select, file, 156, 4, 3463);
			attr(h4, "class", "svelte-i7410n");
			add_location(h4, file, 155, 2, 3447);
			attr(div0, "class", "space-maker svelte-i7410n");
			add_location(div0, file, 166, 2, 3688);
			attr(img, "class", "class-img svelte-i7410n");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 181, 4, 3938);
			attr(div1, "class", "class-img-container svelte-i7410n");
			add_location(div1, file, 180, 2, 3900);
			attr(div2, "class", "brother-info svelte-i7410n");
			add_location(div2, file, 189, 2, 4081);
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 158, 8, 3593);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-i7410n");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 169, 4, 3744);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-i7410n");
			add_location(h4, file, 205, 6, 4599);
		},
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h5, "class", "brother-key svelte-i7410n");
			add_location(h5, file, 201, 10, 4491);
			attr(h4, "class", "svelte-i7410n");
			add_location(h4, file, 201, 45, 4526);
		},
