...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-noqi1z");
			add_location(div0, file$2, 56, 0, 990);

			attr(button, "class", "svelte-noqi1z");
			add_location(button, file$2, 61, 8, 1156);
			attr(section, "class", "header svelte-noqi1z");
			add_location(section, file$2, 59, 4, 1089);
			add_location(hr0, file$2, 63, 1, 1228);

			add_location(hr1, file$2, 65, 1, 1249);
			attr(div1, "class", "modal svelte-noqi1z");
			add_location(div1, file$2, 58, 0, 1065);
...
// (77:8) <h2 class="modal-li" slot="header">
function create_header_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "modal-li svelte-nxsrcv");
			attr(h2, "slot", "header");
			add_location(h2, file$3, 76, 8, 1649);
		},
...
// (76:4) <Modal on:close="{() => broVis = false}">
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-nxsrcv");
			add_location(li0, file$3, 78, 12, 1726);
			attr(li1, "class", "modal-li svelte-nxsrcv");
			add_location(li1, file$3, 79, 12, 1776);
			attr(li2, "class", "modal-li svelte-nxsrcv");
			add_location(li2, file$3, 80, 12, 1826);
			attr(li3, "class", "modal-li svelte-nxsrcv");
			add_location(li3, file$3, 81, 12, 1876);
			attr(li4, "class", "modal-li svelte-nxsrcv");
			add_location(li4, file$3, 82, 12, 1926);
			add_location(ul, file$3, 77, 8, 1709);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 84, 8, 1986);
		},
...
// (91:8) <h2 class="modal-li" slot="header">
function create_header_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "modal-li svelte-nxsrcv");
			attr(h2, "slot", "header");
			add_location(h2, file$3, 90, 8, 2145);
		},
...
// (90:4) <Modal on:close="{() => philVis = false}">
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-nxsrcv");
			add_location(li0, file$3, 92, 12, 2223);
			attr(li1, "class", "modal-li svelte-nxsrcv");
			add_location(li1, file$3, 93, 12, 2273);
			attr(li2, "class", "modal-li svelte-nxsrcv");
			add_location(li2, file$3, 94, 12, 2323);
			attr(li3, "class", "modal-li svelte-nxsrcv");
			add_location(li3, file$3, 95, 12, 2373);
			attr(li4, "class", "modal-li svelte-nxsrcv");
			add_location(li4, file$3, 96, 12, 2423);
			add_location(ul, file$3, 91, 8, 2206);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 98, 8, 2483);
		},
...
// (105:8) <h2 class="modal-li" slot="header">
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "modal-li svelte-nxsrcv");
			attr(h2, "slot", "header");
			add_location(h2, file$3, 104, 8, 2640);
		},
...
// (104:4) <Modal on:close="{() => proVis = false}">
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-nxsrcv");
			add_location(li0, file$3, 106, 12, 2721);
			attr(li1, "class", "modal-li svelte-nxsrcv");
			add_location(li1, file$3, 107, 12, 2771);
			attr(li2, "class", "modal-li svelte-nxsrcv");
			add_location(li2, file$3, 108, 12, 2821);
			attr(li3, "class", "modal-li svelte-nxsrcv");
			add_location(li3, file$3, 109, 12, 2871);
			attr(li4, "class", "modal-li svelte-nxsrcv");
			add_location(li4, file$3, 110, 12, 2921);
			add_location(ul, file$3, 105, 8, 2704);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 112, 8, 2981);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-nxsrcv");
			add_location(img0, file$3, 61, 8, 1200);
			attr(span0, "class", "svelte-nxsrcv");
			add_location(span0, file$3, 62, 8, 1256);
			attr(li0, "class", "svelte-nxsrcv");
			add_location(li0, file$3, 60, 4, 1156);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-nxsrcv");
			add_location(img1, file$3, 65, 8, 1340);
			attr(span1, "class", "svelte-nxsrcv");
			add_location(span1, file$3, 66, 8, 1396);
			attr(li1, "class", "svelte-nxsrcv");
			add_location(li1, file$3, 64, 4, 1295);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-nxsrcv");
			add_location(img2, file$3, 69, 8, 1480);
			attr(span2, "class", "svelte-nxsrcv");
			add_location(span2, file$3, 70, 8, 1536);
			attr(li2, "class", "svelte-nxsrcv");
			add_location(li2, file$3, 68, 4, 1436);
			attr(ul, "class", "pillared svelte-nxsrcv");
			add_location(ul, file$3, 59, 0, 1130);
