...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-dbpqv8");
			add_location(img, file, 71, 8, 1321);
			attr(div, "class", "carousel svelte-dbpqv8");
			add_location(div, file, 70, 6, 1290);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button svelte-dbpqv8");
			add_location(button0, file, 67, 2, 1187);
			attr(div0, "class", "carousel-wrapper svelte-dbpqv8");
			add_location(div0, file, 68, 2, 1235);
			attr(button1, "class", "carousel-button svelte-dbpqv8");
			add_location(button1, file, 75, 2, 1429);
			attr(div1, "class", "button-wrapper svelte-dbpqv8");
			add_location(div1, file, 66, 0, 1156);
		},
