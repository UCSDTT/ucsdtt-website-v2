...
function create_if_block_1(ctx) {
	...
	return {
		...
		i: function intro(local) {
			if (!h1_intro) {
				add_render_callback(() => {
					h1_intro = create_in_transition(h1, fade$1, {});
					h1_intro.start();
				});
			}
		},
...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 57, 12, 1179);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal");
			add_location(span, file$1, 60, 12, 1271);
		},
		...
		o: function outro(local) {
			...
			span_outro = create_out_transition(span, fly, {y: -4, duration: 500});
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 55, 4, 1135);
			add_location(section, file$1, 54, 0, 1121);
		},
