...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1fcwu76");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 71, 2, 1401);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-1fcwu76");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 83, 2, 1573);
			attr(div0, "class", "class-img-container svelte-1fcwu76");
			add_location(div0, file, 82, 0, 1537);
			attr(div1, "class", "space-maker svelte-1fcwu76");
			add_location(div1, file, 92, 2, 1731);
			attr(div2, "class", "brother-info");
			add_location(div2, file, 91, 0, 1702);
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handleMouseClick(event) {
	...
	$$self.$$.update = ($$dirty = { my: 1, mx: 1 }) => {
		...
		if ($$dirty.mx) { $$invalidate('picX', picX = `${mx - 95}px`); }
	};
