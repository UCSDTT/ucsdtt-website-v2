...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-m9hrp7");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "class-img svelte-m9hrp7");
