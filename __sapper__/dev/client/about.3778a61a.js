...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-88gbpo");
			add_location(img, file, 82, 8, 1485);
			attr(div, "class", "carousel svelte-88gbpo");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-88gbpo");
			add_location(button0, file, 78, 2, 1339);
			attr(div0, "class", "carousel-wrapper svelte-88gbpo");
			add_location(div0, file, 79, 2, 1399);
			attr(button1, "class", "carousel-button button-right svelte-88gbpo");
			add_location(button1, file, 86, 2, 1593);
			attr(div1, "class", "button-wrapper svelte-88gbpo");
