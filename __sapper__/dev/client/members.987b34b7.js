...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1wmxr1n");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 70, 2, 1381);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-1wmxr1n");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 82, 2, 1553);
			attr(div0, "class", "class-img-container svelte-1wmxr1n");
			add_location(div0, file, 81, 0, 1517);
			add_location(h3, file, 91, 2, 1711);
			attr(div1, "class", "brother-info svelte-1wmxr1n");
			add_location(div1, file, 90, 0, 1682);
