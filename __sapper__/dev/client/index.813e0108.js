...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-qxlz2d");
			add_location(div, file$2, 42, 0, 724);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas");
			add_location(img, file$2, 53, 0, 910);
			add_location(br0, file$2, 60, 0, 1124);
			add_location(br1, file$2, 61, 0, 1130);
			add_location(br2, file$2, 62, 0, 1136);
			add_location(br3, file$2, 63, 0, 1142);
			add_location(br4, file$2, 64, 0, 1148);
			add_location(br5, file$2, 65, 0, 1154);
			add_location(br6, file$2, 66, 0, 1160);
			add_location(br7, file$2, 67, 0, 1166);
			add_location(br8, file$2, 68, 0, 1172);
			add_location(br9, file$2, 69, 0, 1178);
			add_location(br10, file$2, 70, 0, 1184);
			add_location(br11, file$2, 71, 0, 1190);
			add_location(br12, file$2, 72, 0, 1196);
			add_location(br13, file$2, 73, 0, 1202);
			add_location(br14, file$2, 74, 0, 1208);
			add_location(br15, file$2, 75, 0, 1214);
			add_location(br16, file$2, 76, 0, 1220);
			add_location(br17, file$2, 77, 0, 1226);
			add_location(br18, file$2, 78, 0, 1232);
			add_location(br19, file$2, 79, 0, 1238);
			add_location(br20, file$2, 80, 0, 1244);
			add_location(br21, file$2, 81, 0, 1250);
			add_location(br22, file$2, 82, 0, 1256);
			add_location(br23, file$2, 83, 0, 1262);
			add_location(br24, file$2, 84, 0, 1268);
			add_location(br25, file$2, 85, 0, 1274);
			add_location(br26, file$2, 86, 0, 1280);
			add_location(br27, file$2, 87, 0, 1286);
			add_location(br28, file$2, 88, 0, 1292);
			add_location(br29, file$2, 89, 0, 1298);
			add_location(br30, file$2, 90, 0, 1304);
			add_location(br31, file$2, 91, 0, 1310);
			add_location(br32, file$2, 92, 0, 1316);
			add_location(br33, file$2, 93, 0, 1322);
			add_location(br34, file$2, 94, 0, 1328);
			add_location(br35, file$2, 95, 0, 1334);
			add_location(br36, file$2, 96, 0, 1340);
			add_location(br37, file$2, 97, 0, 1346);
			add_location(br38, file$2, 98, 0, 1352);
			add_location(br39, file$2, 99, 0, 1358);
			add_location(br40, file$2, 100, 0, 1364);
			add_location(br41, file$2, 101, 0, 1370);
			add_location(br42, file$2, 102, 0, 1376);
			add_location(br43, file$2, 103, 0, 1382);
			add_location(br44, file$2, 104, 0, 1388);
			add_location(br45, file$2, 105, 0, 1394);
			add_location(br46, file$2, 106, 0, 1400);
			add_location(br47, file$2, 107, 0, 1406);
			add_location(br48, file$2, 108, 0, 1412);
			add_location(br49, file$2, 109, 0, 1418);
			add_location(br50, file$2, 110, 0, 1424);
			add_location(br51, file$2, 111, 0, 1430);
			add_location(br52, file$2, 112, 0, 1436);
			add_location(br53, file$2, 113, 0, 1442);
			add_location(br54, file$2, 114, 0, 1448);
			add_location(br55, file$2, 115, 0, 1454);
			add_location(br56, file$2, 116, 0, 1460);
			add_location(br57, file$2, 117, 0, 1466);
			add_location(br58, file$2, 118, 0, 1472);
			add_location(br59, file$2, 119, 0, 1478);
			add_location(br60, file$2, 120, 0, 1484);
			add_location(br61, file$2, 121, 0, 1490);
			add_location(br62, file$2, 122, 0, 1496);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$2, 123, 14, 1516);
			attr(p, "class", "svelte-qxlz2d");
			add_location(p, file$2, 123, 0, 1502);
		},
