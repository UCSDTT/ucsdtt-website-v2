...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 84, 8, 1545);
			attr(div, "class", "carousel svelte-1ox04ca");
			add_location(div, file, 83, 6, 1514);
		},
