import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, e as element, t as text, a as space, c as claim_element, b as children, d as claim_text, f as detach, g as attr, h as add_location, G as set_style, H as listen, j as insert, k as append, w as set_data, n as noop, I as run_all, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.b5534b6a.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p0, "class", "svelte-1jwsq9j");
			add_location(p0, file, 63, 0, 1228);
			attr(p1, "class", "svelte-1jwsq9j");
			add_location(p1, file, 64, 0, 1243);
			attr(p2, "class", "svelte-1jwsq9j");
			add_location(p2, file, 65, 0, 1258);
			attr(p3, "class", "svelte-1jwsq9j");
			add_location(p3, file, 66, 0, 1273);
			attr(div0, "class", "cursor-box svelte-1jwsq9j");
			set_style(div0, "top", ctx.picY);
			set_style(div0, "left", ctx.picX);
			add_location(div0, file, 70, 0, 1357);
			attr(img, "class", "class-img svelte-1jwsq9j");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 80, 2, 1479);
			attr(div1, "class", "class-img-container svelte-1jwsq9j");
			add_location(div1, file, 79, 0, 1443);
