...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p0, file, 46, 0, 980);
			add_location(p1, file, 47, 0, 995);
			add_location(p2, file, 48, 0, 1010);
			add_location(p3, file, 49, 0, 1025);
			attr(div0, "class", "cursor-box svelte-14mzc5a");
			set_style(div0, "top", (ctx.my - ctx.sy + "px"));
			set_style(div0, "left", (ctx.mx + "px"));
			add_location(div0, file, 51, 0, 1041);
			attr(img, "class", "class-img");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 61, 2, 1178);
			attr(div1, "class", "class-img-container");
			add_location(div1, file, 60, 0, 1142);
