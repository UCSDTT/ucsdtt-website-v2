...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 203, 2, 4619);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-15ieja");
			add_location(select, file, 148, 4, 3359);
			attr(h4, "class", "svelte-15ieja");
			add_location(h4, file, 147, 2, 3325);
			attr(div0, "class", "space-maker svelte-15ieja");
			add_location(div0, file, 158, 2, 3584);
			attr(img, "class", "class-img svelte-15ieja");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 173, 4, 3834);
			attr(div1, "class", "class-img-container svelte-15ieja");
			add_location(div1, file, 172, 2, 3796);
			attr(div2, "class", "brother-info svelte-15ieja");
			add_location(div2, file, 181, 2, 3977);
...
// (150:6) {#each Object.keys(pledgeClasses) as key}
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 150, 8, 3489);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-15ieja");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 161, 4, 3640);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-15ieja");
			add_location(h4, file, 197, 6, 4492);
		},
...
// (185:8) {#if curBrother[key].length !== 0 &&            key !== 'pixelLocationX' &&           key !== 'pixelLocationY' &&           key !== 'city, state, country' &&           key !== 'email' &&           key !== 'last updated' &&           key !== 'what i do' &&           key !== 'phone number'         }
function create_if_block_2(ctx) {
	var h40, strong, t0_value = ctx.key, t0, t1, h41, t2_value = ctx.curBrother[ctx.key], t2;
	...
	return {
		...
		l: function claim(nodes) {
			h40 = claim_element(nodes, "H4", { class: true }, false);
			var h40_nodes = children(h40);

			strong = claim_element(h40_nodes, "STRONG", {}, false);
			...
			h41 = claim_element(nodes, "H4", { class: true }, false);
		...
		h: function hydrate() {
			add_location(strong, file, 193, 14, 4391);
			attr(h40, "class", "svelte-15ieja");
			add_location(h40, file, 193, 10, 4387);
			attr(h41, "class", "svelte-15ieja");
			add_location(h41, file, 193, 42, 4419);
		},
...
// (184:6) {#each Object.keys(curBrother) as key}
