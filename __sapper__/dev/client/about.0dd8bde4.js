...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-yumz93");
			add_location(img, file, 57, 8, 1056);
			attr(div, "class", "carousel svelte-yumz93");
			add_location(div, file, 56, 6, 1025);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-yumz93");
			add_location(div0, file, 54, 2, 970);
			attr(div1, "class", "button-wrapper");
			add_location(div1, file, 53, 0, 939);
		},
