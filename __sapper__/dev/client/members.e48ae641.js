...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 197, 2, 4523);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-1kt62qn");
			add_location(select, file, 142, 4, 3288);
			attr(h4, "class", "svelte-1kt62qn");
			add_location(h4, file, 141, 2, 3254);
			attr(div0, "class", "space-maker svelte-1kt62qn");
			add_location(div0, file, 152, 2, 3513);
			attr(img, "class", "class-img svelte-1kt62qn");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 167, 4, 3763);
			attr(div1, "class", "class-img-container svelte-1kt62qn");
			add_location(div1, file, 166, 2, 3725);
			attr(div2, "class", "brother-info svelte-1kt62qn");
			add_location(div2, file, 175, 2, 3906);
...
// (144:6) {#each Object.keys(pledgeClasses) as key}
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 144, 8, 3418);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1kt62qn");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 155, 4, 3569);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-1kt62qn");
			add_location(h4, file, 191, 6, 4396);
		},
...
// (179:8) {#if curBrother[key].length !== 0 &&            key !== 'pixelLocationX' &&           key !== 'pixelLocationY' &&           key !== 'city, state, country' &&           key !== 'email' &&           key !== 'last updated' &&           key !== 'what i do' &&           key !== 'phone number'         }
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-1kt62qn");
			add_location(h4, file, 187, 10, 4316);
		},
...
// (178:6) {#each Object.keys(curBrother) as key}
