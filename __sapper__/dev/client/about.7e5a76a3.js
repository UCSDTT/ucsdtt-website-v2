...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-168xgi");
			add_location(img, file, 62, 8, 1132);
			attr(div, "class", "carousel svelte-168xgi");
			add_location(div, file, 61, 6, 1101);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(button0, file, 58, 2, 1022);
			attr(div0, "class", "carousel-wrapper svelte-168xgi");
			add_location(div0, file, 59, 2, 1046);
			add_location(button1, file, 66, 2, 1240);
			attr(div1, "class", "button-wrapper svelte-168xgi");
			add_location(div1, file, 57, 0, 991);
		},
