...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-14epqfe");
			add_location(img0, file$2, 47, 8, 912);
			attr(span0, "class", "svelte-14epqfe");
			add_location(span0, file$2, 47, 55, 959);
			attr(li0, "class", "svelte-14epqfe");
			add_location(li0, file$2, 47, 4, 908);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-14epqfe");
			add_location(img1, file$2, 48, 8, 997);
			attr(span1, "class", "svelte-14epqfe");
			add_location(span1, file$2, 48, 55, 1044);
			attr(li1, "class", "svelte-14epqfe");
			add_location(li1, file$2, 48, 4, 993);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-14epqfe");
			add_location(img2, file$2, 49, 8, 1083);
			attr(span2, "class", "svelte-14epqfe");
			add_location(span2, file$2, 49, 55, 1130);
			attr(li2, "class", "svelte-14epqfe");
			add_location(li2, file$2, 49, 4, 1079);
			attr(ul, "class", "pillared svelte-14epqfe");
			add_location(ul, file$2, 46, 0, 882);
		},
