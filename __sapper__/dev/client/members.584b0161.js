...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-et4vui");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 71, 2, 1402);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-et4vui");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 83, 2, 1574);
			attr(div0, "class", "class-img-container svelte-et4vui");
			add_location(div0, file, 82, 0, 1538);
			attr(div1, "class", "space-maker svelte-et4vui");
			add_location(div1, file, 92, 2, 1732);
			attr(div2, "class", "brother-info");
			add_location(div2, file, 91, 0, 1703);
