...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-6d6l");
			add_location(img, file, 80, 8, 1435);
			attr(div, "class", "carousel svelte-6d6l");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-6d6l");
			add_location(button0, file, 76, 2, 1289);
			attr(div0, "class", "carousel-wrapper svelte-6d6l");
			add_location(div0, file, 77, 2, 1349);
			attr(button1, "class", "carousel-button button-right svelte-6d6l");
			add_location(button1, file, 84, 2, 1543);
			attr(div1, "class", "button-wrapper svelte-6d6l");
