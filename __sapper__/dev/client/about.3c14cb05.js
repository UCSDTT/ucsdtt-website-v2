...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 48, 0, 801);
			add_location(h3, file, 50, 0, 817);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-oe20qm");
			add_location(img0, file, 54, 4, 927);
			attr(h40, "class", "svelte-oe20qm");
			add_location(h40, file, 55, 4, 975);
			add_location(p0, file, 56, 4, 1000);
			attr(div0, "class", "pillar svelte-oe20qm");
			add_location(div0, file, 53, 2, 902);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-oe20qm");
			add_location(img1, file, 64, 4, 1336);
			attr(h41, "class", "svelte-oe20qm");
			add_location(h41, file, 65, 4, 1384);
			add_location(p1, file, 66, 4, 1410);
			attr(div1, "class", "pillar svelte-oe20qm");
			add_location(div1, file, 63, 2, 1311);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-oe20qm");
			add_location(img2, file, 75, 4, 1773);
			attr(h42, "class", "svelte-oe20qm");
			add_location(h42, file, 76, 4, 1821);
			add_location(p2, file, 77, 4, 1850);
			attr(div2, "class", "pillar svelte-oe20qm");
			add_location(div2, file, 74, 2, 1748);
			attr(div3, "class", "pillars svelte-oe20qm");
			add_location(div3, file, 52, 0, 878);
		},
