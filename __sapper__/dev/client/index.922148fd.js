...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(li0, file$3, 101, 12, 2430);
			attr(li1, "class", "modal-li svelte-1teh65m");
			add_location(li1, file$3, 102, 12, 2480);
			attr(li2, "class", "modal-li svelte-1teh65m");
			add_location(li2, file$3, 103, 12, 2530);
			attr(li3, "class", "modal-li svelte-1teh65m");
			add_location(li3, file$3, 104, 12, 2580);
			attr(li4, "class", "modal-li svelte-1teh65m");
			add_location(li4, file$3, 105, 12, 2630);
			add_location(ul, file$3, 100, 8, 2413);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 107, 8, 2690);
		},
