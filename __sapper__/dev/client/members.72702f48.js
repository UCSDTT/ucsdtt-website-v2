...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-sypunp");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "class-img svelte-sypunp");
