...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(section, file$1, 25, 0, 352);
			add_location(br0, file$1, 39, 0, 666);
			add_location(br1, file$1, 40, 0, 672);
			add_location(br2, file$1, 41, 0, 678);
			add_location(br3, file$1, 42, 0, 684);
			add_location(br4, file$1, 43, 0, 690);
			add_location(br5, file$1, 44, 0, 696);
			add_location(br6, file$1, 45, 0, 702);
			add_location(br7, file$1, 46, 0, 708);
			add_location(br8, file$1, 47, 0, 714);
			add_location(br9, file$1, 48, 0, 720);
			add_location(br10, file$1, 49, 0, 726);
			add_location(br11, file$1, 50, 0, 732);
			add_location(br12, file$1, 51, 0, 738);
			add_location(br13, file$1, 52, 0, 744);
			add_location(br14, file$1, 53, 0, 750);
			add_location(br15, file$1, 54, 0, 756);
			add_location(br16, file$1, 55, 0, 762);
			add_location(br17, file$1, 56, 0, 768);
			add_location(br18, file$1, 57, 0, 774);
			add_location(br19, file$1, 58, 0, 780);
			add_location(br20, file$1, 59, 0, 786);
			add_location(br21, file$1, 60, 0, 792);
			add_location(br22, file$1, 61, 0, 798);
			add_location(br23, file$1, 62, 0, 804);
			add_location(br24, file$1, 63, 0, 810);
			add_location(br25, file$1, 64, 0, 816);
			add_location(br26, file$1, 65, 0, 822);
			add_location(br27, file$1, 66, 0, 828);
			add_location(br28, file$1, 67, 0, 834);
			add_location(br29, file$1, 68, 0, 840);
			add_location(br30, file$1, 69, 0, 846);
			add_location(br31, file$1, 70, 0, 852);
			add_location(br32, file$1, 71, 0, 858);
			add_location(br33, file$1, 72, 0, 864);
			add_location(br34, file$1, 73, 0, 870);
			add_location(br35, file$1, 74, 0, 876);
			add_location(br36, file$1, 75, 0, 882);
			add_location(br37, file$1, 76, 0, 888);
			add_location(br38, file$1, 77, 0, 894);
			add_location(br39, file$1, 78, 0, 900);
			add_location(br40, file$1, 79, 0, 906);
			add_location(br41, file$1, 80, 0, 912);
			add_location(br42, file$1, 81, 0, 918);
			add_location(br43, file$1, 82, 0, 924);
			add_location(br44, file$1, 83, 0, 930);
			add_location(br45, file$1, 84, 0, 936);
			add_location(br46, file$1, 85, 0, 942);
			add_location(br47, file$1, 86, 0, 948);
			add_location(br48, file$1, 87, 0, 954);
			add_location(br49, file$1, 88, 0, 960);
			add_location(br50, file$1, 89, 0, 966);
			add_location(br51, file$1, 90, 0, 972);
			add_location(br52, file$1, 91, 0, 978);
			add_location(br53, file$1, 92, 0, 984);
			add_location(br54, file$1, 93, 0, 990);
			add_location(br55, file$1, 94, 0, 996);
			add_location(br56, file$1, 95, 0, 1002);
			add_location(br57, file$1, 96, 0, 1008);
			add_location(br58, file$1, 97, 0, 1014);
			add_location(br59, file$1, 98, 0, 1020);
			add_location(br60, file$1, 99, 0, 1026);
			add_location(br61, file$1, 100, 0, 1032);
			add_location(br62, file$1, 101, 0, 1038);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$1, 102, 14, 1058);
			attr(p, "class", "svelte-sazog6");
			add_location(p, file$1, 102, 0, 1044);
		},
