...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 40, 0, 669);
			add_location(h3, file, 42, 0, 685);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-1furuv0");
			add_location(img0, file, 46, 4, 795);
			add_location(h40, file, 47, 4, 843);
			add_location(p0, file, 48, 4, 868);
			attr(div0, "class", "pillar svelte-1furuv0");
			add_location(div0, file, 45, 2, 770);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1furuv0");
			add_location(img1, file, 56, 4, 1204);
			add_location(h41, file, 57, 4, 1252);
			add_location(p1, file, 58, 4, 1278);
			attr(div1, "class", "pillar svelte-1furuv0");
			add_location(div1, file, 55, 2, 1179);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1furuv0");
			add_location(img2, file, 67, 4, 1641);
			add_location(h42, file, 68, 4, 1689);
			add_location(p2, file, 69, 4, 1718);
			attr(div2, "class", "pillar svelte-1furuv0");
			add_location(div2, file, 66, 2, 1616);
			attr(div3, "class", "pillars svelte-1furuv0");
			add_location(div3, file, 44, 0, 746);
		},
