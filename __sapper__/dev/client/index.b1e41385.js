...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 71, 12, 1621);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal");
			add_location(span, file$1, 74, 12, 1713);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 69, 4, 1577);
			add_location(section, file$1, 68, 0, 1563);
		},
