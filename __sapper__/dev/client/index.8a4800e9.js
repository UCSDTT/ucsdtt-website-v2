...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 73, 12, 1706);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal");
			add_location(span, file$1, 76, 12, 1798);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 71, 4, 1662);
			add_location(section, file$1, 70, 0, 1648);
		},
...
function instance$1($$self, $$props, $$invalidate) {
    ...
    function pickNextIndex(curIndex) {
        ...
        if (unusedWordIndices.size === 0) {
            unusedWordIndices = new Set(indices);
        }
        let setIndex = Math.floor(Math.random() * unusedWordIndices.size);
        console.log(unusedWordIndices[setIndex]);
        return unusedWordIndices.values[setIndex];
    }
