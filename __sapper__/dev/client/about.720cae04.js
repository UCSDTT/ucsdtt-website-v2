...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 46, 0, 769);
			add_location(h3, file, 48, 0, 785);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-1y384ce");
			add_location(img0, file, 52, 4, 895);
			attr(h40, "class", "svelte-1y384ce");
			add_location(h40, file, 53, 4, 943);
			add_location(p0, file, 54, 4, 968);
			attr(div0, "class", "pillar svelte-1y384ce");
			add_location(div0, file, 51, 2, 870);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1y384ce");
			add_location(img1, file, 62, 4, 1304);
			attr(h41, "class", "svelte-1y384ce");
			add_location(h41, file, 63, 4, 1352);
			add_location(p1, file, 64, 4, 1378);
			attr(div1, "class", "pillar svelte-1y384ce");
			add_location(div1, file, 61, 2, 1279);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1y384ce");
			add_location(img2, file, 73, 4, 1741);
			attr(h42, "class", "svelte-1y384ce");
			add_location(h42, file, 74, 4, 1789);
			add_location(p2, file, 75, 4, 1818);
			attr(div2, "class", "pillar svelte-1y384ce");
			add_location(div2, file, 72, 2, 1716);
			attr(div3, "class", "pillars svelte-1y384ce");
			add_location(div3, file, 50, 0, 846);
		},
