...
function create_header_slot_2(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			h2 = claim_element(nodes, "H2", { slot: true }, false);
...
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(ul, "class", "modal-li svelte-1swkb6t");
			add_location(ul, file$3, 76, 8, 1673);
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(ul, "class", "modal-li svelte-1swkb6t");
			add_location(ul, file$3, 90, 8, 2170);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(ul, "class", "modal-li svelte-1swkb6t");
			add_location(ul, file$3, 104, 8, 2668);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
