...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 120, 8, 2342);
			attr(div, "class", "carousel svelte-smhls4");
			add_location(div, file, 119, 6, 2311);
		},
