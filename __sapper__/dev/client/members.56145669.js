...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 72, 2, 1404);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(p0, file, 64, 0, 1256);
			attr(p1, "class", "svelte-y96gx0");
			add_location(p1, file, 65, 0, 1271);
			attr(p2, "class", "svelte-y96gx0");
			add_location(p2, file, 66, 0, 1286);
			attr(p3, "class", "svelte-y96gx0");
			add_location(p3, file, 67, 0, 1301);
			...
			add_location(img, file, 83, 2, 1544);
			attr(div, "class", "class-img-container svelte-y96gx0");
			add_location(div, file, 82, 0, 1508);
