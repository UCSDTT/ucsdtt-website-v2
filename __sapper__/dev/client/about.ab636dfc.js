...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-14qunv8");
			add_location(img, file, 58, 6, 1134);
			attr(div, "class", "carousel svelte-14qunv8");
			add_location(div, file, 57, 4, 1105);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-14qunv8");
			add_location(div, file, 55, 0, 1054);
		},
