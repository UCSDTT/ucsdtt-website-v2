import { S as SvelteComponentDev, i as init, s as safe_not_equal, v as globals, e as element, t as text, a as space, c as claim_element, b as children, d as claim_text, f as detach, h as add_location, g as attr, H as listen, j as insert, k as append, n as noop, I as run_all, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.b5534b6a.js';
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 84, 4, 1934);
			attr(div0, "class", "class-img-container svelte-rw9xld");
			add_location(div0, file, 83, 2, 1896);
			attr(div1, "class", "pledge-classes");
			add_location(div1, file, 82, 0, 1865);

			dispose = [
				listen(button, "click", ctx.toggleVisible),
				listen(img, "click", zoom)
			];
		},
...
function instance($$self, $$props, $$invalidate) {
  ...
  function toggleVisible() {
	...
	return { pledgeClasses, curClass, toggleVisible };
}
