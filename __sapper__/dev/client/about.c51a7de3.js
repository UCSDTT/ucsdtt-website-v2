...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img1, file, 39, 2, 719);
			attr(div1, "class", "pillar svelte-1h7e6kf");
			add_location(div1, file, 38, 1, 696);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			add_location(img2, file, 42, 2, 793);
			attr(div2, "class", "pillar svelte-1h7e6kf");
			add_location(div2, file, 41, 1, 770);
