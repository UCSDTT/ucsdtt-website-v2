...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-djia3q");
			add_location(h1, file, 32, 2, 768);
			attr(p0, "class", "svelte-djia3q");
			add_location(p0, file, 33, 2, 823);
			add_location(strong0, file, 41, 4, 1126);
			attr(p1, "class", "svelte-djia3q");
			add_location(p1, file, 39, 2, 1076);
			add_location(strong1, file, 47, 4, 1357);
			add_location(strong2, file, 48, 4, 1391);
			add_location(strong3, file, 49, 4, 1426);
			add_location(strong4, file, 50, 4, 1466);
			add_location(strong5, file, 51, 4, 1499);
			add_location(strong6, file, 52, 4, 1531);
			add_location(strong7, file, 53, 4, 1563);
			add_location(strong8, file, 54, 4, 1595);
			add_location(strong9, file, 55, 4, 1626);
			add_location(strong10, file, 56, 4, 1664);
			add_location(strong11, file, 57, 4, 1717);
			add_location(strong12, file, 58, 4, 1751);
			add_location(strong13, file, 59, 8, 1788);
			attr(p2, "class", "svelte-djia3q");
			add_location(p2, file, 46, 2, 1349);
			add_location(strong14, file, 63, 4, 1894);
			add_location(strong15, file, 64, 4, 1941);
			attr(p3, "class", "svelte-djia3q");
			add_location(p3, file, 61, 2, 1831);
			attr(img, "src", "images/founders.jpg");
			attr(img, "alt", "the mighty founders");
			attr(img, "class", "svelte-djia3q");
			add_location(img, file, 66, 2, 1978);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-djia3q");
			add_location(div, file, 31, 0, 748);
		},
