...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 54, 0, 892);
			add_location(h3, file, 56, 0, 908);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-mgcmkh");
			add_location(img0, file, 60, 4, 1018);
			attr(h40, "class", "svelte-mgcmkh");
			add_location(h40, file, 61, 4, 1066);
			add_location(p0, file, 62, 4, 1091);
			attr(div0, "class", "pillar svelte-mgcmkh");
			add_location(div0, file, 59, 2, 993);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-mgcmkh");
			add_location(img1, file, 70, 4, 1427);
			attr(h41, "class", "svelte-mgcmkh");
			add_location(h41, file, 71, 4, 1475);
			add_location(p1, file, 72, 4, 1501);
			attr(div1, "class", "pillar svelte-mgcmkh");
			add_location(div1, file, 69, 2, 1402);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-mgcmkh");
			add_location(img2, file, 81, 4, 1864);
			attr(h42, "class", "svelte-mgcmkh");
			add_location(h42, file, 82, 4, 1912);
			add_location(p2, file, 83, 4, 1941);
			attr(div2, "class", "pillar svelte-mgcmkh");
			add_location(div2, file, 80, 2, 1839);
			attr(div3, "class", "pillars svelte-mgcmkh");
			add_location(div3, file, 58, 0, 969);
		},
