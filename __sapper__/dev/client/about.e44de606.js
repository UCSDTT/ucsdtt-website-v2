...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1accrw6");
			add_location(img, file, 51, 6, 984);
			attr(div, "class", "carousel svelte-1accrw6");
			add_location(div, file, 50, 4, 955);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-1accrw6");
			add_location(div, file, 48, 0, 904);
		},
