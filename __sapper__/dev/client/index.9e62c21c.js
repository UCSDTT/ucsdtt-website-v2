...
function create_default_slot_2(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t = claim_text(h1_nodes, "Brotherhood");
			h1_nodes.forEach(detach);
			this.h();
		},

		h: function hydrate() {
			add_location(h1, file$3, 69, 8, 1536);
		},
...
// (75:4) <Modal on:close="{() => philVis = false}">
function create_default_slot_1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t = claim_text(h1_nodes, "Philanthropy");
			h1_nodes.forEach(detach);
			this.h();
		},

		h: function hydrate() {
			add_location(h1, file$3, 75, 8, 1646);
		},
...
// (81:4) <Modal on:close="{() => proVis = false}">
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t = claim_text(h1_nodes, "Professionalism");
			h1_nodes.forEach(detach);
			this.h();
		},

		h: function hydrate() {
			add_location(h1, file$3, 81, 8, 1755);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img0, file$3, 54, 8, 1056);
			...
			add_location(img1, file$3, 58, 8, 1195);
			...
			add_location(img2, file$3, 62, 8, 1336);
			...
			dispose = [
				listen(img0, "click", ctx.click_handler),
				listen(img1, "click", ctx.click_handler_1),
				listen(img2, "click", ctx.click_handler_2)
			];
		},
