...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-nokwq0");
			add_location(div0, file$2, 55, 0, 953);

			attr(button, "class", "svelte-nokwq0");
			add_location(button, file$2, 60, 8, 1119);
			attr(section, "class", "header svelte-nokwq0");
			add_location(section, file$2, 58, 4, 1052);
			add_location(hr0, file$2, 62, 1, 1191);

			add_location(hr1, file$2, 64, 1, 1212);
			attr(div1, "class", "modal svelte-nokwq0");
			add_location(div1, file$2, 57, 0, 1028);
