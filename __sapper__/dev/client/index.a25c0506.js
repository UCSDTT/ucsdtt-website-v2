...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "text-display lg-view svelte-thirwy");
			add_location(h1, file, 54, 1, 891);
		},
