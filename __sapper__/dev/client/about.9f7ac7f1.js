...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 41, 0, 695);
			add_location(h3, file, 43, 0, 711);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-4bqeon");
			add_location(img0, file, 47, 4, 821);
			add_location(h40, file, 48, 4, 869);
			add_location(p0, file, 49, 4, 894);
			attr(div0, "class", "pillar svelte-4bqeon");
			add_location(div0, file, 46, 2, 796);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-4bqeon");
			add_location(img1, file, 57, 4, 1230);
			add_location(h41, file, 58, 4, 1278);
			add_location(p1, file, 59, 4, 1304);
			attr(div1, "class", "pillar svelte-4bqeon");
			add_location(div1, file, 56, 2, 1205);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-4bqeon");
			add_location(img2, file, 68, 4, 1667);
			add_location(h42, file, 69, 4, 1715);
			add_location(p2, file, 70, 4, 1744);
			attr(div2, "class", "pillar svelte-4bqeon");
			add_location(div2, file, 67, 2, 1642);
			attr(div3, "class", "pillars svelte-4bqeon");
			add_location(div3, file, 45, 0, 772);
		},
