...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 212, 2, 4741);
		},
...
function create_if_block(ctx) {
	var h4, t0, select, t1, div0, t2, t3, div1, img, img_src_value, img_alt_value, t4, div2, dispose;
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-1x4j4tb");
			add_location(select, file, 156, 4, 3461);
			attr(h4, "class", "svelte-1x4j4tb");
			add_location(h4, file, 155, 2, 3445);
			attr(div0, "class", "space-maker svelte-1x4j4tb");
			add_location(div0, file, 166, 2, 3686);
			attr(img, "class", "class-img svelte-1x4j4tb");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 181, 4, 3936);
			attr(div1, "class", "class-img-container svelte-1x4j4tb");
			add_location(div1, file, 180, 2, 3898);
			attr(div2, "class", "brother-info svelte-1x4j4tb");
			add_location(div2, file, 189, 2, 4079);
...
// (158:6) {#each Object.keys(pledgeClasses) as key}
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 158, 8, 3591);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1x4j4tb");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 169, 4, 3742);
...
function create_else_block(ctx) {
	...
	return {
		c: function create() {
			...
			t1 = space();
			h4 = element("h4");
			t2 = text("Click on a brother (from the class) to see more information.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t2 = claim_text(h4_nodes, "Click on a brother (from the class) to see more information.");
			h4_nodes.forEach(detach);
			this.h();
		},

		h: function hydrate() {
			add_location(h3, file, 205, 6, 4597);
			attr(h4, "class", "svelte-1x4j4tb");
			add_location(h4, file, 206, 6, 4616);
		},
...
// (193:8) {#if curBrother[key].length !== 0 &&            key !== 'pixelLocationX' &&           key !== 'pixelLocationY' &&           key !== 'city, state, country' &&           key !== 'email' &&           key !== 'last updated' &&           key !== 'what i do' &&           key !== 'phone number'         }
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h5, "class", "brother-key svelte-1x4j4tb");
			add_location(h5, file, 201, 10, 4489);
			attr(h4, "class", "svelte-1x4j4tb");
			add_location(h4, file, 201, 45, 4524);
		},
...
// (192:6) {#each Object.keys(curBrother) as key}
