...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 99, 12, 2388);
			add_location(li1, file$3, 100, 12, 2421);
			add_location(li2, file$3, 101, 12, 2454);
			add_location(li3, file$3, 102, 12, 2487);
			add_location(li4, file$3, 103, 12, 2520);
			add_location(ul, file$3, 98, 8, 2371);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 105, 8, 2563);
		},
