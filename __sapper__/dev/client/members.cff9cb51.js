...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 211, 2, 4722);
		},
...
function create_else_block(ctx) {
	...
	return {
		c: function create() {
			h4 = element("h4");
			t = text("Click on a brother (from the class) to see more information.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t = claim_text(h4_nodes, "Click on a brother (from the class) to see more information.");
			h4_nodes.forEach(detach);
			this.h();
		},
