...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h30, file, 36, 0, 571);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-1vi9t3z");
			add_location(img0, file, 40, 2, 678);
			add_location(h31, file, 41, 2, 722);
			attr(div0, "class", "pillar svelte-1vi9t3z");
			add_location(div0, file, 39, 1, 655);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1vi9t3z");
			add_location(img1, file, 44, 2, 775);
			add_location(h32, file, 45, 2, 819);
			attr(div1, "class", "pillar svelte-1vi9t3z");
			add_location(div1, file, 43, 1, 752);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1vi9t3z");
			add_location(img2, file, 48, 2, 873);
			add_location(h33, file, 49, 2, 917);
			attr(div2, "class", "pillar svelte-1vi9t3z");
			add_location(div2, file, 47, 1, 850);
			attr(div3, "class", "pillars svelte-1vi9t3z");
			add_location(div3, file, 38, 0, 632);
		},
