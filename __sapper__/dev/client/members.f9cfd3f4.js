...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 196, 2, 4487);
		},
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-1kt62qn");
			add_location(h4, file, 190, 6, 4360);
		},
...
// (179:8) {#if curBrother[key].length !== 0 &&            key !== 'pixelLocationX' &&           key !== 'pixelLocationY' &&           key !== 'city, state, country' &&           key !== 'email' &&           key !== 'last updated' &&           key !== 'what i do'         }
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-1kt62qn");
			add_location(h4, file, 186, 10, 4280);
		},
