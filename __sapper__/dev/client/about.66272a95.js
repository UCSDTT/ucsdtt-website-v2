...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-enxnq");
			add_location(img, file, 59, 6, 1156);
			attr(div, "class", "carousel svelte-enxnq");
			add_location(div, file, 58, 4, 1127);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-enxnq");
			add_location(div, file, 56, 0, 1076);
		},
