...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-zz3f8w");
			add_location(select, file, 152, 4, 3400);
			attr(h4, "class", "svelte-zz3f8w");
			add_location(h4, file, 151, 2, 3366);
			attr(div0, "class", "space-maker svelte-zz3f8w");
			add_location(div0, file, 162, 2, 3625);
			attr(img, "class", "class-img svelte-zz3f8w");
			...
			attr(div1, "class", "class-img-container svelte-zz3f8w");
			add_location(div1, file, 176, 2, 3837);
			attr(div2, "class", "brother-info svelte-zz3f8w");
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-zz3f8w");
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h5, "class", "brother-key svelte-zz3f8w");
