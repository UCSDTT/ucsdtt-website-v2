...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-qha24p");
			add_location(img, file, 58, 6, 1121);
			attr(div, "class", "carousel svelte-qha24p");
			add_location(div, file, 57, 4, 1092);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-qha24p");
			add_location(div, file, 55, 0, 1041);
		},
