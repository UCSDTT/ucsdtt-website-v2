...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1pvuu28");
			add_location(img, file, 64, 8, 1182);
			attr(div, "class", "carousel svelte-1pvuu28");
			add_location(div, file, 63, 6, 1151);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(button0, file, 60, 2, 1072);
			attr(div0, "class", "carousel-wrapper svelte-1pvuu28");
			add_location(div0, file, 61, 2, 1096);
			add_location(button1, file, 68, 2, 1290);
			attr(div1, "class", "button-wrapper svelte-1pvuu28");
			add_location(div1, file, 59, 0, 1041);
		},
