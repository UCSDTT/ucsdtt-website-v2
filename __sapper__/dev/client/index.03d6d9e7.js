...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(br0, file$1, 42, 0, 728);
			add_location(br1, file$1, 43, 0, 734);
			add_location(br2, file$1, 44, 0, 740);
			add_location(br3, file$1, 45, 0, 746);
			add_location(br4, file$1, 46, 0, 752);
			add_location(br5, file$1, 47, 0, 758);
			add_location(br6, file$1, 48, 0, 764);
			add_location(br7, file$1, 49, 0, 770);
			add_location(br8, file$1, 50, 0, 776);
			add_location(br9, file$1, 51, 0, 782);
			add_location(br10, file$1, 52, 0, 788);
			add_location(br11, file$1, 53, 0, 794);
			add_location(br12, file$1, 54, 0, 800);
			add_location(br13, file$1, 55, 0, 806);
			add_location(br14, file$1, 56, 0, 812);
			add_location(br15, file$1, 57, 0, 818);
			add_location(br16, file$1, 58, 0, 824);
			add_location(br17, file$1, 59, 0, 830);
			add_location(br18, file$1, 60, 0, 836);
			add_location(br19, file$1, 61, 0, 842);
			add_location(br20, file$1, 62, 0, 848);
			add_location(br21, file$1, 63, 0, 854);
			add_location(br22, file$1, 64, 0, 860);
			add_location(br23, file$1, 65, 0, 866);
			add_location(br24, file$1, 66, 0, 872);
			add_location(br25, file$1, 67, 0, 878);
			add_location(br26, file$1, 68, 0, 884);
			add_location(br27, file$1, 69, 0, 890);
			add_location(br28, file$1, 70, 0, 896);
			add_location(br29, file$1, 71, 0, 902);
			add_location(br30, file$1, 72, 0, 908);
			add_location(br31, file$1, 73, 0, 914);
			add_location(br32, file$1, 74, 0, 920);
			add_location(br33, file$1, 75, 0, 926);
			add_location(br34, file$1, 76, 0, 932);
			add_location(br35, file$1, 77, 0, 938);
			add_location(br36, file$1, 78, 0, 944);
			add_location(br37, file$1, 79, 0, 950);
			add_location(br38, file$1, 80, 0, 956);
			add_location(br39, file$1, 81, 0, 962);
			add_location(br40, file$1, 82, 0, 968);
			add_location(br41, file$1, 83, 0, 974);
			add_location(br42, file$1, 84, 0, 980);
			add_location(br43, file$1, 85, 0, 986);
			add_location(br44, file$1, 86, 0, 992);
			add_location(br45, file$1, 87, 0, 998);
			add_location(br46, file$1, 88, 0, 1004);
			add_location(br47, file$1, 89, 0, 1010);
			add_location(br48, file$1, 90, 0, 1016);
			add_location(br49, file$1, 91, 0, 1022);
			add_location(br50, file$1, 92, 0, 1028);
			add_location(br51, file$1, 93, 0, 1034);
			add_location(br52, file$1, 94, 0, 1040);
			add_location(br53, file$1, 95, 0, 1046);
			add_location(br54, file$1, 96, 0, 1052);
			add_location(br55, file$1, 97, 0, 1058);
			add_location(br56, file$1, 98, 0, 1064);
			add_location(br57, file$1, 99, 0, 1070);
			add_location(br58, file$1, 100, 0, 1076);
			add_location(br59, file$1, 101, 0, 1082);
			add_location(br60, file$1, 102, 0, 1088);
			add_location(br61, file$1, 103, 0, 1094);
			add_location(br62, file$1, 104, 0, 1100);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$1, 105, 14, 1120);
			attr(p, "class", "svelte-sazog6");
			add_location(p, file$1, 105, 0, 1106);
		},
