...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-18yw3ul");
			add_location(img0, file$2, 34, 8, 653);
			attr(span0, "class", "svelte-18yw3ul");
			add_location(span0, file$2, 34, 55, 700);
			attr(li0, "class", "svelte-18yw3ul");
			add_location(li0, file$2, 34, 4, 649);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-18yw3ul");
			add_location(img1, file$2, 35, 8, 738);
			attr(span1, "class", "svelte-18yw3ul");
			add_location(span1, file$2, 35, 55, 785);
			attr(li1, "class", "svelte-18yw3ul");
			add_location(li1, file$2, 35, 4, 734);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-18yw3ul");
			add_location(img2, file$2, 36, 8, 824);
			attr(span2, "class", "svelte-18yw3ul");
			add_location(span2, file$2, 36, 55, 871);
			attr(li2, "class", "svelte-18yw3ul");
			add_location(li2, file$2, 36, 4, 820);
			attr(ul, "class", "pillared svelte-18yw3ul");
			add_location(ul, file$2, 33, 0, 623);
		},
