...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-6s191e");
			add_location(div0, file$2, 36, 0, 596);

			add_location(hr0, file$2, 40, 1, 721);

			add_location(hr1, file$2, 42, 1, 742);
			attr(button, "class", "svelte-6s191e");
			add_location(button, file$2, 44, 1, 749);
			attr(div1, "class", "modal svelte-6s191e");
			add_location(div1, file$2, 38, 0, 671);
...
// (62:4) <Modal on:close="{() => broVis = false}">
...
// (68:4) <Modal on:close="{() => hilVis = false}">
...
// (74:4) <Modal on:close="{() => rofVis = false}">
...
function create_fragment$3(ctx) {
	var ul, li0, img0, span0, t0, t1, li1, img1, span1, t2, t3, li2, img2, span2, t4, t5, t6, t7, if_block2_anchor, current;

	var if_block0 = (broVis) && create_if_block_2(ctx);

	var if_block1 = (philVis) && create_if_block_1$2(ctx);

	var if_block2 = (profVis) && create_if_block$2(ctx);
	...
	return {
		c: function create() {
			...
			img1 = element("img");
			span1 = element("span");
			t2 = text("Philanthropy");
			t3 = space();
			li2 = element("li");
			img2 = element("img");
			span2 = element("span");
			t4 = text("Professionalism");
			t5 = space();
			if (if_block0) if_block0.c();
			t6 = space();
			if (if_block1) if_block1.c();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(span0_nodes, "Brotherhood");
			...
			t2 = claim_text(span1_nodes, "Philanthropy");
			...
			t4 = claim_text(span2_nodes, "Professionalism");
...
function instance$3($$self, $$props, $$invalidate) {
	...
	function close_handler_1() {
		const $$result = hilVis = false;
		$$invalidate('hilVis', hilVis);
		return $$result;
	}

	function close_handler_2() {
		const $$result = rofVis = false;
		$$invalidate('rofVis', rofVis);
		return $$result;
	}
