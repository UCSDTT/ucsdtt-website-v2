...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 203, 2, 4618);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-zxoojv");
			add_location(select, file, 148, 4, 3358);
			attr(h4, "class", "svelte-zxoojv");
			add_location(h4, file, 147, 2, 3324);
			attr(div0, "class", "space-maker svelte-zxoojv");
			add_location(div0, file, 158, 2, 3583);
			attr(img, "class", "class-img svelte-zxoojv");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 173, 4, 3833);
			attr(div1, "class", "class-img-container svelte-zxoojv");
			add_location(div1, file, 172, 2, 3795);
			attr(div2, "class", "brother-info svelte-zxoojv");
			add_location(div2, file, 181, 2, 3976);
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 150, 8, 3488);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-zxoojv");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 161, 4, 3639);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-zxoojv");
			add_location(h4, file, 197, 6, 4491);
		},
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong, file, 193, 14, 4390);
			add_location(h5, file, 193, 10, 4386);
			attr(h4, "class", "svelte-zxoojv");
			add_location(h4, file, 193, 42, 4418);
		},
