...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 59, 0, 968);
			add_location(h3, file, 61, 0, 984);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-nlunra");
			add_location(img0, file, 65, 4, 1094);
			attr(h40, "class", "svelte-nlunra");
			add_location(h40, file, 66, 4, 1142);
			add_location(p0, file, 67, 4, 1167);
			attr(div0, "class", "pillar svelte-nlunra");
			add_location(div0, file, 64, 2, 1069);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-nlunra");
			add_location(img1, file, 75, 4, 1503);
			attr(h41, "class", "svelte-nlunra");
			add_location(h41, file, 76, 4, 1551);
			add_location(p1, file, 77, 4, 1577);
			attr(div1, "class", "pillar svelte-nlunra");
			add_location(div1, file, 74, 2, 1478);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-nlunra");
			add_location(img2, file, 86, 4, 1940);
			attr(h42, "class", "svelte-nlunra");
			add_location(h42, file, 87, 4, 1988);
			add_location(p2, file, 88, 4, 2017);
			attr(div2, "class", "pillar svelte-nlunra");
			add_location(div2, file, 85, 2, 1915);
			attr(div3, "class", "pillars svelte-nlunra");
			add_location(div3, file, 63, 0, 1045);
		},
