import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, e as element, c as claim_element, b as children, f as detach, g as attr, h as add_location, j as insert, t as text, a as space, d as claim_text, H as listen, k as append, n as noop, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.86736f05.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			img = claim_element(nodes, "IMG", { id: true, src: true, alt: true, class: true }, false);
		...
		h: function hydrate() {
			attr(img, "id", "founders");
			attr(img, "src", "images/founders.jpg");
			attr(img, "alt", "the mighty founders");
			attr(img, "class", "svelte-1wopt9k");
			add_location(img, file, 79, 4, 2161);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-1wopt9k");
			add_location(h1, file, 44, 2, 932);
			attr(p0, "class", "svelte-1wopt9k");
			add_location(p0, file, 45, 2, 987);
			add_location(strong0, file, 52, 4, 1248);
			attr(p1, "class", "svelte-1wopt9k");
			add_location(p1, file, 51, 2, 1240);
			add_location(strong1, file, 59, 4, 1520);
			add_location(strong2, file, 60, 4, 1554);
			add_location(strong3, file, 61, 4, 1589);
			add_location(strong4, file, 62, 4, 1629);
			add_location(strong5, file, 63, 4, 1662);
			add_location(strong6, file, 64, 4, 1694);
			add_location(strong7, file, 65, 4, 1726);
			add_location(strong8, file, 66, 4, 1758);
			add_location(strong9, file, 67, 4, 1789);
			add_location(strong10, file, 68, 4, 1827);
			add_location(strong11, file, 69, 4, 1880);
			add_location(strong12, file, 70, 4, 1914);
			add_location(strong13, file, 71, 8, 1951);
			attr(p2, "class", "svelte-1wopt9k");
			add_location(p2, file, 58, 2, 1512);
			add_location(strong14, file, 75, 4, 2057);
			add_location(strong15, file, 76, 4, 2104);
			attr(p3, "class", "svelte-1wopt9k");
			add_location(p3, file, 73, 2, 1994);
			attr(img, "src", "images/hamntongs.png");
			attr(img, "alt", "the seals");
			attr(img, "class", "svelte-1wopt9k");
			add_location(img, file, 81, 2, 2243);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-1wopt9k");
			add_location(div, file, 43, 0, 912);
