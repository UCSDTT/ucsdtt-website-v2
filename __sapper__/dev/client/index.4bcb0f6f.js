...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$2, 47, 0, 807);
			attr(h1, "class", "svelte-12z78b6");
			add_location(h1, file$2, 59, 1, 1020);
			attr(div1, "class", "pillars-div svelte-12z78b6");
			add_location(div1, file$2, 58, 0, 993);
			add_location(br0, file$2, 66, 0, 1221);
			add_location(br1, file$2, 67, 0, 1227);
			add_location(br2, file$2, 68, 0, 1233);
			add_location(br3, file$2, 69, 0, 1239);
			add_location(br4, file$2, 70, 0, 1245);
			add_location(br5, file$2, 71, 0, 1251);
			add_location(br6, file$2, 72, 0, 1257);
			add_location(br7, file$2, 73, 0, 1263);
			add_location(br8, file$2, 74, 0, 1269);
			add_location(br9, file$2, 75, 0, 1275);
			add_location(br10, file$2, 76, 0, 1281);
			add_location(br11, file$2, 77, 0, 1287);
			add_location(br12, file$2, 78, 0, 1293);
			add_location(br13, file$2, 79, 0, 1299);
			add_location(br14, file$2, 80, 0, 1305);
			add_location(br15, file$2, 81, 0, 1311);
			add_location(br16, file$2, 82, 0, 1317);
			add_location(br17, file$2, 83, 0, 1323);
			add_location(br18, file$2, 84, 0, 1329);
			add_location(br19, file$2, 85, 0, 1335);
			add_location(br20, file$2, 86, 0, 1341);
			add_location(br21, file$2, 87, 0, 1347);
			add_location(br22, file$2, 88, 0, 1353);
			add_location(br23, file$2, 89, 0, 1359);
			add_location(br24, file$2, 90, 0, 1365);
			add_location(br25, file$2, 91, 0, 1371);
			add_location(br26, file$2, 92, 0, 1377);
			add_location(br27, file$2, 93, 0, 1383);
			add_location(br28, file$2, 94, 0, 1389);
			add_location(br29, file$2, 95, 0, 1395);
			add_location(br30, file$2, 96, 0, 1401);
			add_location(br31, file$2, 97, 0, 1407);
			add_location(br32, file$2, 98, 0, 1413);
			add_location(br33, file$2, 99, 0, 1419);
			add_location(br34, file$2, 100, 0, 1425);
			add_location(br35, file$2, 101, 0, 1431);
			add_location(br36, file$2, 102, 0, 1437);
			add_location(br37, file$2, 103, 0, 1443);
			add_location(br38, file$2, 104, 0, 1449);
			add_location(br39, file$2, 105, 0, 1455);
			add_location(br40, file$2, 106, 0, 1461);
			add_location(br41, file$2, 107, 0, 1467);
			add_location(br42, file$2, 108, 0, 1473);
			add_location(br43, file$2, 109, 0, 1479);
			add_location(br44, file$2, 110, 0, 1485);
			add_location(br45, file$2, 111, 0, 1491);
			add_location(br46, file$2, 112, 0, 1497);
			add_location(br47, file$2, 113, 0, 1503);
			add_location(br48, file$2, 114, 0, 1509);
			add_location(br49, file$2, 115, 0, 1515);
			add_location(br50, file$2, 116, 0, 1521);
			add_location(br51, file$2, 117, 0, 1527);
			add_location(br52, file$2, 118, 0, 1533);
			add_location(br53, file$2, 119, 0, 1539);
			add_location(br54, file$2, 120, 0, 1545);
			add_location(br55, file$2, 121, 0, 1551);
			add_location(br56, file$2, 122, 0, 1557);
			add_location(br57, file$2, 123, 0, 1563);
			add_location(br58, file$2, 124, 0, 1569);
			add_location(br59, file$2, 125, 0, 1575);
			add_location(br60, file$2, 126, 0, 1581);
			add_location(br61, file$2, 127, 0, 1587);
			add_location(br62, file$2, 128, 0, 1593);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$2, 129, 14, 1613);
			attr(p, "class", "svelte-12z78b6");
			add_location(p, file$2, 129, 0, 1599);
		},
