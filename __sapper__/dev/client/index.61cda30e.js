...
function create_header_slot$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "slot", "header");
			add_location(h3, file$5, 93, 2, 1612);
		},
...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p0, "class", "svelte-1pske4x");
			add_location(p0, file$5, 95, 3, 1708);
			attr(p1, "class", "svelte-1pske4x");
			add_location(p1, file$5, 102, 1, 2049);
			attr(p2, "class", "svelte-1pske4x");
			add_location(p2, file$5, 110, 1, 2456);
			attr(section, "slot", "left");
			add_location(section, file$5, 94, 2, 1683);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 118, 4, 2649);
			attr(figcaption, "class", "svelte-1pske4x");
			add_location(figcaption, file$5, 127, 1, 2915);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 115, 2, 2576);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div0, "class", "hero-div svelte-1pske4x");
			add_location(div0, file$5, 82, 0, 1410);
			attr(h1, "class", "svelte-1pske4x");
			add_location(h1, file$5, 132, 2, 3021);
			attr(div1, "class", "pillars-div svelte-1pske4x");
			add_location(div1, file$5, 131, 0, 2993);
			add_location(br0, file$5, 140, 0, 3236);
			add_location(br1, file$5, 141, 0, 3243);
			add_location(br2, file$5, 142, 0, 3250);
			add_location(br3, file$5, 143, 0, 3257);
			add_location(br4, file$5, 144, 0, 3264);
			add_location(br5, file$5, 145, 0, 3271);
			add_location(br6, file$5, 146, 0, 3278);
			add_location(br7, file$5, 147, 0, 3285);
			add_location(br8, file$5, 148, 0, 3292);
			add_location(br9, file$5, 149, 0, 3299);
			add_location(br10, file$5, 150, 0, 3306);
			add_location(br11, file$5, 151, 0, 3313);
			add_location(br12, file$5, 152, 0, 3320);
			add_location(br13, file$5, 153, 0, 3327);
			add_location(br14, file$5, 154, 0, 3334);
			add_location(br15, file$5, 155, 0, 3341);
			add_location(br16, file$5, 156, 0, 3348);
			add_location(br17, file$5, 157, 0, 3355);
			add_location(br18, file$5, 158, 0, 3362);
			add_location(br19, file$5, 159, 0, 3369);
			add_location(br20, file$5, 160, 0, 3376);
			add_location(br21, file$5, 161, 0, 3383);
			add_location(br22, file$5, 162, 0, 3390);
			add_location(br23, file$5, 163, 0, 3397);
			add_location(br24, file$5, 164, 0, 3404);
			add_location(br25, file$5, 165, 0, 3411);
			add_location(br26, file$5, 166, 0, 3418);
			add_location(br27, file$5, 167, 0, 3425);
			add_location(br28, file$5, 168, 0, 3432);
			add_location(br29, file$5, 169, 0, 3439);
			add_location(br30, file$5, 170, 0, 3446);
			add_location(br31, file$5, 171, 0, 3453);
			add_location(br32, file$5, 172, 0, 3460);
			add_location(br33, file$5, 173, 0, 3467);
			add_location(br34, file$5, 174, 0, 3474);
			add_location(br35, file$5, 175, 0, 3481);
			add_location(br36, file$5, 176, 0, 3488);
			add_location(br37, file$5, 177, 0, 3495);
			add_location(br38, file$5, 178, 0, 3502);
			add_location(br39, file$5, 179, 0, 3509);
			add_location(br40, file$5, 180, 0, 3516);
			add_location(br41, file$5, 181, 0, 3523);
			add_location(br42, file$5, 182, 0, 3530);
			add_location(br43, file$5, 183, 0, 3537);
			add_location(br44, file$5, 184, 0, 3544);
			add_location(br45, file$5, 185, 0, 3551);
			add_location(br46, file$5, 186, 0, 3558);
			add_location(br47, file$5, 187, 0, 3565);
			add_location(br48, file$5, 188, 0, 3572);
			add_location(br49, file$5, 189, 0, 3579);
			add_location(br50, file$5, 190, 0, 3586);
			add_location(br51, file$5, 191, 0, 3593);
			add_location(br52, file$5, 192, 0, 3600);
			add_location(br53, file$5, 193, 0, 3607);
			add_location(br54, file$5, 194, 0, 3614);
			add_location(br55, file$5, 195, 0, 3621);
			add_location(br56, file$5, 196, 0, 3628);
			add_location(br57, file$5, 197, 0, 3635);
			add_location(br58, file$5, 198, 0, 3642);
			add_location(br59, file$5, 199, 0, 3649);
			add_location(br60, file$5, 200, 0, 3656);
			add_location(br61, file$5, 201, 0, 3663);
			add_location(br62, file$5, 202, 0, 3670);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 205, 2, 3696);
			attr(p, "class", "svelte-1pske4x");
			add_location(p, file$5, 203, 0, 3677);
		},
