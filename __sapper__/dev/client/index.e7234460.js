...
import { f as fade, a as fly } from './chunk.a3641b35.js';
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "text-display lg-view svelte-7he76g");
			add_location(h1, file, 71, 1, 1319);
		},
...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 73, 12, 1725);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal");
			add_location(span, file$1, 76, 12, 1820);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-143iulj");
			add_location(h1, file$1, 71, 4, 1657);
			add_location(section, file$1, 70, 0, 1642);
		},
...
const get_header_slot_context = () => ({ class: `header svelte-dwh743` });
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(hr, file$2, 55, 4, 1066);

			attr(section0, "class", "left-div subcards svelte-dwh743");
			add_location(section0, file$2, 57, 8, 1107);

			attr(section1, "class", "right-div subcards svelte-dwh743");
			add_location(section1, file$2, 60, 8, 1211);
			attr(div, "class", "wrapper svelte-dwh743");
			add_location(div, file$2, 56, 4, 1076);
			attr(section2, "class", "card svelte-dwh743");
			add_location(section2, file$2, 53, 0, 990);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong, file$3, 81, 4, 1409);
			attr(h3, "slot", "header");
			attr(h3, "class", "svelte-12o40hp");
			add_location(h3, file$3, 80, 2, 1385);
		},
...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong0, file$3, 86, 6, 1601);
			add_location(strong1, file$3, 89, 6, 1837);
			add_location(strong2, file$3, 90, 6, 1874);
			add_location(strong3, file$3, 91, 6, 1916);
			attr(p0, "class", "svelte-12o40hp");
			add_location(p0, file$3, 84, 4, 1511);
			add_location(strong4, file$3, 99, 6, 2354);
			attr(p1, "class", "svelte-12o40hp");
			add_location(p1, file$3, 93, 4, 1965);
			add_location(strong5, file$3, 103, 6, 2515);
			attr(p2, "class", "svelte-12o40hp");
			add_location(p2, file$3, 101, 4, 2425);
			attr(section, "slot", "left");
			add_location(section, file$3, 83, 2, 1484);
		},
...
function create_if_block$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(iframe, "class", "svelte-12o40hp");
			add_location(iframe, file$3, 110, 6, 2677);
			attr(figcaption, "class", "svelte-12o40hp");
			add_location(figcaption, file$3, 121, 6, 3040);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(figure, file$3, 106, 2, 2578);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-12o40hp");
			add_location(div, file$3, 69, 0, 1172);
