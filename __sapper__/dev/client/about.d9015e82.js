...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1ncbf3e");
			add_location(img, file, 84, 8, 1525);
			attr(div, "class", "carousel svelte-1ncbf3e");
			add_location(div, file, 83, 6, 1494);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-1ncbf3e");
			add_location(button0, file, 80, 2, 1379);
			attr(div0, "class", "carousel-wrapper svelte-1ncbf3e");
			add_location(div0, file, 81, 2, 1439);
			attr(button1, "class", "carousel-button button-right svelte-1ncbf3e");
			add_location(button1, file, 88, 2, 1633);
			attr(div1, "class", "button-wrapper svelte-1ncbf3e");
			add_location(div1, file, 79, 0, 1348);
		},
