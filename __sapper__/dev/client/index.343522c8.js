...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(span, file$1, 62, 12, 1304);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "labels svelte-13s3e3z");
			add_location(span, file$1, 65, 12, 1381);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "svelte-13s3e3z");
			add_location(h1, file$1, 60, 4, 1260);
			add_location(section, file$1, 59, 0, 1246);
		},
