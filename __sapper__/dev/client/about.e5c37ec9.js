...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 37, 2, 862);
			attr(p0, "class", "svelte-rgrdu4");
			add_location(p0, file, 38, 2, 917);
			add_location(strong0, file, 45, 4, 1178);
			attr(p1, "class", "svelte-rgrdu4");
			add_location(p1, file, 44, 2, 1170);
			add_location(strong1, file, 52, 4, 1450);
			add_location(strong2, file, 53, 4, 1484);
			add_location(strong3, file, 54, 4, 1519);
			add_location(strong4, file, 55, 4, 1559);
			add_location(strong5, file, 56, 4, 1592);
			add_location(strong6, file, 57, 4, 1624);
			add_location(strong7, file, 58, 4, 1656);
			add_location(strong8, file, 59, 4, 1688);
			add_location(strong9, file, 60, 4, 1719);
			add_location(strong10, file, 61, 4, 1757);
			add_location(strong11, file, 62, 4, 1810);
			add_location(strong12, file, 63, 4, 1844);
			add_location(strong13, file, 64, 8, 1881);
			attr(p2, "class", "svelte-rgrdu4");
			add_location(p2, file, 51, 2, 1442);
			add_location(strong14, file, 68, 4, 1987);
			add_location(strong15, file, 69, 4, 2034);
			attr(p3, "class", "svelte-rgrdu4");
			add_location(p3, file, 66, 2, 1924);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-rgrdu4");
			add_location(img0, file, 71, 2, 2071);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-rgrdu4");
			add_location(img1, file, 72, 2, 2145);
			attr(div, "id", "letter");
