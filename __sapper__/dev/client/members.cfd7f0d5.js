...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p0, file, 42, 0, 851);
			add_location(p1, file, 43, 0, 866);
			attr(div0, "class", "cursor-box svelte-19f2tth");
			set_style(div0, "top", (ctx.mx + "px"));
			set_style(div0, "right", (ctx.my + "px"));
			set_style(div0, "position", "absolute");
			set_style(div0, "padding", "2em");
			set_style(div0, "border", "1em gray dotted");
			add_location(div0, file, 45, 0, 882);
			attr(img, "class", "class-img");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 58, 2, 1086);
			attr(div1, "class", "class-img-container");
			add_location(div1, file, 57, 0, 1050);
