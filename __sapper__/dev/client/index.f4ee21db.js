...
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file$3, 70, 8, 1579);
		},
...
function create_header_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 76, 8, 1725);
		},
...
// (76:4) <Modal on:close="{() => philVis = false}">
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			add_location(img, file$3, 77, 8, 1769);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 83, 8, 1913);
		},
...
// (83:4) <Modal on:close="{() => proVis = false}">
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			add_location(img, file$3, 84, 8, 1960);
		},
