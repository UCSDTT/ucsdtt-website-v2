...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 75, 2, 1494);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 87, 2, 1666);
			attr(div0, "class", "class-img-container svelte-1jwl42e");
			add_location(div0, file, 86, 0, 1630);
			attr(div1, "class", "brother-info svelte-1jwl42e");
			add_location(div1, file, 95, 0, 1795);
