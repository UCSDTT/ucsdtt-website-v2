...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-heqkf4");
			add_location(h1, file, 35, 2, 791);
			attr(p0, "class", "svelte-heqkf4");
			add_location(p0, file, 36, 2, 846);
			add_location(strong0, file, 44, 4, 1149);
			attr(p1, "class", "svelte-heqkf4");
			add_location(p1, file, 42, 2, 1099);
			add_location(strong1, file, 50, 4, 1380);
			add_location(strong2, file, 51, 4, 1414);
			add_location(strong3, file, 52, 4, 1449);
			add_location(strong4, file, 53, 4, 1489);
			add_location(strong5, file, 54, 4, 1522);
			add_location(strong6, file, 55, 4, 1554);
			add_location(strong7, file, 56, 4, 1586);
			add_location(strong8, file, 57, 4, 1618);
			add_location(strong9, file, 58, 4, 1649);
			add_location(strong10, file, 59, 4, 1687);
			add_location(strong11, file, 60, 4, 1740);
			add_location(strong12, file, 61, 4, 1774);
			add_location(strong13, file, 62, 8, 1811);
			attr(p2, "class", "svelte-heqkf4");
			add_location(p2, file, 49, 2, 1372);
			add_location(strong14, file, 66, 4, 1917);
			add_location(strong15, file, 67, 4, 1964);
			attr(p3, "class", "svelte-heqkf4");
			add_location(p3, file, 64, 2, 1854);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-heqkf4");
			add_location(img0, file, 69, 2, 2001);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-heqkf4");
			add_location(img1, file, 70, 2, 2075);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-heqkf4");
			add_location(div, file, 34, 0, 771);
		},
