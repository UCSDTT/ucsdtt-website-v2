...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 59, 0, 967);
			add_location(h3, file, 61, 0, 983);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-pge6b");
			add_location(img0, file, 65, 4, 1093);
			attr(h40, "class", "svelte-pge6b");
			add_location(h40, file, 66, 4, 1141);
			add_location(p0, file, 67, 4, 1166);
			attr(div0, "class", "pillar svelte-pge6b");
			add_location(div0, file, 64, 2, 1068);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-pge6b");
			add_location(img1, file, 75, 4, 1502);
			attr(h41, "class", "svelte-pge6b");
			add_location(h41, file, 76, 4, 1550);
			add_location(p1, file, 77, 4, 1576);
			attr(div1, "class", "pillar svelte-pge6b");
			add_location(div1, file, 74, 2, 1477);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-pge6b");
			add_location(img2, file, 86, 4, 1939);
			attr(h42, "class", "svelte-pge6b");
			add_location(h42, file, 87, 4, 1987);
			add_location(p2, file, 88, 4, 2016);
			attr(div2, "class", "pillar svelte-pge6b");
			add_location(div2, file, 85, 2, 1914);
			attr(div3, "class", "pillars svelte-pge6b");
			add_location(div3, file, 63, 0, 1044);
		},
