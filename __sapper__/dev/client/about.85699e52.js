...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 49, 0, 819);
			add_location(h3, file, 51, 0, 835);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-6hjd2z");
			add_location(img0, file, 55, 4, 945);
			attr(h40, "class", "svelte-6hjd2z");
			add_location(h40, file, 56, 4, 993);
			add_location(p0, file, 57, 4, 1018);
			attr(div0, "class", "pillar svelte-6hjd2z");
			add_location(div0, file, 54, 2, 920);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-6hjd2z");
			add_location(img1, file, 65, 4, 1354);
			attr(h41, "class", "svelte-6hjd2z");
			add_location(h41, file, 66, 4, 1402);
			add_location(p1, file, 67, 4, 1428);
			attr(div1, "class", "pillar svelte-6hjd2z");
			add_location(div1, file, 64, 2, 1329);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-6hjd2z");
			add_location(img2, file, 76, 4, 1791);
			attr(h42, "class", "svelte-6hjd2z");
			add_location(h42, file, 77, 4, 1839);
			add_location(p2, file, 78, 4, 1868);
			attr(div2, "class", "pillar svelte-6hjd2z");
			add_location(div2, file, 75, 2, 1766);
			attr(div3, "class", "pillars svelte-6hjd2z");
			add_location(div3, file, 53, 0, 896);
		},
