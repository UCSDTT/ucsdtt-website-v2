...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-jq8ubz");
			add_location(img0, file$2, 30, 12, 494);
			attr(h20, "class", "svelte-jq8ubz");
			add_location(h20, file$2, 30, 8, 490);
			attr(li0, "class", "svelte-jq8ubz");
			add_location(li0, file$2, 30, 4, 486);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-jq8ubz");
			add_location(img1, file$2, 31, 12, 575);
			attr(h21, "class", "svelte-jq8ubz");
			add_location(h21, file$2, 31, 8, 571);
			attr(li1, "class", "svelte-jq8ubz");
			add_location(li1, file$2, 31, 4, 567);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-jq8ubz");
			add_location(img2, file$2, 32, 12, 657);
			attr(h22, "class", "svelte-jq8ubz");
			add_location(h22, file$2, 32, 8, 653);
			attr(li2, "class", "svelte-jq8ubz");
			add_location(li2, file$2, 32, 4, 649);
			attr(ul, "class", "pillared svelte-jq8ubz");
