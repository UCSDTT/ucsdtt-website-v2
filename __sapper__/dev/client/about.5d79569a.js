...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 119, 8, 2285);
			attr(div, "class", "carousel svelte-smhls4");
			add_location(div, file, 118, 6, 2254);
		},
