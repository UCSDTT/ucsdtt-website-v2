...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-left svelte-7tzwwb");
			add_location(button, file, 135, 6, 2604);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-7tzwwb");
			add_location(img, file, 142, 10, 2811);
			attr(div, "class", "carousel svelte-7tzwwb");
			add_location(div, file, 141, 8, 2778);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-right svelte-7tzwwb");
			add_location(button, file, 150, 6, 2986);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-7tzwwb");
			add_location(div0, file, 139, 4, 2719);
			attr(div1, "class", "button-wrapper svelte-7tzwwb");
			add_location(div1, file, 133, 2, 2549);
			attr(figcaption, "class", "carousel-caption svelte-7tzwwb");
			add_location(figcaption, file, 155, 2, 3109);
			attr(figure, "class", "figure-wrapper svelte-7tzwwb");
			add_location(figure, file, 132, 0, 2515);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-16xvucf");
			add_location(h1, file$1, 44, 2, 1003);
			attr(p0, "class", "svelte-16xvucf");
			add_location(p0, file$1, 45, 2, 1058);
			add_location(strong0, file$1, 52, 4, 1319);
			attr(p1, "class", "svelte-16xvucf");
			add_location(p1, file$1, 51, 2, 1311);
			add_location(strong1, file$1, 59, 4, 1591);
			add_location(strong2, file$1, 60, 4, 1625);
			add_location(strong3, file$1, 61, 4, 1660);
			add_location(strong4, file$1, 62, 4, 1700);
			add_location(strong5, file$1, 63, 4, 1733);
			add_location(strong6, file$1, 64, 4, 1765);
			add_location(strong7, file$1, 65, 4, 1797);
			add_location(strong8, file$1, 66, 4, 1829);
			add_location(strong9, file$1, 67, 4, 1860);
			add_location(strong10, file$1, 68, 4, 1898);
			add_location(strong11, file$1, 69, 4, 1951);
			add_location(strong12, file$1, 70, 4, 1985);
			add_location(strong13, file$1, 71, 8, 2022);
			attr(p2, "class", "svelte-16xvucf");
			add_location(p2, file$1, 58, 2, 1583);
			add_location(strong14, file$1, 75, 4, 2128);
			add_location(strong15, file$1, 76, 4, 2175);
			attr(p3, "class", "svelte-16xvucf");
			add_location(p3, file$1, 73, 2, 2065);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-16xvucf");
			add_location(img0, file$1, 78, 2, 2212);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-16xvucf");
			add_location(img1, file$1, 79, 2, 2286);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-16xvucf");
			add_location(div, file$1, 43, 0, 983);
		},
