...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1mnlovl");
			add_location(img, file, 58, 6, 1136);
			attr(div, "class", "carousel svelte-1mnlovl");
			add_location(div, file, 57, 4, 1107);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-1mnlovl");
			add_location(div, file, 55, 0, 1056);
		},
