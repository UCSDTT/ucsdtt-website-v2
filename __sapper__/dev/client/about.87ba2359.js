...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-left svelte-1hj9k7i");
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1hj9k7i");
			add_location(img, file, 142, 10, 2810);
			attr(div, "class", "carousel svelte-1hj9k7i");
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-right svelte-1hj9k7i");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-1hj9k7i");
			add_location(div0, file, 139, 4, 2718);
			attr(div1, "class", "button-wrapper svelte-1hj9k7i");
			add_location(div1, file, 133, 2, 2548);
			attr(figcaption, "class", "carousel-caption svelte-1hj9k7i");
			add_location(figcaption, file, 155, 2, 3108);
			attr(figure, "class", "figure-wrapper svelte-1hj9k7i");
