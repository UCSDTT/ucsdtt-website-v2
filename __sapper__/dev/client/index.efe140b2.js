...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 57, 12, 1185);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal");
			add_location(span, file$1, 60, 12, 1277);
		},
		...
		o: function outro(local) {
			...
			span_outro = create_out_transition(span, fly, {y: -6, duration: 1000});
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 55, 4, 1141);
			add_location(section, file$1, 54, 0, 1127);
		},
