...
function create_fragment(ctx) {
	var div, h1, t0, t1, p0, t2, t3, p1, t4, strong0, t5, t6, t7, p2, strong1, t8, t9, strong2, t10, t11, strong3, t12, t13, strong4, t14, t15, strong5, t16, t17, strong6, t18, t19, strong7, t20, t21, strong8, t22, t23, strong9, t24, t25, strong10, t26, t27, strong11, t28, t29, strong12, t30, t31, strong13, t32, t33, t34, p3, t35, strong14, t36, t37;
	...
	return {
		c: function create() {
			...
			t36 = text("\\Epsilon Delta Chapter of Theta Tau");
			t37 = text(".");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t36 = claim_text(strong14_nodes, "\\Epsilon Delta Chapter of Theta Tau");
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-zxde1a");
			add_location(h1, file, 23, 2, 572);
			attr(p0, "class", "svelte-zxde1a");
			add_location(p0, file, 24, 2, 627);
			add_location(strong0, file, 32, 4, 930);
			attr(p1, "class", "svelte-zxde1a");
			add_location(p1, file, 30, 2, 880);
			add_location(strong1, file, 38, 4, 1161);
			add_location(strong2, file, 39, 4, 1195);
			add_location(strong3, file, 40, 4, 1230);
			add_location(strong4, file, 41, 4, 1270);
			add_location(strong5, file, 42, 4, 1303);
			add_location(strong6, file, 43, 4, 1335);
			add_location(strong7, file, 44, 4, 1367);
			add_location(strong8, file, 45, 4, 1399);
			add_location(strong9, file, 46, 4, 1430);
			add_location(strong10, file, 47, 4, 1468);
			add_location(strong11, file, 48, 4, 1521);
			add_location(strong12, file, 49, 4, 1555);
			add_location(strong13, file, 50, 8, 1592);
			attr(p2, "class", "svelte-zxde1a");
			add_location(p2, file, 37, 2, 1153);
			add_location(strong14, file, 54, 4, 1698);
			attr(p3, "class", "svelte-zxde1a");
			add_location(p3, file, 52, 2, 1635);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-zxde1a");
			add_location(div, file, 22, 0, 552);
		},
