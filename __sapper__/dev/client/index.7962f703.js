...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 99, 4, 1944);
			attr(figcaption, "class", "svelte-1a2i6qs");
			add_location(figcaption, file$5, 108, 1, 2211);
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$5, 113, 2, 2317);
			attr(div1, "class", "pillars-div svelte-1a2i6qs");
			add_location(div1, file$5, 112, 0, 2289);
			add_location(br0, file$5, 121, 0, 2532);
			add_location(br1, file$5, 122, 0, 2539);
			add_location(br2, file$5, 123, 0, 2546);
			add_location(br3, file$5, 124, 0, 2553);
			add_location(br4, file$5, 125, 0, 2560);
			add_location(br5, file$5, 126, 0, 2567);
			add_location(br6, file$5, 127, 0, 2574);
			add_location(br7, file$5, 128, 0, 2581);
			add_location(br8, file$5, 129, 0, 2588);
			add_location(br9, file$5, 130, 0, 2595);
			add_location(br10, file$5, 131, 0, 2602);
			add_location(br11, file$5, 132, 0, 2609);
			add_location(br12, file$5, 133, 0, 2616);
			add_location(br13, file$5, 134, 0, 2623);
			add_location(br14, file$5, 135, 0, 2630);
			add_location(br15, file$5, 136, 0, 2637);
			add_location(br16, file$5, 137, 0, 2644);
			add_location(br17, file$5, 138, 0, 2651);
			add_location(br18, file$5, 139, 0, 2658);
			add_location(br19, file$5, 140, 0, 2665);
			add_location(br20, file$5, 141, 0, 2672);
			add_location(br21, file$5, 142, 0, 2679);
			add_location(br22, file$5, 143, 0, 2686);
			add_location(br23, file$5, 144, 0, 2693);
			add_location(br24, file$5, 145, 0, 2700);
			add_location(br25, file$5, 146, 0, 2707);
			add_location(br26, file$5, 147, 0, 2714);
			add_location(br27, file$5, 148, 0, 2721);
			add_location(br28, file$5, 149, 0, 2728);
			add_location(br29, file$5, 150, 0, 2735);
			add_location(br30, file$5, 151, 0, 2742);
			add_location(br31, file$5, 152, 0, 2749);
			add_location(br32, file$5, 153, 0, 2756);
			add_location(br33, file$5, 154, 0, 2763);
			add_location(br34, file$5, 155, 0, 2770);
			add_location(br35, file$5, 156, 0, 2777);
			add_location(br36, file$5, 157, 0, 2784);
			add_location(br37, file$5, 158, 0, 2791);
			add_location(br38, file$5, 159, 0, 2798);
			add_location(br39, file$5, 160, 0, 2805);
			add_location(br40, file$5, 161, 0, 2812);
			add_location(br41, file$5, 162, 0, 2819);
			add_location(br42, file$5, 163, 0, 2826);
			add_location(br43, file$5, 164, 0, 2833);
			add_location(br44, file$5, 165, 0, 2840);
			add_location(br45, file$5, 166, 0, 2847);
			add_location(br46, file$5, 167, 0, 2854);
			add_location(br47, file$5, 168, 0, 2861);
			add_location(br48, file$5, 169, 0, 2868);
			add_location(br49, file$5, 170, 0, 2875);
			add_location(br50, file$5, 171, 0, 2882);
			add_location(br51, file$5, 172, 0, 2889);
			add_location(br52, file$5, 173, 0, 2896);
			add_location(br53, file$5, 174, 0, 2903);
			add_location(br54, file$5, 175, 0, 2910);
			add_location(br55, file$5, 176, 0, 2917);
			add_location(br56, file$5, 177, 0, 2924);
			add_location(br57, file$5, 178, 0, 2931);
			add_location(br58, file$5, 179, 0, 2938);
			add_location(br59, file$5, 180, 0, 2945);
			add_location(br60, file$5, 181, 0, 2952);
			add_location(br61, file$5, 182, 0, 2959);
			add_location(br62, file$5, 183, 0, 2966);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 186, 2, 2992);
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 184, 0, 2973);
		},
