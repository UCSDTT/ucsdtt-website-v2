...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(br0, file$2, 55, 0, 1056);
			add_location(br1, file$2, 56, 0, 1062);
			add_location(br2, file$2, 57, 0, 1068);
			add_location(br3, file$2, 58, 0, 1074);
			add_location(br4, file$2, 59, 0, 1080);
			add_location(br5, file$2, 60, 0, 1086);
			add_location(br6, file$2, 61, 0, 1092);
			add_location(br7, file$2, 62, 0, 1098);
			add_location(br8, file$2, 63, 0, 1104);
			add_location(br9, file$2, 64, 0, 1110);
			add_location(br10, file$2, 65, 0, 1116);
			add_location(br11, file$2, 66, 0, 1122);
			add_location(br12, file$2, 67, 0, 1128);
			add_location(br13, file$2, 68, 0, 1134);
			add_location(br14, file$2, 69, 0, 1140);
			add_location(br15, file$2, 70, 0, 1146);
			add_location(br16, file$2, 71, 0, 1152);
			add_location(br17, file$2, 72, 0, 1158);
			add_location(br18, file$2, 73, 0, 1164);
			add_location(br19, file$2, 74, 0, 1170);
			add_location(br20, file$2, 75, 0, 1176);
			add_location(br21, file$2, 76, 0, 1182);
			add_location(br22, file$2, 77, 0, 1188);
			add_location(br23, file$2, 78, 0, 1194);
			add_location(br24, file$2, 79, 0, 1200);
			add_location(br25, file$2, 80, 0, 1206);
			add_location(br26, file$2, 81, 0, 1212);
			add_location(br27, file$2, 82, 0, 1218);
			add_location(br28, file$2, 83, 0, 1224);
			add_location(br29, file$2, 84, 0, 1230);
			add_location(br30, file$2, 85, 0, 1236);
			add_location(br31, file$2, 86, 0, 1242);
			add_location(br32, file$2, 87, 0, 1248);
			add_location(br33, file$2, 88, 0, 1254);
			add_location(br34, file$2, 89, 0, 1260);
			add_location(br35, file$2, 90, 0, 1266);
			add_location(br36, file$2, 91, 0, 1272);
			add_location(br37, file$2, 92, 0, 1278);
			add_location(br38, file$2, 93, 0, 1284);
			add_location(br39, file$2, 94, 0, 1290);
			add_location(br40, file$2, 95, 0, 1296);
			add_location(br41, file$2, 96, 0, 1302);
			add_location(br42, file$2, 97, 0, 1308);
			add_location(br43, file$2, 98, 0, 1314);
			add_location(br44, file$2, 99, 0, 1320);
			add_location(br45, file$2, 100, 0, 1326);
			add_location(br46, file$2, 101, 0, 1332);
			add_location(br47, file$2, 102, 0, 1338);
			add_location(br48, file$2, 103, 0, 1344);
			add_location(br49, file$2, 104, 0, 1350);
			add_location(br50, file$2, 105, 0, 1356);
			add_location(br51, file$2, 106, 0, 1362);
			add_location(br52, file$2, 107, 0, 1368);
			add_location(br53, file$2, 108, 0, 1374);
			add_location(br54, file$2, 109, 0, 1380);
			add_location(br55, file$2, 110, 0, 1386);
			add_location(br56, file$2, 111, 0, 1392);
			add_location(br57, file$2, 112, 0, 1398);
			add_location(br58, file$2, 113, 0, 1404);
			add_location(br59, file$2, 114, 0, 1410);
			add_location(br60, file$2, 115, 0, 1416);
			add_location(br61, file$2, 116, 0, 1422);
			add_location(br62, file$2, 117, 0, 1428);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$2, 118, 14, 1448);
			attr(p, "class", "svelte-1wetaz5");
			add_location(p, file$2, 118, 0, 1434);
		},
