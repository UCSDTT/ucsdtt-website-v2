...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(br0, file$1, 37, 0, 609);
			add_location(br1, file$1, 38, 0, 615);
			add_location(br2, file$1, 39, 0, 621);
			add_location(br3, file$1, 40, 0, 627);
			add_location(br4, file$1, 41, 0, 633);
			add_location(br5, file$1, 42, 0, 639);
			add_location(br6, file$1, 43, 0, 645);
			add_location(br7, file$1, 44, 0, 651);
			add_location(br8, file$1, 45, 0, 657);
			add_location(br9, file$1, 46, 0, 663);
			add_location(br10, file$1, 47, 0, 669);
			add_location(br11, file$1, 48, 0, 675);
			add_location(br12, file$1, 49, 0, 681);
			add_location(br13, file$1, 50, 0, 687);
			add_location(br14, file$1, 51, 0, 693);
			add_location(br15, file$1, 52, 0, 699);
			add_location(br16, file$1, 53, 0, 705);
			add_location(br17, file$1, 54, 0, 711);
			add_location(br18, file$1, 55, 0, 717);
			add_location(br19, file$1, 56, 0, 723);
			add_location(br20, file$1, 57, 0, 729);
			add_location(br21, file$1, 58, 0, 735);
			add_location(br22, file$1, 59, 0, 741);
			add_location(br23, file$1, 60, 0, 747);
			add_location(br24, file$1, 61, 0, 753);
			add_location(br25, file$1, 62, 0, 759);
			add_location(br26, file$1, 63, 0, 765);
			add_location(br27, file$1, 64, 0, 771);
			add_location(br28, file$1, 65, 0, 777);
			add_location(br29, file$1, 66, 0, 783);
			add_location(br30, file$1, 67, 0, 789);
			add_location(br31, file$1, 68, 0, 795);
			add_location(br32, file$1, 69, 0, 801);
			add_location(br33, file$1, 70, 0, 807);
			add_location(br34, file$1, 71, 0, 813);
			add_location(br35, file$1, 72, 0, 819);
			add_location(br36, file$1, 73, 0, 825);
			add_location(br37, file$1, 74, 0, 831);
			add_location(br38, file$1, 75, 0, 837);
			add_location(br39, file$1, 76, 0, 843);
			add_location(br40, file$1, 77, 0, 849);
			add_location(br41, file$1, 78, 0, 855);
			add_location(br42, file$1, 79, 0, 861);
			add_location(br43, file$1, 80, 0, 867);
			add_location(br44, file$1, 81, 0, 873);
			add_location(br45, file$1, 82, 0, 879);
			add_location(br46, file$1, 83, 0, 885);
			add_location(br47, file$1, 84, 0, 891);
			add_location(br48, file$1, 85, 0, 897);
			add_location(br49, file$1, 86, 0, 903);
			add_location(br50, file$1, 87, 0, 909);
			add_location(br51, file$1, 88, 0, 915);
			add_location(br52, file$1, 89, 0, 921);
			add_location(br53, file$1, 90, 0, 927);
			add_location(br54, file$1, 91, 0, 933);
			add_location(br55, file$1, 92, 0, 939);
			add_location(br56, file$1, 93, 0, 945);
			add_location(br57, file$1, 94, 0, 951);
			add_location(br58, file$1, 95, 0, 957);
			add_location(br59, file$1, 96, 0, 963);
			add_location(br60, file$1, 97, 0, 969);
			add_location(br61, file$1, 98, 0, 975);
			add_location(br62, file$1, 99, 0, 981);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$1, 100, 14, 1001);
			attr(p, "class", "svelte-1e1i4eg");
			add_location(p, file$1, 100, 0, 987);
		},
