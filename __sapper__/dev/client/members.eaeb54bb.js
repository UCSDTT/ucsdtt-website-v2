...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-y96gx0");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 72, 2, 1402);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p0, "class", "svelte-y96gx0");
			add_location(p0, file, 64, 0, 1254);
			attr(p1, "class", "svelte-y96gx0");
			add_location(p1, file, 65, 0, 1269);
			attr(p2, "class", "svelte-y96gx0");
			add_location(p2, file, 66, 0, 1284);
			attr(p3, "class", "svelte-y96gx0");
			add_location(p3, file, 67, 0, 1299);
			attr(img, "class", "class-img svelte-y96gx0");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 83, 2, 1542);
			attr(div, "class", "class-img-container svelte-y96gx0");
			add_location(div, file, 82, 0, 1506);
