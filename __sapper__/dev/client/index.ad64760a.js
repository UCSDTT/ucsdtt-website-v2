...
function create_if_block(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			path = claim_element(nodes, "path", { d: true, opacity: true, width: true, height: true, class: true, style: true }, true);
...
function create_fragment(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			svg_1 = claim_element(nodes, "svg", { xmlns: true, viewBox: true }, true);
