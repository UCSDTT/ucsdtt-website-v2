...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-j3lc8a");
			add_location(h1, file, 31, 2, 748);
			attr(p0, "class", "svelte-j3lc8a");
			add_location(p0, file, 32, 2, 803);
			add_location(strong0, file, 40, 4, 1106);
			attr(p1, "class", "svelte-j3lc8a");
			add_location(p1, file, 38, 2, 1056);
			add_location(strong1, file, 46, 4, 1337);
			add_location(strong2, file, 47, 4, 1371);
			add_location(strong3, file, 48, 4, 1406);
			add_location(strong4, file, 49, 4, 1446);
			add_location(strong5, file, 50, 4, 1479);
			add_location(strong6, file, 51, 4, 1511);
			add_location(strong7, file, 52, 4, 1543);
			add_location(strong8, file, 53, 4, 1575);
			add_location(strong9, file, 54, 4, 1606);
			add_location(strong10, file, 55, 4, 1644);
			add_location(strong11, file, 56, 4, 1697);
			add_location(strong12, file, 57, 4, 1731);
			add_location(strong13, file, 58, 8, 1768);
			attr(p2, "class", "svelte-j3lc8a");
			add_location(p2, file, 45, 2, 1329);
			add_location(strong14, file, 62, 4, 1874);
			add_location(strong15, file, 63, 4, 1921);
			attr(p3, "class", "svelte-j3lc8a");
			add_location(p3, file, 60, 2, 1811);
			attr(img, "src", "images/founders.jpg");
			attr(img, "alt", "the mighty founders");
			attr(img, "class", "svelte-j3lc8a");
			add_location(img, file, 65, 2, 1958);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-j3lc8a");
			add_location(div, file, 30, 0, 728);
		},
