...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-j105n5");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 70, 2, 1374);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-j105n5");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 82, 2, 1546);
			attr(div0, "class", "class-img-container svelte-j105n5");
			add_location(div0, file, 81, 0, 1510);
			attr(div1, "class", "space-maker svelte-j105n5");
			add_location(div1, file, 91, 2, 1704);
			attr(div2, "class", "brother-info");
			add_location(div2, file, 90, 0, 1675);
