...
function create_left_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t = claim_text(p_nodes, "Lorem ipsoumLorem ipsoumLorem ipsoum Lorem ipsoumLorem ipsoum Lorem\n    ipsoumLorem ipsoumLorem ipsoumLorem ipsoumLorem ipsoum Lorem ipsoumLorem\n    ipsoumLorem ipsoumLorem ipsoumLorem ipsoum Lorem ipsoumLorem ipsoum");
		...
		h: function hydrate() {
			...
			add_location(p, file$5, 93, 2, 1672);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 101, 4, 1991);
			attr(figcaption, "class", "svelte-1a2i6qs");
			add_location(figcaption, file$5, 110, 1, 2257);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 98, 2, 1918);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$5, 115, 2, 2363);
			attr(div1, "class", "pillars-div svelte-1a2i6qs");
			add_location(div1, file$5, 114, 0, 2335);
			add_location(br0, file$5, 123, 0, 2578);
			add_location(br1, file$5, 124, 0, 2585);
			add_location(br2, file$5, 125, 0, 2592);
			add_location(br3, file$5, 126, 0, 2599);
			add_location(br4, file$5, 127, 0, 2606);
			add_location(br5, file$5, 128, 0, 2613);
			add_location(br6, file$5, 129, 0, 2620);
			add_location(br7, file$5, 130, 0, 2627);
			add_location(br8, file$5, 131, 0, 2634);
			add_location(br9, file$5, 132, 0, 2641);
			add_location(br10, file$5, 133, 0, 2648);
			add_location(br11, file$5, 134, 0, 2655);
			add_location(br12, file$5, 135, 0, 2662);
			add_location(br13, file$5, 136, 0, 2669);
			add_location(br14, file$5, 137, 0, 2676);
			add_location(br15, file$5, 138, 0, 2683);
			add_location(br16, file$5, 139, 0, 2690);
			add_location(br17, file$5, 140, 0, 2697);
			add_location(br18, file$5, 141, 0, 2704);
			add_location(br19, file$5, 142, 0, 2711);
			add_location(br20, file$5, 143, 0, 2718);
			add_location(br21, file$5, 144, 0, 2725);
			add_location(br22, file$5, 145, 0, 2732);
			add_location(br23, file$5, 146, 0, 2739);
			add_location(br24, file$5, 147, 0, 2746);
			add_location(br25, file$5, 148, 0, 2753);
			add_location(br26, file$5, 149, 0, 2760);
			add_location(br27, file$5, 150, 0, 2767);
			add_location(br28, file$5, 151, 0, 2774);
			add_location(br29, file$5, 152, 0, 2781);
			add_location(br30, file$5, 153, 0, 2788);
			add_location(br31, file$5, 154, 0, 2795);
			add_location(br32, file$5, 155, 0, 2802);
			add_location(br33, file$5, 156, 0, 2809);
			add_location(br34, file$5, 157, 0, 2816);
			add_location(br35, file$5, 158, 0, 2823);
			add_location(br36, file$5, 159, 0, 2830);
			add_location(br37, file$5, 160, 0, 2837);
			add_location(br38, file$5, 161, 0, 2844);
			add_location(br39, file$5, 162, 0, 2851);
			add_location(br40, file$5, 163, 0, 2858);
			add_location(br41, file$5, 164, 0, 2865);
			add_location(br42, file$5, 165, 0, 2872);
			add_location(br43, file$5, 166, 0, 2879);
			add_location(br44, file$5, 167, 0, 2886);
			add_location(br45, file$5, 168, 0, 2893);
			add_location(br46, file$5, 169, 0, 2900);
			add_location(br47, file$5, 170, 0, 2907);
			add_location(br48, file$5, 171, 0, 2914);
			add_location(br49, file$5, 172, 0, 2921);
			add_location(br50, file$5, 173, 0, 2928);
			add_location(br51, file$5, 174, 0, 2935);
			add_location(br52, file$5, 175, 0, 2942);
			add_location(br53, file$5, 176, 0, 2949);
			add_location(br54, file$5, 177, 0, 2956);
			add_location(br55, file$5, 178, 0, 2963);
			add_location(br56, file$5, 179, 0, 2970);
			add_location(br57, file$5, 180, 0, 2977);
			add_location(br58, file$5, 181, 0, 2984);
			add_location(br59, file$5, 182, 0, 2991);
			add_location(br60, file$5, 183, 0, 2998);
			add_location(br61, file$5, 184, 0, 3005);
			add_location(br62, file$5, 185, 0, 3012);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 188, 2, 3038);
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 186, 0, 3019);
		},
