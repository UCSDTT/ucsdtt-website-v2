...
function create_fragment$2(ctx) {
	var ul, li0, h20, t0, t1, li1, h21, t2, t3, li2, h22, t4, t5, img;
	...
	return {
		...
		l: function claim(nodes) {
			...
			img = claim_element(ul_nodes, "IMG", { src: true, alt: true }, false);
		...
		h: function hydrate() {
			...
			add_location(h20, file$2, 27, 8, 546);
			attr(li0, "class", "svelte-1w49hoe");
			add_location(li0, file$2, 27, 4, 542);
			attr(h21, "class", "svelte-1w49hoe");
			add_location(h21, file$2, 28, 8, 580);
			attr(li1, "class", "svelte-1w49hoe");
			add_location(li1, file$2, 28, 4, 576);
			attr(h22, "class", "svelte-1w49hoe");
			add_location(h22, file$2, 29, 8, 615);
			attr(li2, "class", "svelte-1w49hoe");
			add_location(li2, file$2, 29, 4, 611);
			attr(img, "src", "icons/pillar-white.png");
			attr(img, "alt", "");
			add_location(img, file$2, 30, 4, 649);
