import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, E as svg_element, c as claim_element, b as children, f as detach, g as attr, F as set_style, h as add_location, j as insert, G as create_bidirectional_transition, e as element, a as space, d as claim_text, H as listen, q as transition_in, B as group_outros, r as transition_out, C as check_outros, I as run_all, t as text, m as mount_component, k as append, u as destroy_component } from './chunk.c39bcb07.js';
...
function create_if_block(ctx) {
	var path, path_transition, current;
	...
	return {
		...
		l: function claim(nodes) {
			path = claim_element(nodes, "path", { d: true, opacity: true, class: true, style: true, xmlns: true, viewBox: true }, true);
		...
		h: function hydrate() {
			...
			attr(path, "class", "parallax svelte-mhzkyt");
			set_style(path, "transform", "translate(0, " + ctx.sy * .4 + "px)");
			attr(path, "xmlns", "http://www.w3.org/2000/svg");
			attr(path, "viewBox", "0 0 64 64");
			add_location(path, file, 62, 3, 1064);
		},
		...
		i: function intro(local) {
			if (current) return;
			add_render_callback(() => {
				if (!path_transition) path_transition = create_bidirectional_transition(path, draw, {delay: 250, duration: 1000}, true);
		...
		o: function outro(local) {
			if (!path_transition) path_transition = create_bidirectional_transition(path, draw, {delay: 250, duration: 1000}, false);
...
function create_fragment(ctx) {
	var scrolling = false, clear_scrolling = () => { scrolling = false; }, scrolling_timeout, input, t, svg_1, current, dispose;
	...
	return {
		...
		l: function claim(nodes) {
			input = claim_element(nodes, "INPUT", { type: true }, false);
			var input_nodes = children(input);

			input_nodes.forEach(detach);
			t = claim_text(nodes, "\n\n\n");

			svg_1 = claim_element(nodes, "svg", {}, true);
			var svg_1_nodes = children(svg_1);

			if (if_block) if_block.l(svg_1_nodes);
		...
		h: function hydrate() {
			...
			add_location(input, file, 51, 0, 867);
			add_location(svg_1, file, 56, 0, 999);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(br0, file$1, 41, 0, 700);
			add_location(br1, file$1, 42, 0, 706);
			add_location(br2, file$1, 43, 0, 712);
			add_location(br3, file$1, 44, 0, 718);
			add_location(br4, file$1, 45, 0, 724);
			add_location(br5, file$1, 46, 0, 730);
			add_location(br6, file$1, 47, 0, 736);
			add_location(br7, file$1, 48, 0, 742);
			add_location(br8, file$1, 49, 0, 748);
			add_location(br9, file$1, 50, 0, 754);
			add_location(br10, file$1, 51, 0, 760);
			add_location(br11, file$1, 52, 0, 766);
			add_location(br12, file$1, 53, 0, 772);
			add_location(br13, file$1, 54, 0, 778);
			add_location(br14, file$1, 55, 0, 784);
			add_location(br15, file$1, 56, 0, 790);
			add_location(br16, file$1, 57, 0, 796);
			add_location(br17, file$1, 58, 0, 802);
			add_location(br18, file$1, 59, 0, 808);
			add_location(br19, file$1, 60, 0, 814);
			add_location(br20, file$1, 61, 0, 820);
			add_location(br21, file$1, 62, 0, 826);
			add_location(br22, file$1, 63, 0, 832);
			add_location(br23, file$1, 64, 0, 838);
			add_location(br24, file$1, 65, 0, 844);
			add_location(br25, file$1, 66, 0, 850);
			add_location(br26, file$1, 67, 0, 856);
			add_location(br27, file$1, 68, 0, 862);
			add_location(br28, file$1, 69, 0, 868);
			add_location(br29, file$1, 70, 0, 874);
			add_location(br30, file$1, 71, 0, 880);
			add_location(br31, file$1, 72, 0, 886);
			add_location(br32, file$1, 73, 0, 892);
			add_location(br33, file$1, 74, 0, 898);
			add_location(br34, file$1, 75, 0, 904);
			add_location(br35, file$1, 76, 0, 910);
			add_location(br36, file$1, 77, 0, 916);
			add_location(br37, file$1, 78, 0, 922);
			add_location(br38, file$1, 79, 0, 928);
			add_location(br39, file$1, 80, 0, 934);
			add_location(br40, file$1, 81, 0, 940);
			add_location(br41, file$1, 82, 0, 946);
			add_location(br42, file$1, 83, 0, 952);
			add_location(br43, file$1, 84, 0, 958);
			add_location(br44, file$1, 85, 0, 964);
			add_location(br45, file$1, 86, 0, 970);
			add_location(br46, file$1, 87, 0, 976);
			add_location(br47, file$1, 88, 0, 982);
			add_location(br48, file$1, 89, 0, 988);
			add_location(br49, file$1, 90, 0, 994);
			add_location(br50, file$1, 91, 0, 1000);
			add_location(br51, file$1, 92, 0, 1006);
			add_location(br52, file$1, 93, 0, 1012);
			add_location(br53, file$1, 94, 0, 1018);
			add_location(br54, file$1, 95, 0, 1024);
			add_location(br55, file$1, 96, 0, 1030);
			add_location(br56, file$1, 97, 0, 1036);
			add_location(br57, file$1, 98, 0, 1042);
			add_location(br58, file$1, 99, 0, 1048);
			add_location(br59, file$1, 100, 0, 1054);
			add_location(br60, file$1, 101, 0, 1060);
			add_location(br61, file$1, 102, 0, 1066);
			add_location(br62, file$1, 103, 0, 1072);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$1, 104, 14, 1092);
			attr(p, "class", "svelte-sazog6");
			add_location(p, file$1, 104, 0, 1078);
		},
