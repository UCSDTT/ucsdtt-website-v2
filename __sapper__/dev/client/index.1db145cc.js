...
function create_header_slot$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "slot", "header");
			add_location(h3, file$5, 92, 2, 1598);
		},
...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p, "slot", "left");
			attr(p, "class", "svelte-1e1w67u");
			add_location(p, file$5, 93, 2, 1670);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 99, 4, 1942);
			attr(figcaption, "class", "svelte-1e1w67u");
			add_location(figcaption, file$5, 108, 1, 2209);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 98, 2, 1916);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div0, "class", "hero-div svelte-1e1w67u");
			add_location(div0, file$5, 81, 0, 1396);
			attr(h1, "class", "svelte-1e1w67u");
			add_location(h1, file$5, 113, 2, 2315);
			attr(div1, "class", "pillars-div svelte-1e1w67u");
			add_location(div1, file$5, 112, 0, 2287);
			add_location(br0, file$5, 121, 0, 2530);
			add_location(br1, file$5, 122, 0, 2537);
			add_location(br2, file$5, 123, 0, 2544);
			add_location(br3, file$5, 124, 0, 2551);
			add_location(br4, file$5, 125, 0, 2558);
			add_location(br5, file$5, 126, 0, 2565);
			add_location(br6, file$5, 127, 0, 2572);
			add_location(br7, file$5, 128, 0, 2579);
			add_location(br8, file$5, 129, 0, 2586);
			add_location(br9, file$5, 130, 0, 2593);
			add_location(br10, file$5, 131, 0, 2600);
			add_location(br11, file$5, 132, 0, 2607);
			add_location(br12, file$5, 133, 0, 2614);
			add_location(br13, file$5, 134, 0, 2621);
			add_location(br14, file$5, 135, 0, 2628);
			add_location(br15, file$5, 136, 0, 2635);
			add_location(br16, file$5, 137, 0, 2642);
			add_location(br17, file$5, 138, 0, 2649);
			add_location(br18, file$5, 139, 0, 2656);
			add_location(br19, file$5, 140, 0, 2663);
			add_location(br20, file$5, 141, 0, 2670);
			add_location(br21, file$5, 142, 0, 2677);
			add_location(br22, file$5, 143, 0, 2684);
			add_location(br23, file$5, 144, 0, 2691);
			add_location(br24, file$5, 145, 0, 2698);
			add_location(br25, file$5, 146, 0, 2705);
			add_location(br26, file$5, 147, 0, 2712);
			add_location(br27, file$5, 148, 0, 2719);
			add_location(br28, file$5, 149, 0, 2726);
			add_location(br29, file$5, 150, 0, 2733);
			add_location(br30, file$5, 151, 0, 2740);
			add_location(br31, file$5, 152, 0, 2747);
			add_location(br32, file$5, 153, 0, 2754);
			add_location(br33, file$5, 154, 0, 2761);
			add_location(br34, file$5, 155, 0, 2768);
			add_location(br35, file$5, 156, 0, 2775);
			add_location(br36, file$5, 157, 0, 2782);
			add_location(br37, file$5, 158, 0, 2789);
			add_location(br38, file$5, 159, 0, 2796);
			add_location(br39, file$5, 160, 0, 2803);
			add_location(br40, file$5, 161, 0, 2810);
			add_location(br41, file$5, 162, 0, 2817);
			add_location(br42, file$5, 163, 0, 2824);
			add_location(br43, file$5, 164, 0, 2831);
			add_location(br44, file$5, 165, 0, 2838);
			add_location(br45, file$5, 166, 0, 2845);
			add_location(br46, file$5, 167, 0, 2852);
			add_location(br47, file$5, 168, 0, 2859);
			add_location(br48, file$5, 169, 0, 2866);
			add_location(br49, file$5, 170, 0, 2873);
			add_location(br50, file$5, 171, 0, 2880);
			add_location(br51, file$5, 172, 0, 2887);
			add_location(br52, file$5, 173, 0, 2894);
			add_location(br53, file$5, 174, 0, 2901);
			add_location(br54, file$5, 175, 0, 2908);
			add_location(br55, file$5, 176, 0, 2915);
			add_location(br56, file$5, 177, 0, 2922);
			add_location(br57, file$5, 178, 0, 2929);
			add_location(br58, file$5, 179, 0, 2936);
			add_location(br59, file$5, 180, 0, 2943);
			add_location(br60, file$5, 181, 0, 2950);
			add_location(br61, file$5, 182, 0, 2957);
			add_location(br62, file$5, 183, 0, 2964);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 186, 2, 2990);
			attr(p, "class", "svelte-1e1w67u");
			add_location(p, file$5, 184, 0, 2971);
		},
