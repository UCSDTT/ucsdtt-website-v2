...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 209, 2, 4702);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-1ikbvcr");
			add_location(select, file, 154, 4, 3437);
			attr(h4, "class", "svelte-1ikbvcr");
			add_location(h4, file, 153, 2, 3403);
			attr(div0, "class", "space-maker svelte-1ikbvcr");
			add_location(div0, file, 164, 2, 3662);
			attr(img, "class", "class-img svelte-1ikbvcr");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 179, 4, 3912);
			attr(div1, "class", "class-img-container svelte-1ikbvcr");
			add_location(div1, file, 178, 2, 3874);
			attr(div2, "class", "brother-info svelte-1ikbvcr");
			add_location(div2, file, 187, 2, 4055);
...
// (156:6) {#each Object.keys(pledgeClasses) as key}
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 156, 8, 3567);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1ikbvcr");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 167, 4, 3718);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-1ikbvcr");
			add_location(h4, file, 203, 6, 4573);
		},
...
// (191:8) {#if curBrother[key].length !== 0 &&            key !== 'pixelLocationX' &&           key !== 'pixelLocationY' &&           key !== 'city, state, country' &&           key !== 'email' &&           key !== 'last updated' &&           key !== 'what i do' &&           key !== 'phone number'         }
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h5, "class", "brother-key svelte-1ikbvcr");
			add_location(h5, file, 199, 10, 4465);
			attr(h4, "class", "svelte-1ikbvcr");
			add_location(h4, file, 199, 45, 4500);
		},
...
// (190:6) {#each Object.keys(curBrother) as key}
