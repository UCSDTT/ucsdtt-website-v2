...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-9z0vg9");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p0, "class", "svelte-9z0vg9");
			add_location(p0, file, 65, 0, 1281);
			attr(p1, "class", "svelte-9z0vg9");
			add_location(p1, file, 66, 0, 1296);
			attr(p2, "class", "svelte-9z0vg9");
			add_location(p2, file, 67, 0, 1311);
			attr(p3, "class", "svelte-9z0vg9");
			add_location(p3, file, 68, 0, 1326);
			attr(img, "class", "class-img svelte-9z0vg9");
			...
			attr(div, "class", "class-img-container svelte-9z0vg9");
