...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-qrdptg");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 78, 2, 1550);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file, 75, 0, 1505);
			attr(img, "class", "class-img svelte-qrdptg");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 90, 2, 1722);
			attr(div0, "class", "class-img-container svelte-qrdptg");
			add_location(div0, file, 89, 0, 1686);
			add_location(h2, file, 99, 2, 1880);
			add_location(h3, file, 100, 2, 1918);
			attr(div1, "class", "brother-info svelte-qrdptg");
			add_location(div1, file, 98, 0, 1851);
