import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, E as svg_element, c as claim_element, b as children, f as detach, g as attr, h as add_location, j as insert, F as create_in_transition, G as create_out_transition, e as element, a as space, d as claim_text, H as set_style, I as listen, q as transition_in, B as group_outros, r as transition_out, C as check_outros, J as run_all, K as onMount, t as text, m as mount_component, k as append, u as destroy_component } from './chunk.cabcdd3c.js';
...
function create_if_block(ctx) {
	var path, path_intro, path_outro, current;
	...
	return {
		...
		i: function intro(local) {
			...
			add_render_callback(() => {
				...
				if (!path_intro) path_intro = create_in_transition(path, draw, {delay: 250, duration: 1000});
				path_intro.start();
			});
		...
		o: function outro(local) {
			...
			path_outro = create_out_transition(path, fade, {});
