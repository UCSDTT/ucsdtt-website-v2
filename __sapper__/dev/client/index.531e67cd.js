...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h1, "class", "text-display lg-view svelte-1u62lrc");
			add_location(h1, file, 59, 1, 1047);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = ($$dirty = { iw: 1 }) => {
		if ($$dirty.iw) { $$invalidate('dispSmall', dispSmall = iw <= 1200); }
	};
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(br0, file$1, 42, 0, 727);
			add_location(br1, file$1, 43, 0, 733);
			add_location(br2, file$1, 44, 0, 739);
			add_location(br3, file$1, 45, 0, 745);
			add_location(br4, file$1, 46, 0, 751);
			add_location(br5, file$1, 47, 0, 757);
			add_location(br6, file$1, 48, 0, 763);
			add_location(br7, file$1, 49, 0, 769);
			add_location(br8, file$1, 50, 0, 775);
			add_location(br9, file$1, 51, 0, 781);
			add_location(br10, file$1, 52, 0, 787);
			add_location(br11, file$1, 53, 0, 793);
			add_location(br12, file$1, 54, 0, 799);
			add_location(br13, file$1, 55, 0, 805);
			add_location(br14, file$1, 56, 0, 811);
			add_location(br15, file$1, 57, 0, 817);
			add_location(br16, file$1, 58, 0, 823);
			add_location(br17, file$1, 59, 0, 829);
			add_location(br18, file$1, 60, 0, 835);
			add_location(br19, file$1, 61, 0, 841);
			add_location(br20, file$1, 62, 0, 847);
			add_location(br21, file$1, 63, 0, 853);
			add_location(br22, file$1, 64, 0, 859);
			add_location(br23, file$1, 65, 0, 865);
			add_location(br24, file$1, 66, 0, 871);
			add_location(br25, file$1, 67, 0, 877);
			add_location(br26, file$1, 68, 0, 883);
			add_location(br27, file$1, 69, 0, 889);
			add_location(br28, file$1, 70, 0, 895);
			add_location(br29, file$1, 71, 0, 901);
			add_location(br30, file$1, 72, 0, 907);
			add_location(br31, file$1, 73, 0, 913);
			add_location(br32, file$1, 74, 0, 919);
			add_location(br33, file$1, 75, 0, 925);
			add_location(br34, file$1, 76, 0, 931);
			add_location(br35, file$1, 77, 0, 937);
			add_location(br36, file$1, 78, 0, 943);
			add_location(br37, file$1, 79, 0, 949);
			add_location(br38, file$1, 80, 0, 955);
			add_location(br39, file$1, 81, 0, 961);
			add_location(br40, file$1, 82, 0, 967);
			add_location(br41, file$1, 83, 0, 973);
			add_location(br42, file$1, 84, 0, 979);
			add_location(br43, file$1, 85, 0, 985);
			add_location(br44, file$1, 86, 0, 991);
			add_location(br45, file$1, 87, 0, 997);
			add_location(br46, file$1, 88, 0, 1003);
			add_location(br47, file$1, 89, 0, 1009);
			add_location(br48, file$1, 90, 0, 1015);
			add_location(br49, file$1, 91, 0, 1021);
			add_location(br50, file$1, 92, 0, 1027);
			add_location(br51, file$1, 93, 0, 1033);
			add_location(br52, file$1, 94, 0, 1039);
			add_location(br53, file$1, 95, 0, 1045);
			add_location(br54, file$1, 96, 0, 1051);
			add_location(br55, file$1, 97, 0, 1057);
			add_location(br56, file$1, 98, 0, 1063);
			add_location(br57, file$1, 99, 0, 1069);
			add_location(br58, file$1, 100, 0, 1075);
			add_location(br59, file$1, 101, 0, 1081);
			add_location(br60, file$1, 102, 0, 1087);
			add_location(br61, file$1, 103, 0, 1093);
			add_location(br62, file$1, 104, 0, 1099);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$1, 105, 14, 1119);
			attr(p, "class", "svelte-sazog6");
			add_location(p, file$1, 105, 0, 1105);
		},
