import { S as SvelteComponentDev, i as init, s as safe_not_equal, D as add_render_callback, e as element, t as text, a as space, x as empty, c as claim_element, b as children, d as claim_text, f as detach, h as add_location, H as listen, j as insert, k as append, g as attr, n as noop, I as run_all, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.b5534b6a.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 60, 6, 1311);
			attr(div0, "class", "class-img-container svelte-15e2r1d");
			add_location(div0, file, 59, 4, 1271);
			attr(div1, "class", "pledge-classes");
			add_location(div1, file, 58, 2, 1238);
...
function create_fragment(ctx) {
	var scrolling = false, clear_scrolling = () => { scrolling = false; }, scrolling_timeout, button, t0, t1, if_block_anchor, dispose;
	...
	return {
		...
		h: function hydrate() {
			add_location(button, file, 56, 0, 1172);
			...
			dispose = [
				...
				listen(button, "click", toggleVisible)
			];
		},
