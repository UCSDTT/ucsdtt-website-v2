...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 34, 0, 556);
			add_location(h30, file, 36, 0, 572);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-r3zjye");
			add_location(img0, file, 40, 2, 679);
			add_location(h31, file, 41, 2, 723);
			attr(div0, "class", "pillar svelte-r3zjye");
			add_location(div0, file, 39, 1, 656);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-r3zjye");
			add_location(img1, file, 44, 2, 776);
			add_location(h32, file, 45, 2, 820);
			attr(div1, "class", "pillar svelte-r3zjye");
			add_location(div1, file, 43, 1, 753);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-r3zjye");
			add_location(img2, file, 48, 2, 874);
			add_location(h33, file, 49, 2, 918);
			attr(div2, "class", "pillar svelte-r3zjye");
			add_location(div2, file, 47, 1, 851);
			attr(div3, "class", "pillars svelte-r3zjye");
