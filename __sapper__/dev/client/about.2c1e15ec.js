...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-x54pi2");
			add_location(h1, file, 24, 2, 569);
			attr(p, "class", "svelte-x54pi2");
			add_location(p, file, 25, 2, 624);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-x54pi2");
			add_location(div, file, 23, 0, 549);
		},
