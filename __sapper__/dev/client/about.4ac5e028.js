...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-1pgazdh");
			add_location(h1, file$1, 44, 2, 989);
			attr(p0, "class", "svelte-1pgazdh");
			add_location(p0, file$1, 45, 2, 1044);
			add_location(strong0, file$1, 52, 4, 1305);
			attr(p1, "class", "svelte-1pgazdh");
			add_location(p1, file$1, 51, 2, 1297);
			add_location(strong1, file$1, 59, 4, 1577);
			add_location(strong2, file$1, 60, 4, 1611);
			add_location(strong3, file$1, 61, 4, 1646);
			add_location(strong4, file$1, 62, 4, 1686);
			add_location(strong5, file$1, 63, 4, 1719);
			add_location(strong6, file$1, 64, 4, 1751);
			add_location(strong7, file$1, 65, 4, 1783);
			add_location(strong8, file$1, 66, 4, 1815);
			add_location(strong9, file$1, 67, 4, 1846);
			add_location(strong10, file$1, 68, 4, 1884);
			add_location(strong11, file$1, 69, 4, 1937);
			add_location(strong12, file$1, 70, 4, 1971);
			add_location(strong13, file$1, 71, 8, 2008);
			attr(p2, "class", "svelte-1pgazdh");
			add_location(p2, file$1, 58, 2, 1569);
			add_location(strong14, file$1, 75, 4, 2114);
			add_location(strong15, file$1, 76, 4, 2161);
			attr(p3, "class", "svelte-1pgazdh");
			add_location(p3, file$1, 73, 2, 2051);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-1pgazdh");
			add_location(img0, file$1, 78, 2, 2198);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-1pgazdh");
			add_location(img1, file$1, 79, 2, 2272);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-1pgazdh");
