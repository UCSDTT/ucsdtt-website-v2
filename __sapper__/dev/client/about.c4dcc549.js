...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-bxejwi");
			add_location(img, file, 58, 6, 1122);
			attr(div, "class", "carousel svelte-bxejwi");
			add_location(div, file, 57, 4, 1093);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-bxejwi");
			add_location(div, file, 55, 0, 1042);
		},
