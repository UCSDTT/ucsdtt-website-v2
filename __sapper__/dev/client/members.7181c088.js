...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p0, file, 58, 0, 1172);
			add_location(p1, file, 59, 0, 1187);
			add_location(p2, file, 60, 0, 1202);
			add_location(p3, file, 61, 0, 1217);
			attr(div0, "class", "cursor-box svelte-6dd0yn");
			set_style(div0, "top", ctx.picY);
			set_style(div0, "left", ctx.picX);
			add_location(div0, file, 65, 0, 1301);
			attr(img, "class", "class-img");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 75, 2, 1423);
			attr(div1, "class", "class-img-container svelte-6dd0yn");
			add_location(div1, file, 74, 0, 1387);
