...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1po7eq3");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 74, 2, 1468);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file, 71, 0, 1423);
			attr(img, "class", "class-img svelte-1po7eq3");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 86, 2, 1640);
			attr(div0, "class", "class-img-container svelte-1po7eq3");
			add_location(div0, file, 85, 0, 1604);
			attr(div1, "class", "brother-info svelte-1po7eq3");
			add_location(div1, file, 94, 0, 1769);
