...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 68, 12, 1520);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal");
			add_location(span, file$1, 71, 12, 1612);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 66, 4, 1476);
			add_location(section, file$1, 65, 0, 1462);
		},
