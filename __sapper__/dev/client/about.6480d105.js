...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-3ihyjs");
			add_location(img, file, 52, 6, 1002);
			attr(div, "class", "carousel svelte-3ihyjs");
			add_location(div, file, 51, 4, 973);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-3ihyjs");
			add_location(div, file, 49, 0, 922);
		},
