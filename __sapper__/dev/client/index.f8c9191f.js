...
function create_header_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "modal-li svelte-1utocez");
			attr(h2, "slot", "header");
			add_location(h2, file$3, 77, 8, 1673);
		},
...
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-1utocez");
			add_location(li0, file$3, 79, 12, 1750);
			attr(li1, "class", "modal-li svelte-1utocez");
			add_location(li1, file$3, 80, 12, 1800);
			attr(li2, "class", "modal-li svelte-1utocez");
			add_location(li2, file$3, 81, 12, 1850);
			attr(li3, "class", "modal-li svelte-1utocez");
			add_location(li3, file$3, 82, 12, 1900);
			attr(li4, "class", "modal-li svelte-1utocez");
			add_location(li4, file$3, 83, 12, 1950);
			add_location(ul, file$3, 78, 8, 1733);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 85, 8, 2010);
		},
...
function create_header_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "modal-li svelte-1utocez");
			attr(h2, "slot", "header");
			add_location(h2, file$3, 91, 8, 2169);
		},
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-1utocez");
			add_location(li0, file$3, 93, 12, 2247);
			attr(li1, "class", "modal-li svelte-1utocez");
			add_location(li1, file$3, 94, 12, 2297);
			attr(li2, "class", "modal-li svelte-1utocez");
			add_location(li2, file$3, 95, 12, 2347);
			attr(li3, "class", "modal-li svelte-1utocez");
			add_location(li3, file$3, 96, 12, 2397);
			attr(li4, "class", "modal-li svelte-1utocez");
			add_location(li4, file$3, 97, 12, 2447);
			add_location(ul, file$3, 92, 8, 2230);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 99, 8, 2507);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "class", "modal-li svelte-1utocez");
			attr(h2, "slot", "header");
			add_location(h2, file$3, 105, 8, 2664);
		},
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-1utocez");
			add_location(li0, file$3, 107, 12, 2745);
			attr(li1, "class", "modal-li svelte-1utocez");
			add_location(li1, file$3, 108, 12, 2795);
			attr(li2, "class", "modal-li svelte-1utocez");
			add_location(li2, file$3, 109, 12, 2845);
			attr(li3, "class", "modal-li svelte-1utocez");
			add_location(li3, file$3, 110, 12, 2895);
			attr(li4, "class", "modal-li svelte-1utocez");
			add_location(li4, file$3, 111, 12, 2945);
			add_location(ul, file$3, 106, 8, 2728);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 113, 8, 3005);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1utocez");
			add_location(img0, file$3, 62, 8, 1224);
			attr(span0, "class", "svelte-1utocez");
			add_location(span0, file$3, 63, 8, 1280);
			attr(li0, "class", "svelte-1utocez");
			add_location(li0, file$3, 61, 4, 1180);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1utocez");
			add_location(img1, file$3, 66, 8, 1364);
			attr(span1, "class", "svelte-1utocez");
			add_location(span1, file$3, 67, 8, 1420);
			attr(li1, "class", "svelte-1utocez");
			add_location(li1, file$3, 65, 4, 1319);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1utocez");
			add_location(img2, file$3, 70, 8, 1504);
			attr(span2, "class", "svelte-1utocez");
			add_location(span2, file$3, 71, 8, 1560);
			attr(li2, "class", "svelte-1utocez");
			add_location(li2, file$3, 69, 4, 1460);
			attr(ul, "class", "pillared svelte-1utocez");
			add_location(ul, file$3, 60, 0, 1154);
