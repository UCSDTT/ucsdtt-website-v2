...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong, file$3, 77, 4, 1325);
			attr(h3, "slot", "header");
			add_location(h3, file$3, 76, 2, 1302);
		},
...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(strong0, file$3, 82, 6, 1512);
			add_location(strong1, file$3, 85, 6, 1746);
			add_location(strong2, file$3, 87, 6, 1789);
			add_location(strong3, file$3, 89, 6, 1837);
			attr(p0, "class", "svelte-1fm1lc2");
			add_location(p0, file$3, 80, 4, 1424);
			add_location(strong4, file$3, 98, 6, 2274);
			attr(p1, "class", "svelte-1fm1lc2");
			add_location(p1, file$3, 92, 4, 1891);
			add_location(strong5, file$3, 103, 6, 2438);
			attr(p2, "class", "svelte-1fm1lc2");
			add_location(p2, file$3, 101, 4, 2350);
			attr(section, "slot", "left");
			add_location(section, file$3, 79, 2, 1398);
		},
...
function create_if_block$2(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			iframe = claim_element(nodes, "IFRAME", { width: true, title: true, "max-width": true, src: true, frameborder: true, allow: true, allowfullscreen: true }, false);
		...
		h: function hydrate() {
			...
			add_location(iframe, file$3, 113, 6, 2650);
			attr(figcaption, "class", "svelte-1fm1lc2");
			add_location(figcaption, file$3, 122, 6, 2958);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(figure, file$3, 107, 2, 2505);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-1fm1lc2");
			add_location(div, file$3, 65, 0, 1100);
