...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-ickrhf");
			add_location(img, file, 84, 8, 1523);
			attr(div, "class", "carousel svelte-ickrhf");
			add_location(div, file, 83, 6, 1492);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-ickrhf");
			add_location(button0, file, 80, 2, 1377);
			attr(div0, "class", "carousel-wrapper svelte-ickrhf");
			add_location(div0, file, 81, 2, 1437);
			attr(button1, "class", "carousel-button button-right svelte-ickrhf");
			add_location(button1, file, 88, 2, 1631);
			attr(div1, "class", "button-wrapper svelte-ickrhf");
			add_location(div1, file, 79, 0, 1346);
		},
