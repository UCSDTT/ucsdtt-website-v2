...
function create_header_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 69, 8, 1536);
		},
...
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 71, 12, 1596);
			add_location(li1, file$3, 72, 12, 1629);
			add_location(li2, file$3, 73, 12, 1662);
			add_location(li3, file$3, 74, 12, 1695);
			add_location(li4, file$3, 75, 12, 1728);
			add_location(ul, file$3, 70, 8, 1579);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 77, 8, 1771);
		},
...
function create_header_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 83, 8, 1930);
		},
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 85, 12, 1991);
			add_location(li1, file$3, 86, 12, 2024);
			add_location(li2, file$3, 87, 12, 2057);
			add_location(li3, file$3, 88, 12, 2090);
			add_location(li4, file$3, 89, 12, 2123);
			add_location(ul, file$3, 84, 8, 1974);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 91, 8, 2166);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 97, 8, 2323);
		},
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 99, 12, 2387);
			add_location(li1, file$3, 100, 12, 2420);
			add_location(li2, file$3, 101, 12, 2453);
			add_location(li3, file$3, 102, 12, 2486);
			add_location(li4, file$3, 103, 12, 2519);
			add_location(ul, file$3, 98, 8, 2370);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 105, 8, 2562);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-cw6hkh");
			add_location(img0, file$3, 54, 8, 1087);
			attr(span0, "class", "svelte-cw6hkh");
			add_location(span0, file$3, 55, 8, 1143);
			attr(li0, "class", "svelte-cw6hkh");
			add_location(li0, file$3, 53, 4, 1043);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-cw6hkh");
			add_location(img1, file$3, 58, 8, 1227);
			attr(span1, "class", "svelte-cw6hkh");
			add_location(span1, file$3, 59, 8, 1283);
			attr(li1, "class", "svelte-cw6hkh");
			add_location(li1, file$3, 57, 4, 1182);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-cw6hkh");
			add_location(img2, file$3, 62, 8, 1367);
			attr(span2, "class", "svelte-cw6hkh");
			add_location(span2, file$3, 63, 8, 1423);
			attr(li2, "class", "svelte-cw6hkh");
			add_location(li2, file$3, 61, 4, 1323);
			attr(ul, "class", "pillared svelte-cw6hkh");
			add_location(ul, file$3, 52, 0, 1017);
