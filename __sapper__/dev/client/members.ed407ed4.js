...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-sbaidr");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-sbaidr");
			...
			attr(div0, "class", "class-img-container svelte-sbaidr");
			add_location(div0, file, 81, 0, 1517);
			add_location(h3, file, 91, 2, 1711);
			attr(div1, "class", "brother-info svelte-sbaidr");
