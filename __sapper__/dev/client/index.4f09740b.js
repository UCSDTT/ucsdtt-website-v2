...
function create_header_slot$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "slot", "header");
			add_location(h3, file$5, 76, 1, 1410);
		},
...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(p, file$5, 77, 1, 1481);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p, "slot", "right");
			attr(p, "class", "svelte-ls5l35");
			add_location(p, file$5, 81, 1, 1713);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$5, 64, 0, 1216);
			attr(h1, "class", "svelte-ls5l35");
			add_location(h1, file$5, 88, 1, 1981);
			attr(div1, "class", "pillars-div svelte-ls5l35");
			add_location(div1, file$5, 87, 0, 1954);
			add_location(br0, file$5, 96, 0, 2195);
			add_location(br1, file$5, 97, 0, 2201);
			add_location(br2, file$5, 98, 0, 2207);
			add_location(br3, file$5, 99, 0, 2213);
			add_location(br4, file$5, 100, 0, 2219);
			add_location(br5, file$5, 101, 0, 2225);
			add_location(br6, file$5, 102, 0, 2231);
			add_location(br7, file$5, 103, 0, 2237);
			add_location(br8, file$5, 104, 0, 2243);
			add_location(br9, file$5, 105, 0, 2249);
			add_location(br10, file$5, 106, 0, 2255);
			add_location(br11, file$5, 107, 0, 2261);
			add_location(br12, file$5, 108, 0, 2267);
			add_location(br13, file$5, 109, 0, 2273);
			add_location(br14, file$5, 110, 0, 2279);
			add_location(br15, file$5, 111, 0, 2285);
			add_location(br16, file$5, 112, 0, 2291);
			add_location(br17, file$5, 113, 0, 2297);
			add_location(br18, file$5, 114, 0, 2303);
			add_location(br19, file$5, 115, 0, 2309);
			add_location(br20, file$5, 116, 0, 2315);
			add_location(br21, file$5, 117, 0, 2321);
			add_location(br22, file$5, 118, 0, 2327);
			add_location(br23, file$5, 119, 0, 2333);
			add_location(br24, file$5, 120, 0, 2339);
			add_location(br25, file$5, 121, 0, 2345);
			add_location(br26, file$5, 122, 0, 2351);
			add_location(br27, file$5, 123, 0, 2357);
			add_location(br28, file$5, 124, 0, 2363);
			add_location(br29, file$5, 125, 0, 2369);
			add_location(br30, file$5, 126, 0, 2375);
			add_location(br31, file$5, 127, 0, 2381);
			add_location(br32, file$5, 128, 0, 2387);
			add_location(br33, file$5, 129, 0, 2393);
			add_location(br34, file$5, 130, 0, 2399);
			add_location(br35, file$5, 131, 0, 2405);
			add_location(br36, file$5, 132, 0, 2411);
			add_location(br37, file$5, 133, 0, 2417);
			add_location(br38, file$5, 134, 0, 2423);
			add_location(br39, file$5, 135, 0, 2429);
			add_location(br40, file$5, 136, 0, 2435);
			add_location(br41, file$5, 137, 0, 2441);
			add_location(br42, file$5, 138, 0, 2447);
			add_location(br43, file$5, 139, 0, 2453);
			add_location(br44, file$5, 140, 0, 2459);
			add_location(br45, file$5, 141, 0, 2465);
			add_location(br46, file$5, 142, 0, 2471);
			add_location(br47, file$5, 143, 0, 2477);
			add_location(br48, file$5, 144, 0, 2483);
			add_location(br49, file$5, 145, 0, 2489);
			add_location(br50, file$5, 146, 0, 2495);
			add_location(br51, file$5, 147, 0, 2501);
			add_location(br52, file$5, 148, 0, 2507);
			add_location(br53, file$5, 149, 0, 2513);
			add_location(br54, file$5, 150, 0, 2519);
			add_location(br55, file$5, 151, 0, 2525);
			add_location(br56, file$5, 152, 0, 2531);
			add_location(br57, file$5, 153, 0, 2537);
			add_location(br58, file$5, 154, 0, 2543);
			add_location(br59, file$5, 155, 0, 2549);
			add_location(br60, file$5, 156, 0, 2555);
			add_location(br61, file$5, 157, 0, 2561);
			add_location(br62, file$5, 158, 0, 2567);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 159, 14, 2587);
			attr(p, "class", "svelte-ls5l35");
			add_location(p, file$5, 159, 0, 2573);
		},
