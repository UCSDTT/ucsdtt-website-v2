...
function create_header_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 71, 8, 1579);
		},
...
// (71:4) <Modal on:close="{() => broVis = false}">
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 73, 12, 1639);
			add_location(li1, file$3, 74, 12, 1672);
			add_location(li2, file$3, 75, 12, 1705);
			add_location(li3, file$3, 76, 12, 1738);
			add_location(li4, file$3, 77, 12, 1771);
			add_location(ul, file$3, 72, 8, 1622);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 79, 8, 1814);
		},
...
function create_header_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 85, 8, 1973);
		},
...
// (85:4) <Modal on:close="{() => philVis = false}">
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 87, 12, 2034);
			add_location(li1, file$3, 88, 12, 2067);
			add_location(li2, file$3, 89, 12, 2100);
			add_location(li3, file$3, 90, 12, 2133);
			add_location(li4, file$3, 91, 12, 2166);
			add_location(ul, file$3, 86, 8, 2017);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 93, 8, 2209);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 99, 8, 2366);
		},
...
// (99:4) <Modal on:close="{() => proVis = false}">
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-1teh65m");
			add_location(li0, file$3, 101, 12, 2447);
			attr(li1, "class", "modal-li svelte-1teh65m");
			add_location(li1, file$3, 102, 12, 2497);
			attr(li2, "class", "modal-li svelte-1teh65m");
			add_location(li2, file$3, 103, 12, 2547);
			attr(li3, "class", "modal-li svelte-1teh65m");
			add_location(li3, file$3, 104, 12, 2597);
			attr(li4, "class", "modal-li svelte-1teh65m");
			add_location(li4, file$3, 105, 12, 2647);
			attr(ul, "class", "pillared svelte-1teh65m");
			add_location(ul, file$3, 100, 8, 2413);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 107, 8, 2707);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1teh65m");
			add_location(img0, file$3, 56, 8, 1130);
			attr(span0, "class", "svelte-1teh65m");
			add_location(span0, file$3, 57, 8, 1186);
			attr(li0, "class", "svelte-1teh65m");
			add_location(li0, file$3, 55, 4, 1086);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1teh65m");
			add_location(img1, file$3, 60, 8, 1270);
			attr(span1, "class", "svelte-1teh65m");
			add_location(span1, file$3, 61, 8, 1326);
			attr(li1, "class", "svelte-1teh65m");
			add_location(li1, file$3, 59, 4, 1225);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1teh65m");
			add_location(img2, file$3, 64, 8, 1410);
			attr(span2, "class", "svelte-1teh65m");
			add_location(span2, file$3, 65, 8, 1466);
			attr(li2, "class", "svelte-1teh65m");
			add_location(li2, file$3, 63, 4, 1366);
			attr(ul, "class", "pillared svelte-1teh65m");
			add_location(ul, file$3, 54, 0, 1060);
