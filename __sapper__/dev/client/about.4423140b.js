...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 47, 0, 784);
			add_location(h3, file, 49, 0, 800);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-1ty2on5");
			add_location(img0, file, 53, 4, 910);
			attr(h40, "class", "svelte-1ty2on5");
			add_location(h40, file, 54, 4, 958);
			add_location(p0, file, 55, 4, 983);
			attr(div0, "class", "pillar svelte-1ty2on5");
			add_location(div0, file, 52, 2, 885);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1ty2on5");
			add_location(img1, file, 63, 4, 1319);
			attr(h41, "class", "svelte-1ty2on5");
			add_location(h41, file, 64, 4, 1367);
			add_location(p1, file, 65, 4, 1393);
			attr(div1, "class", "pillar svelte-1ty2on5");
			add_location(div1, file, 62, 2, 1294);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1ty2on5");
			add_location(img2, file, 74, 4, 1756);
			attr(h42, "class", "svelte-1ty2on5");
			add_location(h42, file, 75, 4, 1804);
			add_location(p2, file, 76, 4, 1833);
			attr(div2, "class", "pillar svelte-1ty2on5");
			add_location(div2, file, 73, 2, 1731);
			attr(div3, "class", "pillars svelte-1ty2on5");
			add_location(div3, file, 51, 0, 861);
		},
