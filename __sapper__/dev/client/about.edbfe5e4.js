...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 40, 0, 615);
			add_location(h3, file, 42, 0, 631);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-1nh349");
			add_location(img0, file, 46, 2, 738);
			add_location(h40, file, 47, 2, 782);
			attr(div0, "class", "pillar svelte-1nh349");
			add_location(div0, file, 45, 1, 715);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1nh349");
			add_location(img1, file, 50, 2, 835);
			add_location(h41, file, 51, 2, 879);
			attr(div1, "class", "pillar svelte-1nh349");
			add_location(div1, file, 49, 1, 812);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1nh349");
			add_location(img2, file, 54, 2, 933);
			add_location(h42, file, 55, 2, 977);
			attr(div2, "class", "pillar svelte-1nh349");
			add_location(div2, file, 53, 1, 910);
			attr(div3, "class", "pillars svelte-1nh349");
			add_location(div3, file, 44, 0, 692);
		},
