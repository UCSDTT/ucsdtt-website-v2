...
import { f as fade, P as Pillars } from './chunk.a3641b35.js';
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-left svelte-gw26yu");
			add_location(button, file, 135, 6, 2738);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-gw26yu");
			add_location(img, file, 142, 10, 2952);
			attr(div, "class", "carousel svelte-gw26yu");
			add_location(div, file, 141, 8, 2918);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-right svelte-gw26yu");
			add_location(button, file, 150, 6, 3135);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-gw26yu");
			add_location(div0, file, 139, 4, 2857);
			attr(div1, "class", "button-wrapper svelte-gw26yu");
			add_location(div1, file, 133, 2, 2681);
			attr(figcaption, "class", "carousel-caption svelte-gw26yu");
			add_location(figcaption, file, 155, 2, 3263);
			attr(figure, "class", "figure-wrapper svelte-gw26yu");
			add_location(figure, file, 132, 0, 2646);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-1ad3szv");
			add_location(h1, file$1, 44, 2, 1022);
			attr(p0, "class", "svelte-1ad3szv");
			add_location(p0, file$1, 45, 2, 1078);
			add_location(strong0, file$1, 52, 4, 1346);
			attr(p1, "class", "svelte-1ad3szv");
			add_location(p1, file$1, 51, 2, 1337);
			add_location(strong1, file$1, 59, 4, 1625);
			add_location(strong2, file$1, 60, 4, 1660);
			add_location(strong3, file$1, 61, 4, 1696);
			add_location(strong4, file$1, 62, 4, 1737);
			add_location(strong5, file$1, 63, 4, 1771);
			add_location(strong6, file$1, 64, 4, 1804);
			add_location(strong7, file$1, 65, 4, 1837);
			add_location(strong8, file$1, 66, 4, 1870);
			add_location(strong9, file$1, 67, 4, 1902);
			add_location(strong10, file$1, 68, 4, 1941);
			add_location(strong11, file$1, 69, 4, 1995);
			add_location(strong12, file$1, 70, 4, 2030);
			add_location(strong13, file$1, 71, 8, 2068);
			attr(p2, "class", "svelte-1ad3szv");
			add_location(p2, file$1, 58, 2, 1616);
			add_location(strong14, file$1, 75, 4, 2178);
			add_location(strong15, file$1, 76, 4, 2226);
			attr(p3, "class", "svelte-1ad3szv");
			add_location(p3, file$1, 73, 2, 2113);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-1ad3szv");
			add_location(img0, file$1, 78, 2, 2265);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-1ad3szv");
			add_location(img1, file$1, 79, 2, 2340);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-1ad3szv");
			add_location(div, file$1, 43, 0, 1001);
		},
