...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-lsvorj");
			add_location(h1, file, 29, 2, 701);
			attr(p0, "class", "svelte-lsvorj");
			add_location(p0, file, 30, 2, 756);
			add_location(strong0, file, 38, 4, 1059);
			attr(p1, "class", "svelte-lsvorj");
			add_location(p1, file, 36, 2, 1009);
			add_location(strong1, file, 44, 4, 1290);
			add_location(strong2, file, 45, 4, 1324);
			add_location(strong3, file, 46, 4, 1359);
			add_location(strong4, file, 47, 4, 1399);
			add_location(strong5, file, 48, 4, 1432);
			add_location(strong6, file, 49, 4, 1464);
			add_location(strong7, file, 50, 4, 1496);
			add_location(strong8, file, 51, 4, 1528);
			add_location(strong9, file, 52, 4, 1559);
			add_location(strong10, file, 53, 4, 1597);
			add_location(strong11, file, 54, 4, 1650);
			add_location(strong12, file, 55, 4, 1684);
			add_location(strong13, file, 56, 8, 1721);
			attr(p2, "class", "svelte-lsvorj");
			add_location(p2, file, 43, 2, 1282);
			add_location(strong14, file, 60, 4, 1827);
			add_location(strong15, file, 61, 4, 1874);
			attr(p3, "class", "svelte-lsvorj");
			add_location(p3, file, 58, 2, 1764);
			attr(img, "src", "images/founders.jpg");
			attr(img, "alt", "the mighty founders");
			attr(img, "class", "svelte-lsvorj");
			add_location(img, file, 63, 2, 1911);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-lsvorj");
			add_location(div, file, 28, 0, 681);
		},
