...
function create_header_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 71, 8, 1581);
		},
...
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 73, 12, 1641);
			add_location(li1, file$3, 74, 12, 1674);
			add_location(li2, file$3, 75, 12, 1707);
			add_location(li3, file$3, 76, 12, 1740);
			add_location(li4, file$3, 77, 12, 1773);
			add_location(ul, file$3, 72, 8, 1624);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 79, 8, 1816);
		},
...
function create_header_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 85, 8, 1975);
		},
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 87, 12, 2036);
			add_location(li1, file$3, 88, 12, 2069);
			add_location(li2, file$3, 89, 12, 2102);
			add_location(li3, file$3, 90, 12, 2135);
			add_location(li4, file$3, 91, 12, 2168);
			add_location(ul, file$3, 86, 8, 2019);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 93, 8, 2211);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 99, 8, 2368);
		},
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-gnf4k3");
			add_location(li0, file$3, 101, 12, 2449);
			attr(li1, "class", "modal-li svelte-gnf4k3");
			add_location(li1, file$3, 102, 12, 2499);
			attr(li2, "class", "modal-li svelte-gnf4k3");
			add_location(li2, file$3, 103, 12, 2549);
			attr(li3, "class", "modal-li svelte-gnf4k3");
			add_location(li3, file$3, 104, 12, 2599);
			attr(li4, "class", "modal-li svelte-gnf4k3");
			add_location(li4, file$3, 105, 12, 2649);
			attr(ul, "class", "pillared svelte-gnf4k3");
			add_location(ul, file$3, 100, 8, 2415);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 107, 8, 2709);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-gnf4k3");
			add_location(img0, file$3, 56, 8, 1132);
			attr(span0, "class", "svelte-gnf4k3");
			add_location(span0, file$3, 57, 8, 1188);
			attr(li0, "class", "svelte-gnf4k3");
			add_location(li0, file$3, 55, 4, 1088);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-gnf4k3");
			add_location(img1, file$3, 60, 8, 1272);
			attr(span1, "class", "svelte-gnf4k3");
			add_location(span1, file$3, 61, 8, 1328);
			attr(li1, "class", "svelte-gnf4k3");
			add_location(li1, file$3, 59, 4, 1227);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-gnf4k3");
			add_location(img2, file$3, 64, 8, 1412);
			attr(span2, "class", "svelte-gnf4k3");
			add_location(span2, file$3, 65, 8, 1468);
			attr(li2, "class", "svelte-gnf4k3");
			add_location(li2, file$3, 63, 4, 1368);
			attr(ul, "class", "pillared svelte-gnf4k3");
			add_location(ul, file$3, 54, 0, 1062);
