...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-17x1fap");
			add_location(div0, file$2, 37, 0, 622);

			add_location(hr0, file$2, 41, 1, 747);

			add_location(hr1, file$2, 43, 1, 768);
			attr(button, "class", "svelte-17x1fap");
			add_location(button, file$2, 45, 1, 775);
			attr(div1, "class", "modal svelte-17x1fap");
			add_location(div1, file$2, 39, 0, 697);
