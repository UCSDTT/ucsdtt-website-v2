...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-fq286g");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-fq286g");
			...
			attr(div0, "class", "class-img-container svelte-fq286g");
			add_location(div0, file, 83, 0, 1577);
			attr(div1, "class", "brother-info svelte-fq286g");
