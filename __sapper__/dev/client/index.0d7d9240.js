...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 111, 4, 2390);
			attr(figcaption, "class", "svelte-1a2i6qs");
			add_location(figcaption, file$5, 120, 1, 2656);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 108, 2, 2317);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$5, 125, 2, 2762);
			attr(div1, "class", "pillars-div svelte-1a2i6qs");
			add_location(div1, file$5, 124, 0, 2734);
			add_location(br0, file$5, 133, 0, 2977);
			add_location(br1, file$5, 134, 0, 2984);
			add_location(br2, file$5, 135, 0, 2991);
			add_location(br3, file$5, 136, 0, 2998);
			add_location(br4, file$5, 137, 0, 3005);
			add_location(br5, file$5, 138, 0, 3012);
			add_location(br6, file$5, 139, 0, 3019);
			add_location(br7, file$5, 140, 0, 3026);
			add_location(br8, file$5, 141, 0, 3033);
			add_location(br9, file$5, 142, 0, 3040);
			add_location(br10, file$5, 143, 0, 3047);
			add_location(br11, file$5, 144, 0, 3054);
			add_location(br12, file$5, 145, 0, 3061);
			add_location(br13, file$5, 146, 0, 3068);
			add_location(br14, file$5, 147, 0, 3075);
			add_location(br15, file$5, 148, 0, 3082);
			add_location(br16, file$5, 149, 0, 3089);
			add_location(br17, file$5, 150, 0, 3096);
			add_location(br18, file$5, 151, 0, 3103);
			add_location(br19, file$5, 152, 0, 3110);
			add_location(br20, file$5, 153, 0, 3117);
			add_location(br21, file$5, 154, 0, 3124);
			add_location(br22, file$5, 155, 0, 3131);
			add_location(br23, file$5, 156, 0, 3138);
			add_location(br24, file$5, 157, 0, 3145);
			add_location(br25, file$5, 158, 0, 3152);
			add_location(br26, file$5, 159, 0, 3159);
			add_location(br27, file$5, 160, 0, 3166);
			add_location(br28, file$5, 161, 0, 3173);
			add_location(br29, file$5, 162, 0, 3180);
			add_location(br30, file$5, 163, 0, 3187);
			add_location(br31, file$5, 164, 0, 3194);
			add_location(br32, file$5, 165, 0, 3201);
			add_location(br33, file$5, 166, 0, 3208);
			add_location(br34, file$5, 167, 0, 3215);
			add_location(br35, file$5, 168, 0, 3222);
			add_location(br36, file$5, 169, 0, 3229);
			add_location(br37, file$5, 170, 0, 3236);
			add_location(br38, file$5, 171, 0, 3243);
			add_location(br39, file$5, 172, 0, 3250);
			add_location(br40, file$5, 173, 0, 3257);
			add_location(br41, file$5, 174, 0, 3264);
			add_location(br42, file$5, 175, 0, 3271);
			add_location(br43, file$5, 176, 0, 3278);
			add_location(br44, file$5, 177, 0, 3285);
			add_location(br45, file$5, 178, 0, 3292);
			add_location(br46, file$5, 179, 0, 3299);
			add_location(br47, file$5, 180, 0, 3306);
			add_location(br48, file$5, 181, 0, 3313);
			add_location(br49, file$5, 182, 0, 3320);
			add_location(br50, file$5, 183, 0, 3327);
			add_location(br51, file$5, 184, 0, 3334);
			add_location(br52, file$5, 185, 0, 3341);
			add_location(br53, file$5, 186, 0, 3348);
			add_location(br54, file$5, 187, 0, 3355);
			add_location(br55, file$5, 188, 0, 3362);
			add_location(br56, file$5, 189, 0, 3369);
			add_location(br57, file$5, 190, 0, 3376);
			add_location(br58, file$5, 191, 0, 3383);
			add_location(br59, file$5, 192, 0, 3390);
			add_location(br60, file$5, 193, 0, 3397);
			add_location(br61, file$5, 194, 0, 3404);
			add_location(br62, file$5, 195, 0, 3411);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 198, 2, 3437);
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 196, 0, 3418);
		},
