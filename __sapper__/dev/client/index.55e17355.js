...
const get_header_slot_context$1 = () => ({ class: `header svelte-cg9edx` });
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(section0, "class", "left-div svelte-cg9edx");
			add_location(section0, file$4, 34, 8, 591);

			attr(section1, "class", "right-div svelte-cg9edx");
			add_location(section1, file$4, 37, 8, 683);
			attr(div, "class", "wrapper");
			add_location(div, file$4, 33, 4, 561);
			attr(section2, "class", "card svelte-cg9edx");
			add_location(section2, file$4, 31, 0, 487);
		},
