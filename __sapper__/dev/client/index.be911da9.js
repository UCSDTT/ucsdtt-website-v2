...
function create_fragment$2(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			h1 = claim_element(div1_nodes, "H1", {}, false);
			var h1_nodes = children(h1);
			...
			t68 = claim_text(p_nodes, "Icons from ");
		...
		h: function hydrate() {
			...
			attr(div0, "class", "hero-div svelte-1ioancz");
			add_location(div0, file$2, 46, 0, 785);
			add_location(h1, file$2, 58, 1, 998);
			attr(div1, "class", "pillars-div svelte-1ioancz");
			add_location(div1, file$2, 57, 0, 971);
			add_location(br0, file$2, 65, 0, 1199);
			add_location(br1, file$2, 66, 0, 1205);
			add_location(br2, file$2, 67, 0, 1211);
			add_location(br3, file$2, 68, 0, 1217);
			add_location(br4, file$2, 69, 0, 1223);
			add_location(br5, file$2, 70, 0, 1229);
			add_location(br6, file$2, 71, 0, 1235);
			add_location(br7, file$2, 72, 0, 1241);
			add_location(br8, file$2, 73, 0, 1247);
			add_location(br9, file$2, 74, 0, 1253);
			add_location(br10, file$2, 75, 0, 1259);
			add_location(br11, file$2, 76, 0, 1265);
			add_location(br12, file$2, 77, 0, 1271);
			add_location(br13, file$2, 78, 0, 1277);
			add_location(br14, file$2, 79, 0, 1283);
			add_location(br15, file$2, 80, 0, 1289);
			add_location(br16, file$2, 81, 0, 1295);
			add_location(br17, file$2, 82, 0, 1301);
			add_location(br18, file$2, 83, 0, 1307);
			add_location(br19, file$2, 84, 0, 1313);
			add_location(br20, file$2, 85, 0, 1319);
			add_location(br21, file$2, 86, 0, 1325);
			add_location(br22, file$2, 87, 0, 1331);
			add_location(br23, file$2, 88, 0, 1337);
			add_location(br24, file$2, 89, 0, 1343);
			add_location(br25, file$2, 90, 0, 1349);
			add_location(br26, file$2, 91, 0, 1355);
			add_location(br27, file$2, 92, 0, 1361);
			add_location(br28, file$2, 93, 0, 1367);
			add_location(br29, file$2, 94, 0, 1373);
			add_location(br30, file$2, 95, 0, 1379);
			add_location(br31, file$2, 96, 0, 1385);
			add_location(br32, file$2, 97, 0, 1391);
			add_location(br33, file$2, 98, 0, 1397);
			add_location(br34, file$2, 99, 0, 1403);
			add_location(br35, file$2, 100, 0, 1409);
			add_location(br36, file$2, 101, 0, 1415);
			add_location(br37, file$2, 102, 0, 1421);
			add_location(br38, file$2, 103, 0, 1427);
			add_location(br39, file$2, 104, 0, 1433);
			add_location(br40, file$2, 105, 0, 1439);
			add_location(br41, file$2, 106, 0, 1445);
			add_location(br42, file$2, 107, 0, 1451);
			add_location(br43, file$2, 108, 0, 1457);
			add_location(br44, file$2, 109, 0, 1463);
			add_location(br45, file$2, 110, 0, 1469);
			add_location(br46, file$2, 111, 0, 1475);
			add_location(br47, file$2, 112, 0, 1481);
			add_location(br48, file$2, 113, 0, 1487);
			add_location(br49, file$2, 114, 0, 1493);
			add_location(br50, file$2, 115, 0, 1499);
			add_location(br51, file$2, 116, 0, 1505);
			add_location(br52, file$2, 117, 0, 1511);
			add_location(br53, file$2, 118, 0, 1517);
			add_location(br54, file$2, 119, 0, 1523);
			add_location(br55, file$2, 120, 0, 1529);
			add_location(br56, file$2, 121, 0, 1535);
			add_location(br57, file$2, 122, 0, 1541);
			add_location(br58, file$2, 123, 0, 1547);
			add_location(br59, file$2, 124, 0, 1553);
			add_location(br60, file$2, 125, 0, 1559);
			add_location(br61, file$2, 126, 0, 1565);
			add_location(br62, file$2, 127, 0, 1571);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$2, 128, 14, 1591);
			attr(p, "class", "svelte-1ioancz");
			add_location(p, file$2, 128, 0, 1577);
		},
