import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, c as claim_element, b as children, f as detach, g as attr, h as add_location, j as insert, q as transition_in, k as append, D as add_render_callback, E as create_in_transition, K as create_out_transition, r as transition_out, J as onMount, t as text, a as space, d as claim_text, n as noop, m as mount_component, u as destroy_component } from './chunk.86736f05.js';
import { a as fly, P as Pillars } from './chunk.47bcbe3a.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 34, 6, 598);
			attr(div, "class", "carousel");
			add_location(div, file, 33, 4, 569);
		},
		...
		i: function intro(local) {
			...
			add_render_callback(() => {
				...
				if (!img_intro) img_intro = create_in_transition(img, fly, {x: 10, duration: 1000});
				img_intro.start();
			});
		...
		o: function outro(local) {
			...
			img_outro = create_out_transition(img, fly, {x: -10, duration: 1000});
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-16336j9");
			add_location(div, file, 31, 0, 518);
		},
