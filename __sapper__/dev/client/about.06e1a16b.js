...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-1ch66zm");
			add_location(h1, file, 36, 2, 830);
			attr(p0, "class", "svelte-1ch66zm");
			add_location(p0, file, 37, 2, 885);
			add_location(strong0, file, 44, 4, 1146);
			attr(p1, "class", "svelte-1ch66zm");
			add_location(p1, file, 43, 2, 1138);
			add_location(strong1, file, 51, 4, 1418);
			add_location(strong2, file, 52, 4, 1452);
			add_location(strong3, file, 53, 4, 1487);
			add_location(strong4, file, 54, 4, 1527);
			add_location(strong5, file, 55, 4, 1560);
			add_location(strong6, file, 56, 4, 1592);
			add_location(strong7, file, 57, 4, 1624);
			add_location(strong8, file, 58, 4, 1656);
			add_location(strong9, file, 59, 4, 1687);
			add_location(strong10, file, 60, 4, 1725);
			add_location(strong11, file, 61, 4, 1778);
			add_location(strong12, file, 62, 4, 1812);
			add_location(strong13, file, 63, 8, 1849);
			attr(p2, "class", "svelte-1ch66zm");
			add_location(p2, file, 50, 2, 1410);
			add_location(strong14, file, 67, 4, 1955);
			add_location(strong15, file, 68, 4, 2002);
			attr(p3, "class", "svelte-1ch66zm");
			add_location(p3, file, 65, 2, 1892);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-1ch66zm");
			add_location(img0, file, 70, 2, 2039);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-1ch66zm");
			add_location(img1, file, 71, 2, 2113);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-1ch66zm");
			add_location(div, file, 35, 0, 810);
		},
