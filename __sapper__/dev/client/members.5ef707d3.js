...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 207, 2, 4665);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-1w6jntr");
			add_location(select, file, 152, 4, 3400);
			attr(h4, "class", "svelte-1w6jntr");
			add_location(h4, file, 151, 2, 3366);
			attr(div0, "class", "space-maker svelte-1w6jntr");
			add_location(div0, file, 162, 2, 3625);
			attr(img, "class", "class-img svelte-1w6jntr");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 177, 4, 3875);
			attr(div1, "class", "class-img-container svelte-1w6jntr");
			add_location(div1, file, 176, 2, 3837);
			attr(div2, "class", "brother-info svelte-1w6jntr");
			add_location(div2, file, 185, 2, 4018);
...
// (154:6) {#each Object.keys(pledgeClasses) as key}
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 154, 8, 3530);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1w6jntr");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 165, 4, 3681);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-1w6jntr");
			add_location(h4, file, 201, 6, 4536);
		},
...
// (189:8) {#if curBrother[key].length !== 0 &&            key !== 'pixelLocationX' &&           key !== 'pixelLocationY' &&           key !== 'city, state, country' &&           key !== 'email' &&           key !== 'last updated' &&           key !== 'what i do' &&           key !== 'phone number'         }
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h5, "class", "brother-key svelte-1w6jntr");
			add_location(h5, file, 197, 10, 4428);
			attr(h4, "class", "svelte-1w6jntr");
			add_location(h4, file, 197, 45, 4463);
		},
...
// (188:6) {#each Object.keys(curBrother) as key}
