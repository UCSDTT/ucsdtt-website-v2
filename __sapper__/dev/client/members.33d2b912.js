import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, a as space, c as claim_element, b as children, f as detach, d as claim_text, g as attr, G as set_style, h as add_location, H as listen, j as insert, k as append, n as noop, t as text, m as mount_component, q as transition_in, r as transition_out, u as destroy_component } from './chunk.b5534b6a.js';
...
function create_fragment(ctx) {
	var div0, t, div1, img, img_src_value, img_alt_value, dispose;
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "cursor-box svelte-jqpuub");
			set_style(div0, "top", ctx.picY);
			set_style(div0, "left", ctx.picX);
			add_location(div0, file, 62, 0, 1229);
			attr(img, "class", "class-img");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 75, 2, 1388);
			attr(div1, "class", "class-img-container svelte-jqpuub");
			add_location(div1, file, 71, 0, 1315);
			dispose = listen(div1, "mousemove", ctx.handleMousemove);
		},
