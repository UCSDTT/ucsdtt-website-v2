...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(p2, file$5, 107, 1, 2336);
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 115, 4, 2529);
			attr(figcaption, "class", "svelte-1a2i6qs");
			add_location(figcaption, file$5, 124, 1, 2795);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 112, 2, 2456);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$5, 129, 2, 2901);
			attr(div1, "class", "pillars-div svelte-1a2i6qs");
			add_location(div1, file$5, 128, 0, 2873);
			add_location(br0, file$5, 137, 0, 3116);
			add_location(br1, file$5, 138, 0, 3123);
			add_location(br2, file$5, 139, 0, 3130);
			add_location(br3, file$5, 140, 0, 3137);
			add_location(br4, file$5, 141, 0, 3144);
			add_location(br5, file$5, 142, 0, 3151);
			add_location(br6, file$5, 143, 0, 3158);
			add_location(br7, file$5, 144, 0, 3165);
			add_location(br8, file$5, 145, 0, 3172);
			add_location(br9, file$5, 146, 0, 3179);
			add_location(br10, file$5, 147, 0, 3186);
			add_location(br11, file$5, 148, 0, 3193);
			add_location(br12, file$5, 149, 0, 3200);
			add_location(br13, file$5, 150, 0, 3207);
			add_location(br14, file$5, 151, 0, 3214);
			add_location(br15, file$5, 152, 0, 3221);
			add_location(br16, file$5, 153, 0, 3228);
			add_location(br17, file$5, 154, 0, 3235);
			add_location(br18, file$5, 155, 0, 3242);
			add_location(br19, file$5, 156, 0, 3249);
			add_location(br20, file$5, 157, 0, 3256);
			add_location(br21, file$5, 158, 0, 3263);
			add_location(br22, file$5, 159, 0, 3270);
			add_location(br23, file$5, 160, 0, 3277);
			add_location(br24, file$5, 161, 0, 3284);
			add_location(br25, file$5, 162, 0, 3291);
			add_location(br26, file$5, 163, 0, 3298);
			add_location(br27, file$5, 164, 0, 3305);
			add_location(br28, file$5, 165, 0, 3312);
			add_location(br29, file$5, 166, 0, 3319);
			add_location(br30, file$5, 167, 0, 3326);
			add_location(br31, file$5, 168, 0, 3333);
			add_location(br32, file$5, 169, 0, 3340);
			add_location(br33, file$5, 170, 0, 3347);
			add_location(br34, file$5, 171, 0, 3354);
			add_location(br35, file$5, 172, 0, 3361);
			add_location(br36, file$5, 173, 0, 3368);
			add_location(br37, file$5, 174, 0, 3375);
			add_location(br38, file$5, 175, 0, 3382);
			add_location(br39, file$5, 176, 0, 3389);
			add_location(br40, file$5, 177, 0, 3396);
			add_location(br41, file$5, 178, 0, 3403);
			add_location(br42, file$5, 179, 0, 3410);
			add_location(br43, file$5, 180, 0, 3417);
			add_location(br44, file$5, 181, 0, 3424);
			add_location(br45, file$5, 182, 0, 3431);
			add_location(br46, file$5, 183, 0, 3438);
			add_location(br47, file$5, 184, 0, 3445);
			add_location(br48, file$5, 185, 0, 3452);
			add_location(br49, file$5, 186, 0, 3459);
			add_location(br50, file$5, 187, 0, 3466);
			add_location(br51, file$5, 188, 0, 3473);
			add_location(br52, file$5, 189, 0, 3480);
			add_location(br53, file$5, 190, 0, 3487);
			add_location(br54, file$5, 191, 0, 3494);
			add_location(br55, file$5, 192, 0, 3501);
			add_location(br56, file$5, 193, 0, 3508);
			add_location(br57, file$5, 194, 0, 3515);
			add_location(br58, file$5, 195, 0, 3522);
			add_location(br59, file$5, 196, 0, 3529);
			add_location(br60, file$5, 197, 0, 3536);
			add_location(br61, file$5, 198, 0, 3543);
			add_location(br62, file$5, 199, 0, 3550);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 202, 2, 3576);
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 200, 0, 3557);
		},
