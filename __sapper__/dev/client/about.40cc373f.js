...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-9lvfv1");
			add_location(img, file, 58, 6, 1130);
			attr(div, "class", "carousel svelte-9lvfv1");
			add_location(div, file, 57, 4, 1101);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-9lvfv1");
			add_location(div, file, 55, 0, 1050);
		},
