...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-11zw8is");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 78, 2, 1552);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file, 75, 0, 1507);
			attr(img, "class", "class-img svelte-11zw8is");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 90, 2, 1724);
			attr(div0, "class", "class-img-container svelte-11zw8is");
			add_location(div0, file, 89, 0, 1688);
			add_location(h2, file, 99, 2, 1882);
			add_location(h3, file, 100, 2, 1920);
			attr(div1, "class", "brother-info");
			add_location(div1, file, 98, 0, 1853);
