...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-83za15");
			add_location(h1, file, 28, 2, 613);
			attr(p0, "class", "svelte-83za15");
			add_location(p0, file, 29, 2, 668);
			add_location(strong0, file, 37, 4, 971);
			attr(p1, "class", "svelte-83za15");
			add_location(p1, file, 35, 2, 921);
			add_location(strong1, file, 43, 4, 1202);
			add_location(strong2, file, 44, 4, 1236);
			add_location(strong3, file, 45, 4, 1271);
			add_location(strong4, file, 46, 4, 1311);
			add_location(strong5, file, 47, 4, 1344);
			add_location(strong6, file, 48, 4, 1376);
			add_location(strong7, file, 49, 4, 1408);
			add_location(strong8, file, 50, 4, 1440);
			add_location(strong9, file, 51, 4, 1471);
			add_location(strong10, file, 52, 4, 1509);
			add_location(strong11, file, 53, 4, 1562);
			add_location(strong12, file, 54, 4, 1596);
			add_location(strong13, file, 55, 8, 1633);
			attr(p2, "class", "svelte-83za15");
			add_location(p2, file, 42, 2, 1194);
			add_location(strong14, file, 59, 4, 1739);
			add_location(strong15, file, 60, 4, 1786);
			attr(p3, "class", "svelte-83za15");
			add_location(p3, file, 57, 2, 1676);
			attr(img, "src", "images/founders.jpg");
			attr(img, "alt", "the mighty founders");
			attr(img, "class", "svelte-83za15");
			add_location(img, file, 62, 2, 1823);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-83za15");
			add_location(div, file, 27, 0, 593);
		},
