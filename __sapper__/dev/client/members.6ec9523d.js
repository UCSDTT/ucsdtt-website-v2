...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1egz3hj");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 63, 2, 1277);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-1egz3hj");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 75, 2, 1449);
			attr(div0, "class", "class-img-container svelte-1egz3hj");
			add_location(div0, file, 74, 0, 1413);
			attr(div1, "class", "space-maker");
			add_location(div1, file, 84, 2, 1607);
			attr(div2, "class", "brother-infp");
			add_location(div2, file, 83, 0, 1578);
