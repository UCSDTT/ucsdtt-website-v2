...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-12evkef");
			add_location(h1, file, 33, 2, 803);
			attr(p0, "class", "svelte-12evkef");
			add_location(p0, file, 34, 2, 858);
			add_location(strong0, file, 42, 4, 1161);
			attr(p1, "class", "svelte-12evkef");
			add_location(p1, file, 40, 2, 1111);
			add_location(strong1, file, 48, 4, 1392);
			add_location(strong2, file, 49, 4, 1426);
			add_location(strong3, file, 50, 4, 1461);
			add_location(strong4, file, 51, 4, 1501);
			add_location(strong5, file, 52, 4, 1534);
			add_location(strong6, file, 53, 4, 1566);
			add_location(strong7, file, 54, 4, 1598);
			add_location(strong8, file, 55, 4, 1630);
			add_location(strong9, file, 56, 4, 1661);
			add_location(strong10, file, 57, 4, 1699);
			add_location(strong11, file, 58, 4, 1752);
			add_location(strong12, file, 59, 4, 1786);
			add_location(strong13, file, 60, 8, 1823);
			attr(p2, "class", "svelte-12evkef");
			add_location(p2, file, 47, 2, 1384);
			add_location(strong14, file, 64, 4, 1929);
			add_location(strong15, file, 65, 4, 1976);
			attr(p3, "class", "svelte-12evkef");
			add_location(p3, file, 62, 2, 1866);
			attr(img, "src", "images/founders.jpg");
			attr(img, "alt", "the mighty founders");
			attr(img, "class", "svelte-12evkef");
			add_location(img, file, 67, 2, 2013);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-12evkef");
			add_location(div, file, 32, 0, 783);
		},
