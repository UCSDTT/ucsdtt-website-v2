...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-8rvmql");
			add_location(img, file, 78, 8, 1395);
			attr(div, "class", "carousel svelte-8rvmql");
			add_location(div, file, 77, 6, 1364);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button svelte-8rvmql");
			add_location(button0, file, 74, 2, 1261);
			attr(div0, "class", "carousel-wrapper svelte-8rvmql");
			add_location(div0, file, 75, 2, 1309);
			attr(button1, "class", "carousel-button svelte-8rvmql");
			add_location(button1, file, 82, 2, 1503);
			attr(div1, "class", "button-wrapper svelte-8rvmql");
			add_location(div1, file, 73, 0, 1230);
		},
