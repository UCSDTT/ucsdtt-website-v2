...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(strong1, file, 50, 4, 1388);
			add_location(strong2, file, 51, 4, 1422);
			add_location(strong3, file, 52, 4, 1457);
			add_location(strong4, file, 53, 4, 1497);
			add_location(strong5, file, 54, 4, 1530);
			add_location(strong6, file, 55, 4, 1562);
			add_location(strong7, file, 56, 4, 1594);
			add_location(strong8, file, 57, 4, 1626);
			add_location(strong9, file, 58, 4, 1657);
			add_location(strong10, file, 59, 4, 1695);
			add_location(strong11, file, 60, 4, 1748);
			add_location(strong12, file, 61, 4, 1782);
			add_location(strong13, file, 62, 8, 1819);
			attr(p2, "class", "svelte-tlsyle");
			add_location(p2, file, 49, 2, 1380);
			add_location(strong14, file, 66, 4, 1925);
			add_location(strong15, file, 67, 4, 1972);
			attr(p3, "class", "svelte-tlsyle");
			add_location(p3, file, 64, 2, 1862);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-tlsyle");
			add_location(img0, file, 69, 2, 2009);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-tlsyle");
			add_location(img1, file, 70, 2, 2083);
			attr(div, "id", "letter");
