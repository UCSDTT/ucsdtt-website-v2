...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 40, 0, 663);
			add_location(h3, file, 42, 0, 679);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-cvqnje");
			add_location(img0, file, 46, 4, 789);
			add_location(h40, file, 47, 4, 837);
			add_location(p0, file, 48, 4, 862);
			attr(div0, "class", "pillar svelte-cvqnje");
			add_location(div0, file, 45, 2, 764);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-cvqnje");
			add_location(img1, file, 56, 4, 1198);
			add_location(h41, file, 57, 4, 1246);
			add_location(p1, file, 58, 4, 1272);
			attr(div1, "class", "pillar svelte-cvqnje");
			add_location(div1, file, 55, 2, 1173);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-cvqnje");
			add_location(img2, file, 67, 4, 1635);
			add_location(h42, file, 68, 4, 1683);
			add_location(p2, file, 69, 4, 1712);
			attr(div2, "class", "pillar svelte-cvqnje");
			add_location(div2, file, 66, 2, 1610);
			attr(div3, "class", "pillars svelte-cvqnje");
			add_location(div3, file, 44, 0, 740);
		},
