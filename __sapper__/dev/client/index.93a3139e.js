...
function create_header_slot$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "slot", "header");
			add_location(h3, file$5, 92, 2, 1600);
		},
...
// (94:2) <section slot="left">
function create_left_slot(ctx) {
	var section, p0, t0, br, t1, p1, t2;

	return {
		c: function create() {
			section = element("section");
			p0 = element("p");
			t0 = text("Formed in 1904, Theta Tau is both the nation's largest and oldest co-ed \n\t\tengineering fraternity. Our brothers develop each other to not only \n\t\tfocus on one aspect of ourselves, but on many. We strive to be \n\t\twell-rounded people who excel in brotherhood, philanthropy, and \n\t\tprofessionalism.");
			br = element("br");
			t1 = space();
			p1 = element("p");
			t2 = text("Here at UCSD, Theta Tau has given us lifelong connections in a diverse group\n\t\tof people. Come check us out!");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(p0_nodes, "Formed in 1904, Theta Tau is both the nation's largest and oldest co-ed \n\t\tengineering fraternity. Our brothers develop each other to not only \n\t\tfocus on one aspect of ourselves, but on many. We strive to be \n\t\twell-rounded people who excel in brotherhood, philanthropy, and \n\t\tprofessionalism.");
			...
			t2 = claim_text(p1_nodes, "Here at UCSD, Theta Tau has given us lifelong connections in a diverse group\n\t\tof people. Come check us out!");
		...
		h: function hydrate() {
			add_location(br, file$5, 99, 18, 1997);
			attr(p0, "class", "svelte-1a2i6qs");
			add_location(p0, file$5, 94, 3, 1696);
			attr(p1, "class", "svelte-1a2i6qs");
			add_location(p1, file$5, 101, 1, 2009);
			attr(section, "slot", "left");
			add_location(section, file$5, 93, 2, 1671);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 109, 4, 2218);
			attr(figcaption, "class", "svelte-1a2i6qs");
			add_location(figcaption, file$5, 118, 1, 2484);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 106, 2, 2145);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div0, "class", "hero-div svelte-1a2i6qs");
			add_location(div0, file$5, 81, 0, 1398);
			attr(h1, "class", "svelte-1a2i6qs");
			add_location(h1, file$5, 123, 2, 2590);
			attr(div1, "class", "pillars-div svelte-1a2i6qs");
			add_location(div1, file$5, 122, 0, 2562);
			add_location(br0, file$5, 131, 0, 2805);
			add_location(br1, file$5, 132, 0, 2812);
			add_location(br2, file$5, 133, 0, 2819);
			add_location(br3, file$5, 134, 0, 2826);
			add_location(br4, file$5, 135, 0, 2833);
			add_location(br5, file$5, 136, 0, 2840);
			add_location(br6, file$5, 137, 0, 2847);
			add_location(br7, file$5, 138, 0, 2854);
			add_location(br8, file$5, 139, 0, 2861);
			add_location(br9, file$5, 140, 0, 2868);
			add_location(br10, file$5, 141, 0, 2875);
			add_location(br11, file$5, 142, 0, 2882);
			add_location(br12, file$5, 143, 0, 2889);
			add_location(br13, file$5, 144, 0, 2896);
			add_location(br14, file$5, 145, 0, 2903);
			add_location(br15, file$5, 146, 0, 2910);
			add_location(br16, file$5, 147, 0, 2917);
			add_location(br17, file$5, 148, 0, 2924);
			add_location(br18, file$5, 149, 0, 2931);
			add_location(br19, file$5, 150, 0, 2938);
			add_location(br20, file$5, 151, 0, 2945);
			add_location(br21, file$5, 152, 0, 2952);
			add_location(br22, file$5, 153, 0, 2959);
			add_location(br23, file$5, 154, 0, 2966);
			add_location(br24, file$5, 155, 0, 2973);
			add_location(br25, file$5, 156, 0, 2980);
			add_location(br26, file$5, 157, 0, 2987);
			add_location(br27, file$5, 158, 0, 2994);
			add_location(br28, file$5, 159, 0, 3001);
			add_location(br29, file$5, 160, 0, 3008);
			add_location(br30, file$5, 161, 0, 3015);
			add_location(br31, file$5, 162, 0, 3022);
			add_location(br32, file$5, 163, 0, 3029);
			add_location(br33, file$5, 164, 0, 3036);
			add_location(br34, file$5, 165, 0, 3043);
			add_location(br35, file$5, 166, 0, 3050);
			add_location(br36, file$5, 167, 0, 3057);
			add_location(br37, file$5, 168, 0, 3064);
			add_location(br38, file$5, 169, 0, 3071);
			add_location(br39, file$5, 170, 0, 3078);
			add_location(br40, file$5, 171, 0, 3085);
			add_location(br41, file$5, 172, 0, 3092);
			add_location(br42, file$5, 173, 0, 3099);
			add_location(br43, file$5, 174, 0, 3106);
			add_location(br44, file$5, 175, 0, 3113);
			add_location(br45, file$5, 176, 0, 3120);
			add_location(br46, file$5, 177, 0, 3127);
			add_location(br47, file$5, 178, 0, 3134);
			add_location(br48, file$5, 179, 0, 3141);
			add_location(br49, file$5, 180, 0, 3148);
			add_location(br50, file$5, 181, 0, 3155);
			add_location(br51, file$5, 182, 0, 3162);
			add_location(br52, file$5, 183, 0, 3169);
			add_location(br53, file$5, 184, 0, 3176);
			add_location(br54, file$5, 185, 0, 3183);
			add_location(br55, file$5, 186, 0, 3190);
			add_location(br56, file$5, 187, 0, 3197);
			add_location(br57, file$5, 188, 0, 3204);
			add_location(br58, file$5, 189, 0, 3211);
			add_location(br59, file$5, 190, 0, 3218);
			add_location(br60, file$5, 191, 0, 3225);
			add_location(br61, file$5, 192, 0, 3232);
			add_location(br62, file$5, 193, 0, 3239);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 196, 2, 3265);
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 194, 0, 3246);
		},
