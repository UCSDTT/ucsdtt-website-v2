...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-10zz1z8");
			add_location(img, file, 56, 6, 1087);
			attr(div, "class", "carousel svelte-10zz1z8");
			add_location(div, file, 55, 4, 1058);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-10zz1z8");
			add_location(div, file, 53, 0, 1007);
		},
