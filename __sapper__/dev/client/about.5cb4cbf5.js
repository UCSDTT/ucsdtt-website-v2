...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-j5liht");
			add_location(h1, file$1, 44, 2, 996);
			attr(p0, "class", "svelte-j5liht");
			add_location(p0, file$1, 45, 2, 1051);
			add_location(strong0, file$1, 52, 4, 1312);
			attr(p1, "class", "svelte-j5liht");
			add_location(p1, file$1, 51, 2, 1304);
			add_location(strong1, file$1, 59, 4, 1584);
			add_location(strong2, file$1, 60, 4, 1618);
			add_location(strong3, file$1, 61, 4, 1653);
			add_location(strong4, file$1, 62, 4, 1693);
			add_location(strong5, file$1, 63, 4, 1726);
			add_location(strong6, file$1, 64, 4, 1758);
			add_location(strong7, file$1, 65, 4, 1790);
			add_location(strong8, file$1, 66, 4, 1822);
			add_location(strong9, file$1, 67, 4, 1853);
			add_location(strong10, file$1, 68, 4, 1891);
			add_location(strong11, file$1, 69, 4, 1944);
			add_location(strong12, file$1, 70, 4, 1978);
			add_location(strong13, file$1, 71, 8, 2015);
			attr(p2, "class", "svelte-j5liht");
			add_location(p2, file$1, 58, 2, 1576);
			add_location(strong14, file$1, 75, 4, 2121);
			add_location(strong15, file$1, 76, 4, 2168);
			attr(p3, "class", "svelte-j5liht");
			add_location(p3, file$1, 73, 2, 2058);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-j5liht");
			add_location(img0, file$1, 78, 2, 2205);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-j5liht");
			add_location(img1, file$1, 79, 2, 2279);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-j5liht");
			add_location(div, file$1, 43, 0, 976);
		},
