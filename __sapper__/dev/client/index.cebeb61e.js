...
function create_fragment$2(ctx) {
	var div0, t0, div1, t1, hr0, t2, t3, hr1, t4, button, t5, current, dispose;
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-1cle364");
			add_location(div0, file$2, 38, 0, 650);

			add_location(hr0, file$2, 42, 1, 775);

			add_location(hr1, file$2, 44, 1, 796);
			attr(button, "class", "svelte-1cle364");
			add_location(button, file$2, 46, 1, 803);
			attr(div1, "class", "modal svelte-1cle364");
			add_location(div1, file$2, 40, 0, 725);
