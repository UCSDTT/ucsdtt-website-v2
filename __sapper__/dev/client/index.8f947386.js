...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(br0, file$1, 58, 0, 861);
			add_location(br1, file$1, 59, 0, 867);
			add_location(br2, file$1, 60, 0, 873);
			add_location(br3, file$1, 61, 0, 879);
			add_location(br4, file$1, 62, 0, 885);
			add_location(br5, file$1, 63, 0, 891);
			add_location(br6, file$1, 64, 0, 897);
			add_location(br7, file$1, 65, 0, 903);
			add_location(br8, file$1, 66, 0, 909);
			add_location(br9, file$1, 67, 0, 915);
			add_location(br10, file$1, 68, 0, 921);
			add_location(br11, file$1, 69, 0, 927);
			add_location(br12, file$1, 70, 0, 933);
			add_location(br13, file$1, 71, 0, 939);
			add_location(br14, file$1, 72, 0, 945);
			add_location(br15, file$1, 73, 0, 951);
			add_location(br16, file$1, 74, 0, 957);
			add_location(br17, file$1, 75, 0, 963);
			add_location(br18, file$1, 76, 0, 969);
			add_location(br19, file$1, 77, 0, 975);
			add_location(br20, file$1, 78, 0, 981);
			add_location(br21, file$1, 79, 0, 987);
			add_location(br22, file$1, 80, 0, 993);
			add_location(br23, file$1, 81, 0, 999);
			add_location(br24, file$1, 82, 0, 1005);
			add_location(br25, file$1, 83, 0, 1011);
			add_location(br26, file$1, 84, 0, 1017);
			add_location(br27, file$1, 85, 0, 1023);
			add_location(br28, file$1, 86, 0, 1029);
			add_location(br29, file$1, 87, 0, 1035);
			add_location(br30, file$1, 88, 0, 1041);
			add_location(br31, file$1, 89, 0, 1047);
			add_location(br32, file$1, 90, 0, 1053);
			add_location(br33, file$1, 91, 0, 1059);
			add_location(br34, file$1, 92, 0, 1065);
			add_location(br35, file$1, 93, 0, 1071);
			add_location(br36, file$1, 94, 0, 1077);
			add_location(br37, file$1, 95, 0, 1083);
			add_location(br38, file$1, 96, 0, 1089);
			add_location(br39, file$1, 97, 0, 1095);
			add_location(br40, file$1, 98, 0, 1101);
			add_location(br41, file$1, 99, 0, 1107);
			add_location(br42, file$1, 100, 0, 1113);
			add_location(br43, file$1, 101, 0, 1119);
			add_location(br44, file$1, 102, 0, 1125);
			add_location(br45, file$1, 103, 0, 1131);
			add_location(br46, file$1, 104, 0, 1137);
			add_location(br47, file$1, 105, 0, 1143);
			add_location(br48, file$1, 106, 0, 1149);
			add_location(br49, file$1, 107, 0, 1155);
			add_location(br50, file$1, 108, 0, 1161);
			add_location(br51, file$1, 109, 0, 1167);
			add_location(br52, file$1, 110, 0, 1173);
			add_location(br53, file$1, 111, 0, 1179);
			add_location(br54, file$1, 112, 0, 1185);
			add_location(br55, file$1, 113, 0, 1191);
			add_location(br56, file$1, 114, 0, 1197);
			add_location(br57, file$1, 115, 0, 1203);
			add_location(br58, file$1, 116, 0, 1209);
			add_location(br59, file$1, 117, 0, 1215);
			add_location(br60, file$1, 118, 0, 1221);
			add_location(br61, file$1, 119, 0, 1227);
			add_location(br62, file$1, 120, 0, 1233);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$1, 121, 14, 1253);
			attr(p, "class", "svelte-1hsgy2r");
			add_location(p, file$1, 121, 0, 1239);
		},
