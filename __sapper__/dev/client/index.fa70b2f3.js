...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 57, 12, 1186);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal");
			add_location(span, file$1, 60, 12, 1278);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 55, 4, 1142);
			add_location(section, file$1, 54, 0, 1128);
		},
...
const get_header_slot_context$1 = () => ({ class: `header svelte-1wm1jn3` });

function create_fragment$4(ctx) {
	var section2, t0, section0, t1, section1, current;
	...
	return {
		...
		l: function claim(nodes) {
			...
			section0 = claim_element(section2_nodes, "SECTION", { class: true }, false);
			...
			section1 = claim_element(section2_nodes, "SECTION", { class: true }, false);
		...
		h: function hydrate() {
			attr(section0, "class", "left-div svelte-1wm1jn3");
			add_location(section0, file$4, 42, 4, 804);

			attr(section1, "class", "right-div svelte-1wm1jn3");
			add_location(section1, file$4, 45, 4, 884);
			attr(section2, "class", "card svelte-1wm1jn3");
			add_location(section2, file$4, 40, 0, 730);
		},
...
function create_header_slot$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "slot", "header");
			add_location(h3, file$5, 75, 1, 1334);
		},
...
function create_left_slot(ctx) {
	...
	return {
		c: function create() {
			p = element("p");
			t = text("Lorem ipsoumLorem ipsoumLorem ipsoum Lorem ipsoumLorem ipsoum\n\tLorem ipsoumLorem ipsoumLorem ipsoumLorem ipsoumLorem ipsoum\n\tLorem ipsoumLorem ipsoumLorem ipsoumLorem ipsoumLorem ipsoum\n\tLorem ipsoumLorem ipsoum");
			this.h();
		},

		l: function claim(nodes) {
			p = claim_element(nodes, "P", { slot: true, class: true }, false);
			var p_nodes = children(p);

			t = claim_text(p_nodes, "Lorem ipsoumLorem ipsoumLorem ipsoum Lorem ipsoumLorem ipsoum\n\tLorem ipsoumLorem ipsoumLorem ipsoumLorem ipsoumLorem ipsoum\n\tLorem ipsoumLorem ipsoumLorem ipsoumLorem ipsoumLorem ipsoum\n\tLorem ipsoumLorem ipsoum");
		...
		h: function hydrate() {
			attr(p, "slot", "left");
			attr(p, "class", "svelte-ls5l35");
			add_location(p, file$5, 76, 1, 1405);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p, "slot", "right");
			attr(p, "class", "svelte-ls5l35");
			add_location(p, file$5, 80, 1, 1637);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div0, "class", "hero-div svelte-ls5l35");
			add_location(div0, file$5, 63, 0, 1140);
			attr(h1, "class", "svelte-ls5l35");
			add_location(h1, file$5, 87, 1, 1905);
			attr(div1, "class", "pillars-div svelte-ls5l35");
			add_location(div1, file$5, 86, 0, 1878);
			add_location(br0, file$5, 95, 0, 2119);
			add_location(br1, file$5, 96, 0, 2125);
			add_location(br2, file$5, 97, 0, 2131);
			add_location(br3, file$5, 98, 0, 2137);
			add_location(br4, file$5, 99, 0, 2143);
			add_location(br5, file$5, 100, 0, 2149);
			add_location(br6, file$5, 101, 0, 2155);
			add_location(br7, file$5, 102, 0, 2161);
			add_location(br8, file$5, 103, 0, 2167);
			add_location(br9, file$5, 104, 0, 2173);
			add_location(br10, file$5, 105, 0, 2179);
			add_location(br11, file$5, 106, 0, 2185);
			add_location(br12, file$5, 107, 0, 2191);
			add_location(br13, file$5, 108, 0, 2197);
			add_location(br14, file$5, 109, 0, 2203);
			add_location(br15, file$5, 110, 0, 2209);
			add_location(br16, file$5, 111, 0, 2215);
			add_location(br17, file$5, 112, 0, 2221);
			add_location(br18, file$5, 113, 0, 2227);
			add_location(br19, file$5, 114, 0, 2233);
			add_location(br20, file$5, 115, 0, 2239);
			add_location(br21, file$5, 116, 0, 2245);
			add_location(br22, file$5, 117, 0, 2251);
			add_location(br23, file$5, 118, 0, 2257);
			add_location(br24, file$5, 119, 0, 2263);
			add_location(br25, file$5, 120, 0, 2269);
			add_location(br26, file$5, 121, 0, 2275);
			add_location(br27, file$5, 122, 0, 2281);
			add_location(br28, file$5, 123, 0, 2287);
			add_location(br29, file$5, 124, 0, 2293);
			add_location(br30, file$5, 125, 0, 2299);
			add_location(br31, file$5, 126, 0, 2305);
			add_location(br32, file$5, 127, 0, 2311);
			add_location(br33, file$5, 128, 0, 2317);
			add_location(br34, file$5, 129, 0, 2323);
			add_location(br35, file$5, 130, 0, 2329);
			add_location(br36, file$5, 131, 0, 2335);
			add_location(br37, file$5, 132, 0, 2341);
			add_location(br38, file$5, 133, 0, 2347);
			add_location(br39, file$5, 134, 0, 2353);
			add_location(br40, file$5, 135, 0, 2359);
			add_location(br41, file$5, 136, 0, 2365);
			add_location(br42, file$5, 137, 0, 2371);
			add_location(br43, file$5, 138, 0, 2377);
			add_location(br44, file$5, 139, 0, 2383);
			add_location(br45, file$5, 140, 0, 2389);
			add_location(br46, file$5, 141, 0, 2395);
			add_location(br47, file$5, 142, 0, 2401);
			add_location(br48, file$5, 143, 0, 2407);
			add_location(br49, file$5, 144, 0, 2413);
			add_location(br50, file$5, 145, 0, 2419);
			add_location(br51, file$5, 146, 0, 2425);
			add_location(br52, file$5, 147, 0, 2431);
			add_location(br53, file$5, 148, 0, 2437);
			add_location(br54, file$5, 149, 0, 2443);
			add_location(br55, file$5, 150, 0, 2449);
			add_location(br56, file$5, 151, 0, 2455);
			add_location(br57, file$5, 152, 0, 2461);
			add_location(br58, file$5, 153, 0, 2467);
			add_location(br59, file$5, 154, 0, 2473);
			add_location(br60, file$5, 155, 0, 2479);
			add_location(br61, file$5, 156, 0, 2485);
			add_location(br62, file$5, 157, 0, 2491);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 158, 14, 2511);
			attr(p, "class", "svelte-ls5l35");
			add_location(p, file$5, 158, 0, 2497);
		},
