...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-o80nnc");
			add_location(img, file, 53, 6, 1027);
			attr(div, "class", "carousel svelte-o80nnc");
			add_location(div, file, 52, 4, 998);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-o80nnc");
			add_location(div, file, 50, 0, 947);
		},
