...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 210, 2, 4725);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 180, 4, 3935);
			attr(div1, "class", "class-img-container svelte-1ikbvcr");
			add_location(div1, file, 179, 2, 3897);
			attr(div2, "class", "brother-info svelte-1ikbvcr");
			add_location(div2, file, 188, 2, 4078);
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 157, 8, 3590);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 168, 4, 3741);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-1ikbvcr");
			add_location(h4, file, 204, 6, 4596);
		},
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h5, file, 200, 10, 4488);
			attr(h4, "class", "svelte-1ikbvcr");
			add_location(h4, file, 200, 45, 4523);
		},
