...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-op765d");
			add_location(img0, file$2, 48, 8, 949);
			attr(span0, "class", "svelte-op765d");
			add_location(span0, file$2, 48, 55, 996);
			attr(li0, "class", "svelte-op765d");
			add_location(li0, file$2, 48, 4, 945);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-op765d");
			add_location(img1, file$2, 49, 8, 1034);
			attr(span1, "class", "svelte-op765d");
			add_location(span1, file$2, 49, 55, 1081);
			attr(li1, "class", "svelte-op765d");
			add_location(li1, file$2, 49, 4, 1030);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-op765d");
			add_location(img2, file$2, 50, 8, 1120);
			attr(span2, "class", "svelte-op765d");
			add_location(span2, file$2, 50, 55, 1167);
			attr(li2, "class", "svelte-op765d");
			add_location(li2, file$2, 50, 4, 1116);
			attr(ul, "class", "pillared svelte-op765d");
			add_location(ul, file$2, 47, 0, 919);
		},
