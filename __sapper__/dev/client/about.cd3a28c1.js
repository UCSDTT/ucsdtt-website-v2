...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1sv63j1");
			add_location(img, file, 80, 8, 1435);
			attr(div, "class", "carousel svelte-1sv63j1");
			add_location(div, file, 79, 6, 1404);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-1sv63j1");
			add_location(button0, file, 76, 2, 1289);
			attr(div0, "class", "carousel-wrapper svelte-1sv63j1");
			add_location(div0, file, 77, 2, 1349);
			attr(button1, "class", "carousel-button button-right svelte-1sv63j1");
			add_location(button1, file, 84, 2, 1543);
			attr(div1, "class", "button-wrapper svelte-1sv63j1");
			add_location(div1, file, 75, 0, 1258);
		},
