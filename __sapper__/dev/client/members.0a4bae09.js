...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-18fivsz");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 48, 2, 1041);
			attr(div, "class", "class-img-container svelte-18fivsz");
			add_location(div, file, 47, 0, 1005);
		},
