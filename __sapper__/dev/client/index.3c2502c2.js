...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-w3s1j5");
			add_location(img0, file$2, 34, 8, 583);
			attr(span0, "class", "svelte-w3s1j5");
			add_location(span0, file$2, 34, 55, 630);
			attr(li0, "class", "svelte-w3s1j5");
			add_location(li0, file$2, 34, 4, 579);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-w3s1j5");
			add_location(img1, file$2, 35, 8, 668);
			attr(span1, "class", "svelte-w3s1j5");
			add_location(span1, file$2, 35, 55, 715);
			attr(li1, "class", "svelte-w3s1j5");
			add_location(li1, file$2, 35, 4, 664);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-w3s1j5");
			add_location(img2, file$2, 36, 8, 754);
			attr(span2, "class", "svelte-w3s1j5");
			add_location(span2, file$2, 36, 55, 801);
			attr(li2, "class", "svelte-w3s1j5");
			add_location(li2, file$2, 36, 4, 750);
			attr(ul, "class", "pillared svelte-w3s1j5");
			add_location(ul, file$2, 33, 0, 553);
		},
