...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-60m5sf");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 73, 2, 1448);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file, 70, 0, 1403);
			attr(img, "class", "class-img svelte-60m5sf");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 85, 2, 1620);
			attr(div0, "class", "class-img-container svelte-60m5sf");
			add_location(div0, file, 84, 0, 1584);
			attr(div1, "class", "empty-space svelte-60m5sf");
			add_location(div1, file, 93, 0, 1749);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 31, 0, 537);
		},
