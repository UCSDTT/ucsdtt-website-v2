...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1ybw7qe");
			add_location(img0, file, 79, 4, 2160);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-1ybw7qe");
			add_location(img1, file, 80, 4, 2236);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-1ybw7qe");
			add_location(h1, file, 44, 2, 931);
			attr(p0, "class", "svelte-1ybw7qe");
			add_location(p0, file, 45, 2, 986);
			add_location(strong0, file, 52, 4, 1247);
			attr(p1, "class", "svelte-1ybw7qe");
			add_location(p1, file, 51, 2, 1239);
			add_location(strong1, file, 59, 4, 1519);
			add_location(strong2, file, 60, 4, 1553);
			add_location(strong3, file, 61, 4, 1588);
			add_location(strong4, file, 62, 4, 1628);
			add_location(strong5, file, 63, 4, 1661);
			add_location(strong6, file, 64, 4, 1693);
			add_location(strong7, file, 65, 4, 1725);
			add_location(strong8, file, 66, 4, 1757);
			add_location(strong9, file, 67, 4, 1788);
			add_location(strong10, file, 68, 4, 1826);
			add_location(strong11, file, 69, 4, 1879);
			add_location(strong12, file, 70, 4, 1913);
			add_location(strong13, file, 71, 8, 1950);
			attr(p2, "class", "svelte-1ybw7qe");
			add_location(p2, file, 58, 2, 1511);
			add_location(strong14, file, 75, 4, 2056);
			add_location(strong15, file, 76, 4, 2103);
			attr(p3, "class", "svelte-1ybw7qe");
			add_location(p3, file, 73, 2, 1993);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-1ybw7qe");
			add_location(div, file, 43, 0, 911);
