...
function create_if_block(ctx) {
	var h1, t0, h1_transition, t1, svg_1, g, path, path_transition, current;
	...
	return {
		...
		l: function claim(nodes) {
			...
			path = claim_element(g_nodes, "path", { d: true, opacity: true }, true);
		...
		h: function hydrate() {
			...
			add_location(path, file, 62, 3, 1101);
			add_location(g, file, 61, 2, 1094);
