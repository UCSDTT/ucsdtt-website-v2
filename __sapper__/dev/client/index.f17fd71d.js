...
const file$2 = "src/components/Pillars.svelte";

function create_fragment$2(ctx) {
	var ul, li0, h20, img0, t0, t1, li1, h21, img1, t2, t3, li2, h22, img2, t4;
	...
	return {
		...
		l: function claim(nodes) {
			...
			h20 = claim_element(li0_nodes, "H2", { class: true }, false);
			var h20_nodes = children(h20);

			img0 = claim_element(h20_nodes, "IMG", { src: true, alt: true, class: true }, false);
			var img0_nodes = children(img0);

			img0_nodes.forEach(detach);
			t0 = claim_text(h20_nodes, "Brotherhood");
			...
			h21 = claim_element(li1_nodes, "H2", { class: true }, false);
			var h21_nodes = children(h21);

			img1 = claim_element(h21_nodes, "IMG", { src: true, alt: true, class: true }, false);
			var img1_nodes = children(img1);

			img1_nodes.forEach(detach);
			t2 = claim_text(h21_nodes, "Philanthropy");
			...
			h22 = claim_element(li2_nodes, "H2", { class: true }, false);
			var h22_nodes = children(h22);

			img2 = claim_element(h22_nodes, "IMG", { src: true, alt: true, class: true }, false);
			var img2_nodes = children(img2);

			img2_nodes.forEach(detach);
			t4 = claim_text(h22_nodes, "Professionalism");
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1u1n21o");
			add_location(img0, file$2, 33, 12, 623);
			attr(h20, "class", "svelte-1u1n21o");
			add_location(h20, file$2, 33, 8, 619);
			attr(li0, "class", "svelte-1u1n21o");
			add_location(li0, file$2, 33, 4, 615);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1u1n21o");
			add_location(img1, file$2, 34, 12, 704);
			attr(h21, "class", "svelte-1u1n21o");
			add_location(h21, file$2, 34, 8, 700);
			attr(li1, "class", "svelte-1u1n21o");
			add_location(li1, file$2, 34, 4, 696);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1u1n21o");
			add_location(img2, file$2, 35, 12, 786);
			attr(h22, "class", "svelte-1u1n21o");
			add_location(h22, file$2, 35, 8, 782);
			attr(li2, "class", "svelte-1u1n21o");
			add_location(li2, file$2, 35, 4, 778);
			attr(ul, "class", "pillared svelte-1u1n21o");
			add_location(ul, file$2, 32, 0, 589);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$3, 48, 0, 860);
			attr(h1, "class", "svelte-12z78b6");
			add_location(h1, file$3, 60, 1, 1073);
			attr(div1, "class", "pillars-div svelte-12z78b6");
			add_location(div1, file$3, 59, 0, 1046);
			add_location(br0, file$3, 68, 0, 1287);
			add_location(br1, file$3, 69, 0, 1293);
			add_location(br2, file$3, 70, 0, 1299);
			add_location(br3, file$3, 71, 0, 1305);
			add_location(br4, file$3, 72, 0, 1311);
			add_location(br5, file$3, 73, 0, 1317);
			add_location(br6, file$3, 74, 0, 1323);
			add_location(br7, file$3, 75, 0, 1329);
			add_location(br8, file$3, 76, 0, 1335);
			add_location(br9, file$3, 77, 0, 1341);
			add_location(br10, file$3, 78, 0, 1347);
			add_location(br11, file$3, 79, 0, 1353);
			add_location(br12, file$3, 80, 0, 1359);
			add_location(br13, file$3, 81, 0, 1365);
			add_location(br14, file$3, 82, 0, 1371);
			add_location(br15, file$3, 83, 0, 1377);
			add_location(br16, file$3, 84, 0, 1383);
			add_location(br17, file$3, 85, 0, 1389);
			add_location(br18, file$3, 86, 0, 1395);
			add_location(br19, file$3, 87, 0, 1401);
			add_location(br20, file$3, 88, 0, 1407);
			add_location(br21, file$3, 89, 0, 1413);
			add_location(br22, file$3, 90, 0, 1419);
			add_location(br23, file$3, 91, 0, 1425);
			add_location(br24, file$3, 92, 0, 1431);
			add_location(br25, file$3, 93, 0, 1437);
			add_location(br26, file$3, 94, 0, 1443);
			add_location(br27, file$3, 95, 0, 1449);
			add_location(br28, file$3, 96, 0, 1455);
			add_location(br29, file$3, 97, 0, 1461);
			add_location(br30, file$3, 98, 0, 1467);
			add_location(br31, file$3, 99, 0, 1473);
			add_location(br32, file$3, 100, 0, 1479);
			add_location(br33, file$3, 101, 0, 1485);
			add_location(br34, file$3, 102, 0, 1491);
			add_location(br35, file$3, 103, 0, 1497);
			add_location(br36, file$3, 104, 0, 1503);
			add_location(br37, file$3, 105, 0, 1509);
			add_location(br38, file$3, 106, 0, 1515);
			add_location(br39, file$3, 107, 0, 1521);
			add_location(br40, file$3, 108, 0, 1527);
			add_location(br41, file$3, 109, 0, 1533);
			add_location(br42, file$3, 110, 0, 1539);
			add_location(br43, file$3, 111, 0, 1545);
			add_location(br44, file$3, 112, 0, 1551);
			add_location(br45, file$3, 113, 0, 1557);
			add_location(br46, file$3, 114, 0, 1563);
			add_location(br47, file$3, 115, 0, 1569);
			add_location(br48, file$3, 116, 0, 1575);
			add_location(br49, file$3, 117, 0, 1581);
			add_location(br50, file$3, 118, 0, 1587);
			add_location(br51, file$3, 119, 0, 1593);
			add_location(br52, file$3, 120, 0, 1599);
			add_location(br53, file$3, 121, 0, 1605);
			add_location(br54, file$3, 122, 0, 1611);
			add_location(br55, file$3, 123, 0, 1617);
			add_location(br56, file$3, 124, 0, 1623);
			add_location(br57, file$3, 125, 0, 1629);
			add_location(br58, file$3, 126, 0, 1635);
			add_location(br59, file$3, 127, 0, 1641);
			add_location(br60, file$3, 128, 0, 1647);
			add_location(br61, file$3, 129, 0, 1653);
			add_location(br62, file$3, 130, 0, 1659);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$3, 131, 14, 1679);
			attr(p, "class", "svelte-12z78b6");
			add_location(p, file$3, 131, 0, 1665);
		},
