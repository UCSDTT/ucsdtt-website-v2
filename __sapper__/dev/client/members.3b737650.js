...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-76u2lq");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 71, 2, 1400);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-76u2lq");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 83, 2, 1572);
			attr(div0, "class", "class-img-container svelte-76u2lq");
			add_location(div0, file, 82, 0, 1536);
			attr(div1, "class", "brother-info svelte-76u2lq");
			add_location(div1, file, 91, 0, 1701);
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handleMouseClick(event) {
	...
	$$self.$$.update = ($$dirty = { my: 1, mx: 1 }) => {
		...
		if ($$dirty.mx) { $$invalidate('picX', picX = `${mx - 60}px`); }
	};
