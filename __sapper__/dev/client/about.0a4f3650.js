...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-ac3y92");
			add_location(img, file, 64, 8, 1176);
			attr(div, "class", "carousel svelte-ac3y92");
			add_location(div, file, 63, 6, 1145);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(button0, file, 60, 2, 1066);
			attr(div0, "class", "carousel-wrapper svelte-ac3y92");
			add_location(div0, file, 61, 2, 1090);
			add_location(button1, file, 68, 2, 1284);
			attr(div1, "class", "button-wrapper svelte-ac3y92");
			add_location(div1, file, 59, 0, 1035);
		},
