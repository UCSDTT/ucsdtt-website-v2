...
function create_left_slot(ctx) {
	...
	return {
		c: function create() {
			...
			br = element("br");
			t1 = text("\n\tHere at UCSD, Theta Tau has given us lifelong connections in a diverse group\n\tof people. Come check us out!");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(p_nodes, "Formed in 1904, Theta Tau is both the nation's largest and oldest co-ed \n\tengineering fraternity. Our brothers develop each other to not only \n\tfocus on one aspect of ourselves, but on many. We strive to be \n\twell-rounded people who excel in brotherhood, philanthropy, and \n\tprofessionalism.");
		...
		h: function hydrate() {
			add_location(br, file$5, 98, 17, 1982);
			attr(p, "slot", "left");
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 93, 2, 1671);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(iframe, file$5, 105, 4, 2178);
			attr(figcaption, "class", "svelte-1a2i6qs");
			add_location(figcaption, file$5, 114, 1, 2444);
			attr(figure, "slot", "right");
			add_location(figure, file$5, 102, 2, 2105);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$5, 119, 2, 2550);
			attr(div1, "class", "pillars-div svelte-1a2i6qs");
			add_location(div1, file$5, 118, 0, 2522);
			add_location(br0, file$5, 127, 0, 2765);
			add_location(br1, file$5, 128, 0, 2772);
			add_location(br2, file$5, 129, 0, 2779);
			add_location(br3, file$5, 130, 0, 2786);
			add_location(br4, file$5, 131, 0, 2793);
			add_location(br5, file$5, 132, 0, 2800);
			add_location(br6, file$5, 133, 0, 2807);
			add_location(br7, file$5, 134, 0, 2814);
			add_location(br8, file$5, 135, 0, 2821);
			add_location(br9, file$5, 136, 0, 2828);
			add_location(br10, file$5, 137, 0, 2835);
			add_location(br11, file$5, 138, 0, 2842);
			add_location(br12, file$5, 139, 0, 2849);
			add_location(br13, file$5, 140, 0, 2856);
			add_location(br14, file$5, 141, 0, 2863);
			add_location(br15, file$5, 142, 0, 2870);
			add_location(br16, file$5, 143, 0, 2877);
			add_location(br17, file$5, 144, 0, 2884);
			add_location(br18, file$5, 145, 0, 2891);
			add_location(br19, file$5, 146, 0, 2898);
			add_location(br20, file$5, 147, 0, 2905);
			add_location(br21, file$5, 148, 0, 2912);
			add_location(br22, file$5, 149, 0, 2919);
			add_location(br23, file$5, 150, 0, 2926);
			add_location(br24, file$5, 151, 0, 2933);
			add_location(br25, file$5, 152, 0, 2940);
			add_location(br26, file$5, 153, 0, 2947);
			add_location(br27, file$5, 154, 0, 2954);
			add_location(br28, file$5, 155, 0, 2961);
			add_location(br29, file$5, 156, 0, 2968);
			add_location(br30, file$5, 157, 0, 2975);
			add_location(br31, file$5, 158, 0, 2982);
			add_location(br32, file$5, 159, 0, 2989);
			add_location(br33, file$5, 160, 0, 2996);
			add_location(br34, file$5, 161, 0, 3003);
			add_location(br35, file$5, 162, 0, 3010);
			add_location(br36, file$5, 163, 0, 3017);
			add_location(br37, file$5, 164, 0, 3024);
			add_location(br38, file$5, 165, 0, 3031);
			add_location(br39, file$5, 166, 0, 3038);
			add_location(br40, file$5, 167, 0, 3045);
			add_location(br41, file$5, 168, 0, 3052);
			add_location(br42, file$5, 169, 0, 3059);
			add_location(br43, file$5, 170, 0, 3066);
			add_location(br44, file$5, 171, 0, 3073);
			add_location(br45, file$5, 172, 0, 3080);
			add_location(br46, file$5, 173, 0, 3087);
			add_location(br47, file$5, 174, 0, 3094);
			add_location(br48, file$5, 175, 0, 3101);
			add_location(br49, file$5, 176, 0, 3108);
			add_location(br50, file$5, 177, 0, 3115);
			add_location(br51, file$5, 178, 0, 3122);
			add_location(br52, file$5, 179, 0, 3129);
			add_location(br53, file$5, 180, 0, 3136);
			add_location(br54, file$5, 181, 0, 3143);
			add_location(br55, file$5, 182, 0, 3150);
			add_location(br56, file$5, 183, 0, 3157);
			add_location(br57, file$5, 184, 0, 3164);
			add_location(br58, file$5, 185, 0, 3171);
			add_location(br59, file$5, 186, 0, 3178);
			add_location(br60, file$5, 187, 0, 3185);
			add_location(br61, file$5, 188, 0, 3192);
			add_location(br62, file$5, 189, 0, 3199);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 192, 2, 3225);
			attr(p, "class", "svelte-1a2i6qs");
			add_location(p, file$5, 190, 0, 3206);
		},
