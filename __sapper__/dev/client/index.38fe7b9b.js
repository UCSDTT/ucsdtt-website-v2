...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-5k2npr");
			add_location(div0, file$2, 57, 0, 1027);

			attr(button, "class", "svelte-5k2npr");
			add_location(button, file$2, 62, 8, 1193);
			attr(section, "class", "header svelte-5k2npr");
			add_location(section, file$2, 60, 4, 1126);
			add_location(hr0, file$2, 64, 1, 1265);

			add_location(hr1, file$2, 66, 1, 1286);
			attr(div1, "class", "modal svelte-5k2npr");
			add_location(div1, file$2, 59, 0, 1102);
