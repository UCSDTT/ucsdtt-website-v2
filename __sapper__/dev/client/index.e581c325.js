...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-9au5yr");
			add_location(img0, file$2, 50, 8, 1020);
			attr(span0, "class", "svelte-9au5yr");
			add_location(span0, file$2, 50, 55, 1067);
			attr(li0, "class", "svelte-9au5yr");
			add_location(li0, file$2, 50, 4, 1016);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-9au5yr");
			add_location(img1, file$2, 51, 8, 1105);
			attr(span1, "class", "svelte-9au5yr");
			add_location(span1, file$2, 51, 55, 1152);
			attr(li1, "class", "svelte-9au5yr");
			add_location(li1, file$2, 51, 4, 1101);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-9au5yr");
			add_location(img2, file$2, 52, 8, 1191);
			attr(span2, "class", "svelte-9au5yr");
			add_location(span2, file$2, 52, 55, 1238);
			attr(li2, "class", "svelte-9au5yr");
			add_location(li2, file$2, 52, 4, 1187);
			attr(ul, "class", "pillared svelte-9au5yr");
			add_location(ul, file$2, 49, 0, 990);
		},
