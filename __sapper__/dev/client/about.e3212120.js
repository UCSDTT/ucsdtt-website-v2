...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-2zc9sk");
			add_location(img, file, 110, 8, 2045);
			attr(div, "class", "carousel svelte-2zc9sk");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-2zc9sk");
			add_location(button0, file, 101, 2, 1850);
			attr(div0, "class", "carousel-wrapper svelte-2zc9sk");
			add_location(div0, file, 107, 2, 1959);
			attr(button1, "class", "carousel-button button-right svelte-2zc9sk");
			add_location(button1, file, 114, 2, 2153);
			attr(div1, "class", "button-wrapper svelte-2zc9sk");
