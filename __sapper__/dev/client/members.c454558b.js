...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 203, 2, 4623);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-14njcci");
			add_location(select, file, 148, 4, 3363);
			attr(h4, "class", "svelte-14njcci");
			add_location(h4, file, 147, 2, 3329);
			attr(div0, "class", "space-maker svelte-14njcci");
			add_location(div0, file, 158, 2, 3588);
			attr(img, "class", "class-img svelte-14njcci");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 173, 4, 3838);
			attr(div1, "class", "class-img-container svelte-14njcci");
			add_location(div1, file, 172, 2, 3800);
			attr(div2, "class", "brother-info svelte-14njcci");
			add_location(div2, file, 181, 2, 3981);
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 150, 8, 3493);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-14njcci");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 161, 4, 3644);
...
function create_else_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-14njcci");
			add_location(h4, file, 197, 6, 4496);
		},
...
function create_if_block_2(ctx) {
	var h5, strong, t0_value = ctx.key, t0, t1, h4, t2_value = ctx.curBrother[ctx.key], t2;
	...
	return {
		...
		l: function claim(nodes) {
			...
			strong = claim_element(h5_nodes, "STRONG", {}, false);
		...
		h: function hydrate() {
			add_location(strong, file, 193, 14, 4395);
			add_location(h5, file, 193, 10, 4391);
			attr(h4, "class", "svelte-14njcci");
			add_location(h4, file, 193, 42, 4423);
		},
