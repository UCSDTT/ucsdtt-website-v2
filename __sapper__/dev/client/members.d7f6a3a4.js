...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1wo8gmo");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "class-img svelte-1wo8gmo");
			...
			attr(div0, "class", "class-img-container svelte-1wo8gmo");
			add_location(div0, file, 85, 0, 1603);
			attr(div1, "class", "brother-info svelte-1wo8gmo");
