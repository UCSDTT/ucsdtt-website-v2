...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 78, 8, 1407);
			attr(div, "class", "carousel svelte-8rvmql");
			add_location(div, file, 77, 6, 1376);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-8rvmql");
			add_location(button0, file, 74, 2, 1261);
			attr(div0, "class", "carousel-wrapper svelte-8rvmql");
			add_location(div0, file, 75, 2, 1321);
			attr(button1, "class", "carousel-button button-right svelte-8rvmql");
			add_location(button1, file, 82, 2, 1515);
