...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1f76hbi");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 73, 2, 1449);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(p, file, 70, 0, 1404);
			attr(img, "class", "class-img svelte-1f76hbi");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 85, 2, 1621);
			attr(div0, "class", "class-img-container svelte-1f76hbi");
			add_location(div0, file, 84, 0, 1585);
			attr(div1, "class", "brother-info svelte-1f76hbi");
			add_location(div1, file, 93, 0, 1750);
