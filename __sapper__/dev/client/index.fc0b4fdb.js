...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-juq9bx");
			add_location(img0, file$2, 38, 8, 665);
			attr(span0, "class", "svelte-juq9bx");
			add_location(span0, file$2, 38, 55, 712);
			attr(li0, "class", "svelte-juq9bx");
			add_location(li0, file$2, 38, 4, 661);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-juq9bx");
			add_location(img1, file$2, 39, 8, 750);
			attr(span1, "class", "svelte-juq9bx");
			add_location(span1, file$2, 39, 55, 797);
			attr(li1, "class", "svelte-juq9bx");
			add_location(li1, file$2, 39, 4, 746);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-juq9bx");
			add_location(img2, file$2, 40, 8, 836);
			attr(span2, "class", "svelte-juq9bx");
			add_location(span2, file$2, 40, 55, 883);
			attr(li2, "class", "svelte-juq9bx");
			add_location(li2, file$2, 40, 4, 832);
			attr(ul, "class", "pillared svelte-juq9bx");
			add_location(ul, file$2, 37, 0, 635);
		},
