...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-20m2nx");
			add_location(img0, file$2, 29, 12, 471);
			attr(h20, "class", "svelte-20m2nx");
			add_location(h20, file$2, 29, 8, 467);
			attr(li0, "class", "svelte-20m2nx");
			add_location(li0, file$2, 29, 4, 463);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-20m2nx");
			add_location(img1, file$2, 30, 12, 552);
			attr(h21, "class", "svelte-20m2nx");
			add_location(h21, file$2, 30, 8, 548);
			attr(li1, "class", "svelte-20m2nx");
			add_location(li1, file$2, 30, 4, 544);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-20m2nx");
			add_location(img2, file$2, 31, 12, 634);
			attr(h22, "class", "svelte-20m2nx");
			add_location(h22, file$2, 31, 8, 630);
			attr(li2, "class", "svelte-20m2nx");
			add_location(li2, file$2, 31, 4, 626);
			attr(ul, "class", "pillared svelte-20m2nx");
			add_location(ul, file$2, 28, 0, 437);
		},
