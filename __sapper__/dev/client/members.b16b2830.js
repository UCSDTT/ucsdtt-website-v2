...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 75, 2, 1474);
...
function create_fragment(ctx) {
	var p0, t0, t1, t2, p1, t3, t4, t5, t6, div0, img, img_src_value, img_alt_value, t7, div1, dispose;
	...
	return {
		...
		h: function hydrate() {
			add_location(p0, file, 71, 0, 1422);
			add_location(p1, file, 72, 0, 1438);
			...
			add_location(img, file, 87, 2, 1646);
			attr(div0, "class", "class-img-container svelte-fq286g");
			add_location(div0, file, 86, 0, 1610);
			attr(div1, "class", "brother-info svelte-fq286g");
			add_location(div1, file, 95, 0, 1775);
