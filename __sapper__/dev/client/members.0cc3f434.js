...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-16fjnyt");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 64, 2, 1298);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-16fjnyt");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 76, 2, 1470);
			attr(div0, "class", "class-img-container svelte-16fjnyt");
			add_location(div0, file, 75, 0, 1434);
			attr(div1, "class", "space-maker");
			add_location(div1, file, 85, 2, 1628);
			attr(div2, "class", "brother-infp");
			add_location(div2, file, 84, 0, 1599);
