...
function create_header_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 69, 8, 1547);
		},
...
function create_default_slot_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 71, 12, 1607);
			add_location(li1, file$3, 72, 12, 1640);
			add_location(li2, file$3, 73, 12, 1673);
			add_location(li3, file$3, 74, 12, 1706);
			add_location(li4, file$3, 75, 12, 1739);
			add_location(ul, file$3, 70, 8, 1590);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 77, 8, 1782);
		},
...
function create_header_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 83, 8, 1941);
		},
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 85, 12, 2002);
			add_location(li1, file$3, 86, 12, 2035);
			add_location(li2, file$3, 87, 12, 2068);
			add_location(li3, file$3, 88, 12, 2101);
			add_location(li4, file$3, 89, 12, 2134);
			add_location(ul, file$3, 84, 8, 1985);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 91, 8, 2177);
		},
...
function create_header_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h2, "slot", "header");
			add_location(h2, file$3, 97, 8, 2334);
		},
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(li0, file$3, 99, 12, 2398);
			add_location(li1, file$3, 100, 12, 2431);
			add_location(li2, file$3, 101, 12, 2464);
			add_location(li3, file$3, 102, 12, 2497);
			add_location(li4, file$3, 103, 12, 2530);
			add_location(ul, file$3, 98, 8, 2381);
			attr(img, "src", "images/sigma_fun.jpg");
			attr(img, "alt", "sigmas having fun");
			attr(img, "width", "100%");
			add_location(img, file$3, 105, 8, 2573);
		},
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img0, "class", "svelte-1ji9ojj");
			add_location(img0, file$3, 54, 8, 1098);
			attr(span0, "class", "svelte-1ji9ojj");
			add_location(span0, file$3, 55, 8, 1154);
			attr(li0, "class", "svelte-1ji9ojj");
			add_location(li0, file$3, 53, 4, 1054);
			attr(img1, "src", "icons/pillar-white.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1ji9ojj");
			add_location(img1, file$3, 58, 8, 1238);
			attr(span1, "class", "svelte-1ji9ojj");
			add_location(span1, file$3, 59, 8, 1294);
			attr(li1, "class", "svelte-1ji9ojj");
			add_location(li1, file$3, 57, 4, 1193);
			attr(img2, "src", "icons/pillar-white.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1ji9ojj");
			add_location(img2, file$3, 62, 8, 1378);
			attr(span2, "class", "svelte-1ji9ojj");
			add_location(span2, file$3, 63, 8, 1434);
			attr(li2, "class", "svelte-1ji9ojj");
			add_location(li2, file$3, 61, 4, 1334);
			attr(ul, "class", "pillared svelte-1ji9ojj");
			add_location(ul, file$3, 52, 0, 1028);
