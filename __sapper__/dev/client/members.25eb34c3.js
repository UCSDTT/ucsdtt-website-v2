...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p0, "class", "svelte-1viwg8y");
			add_location(p0, file, 62, 0, 1202);
			attr(p1, "class", "svelte-1viwg8y");
			add_location(p1, file, 63, 0, 1217);
			attr(p2, "class", "svelte-1viwg8y");
			add_location(p2, file, 64, 0, 1232);
			attr(p3, "class", "svelte-1viwg8y");
			add_location(p3, file, 65, 0, 1247);
			attr(div0, "class", "cursor-box svelte-1viwg8y");
			set_style(div0, "top", ctx.picY);
			set_style(div0, "left", ctx.picX);
			add_location(div0, file, 69, 0, 1331);
			attr(img, "class", "class-img");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 79, 2, 1453);
			attr(div1, "class", "class-img-container svelte-1viwg8y");
			add_location(div1, file, 78, 0, 1417);
