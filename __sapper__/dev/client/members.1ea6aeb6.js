...
function create_else_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			add_location(div, file, 210, 2, 4738);
		},
...
function create_if_block(ctx) {
	var h4, t0, t1, t2, t3, t4, select, t5, div0, t6, t7, div1, img, img_src_value, img_alt_value, t8, div2, dispose;

	var each_value_1 = Object.keys(ctx.pledgeClasses);
	...
	var if_block0 = (ctx.boxVisible) && create_if_block_3(ctx);
	...
	return {
		...
		l: function claim(nodes) {
			h4 = claim_element(nodes, "H4", { class: true }, false);
			var h4_nodes = children(h4);

			t0 = claim_text(h4_nodes, "mx: ");
			t1 = claim_text(h4_nodes, ctx.mx);
			t2 = claim_text(h4_nodes, " my: ");
			t3 = claim_text(h4_nodes, ctx.my);
			t4 = claim_text(h4_nodes, " class: \n    ");

			select = claim_element(h4_nodes, "SELECT", { class: true }, false);
		...
		h: function hydrate() {
			...
			attr(select, "class", "class-select svelte-1vozu2z");
			add_location(select, file, 155, 4, 3462);
			attr(h4, "class", "svelte-1vozu2z");
			add_location(h4, file, 154, 2, 3428);
			attr(div0, "class", "space-maker svelte-1vozu2z");
			add_location(div0, file, 165, 2, 3687);
			attr(img, "class", "class-img svelte-1vozu2z");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 180, 4, 3937);
			attr(div1, "class", "class-img-container svelte-1vozu2z");
			add_location(div1, file, 179, 2, 3899);
			attr(div2, "class", "brother-info svelte-1vozu2z");
			add_location(div2, file, 188, 2, 4080);
		...
		p: function update(changed, ctx) {
			...
			if (changed.pledgeClasses) {
				each_value_1 = Object.keys(ctx.pledgeClasses);
...
// (157:6) {#each Object.keys(pledgeClasses) as key}
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(option, file, 157, 8, 3592);
		},
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1vozu2z");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 168, 4, 3743);
...
function create_else_block(ctx) {
	...
	return {
		c: function create() {
			h4 = element("h4");
			t = text("Hi! Click on a brother (from the class) to see more information.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t = claim_text(h4_nodes, "Hi! Click on a brother (from the class) to see more information.");
			h4_nodes.forEach(detach);
			this.h();
		},
		...
		h: function hydrate() {
			attr(h4, "class", "svelte-1vozu2z");
			add_location(h4, file, 204, 6, 4609);
		},
...
function create_if_block_1(ctx) {
	...
	var each_value = Object.keys(ctx.curBrother);
	...
	return {
		...
		p: function update(changed, ctx) {
			if (changed.curBrother) {
				each_value = Object.keys(ctx.curBrother);
...
// (192:8) {#if curBrother[key].length !== 0 &&            key !== 'pixelLocationX' &&           key !== 'pixelLocationY' &&           key !== 'city, state, country' &&           key !== 'email' &&           key !== 'last updated' &&           key !== 'what i do' &&           key !== 'phone number'         }
function create_if_block_2(ctx) {
	var div, h5, t0_value = ctx.key, t0, t1, h4, t2_value = ctx.curBrother[ctx.key], t2;
	...
	return {
		...
		l: function claim(nodes) {
			...
			h5 = claim_element(div_nodes, "H5", { class: true }, false);
			...
			h4 = claim_element(div_nodes, "H4", { class: true }, false);
			var h4_nodes = children(h4);
		...
		h: function hydrate() {
			attr(h5, "class", "brother-key svelte-1vozu2z");
			add_location(h5, file, 200, 15, 4495);
			attr(h4, "class", "svelte-1vozu2z");
			add_location(h4, file, 200, 50, 4530);
			add_location(div, file, 200, 10, 4490);
		},
		...
		p: function update(changed, ctx) {
			if ((changed.curBrother) && t0_value !== (t0_value = ctx.key)) {
				set_data(t0, t0_value);
			}

			if ((changed.curBrother) && t2_value !== (t2_value = ctx.curBrother[ctx.key])) {
...
// (191:6) {#each Object.keys(curBrother) as key}
function create_each_block(ctx) {
	var if_block_anchor;

	var if_block = (ctx.curBrother[ctx.key].length !== 0 && 
          ctx.key !== 'pixelLocationX' &&
          ctx.key !== 'pixelLocationY' &&
          ctx.key !== 'city, state, country' &&
          ctx.key !== 'email' &&
          ctx.key !== 'last updated' &&
          ctx.key !== 'what i do' &&
          ctx.key !== 'phone number') && create_if_block_2(ctx);
	...
	return {
		...
		p: function update(changed, ctx) {
			if (ctx.curBrother[ctx.key].length !== 0 && 
          ctx.key !== 'pixelLocationX' &&
          ctx.key !== 'pixelLocationY' &&
          ctx.key !== 'city, state, country' &&
          ctx.key !== 'email' &&
