...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1pxs0bu");
			add_location(img, file, 81, 8, 1455);
			attr(div, "class", "carousel svelte-1pxs0bu");
			add_location(div, file, 80, 6, 1424);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-1pxs0bu");
			add_location(button0, file, 77, 2, 1309);
			attr(div0, "class", "carousel-wrapper svelte-1pxs0bu");
			add_location(div0, file, 78, 2, 1369);
			attr(button1, "class", "carousel-button button-right svelte-1pxs0bu");
			add_location(button1, file, 85, 2, 1563);
			attr(div1, "class", "button-wrapper svelte-1pxs0bu");
			add_location(div1, file, 76, 0, 1278);
		},
