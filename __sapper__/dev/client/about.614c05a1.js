...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-ty11hz");
			add_location(img, file, 81, 8, 1456);
			attr(div, "class", "carousel svelte-ty11hz");
			add_location(div, file, 80, 6, 1425);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-ty11hz");
			add_location(button0, file, 77, 2, 1310);
			attr(div0, "class", "carousel-wrapper svelte-ty11hz");
			add_location(div0, file, 78, 2, 1370);
			attr(button1, "class", "carousel-button button-right svelte-ty11hz");
			add_location(button1, file, 85, 2, 1564);
			attr(div1, "class", "button-wrapper svelte-ty11hz");
			add_location(div1, file, 76, 0, 1279);
		},
