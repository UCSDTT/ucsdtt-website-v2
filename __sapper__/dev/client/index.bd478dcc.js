...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(div, "class", "hero-div svelte-1vfv7o9");
			add_location(div, file$2, 36, 0, 658);
			add_location(br0, file$2, 53, 0, 1012);
			add_location(br1, file$2, 54, 0, 1018);
			add_location(br2, file$2, 55, 0, 1024);
			add_location(br3, file$2, 56, 0, 1030);
			add_location(br4, file$2, 57, 0, 1036);
			add_location(br5, file$2, 58, 0, 1042);
			add_location(br6, file$2, 59, 0, 1048);
			add_location(br7, file$2, 60, 0, 1054);
			add_location(br8, file$2, 61, 0, 1060);
			add_location(br9, file$2, 62, 0, 1066);
			add_location(br10, file$2, 63, 0, 1072);
			add_location(br11, file$2, 64, 0, 1078);
			add_location(br12, file$2, 65, 0, 1084);
			add_location(br13, file$2, 66, 0, 1090);
			add_location(br14, file$2, 67, 0, 1096);
			add_location(br15, file$2, 68, 0, 1102);
			add_location(br16, file$2, 69, 0, 1108);
			add_location(br17, file$2, 70, 0, 1114);
			add_location(br18, file$2, 71, 0, 1120);
			add_location(br19, file$2, 72, 0, 1126);
			add_location(br20, file$2, 73, 0, 1132);
			add_location(br21, file$2, 74, 0, 1138);
			add_location(br22, file$2, 75, 0, 1144);
			add_location(br23, file$2, 76, 0, 1150);
			add_location(br24, file$2, 77, 0, 1156);
			add_location(br25, file$2, 78, 0, 1162);
			add_location(br26, file$2, 79, 0, 1168);
			add_location(br27, file$2, 80, 0, 1174);
			add_location(br28, file$2, 81, 0, 1180);
			add_location(br29, file$2, 82, 0, 1186);
			add_location(br30, file$2, 83, 0, 1192);
			add_location(br31, file$2, 84, 0, 1198);
			add_location(br32, file$2, 85, 0, 1204);
			add_location(br33, file$2, 86, 0, 1210);
			add_location(br34, file$2, 87, 0, 1216);
			add_location(br35, file$2, 88, 0, 1222);
			add_location(br36, file$2, 89, 0, 1228);
			add_location(br37, file$2, 90, 0, 1234);
			add_location(br38, file$2, 91, 0, 1240);
			add_location(br39, file$2, 92, 0, 1246);
			add_location(br40, file$2, 93, 0, 1252);
			add_location(br41, file$2, 94, 0, 1258);
			add_location(br42, file$2, 95, 0, 1264);
			add_location(br43, file$2, 96, 0, 1270);
			add_location(br44, file$2, 97, 0, 1276);
			add_location(br45, file$2, 98, 0, 1282);
			add_location(br46, file$2, 99, 0, 1288);
			add_location(br47, file$2, 100, 0, 1294);
			add_location(br48, file$2, 101, 0, 1300);
			add_location(br49, file$2, 102, 0, 1306);
			add_location(br50, file$2, 103, 0, 1312);
			add_location(br51, file$2, 104, 0, 1318);
			add_location(br52, file$2, 105, 0, 1324);
			add_location(br53, file$2, 106, 0, 1330);
			add_location(br54, file$2, 107, 0, 1336);
			add_location(br55, file$2, 108, 0, 1342);
			add_location(br56, file$2, 109, 0, 1348);
			add_location(br57, file$2, 110, 0, 1354);
			add_location(br58, file$2, 111, 0, 1360);
			add_location(br59, file$2, 112, 0, 1366);
			add_location(br60, file$2, 113, 0, 1372);
			add_location(br61, file$2, 114, 0, 1378);
			add_location(br62, file$2, 115, 0, 1384);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$2, 116, 14, 1404);
			attr(p, "class", "svelte-1vfv7o9");
			add_location(p, file$2, 116, 0, 1390);
		},
