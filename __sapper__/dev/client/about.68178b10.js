...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(h1, "class", "svelte-1jzlxxy");
			add_location(h1, file, 35, 2, 792);
			attr(p0, "class", "svelte-1jzlxxy");
			add_location(p0, file, 36, 2, 847);
			add_location(strong0, file, 44, 4, 1150);
			attr(p1, "class", "svelte-1jzlxxy");
			add_location(p1, file, 42, 2, 1100);
			add_location(strong1, file, 50, 4, 1381);
			add_location(strong2, file, 51, 4, 1415);
			add_location(strong3, file, 52, 4, 1450);
			add_location(strong4, file, 53, 4, 1490);
			add_location(strong5, file, 54, 4, 1523);
			add_location(strong6, file, 55, 4, 1555);
			add_location(strong7, file, 56, 4, 1587);
			add_location(strong8, file, 57, 4, 1619);
			add_location(strong9, file, 58, 4, 1650);
			add_location(strong10, file, 59, 4, 1688);
			add_location(strong11, file, 60, 4, 1741);
			add_location(strong12, file, 61, 4, 1775);
			add_location(strong13, file, 62, 8, 1812);
			attr(p2, "class", "svelte-1jzlxxy");
			add_location(p2, file, 49, 2, 1373);
			add_location(strong14, file, 66, 4, 1918);
			add_location(strong15, file, 67, 4, 1965);
			attr(p3, "class", "svelte-1jzlxxy");
			add_location(p3, file, 64, 2, 1855);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-1jzlxxy");
			add_location(img0, file, 69, 2, 2002);
			attr(img1, "src", "images/founders.jpg");
			attr(img1, "alt", "the mighty founders");
			attr(img1, "class", "svelte-1jzlxxy");
			add_location(img1, file, 70, 2, 2076);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-1jzlxxy");
			add_location(div, file, 34, 0, 772);
		},
