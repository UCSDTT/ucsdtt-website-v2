...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 48, 6, 959);
			attr(div, "class", "carousel svelte-1okpdjz");
			add_location(div, file, 47, 4, 930);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-1okpdjz");
			add_location(div, file, 45, 0, 879);
		},
