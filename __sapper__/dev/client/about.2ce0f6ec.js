...
function create_if_block_2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-left svelte-1ukexg7");
			add_location(button, file, 137, 6, 2672);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1ukexg7");
			add_location(img, file, 144, 10, 2879);
			attr(div, "class", "carousel svelte-1ukexg7");
			add_location(div, file, 143, 8, 2846);
		},
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button, "class", "carousel-button button-right svelte-1ukexg7");
			add_location(button, file, 152, 6, 3054);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "carousel-wrapper svelte-1ukexg7");
			add_location(div0, file, 141, 4, 2787);
			attr(div1, "class", "button-wrapper svelte-1ukexg7");
			add_location(div1, file, 135, 2, 2617);
			attr(figcaption, "class", "carousel-caption svelte-1ukexg7");
			add_location(figcaption, file, 157, 2, 3177);
			attr(figure, "class", "figure-wrapper svelte-1ukexg7");
			add_location(figure, file, 134, 0, 2583);
