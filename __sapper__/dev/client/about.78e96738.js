...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 55, 0, 910);
			add_location(h3, file, 57, 0, 926);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-1shd8fn");
			add_location(img0, file, 61, 4, 1036);
			attr(h40, "class", "svelte-1shd8fn");
			add_location(h40, file, 62, 4, 1084);
			add_location(p0, file, 63, 4, 1109);
			attr(div0, "class", "pillar svelte-1shd8fn");
			add_location(div0, file, 60, 2, 1011);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1shd8fn");
			add_location(img1, file, 71, 4, 1445);
			attr(h41, "class", "svelte-1shd8fn");
			add_location(h41, file, 72, 4, 1493);
			add_location(p1, file, 73, 4, 1519);
			attr(div1, "class", "pillar svelte-1shd8fn");
			add_location(div1, file, 70, 2, 1420);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1shd8fn");
			add_location(img2, file, 82, 4, 1882);
			attr(h42, "class", "svelte-1shd8fn");
			add_location(h42, file, 83, 4, 1930);
			add_location(p2, file, 84, 4, 1959);
			attr(div2, "class", "pillar svelte-1shd8fn");
			add_location(div2, file, 81, 2, 1857);
			attr(div3, "class", "pillars svelte-1shd8fn");
			add_location(div3, file, 59, 0, 987);
		},
