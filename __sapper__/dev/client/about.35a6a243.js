import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, c as claim_element, b as children, f as detach, g as attr, h as add_location, j as insert, k as append, D as add_render_callback, L as create_bidirectional_transition, t as text, a as space, d as claim_text, H as listen, q as transition_in, B as group_outros, r as transition_out, C as check_outros, I as run_all, J as onMount, n as noop, m as mount_component, u as destroy_component } from './chunk.b5534b6a.js';
import { f as fade, P as Pillars } from './chunk.c7afdc88.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1t4olh1");
			add_location(img, file, 110, 8, 2069);
			attr(div, "class", "carousel svelte-1t4olh1");
			add_location(div, file, 109, 6, 2038);
		},
		...
		i: function intro(local) {
			if (current) return;
			add_render_callback(() => {
				if (!img_transition) img_transition = create_bidirectional_transition(img, fade, {duration:500}, true);
		...
		o: function outro(local) {
			if (!img_transition) img_transition = create_bidirectional_transition(img, fade, {duration:500}, false);
...
function create_fragment(ctx) {
	var div1, button0, t0, t1, div0, t2, button1, t3, current, dispose;
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button button-left svelte-1t4olh1");
			add_location(button0, file, 101, 2, 1874);
			attr(div0, "class", "carousel-wrapper svelte-1t4olh1");
			add_location(div0, file, 107, 2, 1983);
			attr(button1, "class", "carousel-button button-right svelte-1t4olh1");
			add_location(button1, file, 114, 2, 2177);
			attr(div1, "class", "button-wrapper svelte-1t4olh1");
			add_location(div1, file, 100, 0, 1843);

			dispose = [
				listen(button0, "click", ctx.handlePrevClick),
				listen(button1, "click", ctx.handleNextClick)
			];
		},
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handlePrevClick() {
    clearInterval(interval);
    prevImage();
    interval = setInterval(prevImage, 5000);
  }
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 38, 2, 883);
			attr(p0, "class", "svelte-a4aodc");
			add_location(p0, file$1, 39, 2, 938);
			add_location(strong0, file$1, 46, 4, 1199);
			attr(p1, "class", "svelte-a4aodc");
			add_location(p1, file$1, 45, 2, 1191);
			add_location(strong1, file$1, 53, 4, 1471);
			add_location(strong2, file$1, 54, 4, 1505);
			add_location(strong3, file$1, 55, 4, 1540);
			add_location(strong4, file$1, 56, 4, 1580);
			add_location(strong5, file$1, 57, 4, 1613);
			add_location(strong6, file$1, 58, 4, 1645);
			add_location(strong7, file$1, 59, 4, 1677);
			add_location(strong8, file$1, 60, 4, 1709);
			add_location(strong9, file$1, 61, 4, 1740);
			add_location(strong10, file$1, 62, 4, 1778);
			add_location(strong11, file$1, 63, 4, 1831);
			add_location(strong12, file$1, 64, 4, 1865);
			add_location(strong13, file$1, 65, 8, 1902);
			attr(p2, "class", "svelte-a4aodc");
			add_location(p2, file$1, 52, 2, 1463);
			add_location(strong14, file$1, 69, 4, 2008);
			add_location(strong15, file$1, 70, 4, 2055);
			attr(p3, "class", "svelte-a4aodc");
			add_location(p3, file$1, 67, 2, 1945);
			attr(img0, "id", "founders");
			attr(img0, "src", "images/founders.jpg");
			attr(img0, "alt", "the mighty founders");
			attr(img0, "class", "svelte-a4aodc");
			add_location(img0, file$1, 72, 2, 2092);
			attr(img1, "src", "images/hamntongs.png");
			attr(img1, "alt", "the seals");
			attr(img1, "class", "svelte-a4aodc");
			add_location(img1, file$1, 73, 2, 2166);
			attr(div, "id", "letter");
			attr(div, "class", "svelte-a4aodc");
			add_location(div, file$1, 37, 0, 863);
		},
