...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-f9jg75");
			add_location(img, file, 68, 8, 1248);
			attr(div, "class", "carousel svelte-f9jg75");
			add_location(div, file, 67, 6, 1217);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(button0, "class", "carousel-button svelte-f9jg75");
			add_location(button0, file, 64, 2, 1114);
			attr(div0, "class", "carousel-wrapper svelte-f9jg75");
			add_location(div0, file, 65, 2, 1162);
			attr(button1, "class", "carousel-button svelte-f9jg75");
			add_location(button1, file, 72, 2, 1356);
			attr(div1, "class", "button-wrapper svelte-f9jg75");
			add_location(div1, file, 63, 0, 1083);
		},
