...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-f1umht");
			add_location(div0, file$2, 53, 0, 890);

			attr(button, "class", "svelte-f1umht");
			add_location(button, file$2, 58, 8, 1056);
			attr(section, "class", "header svelte-f1umht");
			add_location(section, file$2, 56, 4, 989);
			add_location(hr0, file$2, 60, 1, 1128);

			add_location(hr1, file$2, 62, 1, 1149);
			attr(div1, "class", "modal svelte-f1umht");
			add_location(div1, file$2, 55, 0, 965);
