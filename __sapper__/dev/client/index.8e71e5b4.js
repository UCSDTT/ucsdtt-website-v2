...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$2, 48, 0, 860);
			attr(h1, "class", "svelte-12z78b6");
			add_location(h1, file$2, 60, 1, 1073);
			attr(div1, "class", "pillars-div svelte-12z78b6");
			add_location(div1, file$2, 59, 0, 1046);
			add_location(br0, file$2, 68, 0, 1276);
			add_location(br1, file$2, 69, 0, 1282);
			add_location(br2, file$2, 70, 0, 1288);
			add_location(br3, file$2, 71, 0, 1294);
			add_location(br4, file$2, 72, 0, 1300);
			add_location(br5, file$2, 73, 0, 1306);
			add_location(br6, file$2, 74, 0, 1312);
			add_location(br7, file$2, 75, 0, 1318);
			add_location(br8, file$2, 76, 0, 1324);
			add_location(br9, file$2, 77, 0, 1330);
			add_location(br10, file$2, 78, 0, 1336);
			add_location(br11, file$2, 79, 0, 1342);
			add_location(br12, file$2, 80, 0, 1348);
			add_location(br13, file$2, 81, 0, 1354);
			add_location(br14, file$2, 82, 0, 1360);
			add_location(br15, file$2, 83, 0, 1366);
			add_location(br16, file$2, 84, 0, 1372);
			add_location(br17, file$2, 85, 0, 1378);
			add_location(br18, file$2, 86, 0, 1384);
			add_location(br19, file$2, 87, 0, 1390);
			add_location(br20, file$2, 88, 0, 1396);
			add_location(br21, file$2, 89, 0, 1402);
			add_location(br22, file$2, 90, 0, 1408);
			add_location(br23, file$2, 91, 0, 1414);
			add_location(br24, file$2, 92, 0, 1420);
			add_location(br25, file$2, 93, 0, 1426);
			add_location(br26, file$2, 94, 0, 1432);
			add_location(br27, file$2, 95, 0, 1438);
			add_location(br28, file$2, 96, 0, 1444);
			add_location(br29, file$2, 97, 0, 1450);
			add_location(br30, file$2, 98, 0, 1456);
			add_location(br31, file$2, 99, 0, 1462);
			add_location(br32, file$2, 100, 0, 1468);
			add_location(br33, file$2, 101, 0, 1474);
			add_location(br34, file$2, 102, 0, 1480);
			add_location(br35, file$2, 103, 0, 1486);
			add_location(br36, file$2, 104, 0, 1492);
			add_location(br37, file$2, 105, 0, 1498);
			add_location(br38, file$2, 106, 0, 1504);
			add_location(br39, file$2, 107, 0, 1510);
			add_location(br40, file$2, 108, 0, 1516);
			add_location(br41, file$2, 109, 0, 1522);
			add_location(br42, file$2, 110, 0, 1528);
			add_location(br43, file$2, 111, 0, 1534);
			add_location(br44, file$2, 112, 0, 1540);
			add_location(br45, file$2, 113, 0, 1546);
			add_location(br46, file$2, 114, 0, 1552);
			add_location(br47, file$2, 115, 0, 1558);
			add_location(br48, file$2, 116, 0, 1564);
			add_location(br49, file$2, 117, 0, 1570);
			add_location(br50, file$2, 118, 0, 1576);
			add_location(br51, file$2, 119, 0, 1582);
			add_location(br52, file$2, 120, 0, 1588);
			add_location(br53, file$2, 121, 0, 1594);
			add_location(br54, file$2, 122, 0, 1600);
			add_location(br55, file$2, 123, 0, 1606);
			add_location(br56, file$2, 124, 0, 1612);
			add_location(br57, file$2, 125, 0, 1618);
			add_location(br58, file$2, 126, 0, 1624);
			add_location(br59, file$2, 127, 0, 1630);
			add_location(br60, file$2, 128, 0, 1636);
			add_location(br61, file$2, 129, 0, 1642);
			add_location(br62, file$2, 130, 0, 1648);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$2, 131, 14, 1668);
			attr(p, "class", "svelte-12z78b6");
			add_location(p, file$2, 131, 0, 1654);
		},
