...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-1faz4cq");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 49, 2, 1077);
			attr(div, "class", "class-img-container svelte-1faz4cq");
			add_location(div, file, 48, 0, 1041);
		},
...
function instance($$self, $$props, $$invalidate) {
  ...
  alert(curClass.className);
  alert(curClass.image);
