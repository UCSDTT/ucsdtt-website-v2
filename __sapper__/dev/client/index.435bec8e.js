...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(li0, "class", "modal-li svelte-pz6vt");
			add_location(li0, file$3, 101, 12, 2449);
			attr(li1, "class", "modal-li svelte-pz6vt");
			add_location(li1, file$3, 102, 12, 2499);
			attr(li2, "class", "modal-li svelte-pz6vt");
			add_location(li2, file$3, 103, 12, 2549);
			attr(li3, "class", "modal-li svelte-pz6vt");
			add_location(li3, file$3, 104, 12, 2599);
			attr(li4, "class", "modal-li svelte-pz6vt");
			add_location(li4, file$3, 105, 12, 2649);
			attr(ul, "class", "pillared svelte-pz6vt");
