...
function create_fragment$2(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div0, "class", "modal-background svelte-14qw413");
			add_location(div0, file$2, 38, 0, 646);

			add_location(hr0, file$2, 42, 1, 771);

			add_location(hr1, file$2, 44, 1, 792);
			attr(button, "class", "svelte-14qw413");
			add_location(button, file$2, 46, 1, 799);
			attr(div1, "class", "modal svelte-14qw413");
			add_location(div1, file$2, 40, 0, 721);
