...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "cursor-box svelte-1ucm0gq");
			set_style(div, "top", ctx.picY);
			set_style(div, "left", ctx.picX);
			add_location(div, file, 69, 2, 1356);
...
function create_fragment(ctx) {
	var t0, div0, img, img_src_value, img_alt_value, t1, div2, div1, dispose;
	...
	return {
		...
		h: function hydrate() {
			attr(img, "class", "class-img svelte-1ucm0gq");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 81, 2, 1528);
			attr(div0, "class", "class-img-container svelte-1ucm0gq");
			add_location(div0, file, 80, 0, 1492);
			attr(div1, "class", "space-maker svelte-1ucm0gq");
			add_location(div1, file, 90, 2, 1686);
			attr(div2, "class", "brother-info");
			add_location(div2, file, 89, 0, 1657);
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handleMouseClick(event) {
	...
	$$self.$$.update = ($$dirty = { my: 1, mx: 1 }) => {
		if ($$dirty.my) { $$invalidate('picY', picY = `${my - 130}px`); }
		if ($$dirty.mx) { $$invalidate('picX', picX = `${mx - 70}px`); }
	};
