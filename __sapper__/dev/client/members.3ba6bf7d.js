...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p0, "class", "svelte-4l1uk5");
			add_location(p0, file, 63, 0, 1230);
			attr(p1, "class", "svelte-4l1uk5");
			add_location(p1, file, 64, 0, 1245);
			attr(p2, "class", "svelte-4l1uk5");
			add_location(p2, file, 65, 0, 1260);
			attr(p3, "class", "svelte-4l1uk5");
			add_location(p3, file, 66, 0, 1275);
			attr(div0, "class", "cursor-box svelte-4l1uk5");
			set_style(div0, "top", ctx.picY);
			set_style(div0, "left", ctx.picX);
			add_location(div0, file, 70, 0, 1359);
			attr(img, "class", "class-img svelte-4l1uk5");
			attr(img, "src", img_src_value = ctx.curClass.image);
			attr(img, "alt", img_alt_value = ctx.curClass.className);
			add_location(img, file, 80, 2, 1481);
			attr(div1, "class", "class-img-container svelte-4l1uk5");
			add_location(div1, file, 79, 0, 1445);
