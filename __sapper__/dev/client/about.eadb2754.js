...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-1ln44i4");
			add_location(img, file, 53, 6, 1019);
			attr(div, "class", "carousel svelte-1ln44i4");
			add_location(div, file, 52, 4, 990);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-1ln44i4");
			add_location(div, file, 50, 0, 939);
		},
