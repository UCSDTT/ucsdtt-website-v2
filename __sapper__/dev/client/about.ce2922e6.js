...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 46, 6, 917);
			attr(div, "class", "carousel svelte-6duk3w");
			add_location(div, file, 45, 4, 888);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-6duk3w");
			add_location(div, file, 43, 0, 837);
		},
