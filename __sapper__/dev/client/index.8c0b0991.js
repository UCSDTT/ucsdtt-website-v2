...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(span, file$1, 74, 12, 1737);
		},
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(span, "class", "formal");
			add_location(span, file$1, 77, 12, 1829);
		},
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file$1, 72, 4, 1693);
			add_location(section, file$1, 71, 0, 1679);
		},
...
function instance$1($$self, $$props, $$invalidate) {
    ...
    let unusedWordIndices = new Set(indices);
    ...
    function pickNextIndex(curIndex) {
        unusedWordIndices.delete(curIndex);
        console.log(`size: ${unusedWordIndices.length}`);
        if (unusedWordIndices.length === 0) {
            unusedWordIndices = new Set(indices);
        }
        let setIndex = Math.floor(Math.random() * unusedWordIndices.length);
        console.log(setIndex);
        return unusedWordIndices[setIndex];
    }

    function getIndices() {
        return brotherLabels.map((v, i) => i);
    }
	...
	Object.keys($$props).forEach(key => {
		if (!writable_props.includes(key) && !key.startsWith('$$')) console_1.warn(`<WeAre> was created with unknown prop '${key}'`);
	});
...
class WeAre extends SvelteComponentDev {
	constructor(options) {
		...
		if (ctx.brotherLabels === undefined && !('brotherLabels' in props)) {
			console_1.warn("<WeAre> was created without expected prop 'brotherLabels'");
		}
	}
...
function create_header_slot$1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(h3, "slot", "header");
			add_location(h3, file$5, 80, 1, 1660);
		},
...
function create_left_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(p, file$5, 81, 1, 1731);
		},
...
function create_right_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(p, "slot", "right");
			attr(p, "class", "svelte-ls5l35");
			add_location(p, file$5, 85, 1, 1963);
		},
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file$5, 68, 0, 1466);
			attr(h1, "class", "svelte-ls5l35");
			add_location(h1, file$5, 92, 1, 2231);
			attr(div1, "class", "pillars-div svelte-ls5l35");
			add_location(div1, file$5, 91, 0, 2204);
			add_location(br0, file$5, 100, 0, 2445);
			add_location(br1, file$5, 101, 0, 2451);
			add_location(br2, file$5, 102, 0, 2457);
			add_location(br3, file$5, 103, 0, 2463);
			add_location(br4, file$5, 104, 0, 2469);
			add_location(br5, file$5, 105, 0, 2475);
			add_location(br6, file$5, 106, 0, 2481);
			add_location(br7, file$5, 107, 0, 2487);
			add_location(br8, file$5, 108, 0, 2493);
			add_location(br9, file$5, 109, 0, 2499);
			add_location(br10, file$5, 110, 0, 2505);
			add_location(br11, file$5, 111, 0, 2511);
			add_location(br12, file$5, 112, 0, 2517);
			add_location(br13, file$5, 113, 0, 2523);
			add_location(br14, file$5, 114, 0, 2529);
			add_location(br15, file$5, 115, 0, 2535);
			add_location(br16, file$5, 116, 0, 2541);
			add_location(br17, file$5, 117, 0, 2547);
			add_location(br18, file$5, 118, 0, 2553);
			add_location(br19, file$5, 119, 0, 2559);
			add_location(br20, file$5, 120, 0, 2565);
			add_location(br21, file$5, 121, 0, 2571);
			add_location(br22, file$5, 122, 0, 2577);
			add_location(br23, file$5, 123, 0, 2583);
			add_location(br24, file$5, 124, 0, 2589);
			add_location(br25, file$5, 125, 0, 2595);
			add_location(br26, file$5, 126, 0, 2601);
			add_location(br27, file$5, 127, 0, 2607);
			add_location(br28, file$5, 128, 0, 2613);
			add_location(br29, file$5, 129, 0, 2619);
			add_location(br30, file$5, 130, 0, 2625);
			add_location(br31, file$5, 131, 0, 2631);
			add_location(br32, file$5, 132, 0, 2637);
			add_location(br33, file$5, 133, 0, 2643);
			add_location(br34, file$5, 134, 0, 2649);
			add_location(br35, file$5, 135, 0, 2655);
			add_location(br36, file$5, 136, 0, 2661);
			add_location(br37, file$5, 137, 0, 2667);
			add_location(br38, file$5, 138, 0, 2673);
			add_location(br39, file$5, 139, 0, 2679);
			add_location(br40, file$5, 140, 0, 2685);
			add_location(br41, file$5, 141, 0, 2691);
			add_location(br42, file$5, 142, 0, 2697);
			add_location(br43, file$5, 143, 0, 2703);
			add_location(br44, file$5, 144, 0, 2709);
			add_location(br45, file$5, 145, 0, 2715);
			add_location(br46, file$5, 146, 0, 2721);
			add_location(br47, file$5, 147, 0, 2727);
			add_location(br48, file$5, 148, 0, 2733);
			add_location(br49, file$5, 149, 0, 2739);
			add_location(br50, file$5, 150, 0, 2745);
			add_location(br51, file$5, 151, 0, 2751);
			add_location(br52, file$5, 152, 0, 2757);
			add_location(br53, file$5, 153, 0, 2763);
			add_location(br54, file$5, 154, 0, 2769);
			add_location(br55, file$5, 155, 0, 2775);
			add_location(br56, file$5, 156, 0, 2781);
			add_location(br57, file$5, 157, 0, 2787);
			add_location(br58, file$5, 158, 0, 2793);
			add_location(br59, file$5, 159, 0, 2799);
			add_location(br60, file$5, 160, 0, 2805);
			add_location(br61, file$5, 161, 0, 2811);
			add_location(br62, file$5, 162, 0, 2817);
			attr(a, "href", "https://icons8.com/icons");
			add_location(a, file$5, 163, 14, 2837);
			attr(p, "class", "svelte-ls5l35");
			add_location(p, file$5, 163, 0, 2823);
		},
...
function instance$5($$self) {
	...
	const brotherLabels = ['brothers', 'entrepreneurs', 'leaders'];
