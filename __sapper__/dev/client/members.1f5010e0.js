...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div, file, 82, 2, 1571);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(img, file, 94, 2, 1743);
			attr(div0, "class", "class-img-container svelte-1ct97j0");
			add_location(div0, file, 93, 0, 1707);
			add_location(h2, file, 103, 2, 1901);
			add_location(h3, file, 104, 2, 1939);
			attr(div1, "class", "brother-info svelte-1ct97j0");
			add_location(div1, file, 102, 0, 1872);
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handleMouseClick(event) {
		$$invalidate('mx', mx = event.clientX - 55);
		$$invalidate('my', my = event.clientY - 140);
	...
	$$self.$$.update = ($$dirty = { mx: 1, my: 1 }) => {
		if ($$dirty.mx) { $$invalidate('picX', picX = `${mx}px`); }
		if ($$dirty.my) { $$invalidate('picY', picY = `${my}px`); }
	};
