...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 50, 0, 850);
			add_location(h3, file, 52, 0, 866);
			attr(img0, "src", "icons/pillar.png");
			attr(img0, "alt", "pillar");
			attr(img0, "class", "svelte-1qw0t9e");
			add_location(img0, file, 56, 4, 976);
			attr(h40, "class", "svelte-1qw0t9e");
			add_location(h40, file, 57, 4, 1024);
			add_location(p0, file, 58, 4, 1049);
			attr(div0, "class", "pillar svelte-1qw0t9e");
			add_location(div0, file, 55, 2, 951);
			attr(img1, "src", "icons/pillar.png");
			attr(img1, "alt", "pillar");
			attr(img1, "class", "svelte-1qw0t9e");
			add_location(img1, file, 66, 4, 1385);
			attr(h41, "class", "svelte-1qw0t9e");
			add_location(h41, file, 67, 4, 1433);
			add_location(p1, file, 68, 4, 1459);
			attr(div1, "class", "pillar svelte-1qw0t9e");
			add_location(div1, file, 65, 2, 1360);
			attr(img2, "src", "icons/pillar.png");
			attr(img2, "alt", "pillar");
			attr(img2, "class", "svelte-1qw0t9e");
			add_location(img2, file, 77, 4, 1822);
			attr(h42, "class", "svelte-1qw0t9e");
			add_location(h42, file, 78, 4, 1870);
			add_location(p2, file, 79, 4, 1899);
			attr(div2, "class", "pillar svelte-1qw0t9e");
			add_location(div2, file, 76, 2, 1797);
			attr(div3, "class", "pillars svelte-1qw0t9e");
			add_location(div3, file, 54, 0, 927);
		},
