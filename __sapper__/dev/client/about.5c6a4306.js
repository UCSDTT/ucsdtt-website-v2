...
function create_if_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			attr(img, "class", "svelte-ds3xsg");
			add_location(img, file, 51, 6, 976);
			attr(div, "class", "carousel svelte-ds3xsg");
			add_location(div, file, 50, 4, 947);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			attr(div, "class", "carousel-wrapper svelte-ds3xsg");
			add_location(div, file, 48, 0, 896);
		},
